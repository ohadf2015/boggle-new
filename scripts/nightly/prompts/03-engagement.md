...
`{"id":"03-engagement-__TODAY__-<slug>","date":"__TODAY__","lane":"03-engagement","change":"<one line>","metric":"<posthog:...|sentry:...|supabase:...>","source":"posthog|sentry|supabase","query_hint":"<how to re-measure this in one query>","baseline":<current number>,"direction":"up|down","check_after_days":3}`
