...
export const QRCodeDialog = ({ open, onOpenChange, gameCode, t }) => {
...
export const ValidationModal = ({
  ...
  const handleToggleWord = useCallback((word, isDuplicate) => {
    if (!isDuplicate) {
...
// Final Scores Modal Component
export const FinalScoresModal = ({
  open,
  onOpenChange,
  finalScores,
  tournamentData,
...
export const ExitConfirmDialog = ({ open, onOpenChange, onConfirm, t }) => (
...
export const CancelTournamentDialog = ({ open, onOpenChange, onConfirm, t }) => (
  <AlertDialog open={open} onOpenChange={onOpenChange}>
    <AlertDialogContent className="bg-white dark:bg-slate-800 border-red-500/30">
      <AlertDialogHeader>
        <AlertDialogTitle className="text-slate-900 dark:text-white">
