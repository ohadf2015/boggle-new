...
export const BLAST_TILE_BONUSES: Record<BlastTileType, number> = {
  ...
  locked: 0,       // cooperative obstacle: no per-tile bonus; reward comes from unlock chain completion
  key: 1.5,        // cooperative unlock: reward for collecting a key and triggering the unlock
