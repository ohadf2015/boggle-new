      ...
      // Security headers for all paths
      {
        ...
        headers: [
          ...
          },
          {
            ...
            // When force-disabled, strip the CrazyGames SDK domains only. Monetag (libtl.com SDK +
            // e8ys.com/*.rtmark.net serving) and Google ad domains stay in BOTH branches — they're
            // independent of the CrazyGames toggle. Prod sets CRAZYGAMES_ENABLED=false, so the
            // force-disabled branch is what direct web visitors get → Monetag MUST be there.
            // Monetag In-Page Push (banner zone) loads from nap5k.com then fetches creatives from a
            // ROTATING smart serving domain (observed chain: nap5k.com loader -> jhnwr.com serving -> tzegilo.com creative; all rotate) — these rotate to dodge adblock, so
            // a tight allowlist is inherently brittle. ponytail: pin the observed serving domain(s);
            // upgrade path if banner fill drops = capture the new connect-src/frame-src violation host
            // from the browser console and add it here, or broaden connect-src for ad fetches (weaker CSP).
            value: isCrazyGamesForceDisabled
              // Force-disabled: no SDK script, but still allow iframe embedding for other portals
              ? "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://cdn.lgrckt-in.com https://cdn.lr-in-prod.com https://cdn.lr-ingest.com https://libtl.com https://nap5k.com https://*.nap5k.com https://jhnwr.com https://tzegilo.com https://pagead2.googlesyndication.com https://*.googleadservices.com https://ep2.adtrafficquality.google https://*.posthog.com https://eu.i.posthog.com https://accounts.google.com/gsi/client; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://accounts.google.com/gsi/style; font-src 'self' data: https://fonts.gstatic.com; img-src 'self' data: https: blob:; media-src 'self' data:; connect-src 'self' https://*.supabase.co https://*.sentry.io https://*.logrocket.io https://*.lr-in-prod.com https://*.lgrckt-in.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://*.googlesyndication.com https://*.doubleclick.net https://*.googleadservices.com https://*.adtrafficquality.google https://*.posthog.com https://eu.i.posthog.com https://accounts.google.com/gsi/ https://libtl.com https://nap5k.com https://*.nap5k.com https://e8ys.com https://*.rtmark.net https://jhnwr.com https://tzegilo.com wss: ws:; worker-src 'self' blob:; frame-src 'self' https://libtl.com https://nap5k.com https://*.nap5k.com https://e8ys.com https://*.rtmark.net https://jhnwr.com https://tzegilo.com https://*.googlesyndication.com https://*.doubleclick.net https://googleads.g.doubleclick.net https://accounts.google.com/gsi/; frame-ancestors 'self' https://*.crazygames.com https://crazygames.com https://poki.com https://www.poki.com;"
              // Default: SDK auto-detection enabled — allow CrazyGames SDK script + ads + iframe embedding
              : "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://cdn.lgrckt-in.com https://cdn.lr-in-prod.com https://cdn.lr-ingest.com https://sdk.crazygames.com https://*.crazygames.com https://libtl.com https://nap5k.com https://*.nap5k.com https://jhnwr.com https://tzegilo.com https://pagead2.googlesyndication.com https://*.googleadservices.com https://ep2.adtrafficquality.google https://*.posthog.com https://eu.i.posthog.com https://accounts.google.com/gsi/client; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://accounts.google.com/gsi/style; font-src 'self' data: https://fonts.gstatic.com; img-src 'self' data: https: blob:; media-src 'self' data:; connect-src 'self' https://*.supabase.co https://*.sentry.io https://*.logrocket.io https://*.lr-in-prod.com https://*.lgrckt-in.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://*.crazygames.com https://*.googlesyndication.com https://*.doubleclick.net https://*.googleadservices.com https://*.adtrafficquality.google https://*.posthog.com https://eu.i.posthog.com https://accounts.google.com/gsi/ https://libtl.com https://nap5k.com https://*.nap5k.com https://e8ys.com https://*.rtmark.net https://jhnwr.com https://tzegilo.com wss: ws:; worker-src 'self' blob:; frame-src 'self' https://libtl.com https://nap5k.com https://*.nap5k.com https://e8ys.com https://*.rtmark.net https://jhnwr.com https://tzegilo.com https://*.crazygames.com https://*.googlesyndication.com https://*.doubleclick.net https://googleads.g.doubleclick.net https://accounts.google.com/gsi/; frame-ancestors 'self' https://*.crazygames.com https://crazygames.com https://poki.com https://www.poki.com;",
          },
        ],
      },
    ];
