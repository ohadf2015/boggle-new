      ...
      // CSP frame-ancestors, so embed must receive exactly ONE (permissive) CSP.
      {
        ...
        headers: [
          ...
          },
          {
            ...
            // frame-ancestors also allows feedback-devtools.com: its /preview/:projectId
            // embeds this site so stakeholders can click an element and file feedback.
            // Without it the preview shows a blank frame and its inspection handshake
            // silently never lands. Same list in server/middleware.ts.
