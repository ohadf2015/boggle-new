      ...
      // Security headers for all paths
      {
        ...
        headers: [
          ...
          },
          {
            ...
            // ROTATING smart serving domain (observed: jhnwr.com) — these rotate to dodge adblock, so
            ...
            value: isCrazyGamesForceDisabled
              ...
              ? "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://cdn.lgrckt-in.com https://cdn.lr-in-prod.com https://cdn.lr-ingest.com https://libtl.com https://nap5k.com https://*.nap5k.com https://pagead2.googlesyndication.com https://*.googleadservices.com https://ep2.adtrafficquality.google https://*.posthog.com https://eu.i.posthog.com https://accounts.google.com/gsi/client; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://accounts.google.com/gsi/style; font-src 'self' data: https://fonts.gstatic.com; img-src 'self' data: https: blob:; media-src 'self' data:; connect-src 'self' https://*.supabase.co https://*.sentry.io https://*.logrocket.io https://*.lr-in-prod.com https://*.lgrckt-in.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://*.googlesyndication.com https://*.doubleclick.net https://*.googleadservices.com https://*.adtrafficquality.google https://*.posthog.com https://eu.i.posthog.com https://accounts.google.com/gsi/ https://libtl.com https://nap5k.com https://*.nap5k.com https://e8ys.com https://*.rtmark.net https://jhnwr.com wss: ws:; worker-src 'self' blob:; frame-src 'self' https://libtl.com https://nap5k.com https://*.nap5k.com https://e8ys.com https://*.rtmark.net https://jhnwr.com https://*.googlesyndication.com https://*.doubleclick.net https://googleads.g.doubleclick.net https://accounts.google.com/gsi/; frame-ancestors 'self' https://*.crazygames.com https://crazygames.com https://poki.com https://www.poki.com;"
              // Default: SDK auto-detection enabled — allow CrazyGames SDK script + ads + iframe embedding
              : "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://cdn.lgrckt-in.com https://cdn.lr-in-prod.com https://cdn.lr-ingest.com https://sdk.crazygames.com https://*.crazygames.com https://libtl.com https://nap5k.com https://*.nap5k.com https://pagead2.googlesyndication.com https://*.googleadservices.com https://ep2.adtrafficquality.google https://*.posthog.com https://eu.i.posthog.com https://accounts.google.com/gsi/client; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://accounts.google.com/gsi/style; font-src 'self' data: https://fonts.gstatic.com; img-src 'self' data: https: blob:; media-src 'self' data:; connect-src 'self' https://*.supabase.co https://*.sentry.io https://*.logrocket.io https://*.lr-in-prod.com https://*.lgrckt-in.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://*.crazygames.com https://*.googlesyndication.com https://*.doubleclick.net https://*.googleadservices.com https://*.adtrafficquality.google https://*.posthog.com https://eu.i.posthog.com https://accounts.google.com/gsi/ https://libtl.com https://nap5k.com https://*.nap5k.com https://e8ys.com https://*.rtmark.net https://jhnwr.com wss: ws:; worker-src 'self' blob:; frame-src 'self' https://libtl.com https://nap5k.com https://*.nap5k.com https://e8ys.com https://*.rtmark.net https://jhnwr.com https://*.crazygames.com https://*.googlesyndication.com https://*.doubleclick.net https://googleads.g.doubleclick.net https://accounts.google.com/gsi/; frame-ancestors 'self' https://*.crazygames.com https://crazygames.com https://poki.com https://www.poki.com;",
          },
        ],
      },
    ];
