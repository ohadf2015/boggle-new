...
export const STATIC_WORD_LISTS: Record<Language, string[]> = {
  ...
  ru: [
    ...
    // Интересные слова
    'ДРАКОН', 'ЗАМОК', 'КОРОНА', 'МЕЧА', 'ЩИТ', 'ТРОН', 'КОРОЛЕВСТВО', 'ИМПЕРАТОР',
    'МАГИЯ', 'ЛЕГЕНДА', 'МИФ', 'СКАЗКА', 'СНОВИДЕНИЕ', 'ВИДЕНИЕ', 'СУДЬБА', 'УДАЧА',
    'ПРИКЛЮЧЕНИЕ', 'ПУТЕШЕСТВИЕ', 'ПОИСКИ', 'СОКРОВИЩЕ', 'ТАЙНА', 'ЗАГАДКА', 'ЧУДО', 'ЗАГАДКА',
    // Эмоции и концепции
    'НАДЕЖДА', 'МУЖЕСТВО', 'ХРАБРОСТЬ', 'СИЛА', 'МУДРОСТЬ', 'ИСТИНА', 'ПРАВДА', 'СВОБОДА',
    'РАДОСТЬ', 'СЧАСТЬЕ', 'ЛЮБОВЬ', 'ДРУЖБА', 'ДОВЕРИЕ', 'УВАЖЕНИЕ', 'ЧЕСТЬ', 'СЛАВА',
    // Дополнительные разнообразные слова
    'ОРЕЛ', 'ВОЛК', 'ТИГР', 'ЛЕВ', 'СОКОЛ', 'ЗМЕЯ', 'ФЕНИКС', 'ЕДИНОРОГ',
    'ЯКОРЬ', 'МАЯК', 'КОМПАС', 'КОРАБЛЬ', 'ПОРТ', 'КАПИТАН', 'МОРЯК', 'ПИРАТ',
  ],
};
