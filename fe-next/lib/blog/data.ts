...
export const blogPostsContent: Record<string, PageContent> = {
  ...
  ru: {
    ...
    posts: {
      '10-surprising-benefits-word-games': {
        title: '10 удивительных преимуществ ежедневной игры в словесные игры',
      ...
      'science-behind-word-games': {
        title: 'Наука, стоящая за словесными играми и здоровьем мозга',
      ...
      'daily-challenge-strategies': {
        title: '7 проверенных стратегий для доминирования в таблице лидеров',
      ...
      'multilingual-word-learning': {
        title: 'Полный справочник по многоязычному изучению слов через игры',
      ...
      'top-player-secrets': {
        title: '7 секретов, которые лучшие игроки не хотят раскрывать',
      ...
      'why-word-games-are-addictive': {
        title: 'Почему вы не можете перестать играть в словесные игры (и почему ваш мозг этого не хочет)',
      ...
      'word-game-history': {
        title: 'От древних плиток к цифровым сеткам: невероятная история словесных игр',
        excerpt: 'Украденные идеи, мания к кроссвордам, изобретение домохозяина и одно пятибуквенное слово, которое сломало интернет.',
        readTime: '10 мин чтения',
        category: 'История',
      },
      'word-games-for-kids-education': {
        title: 'Почему каждому учителю нужна словесная игра в своём наборе инструментов',
      ...
      'word-games-and-mental-health': {
        title: 'Как словесные игры стали моим лайфхаком от тревоги (и что об этом думают терапевты)',
      ...
      'multiplayer-word-games-social': {
        title: 'Почему играть в словесные игры с друзьями — совсем другое',
