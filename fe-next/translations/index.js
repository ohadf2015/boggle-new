const translations = {
  en: {
    ...
    common: {
      ...
      connectedToServer: 'Connected to game server',
      connectingToServer: 'Connecting to game server...',
    ...
    multiplayerFlow: {
      selector: {
        ...
        activeRoomsPreview: 'Active Rooms',
        playersOnline: 'online',
      ...
      profileSetup: {
        ...
        forCreate: 'Almost there! Set up your profile to create a room.',
        forJoin: 'Almost there! Set up your profile to join a room.',
        usernameLabel: 'What should we call you?',
      ...
      createForm: {
        ...
        roomNameLabel: 'Room Name',
        roomNamePlaceholder: 'Enter room name (optional)',
    ...
    landing: {
      ...
      subtitleSimple: 'Practice solo or challenge friends',
