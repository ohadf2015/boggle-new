const translations = {
  en: {
    ...
    hostView: {
      ...
      presetEasy: 'Easy',
      presetEasyDesc: '2 min beginner friendly',
      presetQuick: 'Quick',
      presetQuickDesc: '1 min fast game',
      presetParty: 'Party',
      presetPartyDesc: '2 min fun for groups',
      presetChallenge: 'Challenge',
      presetChallengeDesc: '3 min competitive',
  ...
  he: {
    ...
    hostView: {
      ...
      presetEasy: 'קל',
      presetEasyDesc: '2 דקות מתחילים',
      presetQuick: 'מהיר',
      presetQuickDesc: '1 דקות מהירה',
      presetParty: 'מסיבה',
      presetPartyDesc: '2 דקות לקבוצות',
      presetChallenge: 'אתגר',
      presetChallengeDesc: '3 דקות תחרותי',
      letterMinimum: 'מינימום אותיות',
      difficulty: 'רמת קושי',
      timer: 'טיימר',
    ...
    profile: {
      ...
      chooseColor: 'בחר צבע',
      connectedAccount: 'מחובר לחשבון שלך',
      backToGame: 'חזרה למשחק',
  ...
  sv: {
    ...
    hostView: {
      ...
      quickSetup: 'Snabbval',
      presetEasy: 'Lätt',
      presetEasyDesc: '2 min nybörjarvänligt',
      presetQuick: 'Snabb',
      presetQuickDesc: '1 min snabbt spel',
      presetParty: 'Fest',
      presetPartyDesc: '2 min för grupper',
      presetChallenge: 'Utmaning',
      presetChallengeDesc: '3 min tävling',
      letterMinimum: 'minimum bokstäver',
  ...
  ja: {
    ...
    hostView: {
      ...
      quickSetup: 'クイック設定',
      presetEasy: 'イージー',
      presetEasyDesc: '2分の初心者向け',
      presetQuick: 'クイック',
      presetQuickDesc: '1分の高速ゲーム',
      presetParty: 'パーティー',
      presetPartyDesc: '2分のグループ向け',
      presetChallenge: 'チャレンジ',
      presetChallengeDesc: '3分の競争モード',
      letterMinimum: '最小文字数',
      difficulty: '難易度',
      timer: 'タイマー',
    ...
    profile: {
      ...
      chooseEmoji: '絵文字を選択',
      chooseColor: '色を選択',
      connectedAccount: 'アカウントに接続しています',
      backToGame: 'ゲームに戻る',
      backToRoom: 'ルームに戻る',
      backToLobby: 'ロビーに戻る',
      locked: 'ロック中',
  ...
  es: {
    ...
    hostView: {
      ...
      presetEasy: 'Fácil',
      presetEasyDesc: '2 min para principiantes',
      presetQuick: 'Rápido',
      presetQuickDesc: '1 min juego rápido',
      presetParty: 'Fiesta',
      presetPartyDesc: '2 min para grupos',
      presetChallenge: 'Desafío',
      presetChallengeDesc: '3 min competitivo',
      letterMinimum: 'mínimo de letras',
