export const translations = {
  en: {
    ...
    seo: {
      ...
      description: 'Looking for fun indoor activities? Play our free multiplayer word game online! Perfect Christmas activity for kids and the whole family. No download needed - create a room, invite friends, and compete in real-time. Great for family game night, holiday gatherings, and party entertainment.',
      keywords: 'word game online, multiplayer word game, free online game, indoor activities, Christmas activities for kids, family game night, party games, word puzzle game, group games online, holiday games, team building games, games to play with friends, no download games',
      ogTitle: 'LexiClash - Free Multiplayer Word Game for Family & Friends',
      ogDescription: 'Looking for fun indoor activities? Play our free multiplayer word game! Perfect Christmas activity for kids and the whole family. No download - just create a room and play together in real-time.',
      twitterTitle: 'LexiClash - Free Multiplayer Word Game for Family & Friends',
      twitterDescription: 'Looking for fun indoor activities? Play our free multiplayer word game! Perfect Christmas activity for kids and the whole family. No download - just create a room and play together in real-time.',
      locale: 'en_US',
      language: 'English',
    },
    common: {
  ...
  he: {
    ...
    seo: {
      ...
      description: 'מחפשים פעילות ביתית מהנה? משחק מילים קבוצתי אונליין בחינם! פעילות מושלמת לחנוכה לילדים ולכל המשפחה. ללא התקנה - פתחו חדר, הזמינו חברים והתחרו בזמן אמת. מצוין לערב משפחתי, מסיבות וימי גיבוש.',
      keywords: 'משחק מילים, משחק מילים אונליין, פעילות לחנוכה, פעילות ביתית, משחק לילדים, משחק משפחתי, משחק קבוצתי, משחק חינם, פעילות לילדים בבית, משחק מסיבה, ערב משפחתי, משחק רב משתתפים, משחק בעברית, פעילות חורף, משחק לחופשה',
      ogTitle: 'לקסיקלאש - משחק מילים קבוצתי חינם למשפחה וחברים',
      ogDescription: 'מחפשים פעילות ביתית מהנה? משחק מילים קבוצתי אונליין בחינם! פעילות מושלמת לחנוכה לילדים ולכל המשפחה. ללא התקנה - פתחו חדר והתחילו לשחק יחד.',
      twitterTitle: 'לקסיקלאש - משחק מילים קבוצתי חינם למשפחה וחברים',
      twitterDescription: 'מחפשים פעילות ביתית מהנה? משחק מילים קבוצתי אונליין בחינם! פעילות מושלמת לחנוכה לילדים ולכל המשפחה. ללא התקנה - פתחו חדר והתחילו לשחק יחד.',
      locale: 'he_IL',
      language: 'Hebrew',
    },
    common: {
