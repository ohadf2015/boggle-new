const translations = {
  en: {
    ...
    bots: {
      ...
      medium: 'Medium',
      hard: 'Hard',
      selectDifficulty: 'Bot Difficulty',
      addBot: 'Add Bot',
      adding: 'Adding...',
      remove: 'Remove bot',
      currentBots: 'Bots in Room',
      helpText: 'Bots will automatically find and submit words during the game.',
    },
    music: {
      volume: 'Volume',
      musicVolume: 'Music',
  ...
  he: {
    ...
    bots: {
      ...
      medium: 'בינוני',
      hard: 'קשה',
      selectDifficulty: 'רמת קושי',
      addBot: 'הוסף בוט',
      adding: 'מוסיף...',
      remove: 'הסר בוט',
      currentBots: 'בוטים בחדר',
      helpText: 'בוטים ימצאו ויגישו מילים באופן אוטומטי במהלך המשחק.',
    },
    music: {
      volume: 'עוצמה',
      musicVolume: 'מוזיקה',
  ...
  sv: {
    ...
    bots: {
      ...
      medium: 'Mellan',
      hard: 'Svår',
      selectDifficulty: 'Bot-svårighet',
