export const translations = {
  en: {
    ...
    seo: {
      ...
      description: 'LexiClash - Fast-paced multiplayer word game perfect for parties, team building, and family fun! A great activity for kids and the whole family during Christmas! Find words, compete in real-time. Free online game inspired by Alias and Kahoot - no download required!',
      keywords: 'LexiClash, word game, multiplayer game, online game, party game, Alias game, Kahoot alternative, team building game, family game, word puzzle, free online game, real-time multiplayer, kids game, Christmas activity, family activity',
      ogTitle: 'LexiClash - Multiplayer Word Game like Alias & Kahoot',
      ogDescription: 'LexiClash - Fast-paced multiplayer word game perfect for parties, team building, and family fun! A great activity for kids and the whole family during Christmas! Find words, compete in real-time. Free online game - no download required!',
      twitterTitle: 'LexiClash - Multiplayer Word Game like Alias & Kahoot',
      twitterDescription: 'LexiClash - Fast-paced multiplayer word game perfect for parties, team building, and family fun! A great activity for kids and the whole family during Christmas! Find words, compete in real-time. Free online game - no download required!',
      locale: 'en_US',
      language: 'English',
    },
    common: {
  ...
  he: {
    ...
    seo: {
      ...
      description: 'LexiClash - משחק מילים מהיר וממכר לקבוצות! חברו אותיות, מצאו מילים והתחרו בזמן אמת. מושלם למסיבות, ימי גיבוש ומשפחה. פעילות מעולה לילדים ולכל המשפחה בחנוכה מהבית! משחק בסגנון Alias ו-Kahoot בעברית ואנגלית - חינם ללא התקנה!',
      keywords: 'LexiClash, לקסיקלאש, Alias, Elias, Kahoot, alias game online, משחק אליאס אונליין, party game, משחק מסיבה, משחק מילים, משחק חברה, משחק רב משתתפים, משחק אונליין, משחק בעברית, משחק משפחתי, משחק לילדים, משחק חנוכה, פעילות משפחתית, Word Game, Multiplayer',
      ogTitle: 'LexiClash (לקסיקלאש) - משחק מילים בסגנון אליאס וקהוט',
      ogDescription: 'LexiClash - משחק מילים מהיר וממכר לקבוצות! חברו אותיות, מצאו מילים והתחרו בזמן אמת. מושלם למסיבות, ימי גיבוש ומשפחה. פעילות מעולה לילדים ולכל המשפחה בחנוכה מהבית! משחק בסגנון Alias ו-Kahoot - חינם ללא התקנה!',
      twitterTitle: 'LexiClash (לקסיקלאש) - משחק מילים בסגנון אליאס וקהוט',
      twitterDescription: 'LexiClash - משחק מילים מהיר וממכר לקבוצות! חברו אותיות, מצאו מילים והתחרו בזמן אמת. מושלם למסיבות, ימי גיבוש ומשפחה. פעילות מעולה לילדים ולכל המשפחה בחנוכה מהבית! משחק בסגנון Alias ו-Kahoot - חינם ללא התקנה!',
      locale: 'he_IL',
      language: 'Hebrew',
    },
    common: {
