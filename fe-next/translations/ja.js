...
const ja = {
  ...
  "seo": {
    ...
    "daily": {
      "title": "今日の単語 — 毎日の無料単語パズル（ワードハント & ワードホイール）| LexiClash",
      "description": "今日の単語に挑戦！毎日無料の単語パズル。2つのモード：ワードハントサバイバル（10回でWorlde風）とデイリーワードホイール。世界中で同じボード。絵文字で結果をシェア、グローバルランキングで競争。毎日新パズル、登録不要。",
      "ogTitle": "今日の単語 — 毎日の無料単語パズル",
      "ogDescription": "今日の単語：ワードハント＋ワードホイール。世界中で同じパズル、結果をシェア、デイリーストリークを積もう。無料・登録不要。"
    },
    "multiplayer": {
      "title": "マルチプレイヤーワードゲーム｜友達とオンライン対戦・無料 - LexiClash",
      "description": "友達とリアルタイム単語バトル — 登録不要・ダウンロード不要。ルーム作成、リンク共有、ライブ対戦。6モード、5言語対応、毎日のランキング。今すぐ無料でプレイ →",
      "ogTitle": "リアルタイム単語バトル｜友達と無料で対戦",
      "ogDescription": "ルーム作成、リンク共有、ライブで単語競争。6モード、5言語。ブラウザで無料プレイ。"
    },
    "about": {
...
"game": {
  ...
  "practiceHub": {
    ...
    "greet": "モードを選んでプレイ！",
    "quickStartCta": "すぐに始める",
    "skipAllCta": "スキップ — 遊び方は知っている",
