  ...
  "legal": {
    ...
    "privacy": {
      ...
      "advertising": {
        ...
        "optOut": "広告はすでに非パーソナライズされているため、オプトアウトは不要です。Googleの広告ポリシーの詳細は https://www.google.com/settings/ads でご確認いただけます。",
        "learnMore": "Googleが子供向けコンテンツをどのように扱うかについての詳細は、https://policies.google.com/technologies/partner-sitesをご覧ください"
      },
      "advertisingPartners": {
        "title": "広告パートナー",
        "intro": "Google AdSenseと提携し、ウェブサイトに非パーソナライズ広告を表示しています。広告収入はすべてのプレイヤーにLexiClashを無料で提供し続けることに役立っています。すべての広告は子供向けコンテンツ処理（TFCD）モードで動作しています。",
        "howItWorks": {
          "title": "広告の仕組み",
          "cookies": "すべての広告は非パーソナライズ — 広告ターゲティングのための閲覧行動の追跡はありません",
          ...
          "thirdParty": "Googleの広告配信は子供向けサイトのCOPPA要件に準拠しています"
        },
        "yourChoices": {
          "title": "お客様の選択",
          "intro": "すべての広告が非パーソナライズされているため、特別な操作は不要です。詳細情報：",
          "optOut": "非パーソナライズ広告について学ぶ",
          "googlePrivacy": "Googleのプライバシー慣行を確認",
          "partnerPolicy": "AdSenseパートナーポリシーについて学ぶ"
        },
        "important": {
          "title": "重要：",
          "content": "LexiClashのすべての広告は非パーソナライズであり、子供向けコンテンツの要件に準拠しています。興味ベースの広告やリマーケティング広告は配信されません。Googleの広告ポリシーの詳細は以下からご確認いただけます"
        }
      },
      "cookies": {
        "title": "5. Cookieとローカルストレージ",
        "content": "以下の目的でエッセンシャルCookieとローカルストレージを使用します：認証トークン（Supabase）、ユーザー名と設定（localStorage）、テーマ設定（ダーク/ライトモード）、言語設定。また、分析目的でLogRocket Cookieを使用します。広告は子供向けコンテンツ処理（TFCD）モードで動作しており、Cookieは広告頻度制限と集約レポートのみに制限されています — パーソナライズされた広告やクロスサイトトラッキングCookieは使用されません。"
      },
      "dataRetention": {
        "title": "6. データ保持",
