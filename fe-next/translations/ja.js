...
"createForm": {
  ...
  "teacher": {
    ...
    "subscription": {
      ...
      "usagePromptStudentsBody": "このクラスに{{count}}人の生徒がいるね。Teacher Proなら全員カバーできるよ — クラスも生徒数も無制限、進捗分析と印刷できるレポートつき。",
      "usagePromptAssignmentsBody": "このクラスに{{count}}件の課題を作ったね。Teacher Proで上限解除 — 課題無制限、進捗分析とレポートつき。",
