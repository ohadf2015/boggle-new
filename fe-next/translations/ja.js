...
const ja = {
  ...
  "legal": {
    ...
    "privacy": {
      ...
      "advertising": {
        "title": "4. サードパーティ広告",
        "intro": "Google AdSenseを通じて非パーソナライズ広告を表示しています。LexiClashは子供を含むすべての年齢のプレイヤー向けに設計されているため、広告配信はGoogleの子供向けコンテンツ処理（TFCD）モードで動作しています。",
        "googleAdsense": "Google AdSense：LexiClashに表示されるすべての広告は非パーソナライズです。子供向けコンテンツ処理タグ（TFCD）を有効にしており、広告のパーソナライゼーション、興味ベースの広告、リマーケティングを防止しています。",
      ...
      "advertisingPartners": {
        "title": "広告パートナー",
        "intro": "Google AdSenseと提携し、ウェブサイトに広告を表示しています。Googleを含むサードパーティベンダーは、Cookieを使用して広告を配信します。Googleの広告Cookieの使用により、GoogleおよびそのパートナーはユーザーのLexiClashおよびインターネット上の他のサイトへの訪問に基づいて広告を配信できます。広告収入はすべてのプレイヤーにLexiClashを無料で提供し続けることに役立っています。すべての広告は子供向けコンテンツ処理（TFCD）モードで動作しています。",
        "howItWorks": {
          "title": "広告の仕組み",
    ...
    "disclaimer": {
      ...
      "advertising": {
        "title": "広告コンテンツ",
        "content": "LexiClashは、Google AdSenseを含むサードパーティ広告ネットワークが提供する広告を表示します。これらの広告はLexiClashによる推奨ではありません。広告コンテンツは、さまざまな要因に基づいて広告ネットワークによって決定され、LexiClashの見解や価値観を反映しない場合があります。サイトに表示される広告の正確性やコンテンツについて、当社は責任を負いません。"
      },
      "liability": {
        "title": "責任の制限",
...
"wordHunt": {
  ...
  "dailyWordWheelLanding": {
    ...
    "steps": {
      ...
      "2": { "title": "単語を見つける", "desc": "ホイールの文字で単語を作ろう。すべての単語に中央の文字を含める必要があります。長い単語 = 高得点。" },
    ...
    "faq": {
      ...
      "items": [
        ...
        { "q": "遊び方は？", "a": "ホイールに配置された文字と中央の文字が与えられます。単語を作ろう — すべての単語に中央の文字を含める必要があります。制限時間内にできるだけ多くの単語を見つけましょう。" },
