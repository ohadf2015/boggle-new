...
const ja = {
  ...
  "legal": {
    ...
    "privacy": {
      ...
      "advertising": {
        "title": "4. サードパーティ広告",
        "intro": "当社のウェブサイトを訪問した際に広告を表示するため、サードパーティの広告会社を使用しています。これらの会社は、お客様が興味を持つ可能性のある商品やサービスに関する広告を提供するために、お客様の訪問に関する情報を使用することがあります。",
        "googleAdsense": "Google AdSense：Google AdSenseを介して広告を表示しており、広告のパーソナライゼーションのためにCookieやウェブビーコンを使用してお客様の閲覧行動に関する情報を収集することがあります。",
        "cookies": "広告Cookie：サードパーティの広告主は、ウェブサイト全体でお客様の閲覧を追跡し、関連する広告を表示するために、お客様のデバイスにCookieを配置することがあります。",
        "personalization": "広告のパーソナライゼーション：広告は、広告パートナーによって収集されたお客様の興味、閲覧履歴、人口統計情報に基づいてパーソナライズされることがあります。",
        "thirdPartyAccess": "サードパーティアクセス：広告パートナーは、表示されたページ、滞在時間、広告のクリックなど、お客様の訪問に関するデータに、それぞれのプライバシーポリシーに従ってアクセスすることがあります。",
