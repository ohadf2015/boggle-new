...
const ja = {
  ...
  "common": {
    ...
    "reconnecting": "再接続中...",
    "reconnected": "復帰しました！",
    "connectionLost": "接続が切れた",
    "notConnected": "接続なし",
    "connected": "接続済み",
    "connecting": "接続中...",
    "connectedToServer": "プレイ準備完了！",
    "connectingToServer": "バトル準備中...",
  ...
  "share": {
    ...
    "challengeFriends": "友達を呼べ！😈",
    "beatMyScore": "これ超えられる？",
    "canYouBeatMe": "超えてみろ。"
  },
  "errors": {
    "unstableConnection": "接続不安定 - ラグる可能性あり",
    "slowConnection": "接続遅い",
    "sessionExpired": "セッション切れ。新しいルームへ！",
    "gameCodeNotExist": "コードが存在しない。確認して！",
    "usernameTaken": "名前使用中！別の名前で",
    "gameCodeExists": "コード使用中。別のを試して",
    "somethingWentWrong": "うーん、何か壊れた",
    "unexpectedError": "おっと！ページ更新してみて",
    "errorDetails": "詳細",
    "refreshPage": "更新",
    "connectionTimeout": "タイムアウト",
    "rateLimited": "ちょっと待って！",
    "connectionLost": "接続切れ",
    "notConnected": "接続なし"
  },
  "validation": {
    ...
    "usernameTooShort": "短すぎ！2文字以上",
    "usernameTooLong": "長すぎ！20文字以内",
    "usernameInvalidChars": "英数字のみ",
    "roomNameTooShort": "短すぎ！2文字以上",
    "roomNameTooLong": "長すぎ！30文字以内",
    "roomNameInvalidChars": "英数字のみ",
    "gameCodeRequired": "参加にはコードが必要",
    "gameCodeInvalid": "コードは6〜10文字の英数字",
    "wordRequired": "単語を入力",
    "wordTooLong": "長すぎ",
