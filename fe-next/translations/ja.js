  ...
  "wordcraft": {
    ...
    "cascade": {
      "intro": {
        ...
        "howTo": "隣接する文字をスワイプして単語を作ろう。タイルを燃やして、カスケードを発動して、火の行から逃げろ。",
        "start": "Cascade 開始"
      },
      "endRound": "ラウンド終了",
      "combo": {
      ...
      "fireWarning": "火が上昇 — 長い単語で対抗しよう！",
      "error": {
        "TOO_SHORT": "単語は3文字以上必要です。",
        "NOT_CONTIGUOUS": "文字は隣接していなくてはいけません。",
        "REUSED_CELL": "各文字は1回だけ使えます。",
        "UNKNOWN_CELL": "そのタイルは存在しません。",
        "EMPTY_CELL": "パスが燃焼したタイルを通っています。",
        "INVALID_WORD": "これは単語ではありません。"
      },
      "card": {
        "pyro": { "name": "パイロ", "desc": "5文字以上の単語はランダムタイルを1枚追加で燃焼させます。" },
        "frost": { "name": "フロスト", "desc": "6文字以上の単語は火を8秒間一時停止します。" },
        "diagonal": { "name": "ダイアゴナル", "desc": "スワイプ経路に斜め移動を含められます。" },
        "echo": { "name": "エコー", "desc": "ラウンド内の最初の自動カスケードが3倍スコア。" },
        "emberBoost": { "name": "エンバーブースト", "desc": "火が半分を超えると単語スコアが2倍。" },
        "staticSpark": { "name": "スタティックスパーク", "desc": "すべての単語に+5固定チップ。" }
      }
    }
  },
  mp: {
