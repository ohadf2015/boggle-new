...
const ja = {
  "adventurePlay": {
    ...
    "map": {
      ...
      "primerTitle": "冒険の進め方",
      "primerMap": "マップを一歩ずつ登ろう：バトル、ショップ、休憩、宝箱、？イベント。ボスは頂上で待っている。",
      "primerFight": "バトルでは、つづった単語がそのまま相手へのダメージに。5文字以上の単語でシールドが張れる。ハートがなくなると冒険は終了。",
      "primerKeep": "レリックとポーションは冒険中ずっと有効で、次の冒険にも持ち越せる。ゴールドはショップで使おう。残ったゴールドの半分はコインとして貯まる。",
      "treasureTitle": "中身は？",
    ...
    "variety": {
      ...
      "rule": {
        "classic": "時間切れになる前に、じゅうぶんな点数をかせごう。",
        "hunt": "かくれた言葉を見つけよう。最初の文字がヒントだよ。",
        "chain": "前の言葉の最後の文字から次の言葉を始めよう。",
        "fog": "きりが盤面をおおっている。最後の言葉のとなりだけが見える。",
        "bomb": "導火線が燃えつきる前に、ばくだんのマスを言葉に使おう。まにあわないと4秒へる。",
        "elite": "反撃してくる強い敵。時間切れの前にHPをゼロにしよう。",
        "boss": "この世界のボス。言葉はすべて攻撃だ。攻撃を続けて、反撃に耐えよう。"
      },
      "twist": {
        "hunt": "かくれた言葉！盤面から見つけよう。最初の文字がヒントだよ。",
        "chain": "しりとり！前の言葉の最後の文字から始めよう。",
        "fog": "きり！最後の言葉のとなりのマスだけが見える。",
        "bomb": "ばくだん！導火線が燃えつきる前にマスを使おう。まにあわないと4秒へる。",
        "long-words": "長い言葉だけ：4文字以上。",
        "rush": "ラッシュ：時間は60秒だけ。",
        "grand-hunt": "グランドハント：6x6の大きな盤面で、さがす言葉も多い。",
        "ambush": "待ちぶせ！エリートが早めにおそってくる。HPは少ないけど、攻撃は同じ。",
        "blackout": "ブラックアウト：言葉の最後の文字のまわりだけが光る。4文字以上。",
        "finale": "フィナーレ：4文字以上で、時間は75秒だけ。"
      },
      "newRule": "新ルール",
      "chapterTag": "第{world}章",
      "chapterGo": "出発！",
      "worldNewRule": "この世界の新ルール",
      "threat": "危険度 {threat}/5",
      "goalScore": "目標スコア",
      "goalHunt": "さがす言葉",
      "goalDamage": "あたえるダメージ",
      "secondsShort": "{seconds}秒",
      "eliteName": "{world}のエリート",
      "pathLabel": "レベル {level}/{total}",
      "demoLetters": "さくらねこいぬたま",
      "huntTitle": "かくれた言葉",
      "huntCount": "{found}/{need}",
      "huntMasked": "かくれた言葉：{first}から始まる{count}文字",
      "chainStart": "どの言葉からでも始められる",
      "chainNext": "次の言葉はこの文字から",
      "chainBroken": "しりとり失敗！「{letter}」から始めよう",
      ...
      "youAreHere": "いまここ",
      "pathCleared": "このランでクリア",
      "rampTitle": "難易度",
      "worldRoute": "ステージ: {kinds}"
    },
    "combat": {
      "boss": "ボス",
      "elite": {
      ...
      "ruleTag": "ルール",
      "rule": {
        "w1": "ボスが構えている間に5文字以上の単語を作ると、攻撃をキャンセルできる。",
        "w2": "針は2本ずつ飛んでくる。着弾前に両方タップしよう。",
        "w3": "盤面に残った呪いはハート2つ分のダメージ。",
        "w4": "シャッフルで盤面が見えない時間が2倍になる。",
        "w5": "シールドをチャージできるのは6文字以上の単語だけ。",
        "w6": "凍結は1マス多く、氷の破片は2本ずつ飛んでくる。",
        "w7": "このボスを中断できるのは6文字以上の単語だけ。",
        "w8": "飛び道具が3連射でやってくる。",
        "w9": "凍結と呪いが2マス多く、呪いはハート2つ分。",
        "w10": "中断は6文字以上のみ、呪いはハート2つ分、飛び道具は2本ずつ。"
      },
      "eliteRule": {
        "freeze": "マスを凍らせてくる。タップして解凍しよう。",
        "projectile": "火の玉を投げてくる。着弾前にタップしよう。",
        "curse": "マスを呪ってくる。噛まれる前にタップで浄化しよう。",
        "shuffle": "盤面をシャッフルする。記憶を頼りに単語を作ろう。",
        "drain": "攻撃のたびにシールドのチャージを奪う。タイミングよく構えよう。"
      },
      "move": {
        "hit": "ストライク",
        "hit-heavy": "ヘビースラム",
        "freeze": "フロストブレス",
        "freeze-heavy": "ディープフリーズ",
        "curse": "ヘックス",
        "curse-heavy": "プレイグヘックス",
        "projectile": "ファイアボール",
        "projectile-heavy": "連射",
        "shuffle": "スクランブル",
        "shuffle-heavy": "カオススクランブル",
        "drain": "吸収",
        "drain-heavy": "魂吸い"
      },
      "status": {
      ...
      "consequence": {
        "freeze": "{count}マスが凍った！タップで解凍！",
        "curse": "{count}マスに呪い！噛まれる前にタップで浄化！",
        "hit": "-{count} HP！次はシールドを構えよう。",
        "drain": "-{count} HP、シールドも1つ奪われた！",
        "shuffle": "盤面がシャッフル！記憶で綴れ！",
        "blocked": "シールドが攻撃を完全に防いだ！"
      },
      "incomingIn": "攻撃まで {seconds}秒",
      "nextMove": "次の行動",
      ...
      "shieldUp": "シールド展開！",
      "raiseShield": "ブロック！",
      "shieldEarn": "{count}文字以上でチャージ",
      "shieldAria": "シールドを構える（チャージ{count}）",
      "skip": "続ける",
      "bossBattle": "ボスバトル！",
      "eliteFight": "エリート戦！",
      "tapToFight": "タップしてバトル開始",
      "phaseTwo": "第2形態！",
      "enraged": "激怒！",
      "phaseTaunt1": "準備運動は終わり。ここからが本番だ！",
      "phaseTaunt2": "もう許さん！全力で行くぞ！",
      "kill": {
        "squashed": "ペチャンコ！",
        "whomped": "ボコボコ！",
        "crushed": "粉砕！",
        ...
        "obliterated": "消滅！",
        "damage": "{points}ダメージ",
        "overkill": "+{points} オーバーキル",
        "trophy": "戦利品レリック",
        "addedToRun": "ランに追加",
        "bossTrophy": "ワールドトロフィー獲得！",
        "bossStars": "獲得スター"
      },
      "defeat": {
        "slainBy": "{move}で倒れた",
        "hpLeft": "{name}の残りHP {percent}%",
        "continue": "タップして続ける"
      },
      "bossDefeated": "ボス撃破！",
      "eliteDefeated": "エリート撃破！",
      "youFell": "力尽きた！",
      "thawTile": "凍ったマスを解凍",
      "cleanseTile": "呪われたマスを浄化",
      "tap": "タップ！",
      "deflect": "飛び道具をはじく"
    },
    "ledger": {
    ...
    "loot": {
      ...
      "runOver": "ラン終了",
      "runOverSub": "最初のフロアから新しいマップへ。レリックとポーションは持ち越し、スターとコレクションもそのまま。",
      "newRun": "新しいラン",
      "runComplete": "ランクリア！",
      ...
      "kindGold": "ゴールド",
      "healDesc": "今すぐハートを回復",
      "goldDesc": "このランで使えるゴールド",
      "tapCard": "カードをタップして詳しく見る",
      "take": "これにする",
      "currentRun": "進行中のラン",
      "runStep": "レベル {step}/{total}",
      "continueRun": "つづける",
      "levelUp": "レベルアップ！",
      "levelUpCleared": "レベル {step}/{total} クリア",
      ...
      "stackPerLevel": "1レベルあたりの点数(このランの単語から計算)",
      "contribAria": "{name}:このレベルで+{n}点",
      "value": {
        "label": "このラン",
        "hitsLine": "{total}語中 {hits}語で発動",
        "synergy": "コンボ",
        "synergyHint": "持っているレリックと重なる",
        "ptsPerLevel": "点 / レベル",
        "goldPerLevel": "ゴールド / レベル",
        "seconds": "秒 / レベル",
        "shield": "シールド / 戦闘",
        "frost": "呪いの時間",
        "revive": "追加ライフ",
        ...
        "cards": "カード / 選択",
        "noData": "まだ単語なし",
        "stackLine": "単体 → レリックと合わせて",
        "timePts": "+{secs}秒で1レベルあたりの点数"
      }
    },
    "juice": {
      "nice": "ナイス！",
      ...
      "notAWord": "単語じゃない",
      "alreadyFound": "もう見つけた",
      "breaksChain": "チェーンが切れる",
      "hint": "ヒント",
      "hintAria": "ヒント 残り{count}回",
      "foeTag": "敵",
      "foeHp": "HP {hp}/{max}",
      "foeDown": "撃破！",
      "foeGoal": "{max}ダメージで星3つ"
    },
    "draftTitle": "ごほうびを選ぼう",
    "draftSub": "このワールドの間ずっと続くよ。",
    "skip": "スキップ",
    "hp": "HP",
    "gold": "{gold} ゴールド",
    "shield": "シールド（{count}）",
    ...
    "incoming": "攻撃がくる！",
    "deflect": "はじけ！",
    "huntGoal": "かくれた言葉をさがそう：{count}個・{found}個発見",
    ...
    "relic": {
      ...
      "vampire-fang": "吸血鬼の牙",
      "gold-tooth": "金の歯",
      "lucky-clover": "幸運のクローバー",
      "phoenix-feather": "不死鳥の羽"
    },
    "relicDesc": {
      "sharp-quill": "6文字以上の言葉が+50%",
      "long-bow": "7文字以上の言葉が2倍",
      "short-sword": "3文字の言葉に+2点",
      "storm-rune": "ちょうど5文字の言葉に+5点",
      "twin-ink": "各レベル最初の言葉が2倍",
      "echo-stone": "見つけた言葉1つにつき+1点（最大+10）",
      "magnet": "すべての言葉が+20%",
      "heart-locket": "最大HP+1",
      "hourglass": "毎レベル+10秒",
    ...
    "potionDesc": {
      "heal": "HP+2",
      "time": "+15秒",
      "cleanse": "凍ったマスとのろわれたマスを消し、敵をひるませる",
      "insight": "ヒント+2"
    },
    "longerWords": "もっと長い単語",
    "title": "アドベンチャー",
    ...
    "failed": "あと少し！",
    "newItems": "コレクションに追加",
    "skinUnlocked": "新しいタイルスキンを獲得！",
    "equipSkin": "装備する",
    "equipped": "装備中",
    "skinVault": "スキン保管庫",
    "skinVaultHint": "各ワールドのボスを倒してタイルを手に入れよう。どのモードでも使えるよ。",
    "beatBoss": "{boss}を倒す",
    "beatPrevBoss": "前のボスを倒そう",
    "foundWords": "見つけた単語",
    "signInRequired": "アドベンチャーを遊ぶにはログインしてね",
    "achievements": "実績",
    "starsEarned": "星 {stars}/3"
  },
  "vocabQuiz": {
    "correctShort": "せいかい！",
    "lockedInCount": "{total}人中{locked}人が回答",
    "rank": "{total}人中{position}位",
    "score": {
      "label": "あなたのスコア：{score}"
    },
    "mascot": {
    ...
    "sweep": {
      "title": "クラス全員せいかい！",
      "subtitle": "ひとりものこさず当たりました。"
    },
    "nextUp": {
      "label": "つぎのことば",
      "finalScores": "さいしゅうスコア！",
      "tease": "つぎのことばは {letter} ではじまる{count}文字です"
    },
    ...
    "practice": {
      "title": "練習することば",
      "stillIn": "まだクラスにいるよ。次のゲームが始まると、そのままもどれるよ。",
      "close": "結果にもどる"
    }
  },
  "pricing": {
  ...
  "wordTowerV2": {
    ...
    "rivals": {
      "rattled": "ゆさぶった！",
      "rattledBody": "階は落ちなかったが、{name}のコインが{coins}枚こぼれ落ちた。",
      "missed": "完全に空振り！",
      "scrap": "+{coins} くず鉄",
      "banked": "一撃で{coins}コイン獲得",
      "pickFloor": "壊したい階を選ぼう。",
      "aimAt": "{word}を狙う",
      "floorsDown": "{total}階中{n}階が崩落",
      "shieldDown": "相手のシールドを破壊",
      "reclaimed": "{coins}を取り返した",
      "prizeShield": "シールドを破壊 ・ +{n}コイン",
      "prizeLoot": "+{n}コインと相手の戦利品",
      "floorOf": "{total}階中{n}階",
      "wreckFloor": "{word}を壊す",
      "calledShot": "宣言：{word}",
      "title": "だれが一番高い？",
      "you": "あなた",
      "someone": "ライバル",
      "loading": "ライバルを探しています…",
      "none": "まだ近所にライバルがいません。もっと高く積めば見つかります。",
      "emptyTower": "まだ何も建っていない",
      "wreck": "壊す",
      "wreckName": "{name}のタワーを壊す",
      "district": "地区 {n}",
      "floors": "{n}階",
      "charges": "破壊 {n} 回分",
      "noCharges": "1ラウンド遊ぶと破壊が1回もらえます",
      "target": "{name}のタワー",
      "taunt": "{name}は君のタワーがぐらぐらだと言っている。相手のタワーで証明しよう。",
      "tauntRevenge": "{name}が先に手を出した。決着をつけよう。",
      "revengeCta": "仕返しする",
      "revengeName": "{name}にやり返す",
      "ledgerThem": "{name}が{n}奪った",
      "ledgerYou": "{n}取り返した",
      "ledgerAhead": "{name}より{n}リード中。",
      "ledgerSquare": "{name}とは貸し借りなし。今のところ。",
      ...
      "smashed": "破壊！",
      "grazed": "かすっただけ！",
      "smashedBody": "{name}のタワーから{n}階を落とした。",
      "plotDown": "{plot}が使用不能に",
      "stole": "{coins} を奪った",
      "earned": "+{coins} コイン",
      "nothing": "かすり傷ひとつない。今夜{name}はぐっすりだ。",
      "pickAnother": "別のライバルを選ぶ",
      "back": "戻る",
      "raidFailed": "襲撃は失敗",
      "raidError": "うまくいきませんでした。もう一度どうぞ。",
      "revengeTitle": "仕返しの時間",
      "revengeBody": "{name}が君の{plot}を壊して{coins}コインを持ち去った。",
      "revengeBodyBlocked": "{name}が襲ってきたが、シールドが守り抜いた。",
      "revenge": "仕返し",
      "dismiss": "あとで",
      "moreRaids": "他に{n}件の襲撃",
      "guestTitle": "相手を見てみよう",
      "guestBody": "サインインすると本物のタワーに挑み、壊して、借りを返せます。",
      "signIn": "サインイン",
      "plot": {
        "foundation": "基礎",
        "craneYard": "クレーン置き場",
    ...
    "chest": {
      ...
      "continue": "受け取る",
      "guest": "ログインしてライバルと対戦",
      "item": { "shield": "シールド×{n}", "brick": "ゴールドブロック×{n}", "blueprint": "設計図×{n}" },
      "tease": { "perfects": "あと{n}回パーフェクトで{tier}の確率アップ", "floors": "あと{n}階で{tier}の確率アップ" }
    },
    "estate": {
      "art": {
        "bakery": "パン屋",
      ...
      "need": "あと{n}コイン",
      "damaged": "損壊",
      "progress": "{done}/{total} レベル",
      "coins": "{n} コイン",
      "built": "完成！",
      "repaired": "修理完了！",
      "guest": "この端末に保存中。ログインするとレイドできます。",
      "perksTitle": "街区が効いています",
      "perksNone": "街区を建ててタワーを安定させよう",
      "newsRaids": "留守中に{n}件のレイド",
      "newsAffordable": "今すぐ建てられる区画が{n}件",
      "newsDamaged": "{n}区画が修理待ち",
      "newsNone": "街区は平和です",
      "completeTitle": "{name} 完成！",
      "completeSub": "5つのランドマーク、街区ひとつ完成。",
      "completeNext": "{name} 解放",
      "completeCta": "{name} を開く",
      "reward": "+{coins}コイン、+1設計図、+1シールド",
      "shields": "シールド",
      "bricks": "金のレンガ",
      "blueprints": "設計図",
      "perkLine": {
        "foundation": "タワーの揺れが{n}%減少",
        "craneYard": "パーフェクト判定が{n}%広い",
        "vault": "1回ごとのコイン+{n}%",
        "insurance": "シールド枠+{n}",
        "landmark": "スコア+{n}%",
      },
      ...
      "building": {
        ...
        "stone-cellar": "石の地下倉",
        "timber-hoist": "木組みホイスト",
        "guild-bank": "ギルド銀行",
        "watch-house": "見張り小屋",
        "clock-tower": "時計塔",
        "brick-arcade": "れんがアーケード",
        "cargo-lift": "貨物リフト",
        "bazaar": "バザール",
        "fire-station": "消防署",
        "grand-bazaar-dome": "バザールドーム",
        "terrace-walls": "テラスの壁",
        "garden-crane": "庭園クレーン",
        "greenhouse-bank": "温室銀行",
        "rain-shelter": "雨よけ小屋",
        "botanic-spire": "植物の尖塔",
        "rail-bed": "線路の路盤",
        "gantry-crane": "門型クレーン",
        ...
        "steel-piles": "鋼管杭",
        "neon-rig": "ネオンリグ",
        "arcade-vault": "アーケード金庫",
        "security-hub": "警備ハブ",
        "neon-tower": "ネオンタワー",
        "sea-wall": "防波堤",
        "container-crane": "コンテナクレーン",
        "customs-house": "税関",
        "coast-guard": "沿岸警備隊",
        "harbor-bridge": "港の橋",
        "deep-caissons": "深層ケーソン",
        "tower-crane": "タワークレーン",
        "trading-floor": "取引フロア",
        "insurance-tower": "保険タワー",
        "glass-pyramid": "ガラスのピラミッド",
        "sky-anchors": "スカイアンカー",
        "sky-hoist": "スカイホイスト",
        "cloud-bank": "雲の銀行",
        "storm-shield": "嵐のシールド",
  ...
  "seo": {
    ...
    "language": "Japanese",
    "showcase3d": {
      "title": "日本語の単語ゲーム | LexiClash 無料マルチプレイ オンライン",
      "description": "日本語のオンライン単語ゲームをリアルタイムで最大4人でプレイ。コンボを構築し、グローバルランキングを登り、無料でプレイ — ダウンロード不要、登録不要、ブラウザで。"
    },
    "leaderboard": {
      "title": "ライブランキング — トップ単語ゲームプレイヤー（デイリー・週間・歴代）| LexiClash",
      "description": "ライブランキング — 8つのゲームモードのトップ単語プレイヤー：デイリー、週間、歴代。言語、国、モードでフィルタ可能。リアルタイム更新。",
      "ogTitle": "ライブランキング — デイリー・週間・歴代",
      "ogDescription": "世界トップの単語ゲームプレイヤーのライブランキング。リアルタイム更新。参加して競おう！"
    },
    "profile": {
    ...
    "daily": {
      "title": "デイリーワードホイール & ワードハント — 無料の毎日パズル、世界共通ボード | LexiClash",
      "description": "デイリーワードホイール + ワードハント — 無料、登録不要。世界共通のボード、10回挑戦（Wordle風）、絵文字で結果をシェア、グローバルランキングで競争。24時間ごとに新パズル。",
      "ogTitle": "デイリーワードホイール — 今日の無料単語パズル",
      "ogDescription": "デイリーワードホイール + ワードハント。世界共通のパズル、結果をシェア、ストリークを積もう。無料・登録不要。"
    },
    "multiplayer": {
    ...
    "practice": {
      "title": "ワードゲーム練習モード - 学習・チュートリアル | LexiClash",
      "description": "自分のペースでワードゲームを練習！タイマーなし、プレッシャーなし — boggle、word hunt、ワードホイールの仕組みをコーチングのヒントで学習。初心者向け無料チュートリアル。",
      "ogTitle": "練習モード - ストレスなしでワードゲームを学習",
      "ogDescription": "コーチングチュートリアルで3つのモードをマスター。タイマーなし、自分のペースで学習！"
    },
    "practiceClassic": {
      "title": "Boggle練習 - クラシック単語検索を学習 | LexiClash",
      "description": "クラシックなboggle単語検索を自分のペースで練習。ゲーム内コーチングのヒント、タイマーなし、プレッシャーなし。初心者向け無料チュートリアル。",
      "ogTitle": "Boggle練習 - クラシック単語検索チュートリアル",
      "ogDescription": "コーチングのヒントでクラシック単語検索を学習。ストレスフリー練習モード！"
    },
    "practiceWordHunt": {
      "title": "Word Hunt練習 - デイリーハントモード | LexiClash",
      "description": "Word Huntを自分のペースで練習。長い単語の発見、ボーナスタイルのチェーン、スコアコンボの構築をチュートリアルで学習。タイマーなし無料。",
      "ogTitle": "Word Hunt練習 - チュートリアルモード",
      "ogDescription": "ストレスフリーチュートリアルでWord Huntをマスター。タイマーなし！"
    },
    "practiceWheelRush": {
      "title": "ワードホイール練習 - アナグラムモード | LexiClash",
      "description": "ワードホイールアナグラムモードを自分のペースで練習。コーチプロンプト、隠しボーナスワード、タイマーなし。初心者に最適な無料チュートリアル。",
      "ogTitle": "ワードホイール練習 - アナグラムチュートリアル",
      "ogDescription": "コーチプロンプトでアナグラムホイールを学習。ストレスフリー無料チュートリアル！"
    },
    "community": {
    ...
    "educationClassroomGame": {
      "title": "クラスゲーム — リアルタイム対戦で全員参加 | LexiClash",
      "description": "教室全体でワードゲーム。先生がダッシュボードから開始、生徒はスマホやタブレットからコードを入力して参加。登録不要。",
    ...
    "dailyWordWheel": {
      "title": "デイリーワードホイール｜毎日の無料単語パズル・Wordleの代替 LexiClash",
      "description": "毎日新しい文字ホイール — 全ての単語を見つけてタイマーに勝とう。結果共有、連続記録、世界ランキング上位を目指そう。無料・登録不要。今すぐプレイ →",
      "ogTitle": "今日のワードホイール — 全ての単語を見つけよう",
      "ogDescription": "毎日のホイールを回し、時計と競争、ストリークを共有。無料パズル、毎日新作。"
    },
    "playerProfile": {
    ...
    "educationDuels": {
      ...
      "description": "クラスメートにいつでも挑戦。リアルタイム対戦で語彙力と反応速度を競い合う。友達がオンラインじゃなくても後で挑戦できます。",
      "ogTitle": "ワードデュエル — 友達と競い合う",
      "ogDescription": "友達と1対1でリアルタイム対戦。語彙力の腕試し。"
    },
    "communityBoard": {
  ...
  "deleteAccountWeb": {
    ...
    "enterEmail": "LexiClashアカウントに関連付けられたメールアドレスを入力してください。確認リンクを送信します。",
  ...
  "share": {
    ...
    "emojiCard": {
      ...
      "connectionsHeader": "LexiClash ワードブリッジ · {date}",
      "bridges": "ブリッジ",
      "share": "シェア",
      "copy": "コピー",
  ...
  "multiplayerFlow": {
    ...
    "roomList": {
      ...
      "socialHub": "ソーシャルハブ",
      "arenaHub": "アリーナハブ",
      "heroAlt": "ネオン光るアリーナで対戦する二人のプレイヤー",
      "createPrivateBattle": "プライベートバトルを作成",
      "openArenas": "オープンアリーナ",
      "liveMatches": "ライブマッチ進行中",
...
"createForm": {
  ...
  "tvResults": {
    ...
    "pointsApart": "差!",
    "bonusPts": "ボーナス",
    "fastestFirstWord": "最速の一手！",
    "highestAccuracy": "完璧な精度!",
    "mostLongWords": "長い単語のマスター!",
    "bestComboStreak": "止められない連続!",
    "mostUniqueFinds": "誰も見つけなかった言葉を発掘！",
    "strongFinisher": "最後の数秒を制覇!",
    "vocabularyVirtuoso": "語彙の達人",
    "longestSingleWord": "最長の単語を発見!",
    "speedDemon": "スピードデーモン",
    "highestWpm": "最速の単語/分!",
    "comebackKid": "逆転の星",
    "biggestImprovement": "後半で大逆転!",
    "explorer": "エクスプローラー",
    "mostVariety": "最も多彩な単語の長さ!",
    "lengths": "種類",
    "steadyEddie": "安定王",
    "mostConsistent": "最も安定したペース!",
    "shortAndSweet": "短くてキレイ",
    ...
    "mascotComments": {
      "awardsIntro1": "受賞者は...",
      "awardsIntro2": "ドラムロール!",
      "awardsIntro3": "栄光を掴むのは誰?",
      "awardsIntro4": "待ちに待った瞬間!",
      "awardsIntro5": "レジェンドを讃えよう!"
    },
    "andMore": "他{count}人",
    "andMorePlural": "他{count}人",
    "spotlight": {
      "heading": "🎭 プレイヤースポットライト",
      "mascotIntro1": "どんなプレイヤーがいるか見てみましょう！",
      "mascotIntro2": "みんなにドラマがある。これがあなたの物語！",
      "mascotIntro3": "キャラクターたちに会う時間です！",
      "mascotIntro4": "誰がどうプレイした？見てみましょう！",
      "mascotIntro5": "スポットライトはあなたに！",
      "andMore": "他{count}人",
      "andMorePlural": "他{count}人",
      "archetypes": {
        "the-ghost": {
  ...
  "onboarding": {
    ...
    "ftue": {
      ...
      "editAvatar": "アバターをカスタマイズ",
      "yourScore": "{{score}}点獲得",
      "averageScore": "今日の平均は{{average}}点",
      "yourScoreLabel": "あなたの点数",
      "averageScoreLabel": "平均",
      "nameHint": "2〜20文字",
      "tryAgain": "もう一回？",
      "continue": "続ける",
      "aboveAverage": "平均以上！",
  ...
  "results": {
    ...
    "turningPointOpponent": "{{player}}が{{word}}（{{score}}点）を見つけてリードを奪った",
    ...
    "revenge": {
      "header": "リベンジ戦",
      "breathingDown": "あと一歩だった",
      "oneWordAway": "あと一語あれば{player}は負けてた。",
      "unfinishedBusiness": "決着はまだついてない",
      "twoWordsFromGlory": "あと二語で勝てた。{player}はただ運が良かっただけ。",
      "nextTimeItsPersonal": "次こそ{player}に借りを返す。",
      "runItBack": "もう一戦！",
      "theyGotLucky": "今回は{player}に取られた。でも勝負はこれから。",
      "comebackArc": "逆転劇、開幕",
      "everyVillainNeedsOrigin": "すべてのライバル関係には始まりがある。{player}が火をつけた。"
    },
    "defend": {
      "untouchable": "王者の風格",
      "theyNeedAPlan": "{player}は作戦を練り直す必要がある。",
      "staySharp": "気を抜くな、チャンピオン",
      "theyreStudying": "{player}は君のプレイを分析中。",
      "thinIce": "追い上げが来てる",
      "comingForYou": "{player}はあと一戦で逆転できる距離。油断禁物。"
    },
    "greatVictory": "勝利！",
    "greatBattle": "激戦！",
    ...
    "pointsBehind": "1位まであと{points}ポイント",
    "mvp": {
      "longestWord": "最長",
      "comboKing": "コンボ",
      "uniqueFinder": "ユニーク",
    ...
    "awards": {
      ...
      "wordsmith": "文字の魔術師",
      "wordsmithDesc": "盤上で一番長い単語を引き当てた",
      "comboKing": "コンボの鬼",
      "comboKingDesc": "コンボボーナスを荒稼ぎ",
      "speedDemon": "弾丸タイピスト",
      ...
      "lateBloomer": "逆転の星",
      "lateBloomerDesc": "ラスト1分で一気に稼いだ",
      "bigFish": "大物ハンター",
      "bigFishDesc": "試合で一番デカい単語を仕留めた"
    },
    "pointsFromFirst": "1位まで{points}点",
    "justBehind": "1位まであと{points}ポイント",
    "pts": "ポイント",
    "rematch": "リマッチ",
    "target": "ターゲット",
    "totalPoints": "合計ポイント",
  ...
  "tutorial": {
    ...
    "wordHunt": {
      ...
      "step2ImageAlt": "王冠をかぶったマスコットが喜ぶ様子。長いタイルの列は挑戦回数を消費し、短い列はハートが飛び出して無料でライフが増える",
  ...
  "cosmetics": {
    ...
    "tileSkins": "タイルスキン",
    "boardThemes": "ボードテーマ",
    "victoryEffects": "勝利エフェクト",
    "profileFrames": "プロフィールフレーム",
    "equipped": "装備中",
    "locked": "ロック中",
    "equip": "装備",
    "unequip": "外す",
    ...
    "items": {
      ...
      "tileNeon": "ネオングロー",
      "tileNeonDesc": "ボードを照らすネオンタイル。",
      "tileWooden": "ウッドタイル",
      "tileWoodenDesc": "温かみのある木製タイル。",
      "tileCrystal": "クリスタルタイル",
      "tileCrystalDesc": "エリートプレイヤー向けの輝くクリスタル。",
      "tileFire": "ファイアタイル",
      "tileFireDesc": "燃え盛る情熱のタイル。",
      "boardClassic": "クラシックボード",
      "boardClassicDesc": "オリジナルのゲームボード。",
      "boardDark": "ダークボード",
      "boardDarkDesc": "集中力を高めるダークテーマ。",
      "boardOcean": "オーシャンボード",
      "boardOceanDesc": "穏やかな波が背景に。",
      "boardGalaxy": "ギャラクシーボード",
      "boardGalaxyDesc": "星々の中でプレイ。",
      "victoryConfetti": "紙吹雪",
      "victoryConfettiDesc": "クラシックな紙吹雪のお祝い。",
      "victoryFireworks": "花火",
      "victoryFireworksDesc": "花火で空を照らそう。",
      "victoryLightning": "稲妻",
      "victoryLightningDesc": "勝利の雷鳴。",
      "frameNone": "フレームなし",
      "frameNoneDesc": "シンプルなフレームなし。",
      "frameBronze": "ブロンズフレーム",
      "frameBronzeDesc": "初心者向けのブロンズフレーム。",
      "frameSilver": "シルバーフレーム",
      "frameSilverDesc": "磨かれたシルバーフレーム。",
      "frameGold": "ゴールドフレーム",
  ...
  "legal": {
    ...
    "index": {
      ...
      "disclaimerDescription": "サービスとコンテンツに関する重要な免責事項"
    },
    "terms": {
      "title": "利用規約",
      ...
      "acceptance": {
        "title": "1. 規約への同意",
        "content": "LexiClashにアクセスまたは使用することにより、お客様はこの利用規約およびプライバシーポリシーに拘束されることに同意するものとします。これらの条件に同意されない場合は、当社のサービスをご利用にならないでください。当社はいつでもこれらの条件を変更する権利を留保し、お客様の継続的な使用は変更への同意を構成します。"
      },
      "service": {
        "title": "2. サービスの説明",
        "content": "LexiClashは、ユーザーが他のプレイヤーとリアルタイムでワードゲームをプレイできるマルチプレイヤーワードゲームプラットフォームです。サービスには、シングルプレイヤーモード、マルチプレイヤールーム、デイリーチャレンジ、リーダーボード、および関連機能が含まれます。当社は、いつでもサービスのあらゆる側面を変更、一時停止、または中止する権利を留保します。"
      },
      "accounts": {
        "title": "3. ユーザーアカウント",
        "content": "GoogleまたはDiscord認証を使用してアカウントを作成できます。お客様は、アカウントの機密性を維持し、アカウントで発生するすべての活動について責任を負います。アカウントを作成するには13歳以上である必要があります。お客様は正確な情報を提供し、必要に応じて更新することに同意するものとします。"
      },
      "conduct": {
        "title": "4. ユーザー行動規範",
        "content": "お客様は以下のことをしないことに同意するものとします：違法な目的でサービスを使用すること、他のユーザーを嫌がらせ、虐待、または傷つけること、チート、ボットの使用、またはバグの悪用による不正な利益の獲得、他人へのなりすままたは所属の虚偽表示、サービスへの妨害または中断、サービスの任意の部分への不正アクセスの試み、またはサービスを損傷、無効化、または損なう可能性のある活動への参加。"
      },
      "contentLicense": {
        "title": "5. ユーザーコンテンツライセンス",
        "content": "LexiClashにコンテンツ（プロフィール情報、ゲームデータ、フィードバックなど）を送信することにより、お客様は当社に、サービスの提供および改善に関連して、そのようなコンテンツを使用、複製、変更、表示するための非独占的、世界規模、ロイヤリティフリーのライセンスを付与するものとします。お客様はコンテンツの所有権を保持しますが、当社が分析およびサービス改善のために匿名化および集計されたデータを使用することに同意するものとします。"
      },
      "intellectualProperty": {
        "title": "6. 知的財産権",
        "content": "LexiClashとそのオリジナルコンテンツ、機能、および機能性は、LexiClash Ltdが所有し、国際的な著作権、商標、およびその他の知的財産法によって保護されています。当社の商標およびトレードドレスは、当社の事前の書面による同意なしに、いかなる製品またはサービスに関連して使用することはできません。"
      },
      "disclaimers": {
        "title": "7. 免責事項",
        "content": "サービスは、明示的または黙示的を問わず、いかなる種類の保証もなく「現状のまま」および「利用可能な状態で」提供されます。当社は、サービスが中断なく、安全に、またはエラーなく動作することを保証するものではありません。当社は、商品性、特定目的への適合性、および非侵害を含むがこれらに限定されない、すべての保証を否認します。"
      },
      "liability": {
        "title": "8. 責任の制限",
        "content": "法律で許可される最大限の範囲において、LexiClash Ltdは、お客様のサービスの使用または使用不能から生じる、利益、データ、またはのれんの損失を含むがこれらに限定されない、間接的、偶発的、特別、結果的、または懲罰的損害について責任を負いません。当社の総責任は、過去12か月間にお客様が当社に支払った金額を超えないものとします。"
      },
      "indemnification": {
        "title": "9. 補償",
        "content": "お客様は、サービスの使用、これらの条件への違反、または他者の権利の侵害から生じる、すべての請求、損害、損失、または費用（合理的な弁護士費用を含む）から、LexiClash Ltdおよびその役員、取締役、従業員、代理人を防御、補償、および免責することに同意するものとします。"
      },
      "termination": {
        "title": "10. 終了",
        "content": "当社は、これらの条件に違反する、または他のユーザー、当社、または第三者に有害であると当社が判断する行為に対して、事前の通知なしに、直ちにお客様のアカウントおよびサービスへのアクセスを終了または停止することができます。終了時に、サービスを使用する権利は直ちに終了します。また、プロフィール設定からいつでもアカウントを削除することもできます。"
      },
      "modifications": {
        "title": "11. 条件の変更",
        "content": "当社は、いつでもこれらの条件を変更する権利を留保します。重要な変更については、更新された発効日とともにこのページに新しい条件を掲載することで通知します。変更後のサービスの継続的な使用は、新しい条件への同意を構成します。"
      },
      "governingLaw": {
        "title": "12. 準拠法",
        "content": "この利用規約は、法の抵触に関する規定にかかわらず、イスラエル国の法律に準拠し、それに従って解釈されるものとします。これらの条件から生じるすべての法的措置または手続きは、イスラエルの裁判所でのみ提起されるものとします。"
      },
      "disputes": {
        "title": "13. 紛争解決",
        "content": "これらの条件またはサービスから生じる、またはそれらに関連するすべての紛争は、まず誠実な交渉を通じて解決を試みるものとします。交渉が失敗した場合、紛争は、お客様が少額訴訟裁判所で請求を提起する権利がある場合を除き、イスラエルの仲裁法に従った拘束力のある仲裁によって解決されるものとします。"
      },
      "severability": {
        "title": "14. 可分性",
        "content": "これらの条件のいずれかの条項が執行不能または無効であると判明した場合、その条項は、これらの条件が完全に有効であり続けるために必要な最小限の範囲で制限または排除されるものとします。これらの条件のいずれかの権利または条項を行使しなかったとしても、そのような権利または条項の放棄とはみなされません。"
      }
    },
    "privacy": {
      "title": "プライバシーポリシー",
      ...
      "advertising": {
        "title": "4. サードパーティ広告",
        "intro": "Google AdMobを通じて非パーソナライズ広告を表示しています。LexiClashは子供を含むすべての年齢のプレイヤー向けに設計されているため、広告配信はGoogleの子供向けコンテンツ処理（TFCD）モードで動作しています。",
        "googleAdmob": "Google AdMob：LexiClashに表示されるすべての広告は非パーソナライズです。子供向けコンテンツ処理タグ（TFCD）を有効にしており、広告のパーソナライゼーション、興味ベースの広告、リマーケティングを防止しています。",
        "cookies": "広告Cookie：TFCDモードでは、Googleはパーソナライズされた広告Cookieを設定しません。広告の頻度制限と集約された広告レポートのみに限定されたCookieが使用される場合があります。",
        "personalization": "広告のパーソナライゼーションなし：閲覧履歴、興味、人口統計プロファイルに基づいて広告がパーソナライズされることはありません。すべてのユーザーに同じコンテキスト型の非ターゲット広告が表示されます。",
        "thirdPartyAccess": "限定的なデータアクセス：子供向けコンテンツ処理の下、広告パートナーは広告パフォーマンスレポートのための集約された非識別データのみを受け取ります。",
        "optOut": "Google広告設定（https://www.google.com/settings/ads）にアクセスして、パーソナライズド広告をオプトアウトできます。また、https://www.aboutads.info/choices にアクセスして、サードパーティベンダーの広告Cookieをオプトアウトすることもできます。",
        "learnMore": "Googleが子供向けコンテンツをどのように扱うかについての詳細は、https://policies.google.com/technologies/partner-sitesをご覧ください"
      },
      "advertisingPartners": {
        "title": "広告パートナー",
        "intro": "Google AdMobと提携し、ウェブサイトに広告を表示しています。Googleを含むサードパーティベンダーは、Cookieを使用して広告を配信します。Googleの広告Cookieの使用により、GoogleおよびそのパートナーはユーザーのLexiClashおよびインターネット上の他のサイトへの訪問に基づいて広告を配信できます。広告収入はすべてのプレイヤーにLexiClashを無料で提供し続けることに役立っています。すべての広告は子供向けコンテンツ処理（TFCD）モードで動作しています。",
        "howItWorks": {
          "title": "広告の仕組み",
          "cookies": "Googleを含むサードパーティベンダーは、このサイトおよび他のウェブサイトへの過去の訪問に基づいてCookieを使用して広告を配信します",
          "control": "子供向けコンテンツ処理（TFCD）がデフォルトで有効になっており、広告のパーソナライゼーションがないことを保証します",
          "noSale": "お客様の個人データを広告主に販売することは絶対にありません",
          "revenue": "広告収入は、LexiClashを無料で提供し続けるのに役立っています",
          "thirdParty": "Googleは、広告配信、フリークエンシーキャップ、集約レポートのために、デバイス固有の情報（デバイスの種類、オペレーティングシステム、ブラウザなど）およびIPベースの位置データを収集する場合があります"
        },
        "yourChoices": {
          "title": "お客様の選択",
          "intro": "LexiClashの広告を制御するためのいくつかのオプションがあります：",
          "optOut": "Google広告設定にアクセスして、パーソナライズド広告をオプトアウトできます",
          "googlePrivacy": "Googleのプライバシー慣行を確認",
          "partnerPolicy": "AdMobパートナーポリシーについて学ぶ",
          "browserCookies": "ブラウザの設定からCookieを管理または削除できます。Cookieを無効にすると、サイトの機能に影響する場合があります。",
          "aboutAds": "以下にアクセスして、サードパーティベンダーの広告Cookieをオプトアウトすることもできます"
        },
        "important": {
          "title": "重要：",
          "content": "LexiClashのすべての広告は非パーソナライズであり、子供向けコンテンツの要件に準拠しています。興味ベースの広告やリマーケティング広告は配信されません。Googleがパートナーサイトでデータをどのように使用するかについての詳細は、https://policies.google.com/technologies/partner-sites をご覧ください。Googleの広告ポリシーの詳細は以下からご確認いただけます"
        }
      },
      "cookies": {
        "title": "5. Cookieとローカルストレージ",
        "content": "以下の目的でエッセンシャルCookieとローカルストレージを使用します：認証トークン（Supabase）、ユーザー名と設定（localStorage）、テーマ設定（ダーク/ライトモード）、言語設定。また、分析目的でLogRocket Cookieを使用します。Googleを含むサードパーティベンダーは、広告配信、フリークエンシーキャップ、集約レポートのためにCookieを使用します。広告は子供向けコンテンツ処理（TFCD）モードで動作しています — パーソナライズされた広告やクロスサイトトラッキングCookieは使用されません。ブラウザの設定からCookieを管理できます：ほとんどのブラウザでは、ウェブサイトからのCookieの表示、削除、ブロックが可能です。エッセンシャルCookieを無効にすると、サイトが正常に機能しなくなる場合がありますのでご注意ください。"
      },
      "dataRetention": {
        "title": "6. データ保持",
      ...
      "childrensPrivacy": {
        "title": "12. 子供のプライバシー",
        "content": "LexiClashは子供を含む6歳以上のプレイヤー向けに設計されています。子供のプライバシーを保護するため、児童オンラインプライバシー保護法（COPPA）および同様の国際規制の遵守に取り組んでいます。",
        "measures": "当社が講じる措置：",
        "noPersonalizedAds": "パーソナライズド広告なし — すべての広告は子供向けコンテンツ処理（TFCD）モードで配信され、興味ベースの広告ターゲティングを防止します",
        "noAdTracking": "広告トラッキングCookieなし — 広告ネットワークが子供のウェブサイト間の閲覧行動を追跡することを許可しません",
        "minimalData": "最小限のデータ収集 — ゲーム体験の提供に必要なデータのみを収集します",
        "parentalInvolvement": "保護者の関与 — 利用規約に記載されている通り、13歳未満のユーザーはアカウント作成に保護者の同意が必要です",
        "noDataSale": "子供のデータの販売なし — 子供を含むいかなるユーザーの個人情報も、マーケティング目的で第三者に販売、貸与、共有することはありません",
    ...
    "cookies": {
      ...
      "cookiesWeUse": {
        ...
        "advertising": {
          "title": "広告Cookie",
          "admob": "Google AdMob — ゲームを支援するための広告を配信します。子供向けコンテンツ（TFCD）モードでは、パーソナライズされた広告Cookieは設定されません",
      ...
      "thirdPartyCookies": {
        ...
        "google": "Google AdMob — 非パーソナライズ広告の配信用。Googleは頻度制限とレポートのためにCookieを使用する場合があります。詳細はGoogleのプライバシーポリシーをご覧ください。",
    ...
    "about": {
      ...
      "whoWeAre": {
        "title": "私たちについて",
        "content": "LexiClashは、イスラエルを拠点とするLexiClash Ltdが開発したリアルタイムマルチプレイヤーワードストラテジーゲームです。若い学習者から熟練したワード愛好家まで、あらゆる年齢のプレイヤー向けに、複数の言語と文化にまたがる魅力的で教育的、かつ競争的なワードゲームを作成しています。",
        "content2": "小さな情熱プロジェクトとして始まったものは、世界中の何千人ものプレイヤーにサービスを提供するプラットフォームへと成長しました。私たちのチームは、ゲームデザイン、教育テクノロジー、多言語ソフトウェア開発の深い専門知識を組み合わせ、他に類を見ないワードゲーム体験を提供しています。すべてのゲームセッションを楽しく、公平で、豊かなものにすることに取り組んでいます。"
      },
      "story": {
        "title": "私たちのストーリー",
      ...
      "mission": {
        "title": "私たちの使命",
        "content": "私たちの使命は、言語学習を楽しく、社会的で、競争的にすることです。語彙を増やし、言語スキルを磨く最良の方法は遊びを通じてだと信じています。フラッシュカードや暗記のような従来の学習方法は退屈に感じることがあります。しかし、他のプレイヤーと最長の単語を作ろうと競争したり、文字グリッド上で隠されたターゲットを探したりしているとき、学習は自然に、楽しく起こります。",
        "content2": "私たちはすべての人のためにLexiClashを構築しています：読み始めたばかりの6歳の子供から、楽しいチャレンジを求めるティーンエイジャー、頭を鋭く保ちたい大人、ワードパズルを楽しむシニアまで。私たちの目標は、言語、文化、世代を超えて人々をつなぐゲームを作ること — 言葉は本当に普遍的であることを証明することです。"
      },
      "whatMakesUsDifferent": {
        "title": "私たちの違い",
        "intro": "LexiClashは単なるワードゲームではありません。体験のあらゆる側面をオリジナル、包括的、そして深くエンゲージングになるようデザインしました。市場の他のワードゲームとの違いをご紹介します：",
        "gameModes": {
          "title": "オリジナルゲームモード",
          "content": "タイルが爆発して連鎖反応を起こすBlast Modeから、特定のターゲットワードを見つけるレースのWord Hunt、毎日すべてのプレイヤーに同じパズルを提供するデイリーチャレンジまで。アドベンチャーモードでは、ボスバトル、スペシャルタイル、パワーアップを備えた10のテーマワールドに100レベルがあります。"
        },
        "multilingual": {
          "title": "真の多言語サポート",
        ...
        "education": {
          "title": "教育統合",
          "content": "教育モードでは、教師がカスタムワードレッスンを作成し、生徒にチャレンジを割り当て、時間の経過とともに進捗を追跡できます。世界中の教室が、生徒が実際に楽しんで使用する補助学習ツールとしてLexiClashを使用しています。"
        },
        "design": {
          "title": "大胆なネオブルタリストデザイン",
          "content": "私たちの独特のビジュアルスタイルは、パーティーゲームにインスパイアされた太い枠線、ハードシャドウ、鮮やかな色彩が特徴です。デザインは単なる美学ではなく、視覚障害のあるプレイヤーを含むすべてのプレイヤーに高いコントラストと読みやすさを保証します。"
        }
      },
      "whatWeDo": {
        "title": "私たちがすること",
        "content": "スピード、戦略、語彙スキルを組み合わせ、エンターテイメントと教育の両方を兼ね備えた体験を提供するリアルタイムマルチプレイヤーワードゲームを開発しています。LexiClashはヘブライ語、英語、スウェーデン語、日本語、スペイン語をサポートしており、今後さらに多くの言語が計画されています。",
        "content2": "コアゲーム以外にも、教育者向けツールの構築、デイリーチャレンジや季節イベントの開催、競争リーダーボードの維持、コミュニティのフィードバックに基づく新しいゲームモードと機能の継続的な開発を行っています。すべてのアップデートは、プレイヤーのニーズと世界最高のワードゲームプラットフォームを作るという私たちのコミットメントによって推進されています。"
      },
      "technology": {
        "title": "スピードのために構築",
        "content": "LexiClashはNext.jsやリアルタイムWebSocket接続を含む最先端のウェブ技術で構築されています。エンジンは100ms未満の応答時間を提供し、シームレスなマルチプレイヤーゲームプレイを実現 — 単語を送信すると、スコアが即座に表示されます。ゲームは完全にブラウザで動作し、アプリのダウンロードは不要で、インターネット接続のあるあらゆるデバイスからアクセスできます。",
        "content2": "高速な初期ページロードのためのサーバーサイドレンダリング、ライブマルチプレイヤーマッチのためのリアルタイムデータ同期、低速接続でもスムーズなゲームプレイを確保するインテリジェントキャッシングを使用しています。インフラストラクチャは何千人もの同時プレイヤーに対応するために自動的にスケーリングし、プレイヤーが期待するレスポンシブな体験を維持するためにパフォーマンスを継続的に監視しています。"
      },
      "forEducators": {
        "title": "教育者の方へ",
        "content": "LexiClashは初日から教育を念頭に設計されました。教育モードは、教師にワードゲームをカリキュラムに統合するための強力なツールセットを提供します。教師は授業計画に沿ったカスタム単語リストの作成、個々の生徒やクラス全体への時間制限付きチャレンジの割り当て、詳細な分析ダッシュボードによる進捗の監視が可能です。",
        "content2": "研究は一貫して、競争的なワードゲームが従来の学習方法と比較して語彙の定着率を大幅に向上させることを示しています。語彙練習をゲームに変えることで、生徒はより長く集中し、より多くを記憶します。LexiClashは世界中の語学クラス、ESLプログラム、外国語コースで使用されています。多言語サポートにより、バイリンガル教育や言語イマージョンプログラムに特に価値があります。"
      },
      "community": {
        "title": "コミュニティ",
        "content": "LexiClashコミュニティは多様で、温かく、毎日成長しています。カジュアルな家族のゲームナイトから激しい競技トーナメントまで、あらゆる年齢、スキルレベル、バックグラウンドのプレイヤーが参加しています。毎日全員が同じパズルをプレイするデイリーチャレンジ、競争を新鮮に保つ週次リーダーボードリセット、祝日や文化的なお祝い時の特別テーマイベントを開催しています。",
        "content2": "最高のゲームはプレイヤーによって形作られると信じています。だからこそ、ソーシャルメディアチャンネルやゲーム内フィードバックツールを通じてコミュニティのフィードバックに積極的に耳を傾けています。Blast Modeやストリークシステムを含む最も人気のある機能の多くは、プレイヤーの提案から生まれました。LexiClashをお気に入りのワードゲームにした30カ国以上の何千人ものワードゲーム愛好家に加わりましょう。"
      },
      "values": {
        "title": "私たちの信念",
        "content": "LexiClashでは、私たちの価値観がゲームデザインからデータ管理まで、あらゆる決定を導いています。ゲームには教育し、つなぎ、インスパイアする力があると信じており、その責任を真剣に受け止めています。",
        "accessibility": {
          "title": "アクセシビリティと包括性",
          "content": "LexiClashはペイウォールなしの無料プレイです。スクリーンリーダー、キーボードナビゲーション、モーション軽減、高コントラストデザインをサポートし、すべての人がプレイできるようにしています。"
        },
        "privacy": {
          "title": "プライバシー第一",
          "content": "COPPA準拠の実践、子供に安全な広告、透明なデータポリシーでプレイヤーのプライバシーを保護しています — 特に若いプレイヤーのために。個人データを販売することは決してありません。"
        },
        "fairPlay": {
          "title": "フェアプレイ",
          "content": "ペイトゥウィンの仕組みも、不公平なアドバンテージもありません。すべてのプレイヤーが平等な条件で競争します。ワードバリデーションとスコアリングシステムは一貫性があり透明です。"
        }
      },
      "team": {
        "title": "私たちのチーム",
        "content": "LexiClashは、イスラエルを拠点とするOhad Fisherと情熱的なワードゲーム愛好家、ソフトウェアエンジニア、教育スペシャリストのチームによって設立されました。最高のマルチプレイヤーワードゲーム体験を作ることに深く取り組む小さいながらも献身的なチームです。すべてのチームメンバーが言語への愛、テクノロジーへの情熱、そして楽しく、公平で、すべての人がアクセスできるゲームを作るというコミットメントを持っています。"
      },
      "contact": {
        "title": "お問い合わせ",
        "content": "ご質問、フィードバック、またはパートナーシップのお問い合わせがありますか？ぜひお聞かせください！提案のあるプレイヤー、教室でLexiClashを使用することに興味のある教師、情報を探しているジャーナリストの方 — お気軽にご連絡ください。"
      },
      "businessInfo": {
        "title": "事業情報",
        "companyLabel": "会社名",
    ...
    "disclaimer": {
      ...
      "general": {
        "title": "一般的な免責事項",
        "content": "LexiClashで提供される情報は、一般的な娯楽および教育目的のみを目的としています。正確性に努めていますが、本ウェブサイト上のコンテンツの完全性、正確性、信頼性について、いかなる保証または表明も行いません。本サイトの使用および情報への依存は、お客様ご自身の責任で行ってください。"
      },
      "noProfessionalAdvice": {
        "title": "専門的なアドバイスではありません",
        "content": "LexiClashはワードゲームプラットフォームです。本ウェブサイトのいかなる内容も、専門的、教育的、言語学的、またはその他のいかなる形式のアドバイスを構成するものではありません。ゲームコンテンツ、単語の定義、教育機能は娯楽目的で提供されており、権威ある言語リファレンスとして依存すべきではありません。"
      },
      "asIs": {
        "title": "「現状のまま」の提供",
        "content": "LexiClashは、明示的または黙示的を問わず、いかなる種類の保証もなく、「現状のまま」および「利用可能な状態で」提供されます。サービスが中断なく、安全で、エラーフリーであることを保証しません。ゲームスコア、リーダーボード、統計は娯楽目的で提供されます。"
      },
      "thirdParty": {
        "title": "サードパーティのリンクとコンテンツ",
        "content": "LexiClashには、サードパーティのウェブサイトまたはサービスへのリンクが含まれている場合があります。サードパーティサイトのコンテンツ、プライバシーポリシー、慣行について、当社は管理していません。サードパーティのコンテンツ、製品、またはサービスについて、当社は推奨も責任も負いません。"
      },
      "advertising": {
        "title": "広告コンテンツ",
        "content": "LexiClashは、Google AdMobを含むサードパーティ広告ネットワークが提供する広告を表示します。これらの広告はLexiClashによる推奨ではありません。広告コンテンツは、さまざまな要因に基づいて広告ネットワークによって決定され、LexiClashの見解や価値観を反映しない場合があります。サイトに表示される広告の正確性やコンテンツについて、当社は責任を負いません。"
      },
      "liability": {
        "title": "責任の制限",
        "content": "法律で認められる最大限の範囲で、LexiClashおよびその制作者は、データの損失、利益の損失、サービスの中断を含むがこれらに限定されない、サービスの使用から生じる間接的、偶発的、特別、結果的、または懲罰的な損害について責任を負わないものとします。"
      },
      "changes": {
        "title": "本免責事項の変更",
        "content": "当社は、本免責事項をいつでも更新する権利を留保します。変更は、更新された改訂日とともにこのページに掲載されます。変更後もLexiClashを継続して使用することは、更新された免責事項の承諾を意味します。"
      },
      "contact": {
        "title": "お問い合わせ",
        "content": "本免責事項についてご質問がある場合は、lexiclash.game@gmail.comまでお問い合わせください。"
      }
    }
  },
  "season": {
  ...
  "wordFeedback": {
    ...
    "witty1": "{player}が「{word}」は本当の言葉だと主張...",
    "witty2": "本当の言葉？天才的発想？あなたが決めて！",
    "witty3": "{player}の脳内辞書で「{word}」を発見",
    "witty4": "辞書編集者が「{word}」について知りたがっている",
    "witty5": "本当っぽい...本当？",
    "witty6": "「{word}」は天才か狂気か？",
  ...
  "blog": {
    ...
    "addictiveTitle": "ワードゲームがやめられない理由",
    "brainTrainingTitle": "脳トレとしてのワードゲーム",
  ...
  "landing": {
    ...
    "tickerWord": "ワード",
    "tickerStreak": "連勝",
    "tickerScored": "{count}語で{score}ポイント獲得",
    "tickerFoundWord": "「{word}」を発見 ({score}ポイント)",
    "tickerScoredPts": "{score}ポイント獲得",
    "tickerCracked": "{tries}回で単語を解読",
    "tickerCleared": "{combo}xコンボで{tiles}タイルをクリア",
    "tickerFoundLong": "「{word}」を発見 ({length}文字!)",
    "tickerFun1": "ワード筋をウォームアップ中",
    "tickerFun2": "隠れた宝石を発見",
    "tickerFun3": "絶好調",
    ...
    "tickerFun9": "見事なプレイ",
    "tickerFun10": "ボードを支配中",
    "tickerFun11": "こっそり長い単語を発見",
    "tickerFun12": "最高のセッション中",
  ...
  "singlePlayer": {
    ...
    "preset": {
      ...
      "quickDesc": "1分スピードゲーム",
      "standard": "スタンダード",
      "standardDesc": "2分クラシックゲーム",
      "intense": "インテンス",
      "intenseDesc": "大きいボード、3分",
      "friendly": "フレンドリー",
      "friendlyDesc": "イージーモード、ボット1体",
      "competitive": "ガチ勝負",
      "competitiveDesc": "ミディアム、ボット2体",
      "battle": "バトル",
      "battleDesc": "ハードモード、ボット3体",
      "explorer": "エクスプローラー",
      "explorerDesc": "時間制限なし、イージーボード",
      "hunter": "ハンター",
      "hunterDesc": "時間制限なし、ミディアムボード",
      "mastery": "マスタリー",
      "masteryDesc": "時間制限なし、ハードボード",
      "warmup": "ウォームアップ",
      "warmupDesc": "1分イージーチャレンジ",
      "personalBest": "自己ベスト",
      "personalBestDesc": "ハイスコアを超えろ",
      "ultra": "ウルトラ",
      "ultraDesc": "3分ハードチャレンジ"
    },
    "mode": {
      "soloBots": "ボット対戦",
      "soloBotsDesc": "AI相手に勝負",
      "practice": "練習",
  ...
  "practice": {
    ...
    "instructions": {
      ...
      "cta": "いってみよう！",
      "classic": {
        "line1": "指で文字をなぞろう — 一列に並んでいなくてOK。",
        "line2": "ななめもアリ。どの方向でも大丈夫！",
        "line3": "本物の単語を3つ見つけたら勝ち。タイマーなし、プレッシャーなし。"
      },
      "wordHunt": {
        "line1": "盤面に秘密の単語が隠れているよ。上のカテゴリーがヒント！",
        "line2": "なんでも推測してOK — 色で答えに近い文字がわかるよ。",
        "line3": "秘密の単語を解いたら勝ち。じっくり時間をかけて。"
      },
      "wheelRush": {
        "line1": "ホイールのまわりの文字をタップして単語を作ろう。",
        "line2": "光ってる中央の文字は毎回必ず使ってね。",
        "line3": "本物の単語を3つ見つけてクリア — のんびりいこう！"
      }
    },
    "modifier": {
      "todayLabel": "今日のお題",
  ...
  "sendChallenge": "挑戦を送る",
  "selectDuelType": "デュエルタイプを選択",
  "turnBased": "ターン制",
  "realTime": "リアルタイム",
  "turnBasedDesc": "自分のペースでプレイ",
  "realTimeDesc": "ライブで対戦",
  "waitingForStart": "対戦相手を待っています...",
  "timeRemaining": "残り時間",
  "yourScore": "あなたのスコア",
  ...
  "forfeitDescription": "このデュエルに負けとなり、相手が勝利します。この操作は取り消せません。",
  "forfeitConfirm": "はい、棄権します",
  "forfeitCancel": "キャンセル",
  "wonByForfeit": "棄権勝ち",
  "lostByForfeit": "棄権負け",
  "realtimeDuel": "リアルタイムデュエル",
  "duelComplete": "デュエル完了！",
  "rules": {
  ...
  "daily": {
    ...
    "chaseChasing": "{name} まであと {points}",
    "chaseChasingCta": "いい単語ひとつで逆転できる",
    "chaseLeading": "{name} に {points} 差でリード中",
    "chaseLeadingCta": "首位をキープしよう",
    "chaseRank": "{total}人中 {rank}位",
    "chaseChasingNoGap": "次のライバルは {name}",
    "chaseLeadingNoGap": "{name} がすぐ後ろにいる",
    ...
    "quitConfirmTitle": "ゲームの途中で終了しますか？",
    "imSure": "終了する",
    "wordsFound": "{count}語発見",
    "streak": "ストリーク",
  ...
  "dailyWordWheelLanding": {
    "hero": {
      "title": "デイリーワードホイール",
      "subtitle": "毎日の無料ワードパズル",
      "description": "毎日新しいワードホイールパズル。文字ホイールから単語を見つけ、世界記録に挑戦し、連続記録を追跡。無料、ダウンロード不要。",
      "cta": "今日のワードホイールをプレイ",
      "leaderboard": "世界記録を見る"
    },
    "steps": {
  ...
  "wordWheel": {
    "youFoundEverything": "相手が見つけた言葉をすべて見つけました。お見事。",
    "title": "ワードホイール",
    ...
    "results": {
      ...
      "nextUpBadge": "次はこれ",
      "playConnectionsTitle": "次はワードブリッジ",
      "playConnectionsDesc": "今日のワードブリッジパズルを解いてデイリーセットを完成させよう",
  ...
  "wordHunt": {
    ...
    "leaderboard": {
      ...
      "live": "ライブ",
      "movedUp": "{count}位アップ",
      "movedDown": "{count}位ダウン",
      "newEntry": "NEW",
      "seasonPts": "シーズンpt",
      "daysPlayed": "{count}日プレイ",
      "dayPlayed": "1日プレイ",
      "seasonNoPlayers": "まだシーズンスコアがありません。今日のパズルが最初の一歩です",
      "seasonEndsIn": "終了まで{days}日{hours}時間",
      "seasonEnded": "シーズン終了",
      "seasonHint": "デイリーを遊ぶたびにシーズンスコアが積み上がります",
      "currentSeason": "開催中",
      "seasonPicker": "シーズンを選択",
      "languageScope": "言語フィルター"
    },
    "shareMessage": {
  ...
  "pushNotifications": {
    "settings": {
      "title": "プッシュ通知",
      "description": "デイリーパズルのリマインダーを受け取る",
      "enabled": "デイリーリマインダー",
      "enabledDesc": "毎朝チャレンジを思い出させてくれる",
      "time": "リマインド時間",
      "timeDesc": "新鮮なパズルで起こす時間",
      "permissionRequired": "許可が必要です",
      "permissionDenied": "通知がブロックされています",
      "permissionDeniedDesc": "リマインダーを受け取るには、端末設定で通知を有効にしてください",
      "openSettings": "設定を開く",
      "enableButton": "リマインダーをオンにする",
      "saved": "リマインダー設定完了！"
    },
    "daily": {
      ...
      "bodyWithHint": "今日のパズルで『{letter}』発見。残りも見つけられる？",
      "title4": "チクタク、時間が過ぎていく！",
      "body4": "デイリーチャレンジは深夜にリセット。チャンスを逃すな！",
      "title5": "秘密の文字: {letter} 💡",
      "bodyWithHint2": "これが最初のヒント。今日のグリッドに隠れている全ての言葉を見つけよう！",
      "title6": "おはよう、ワードハンター！ ☀️",
      "body6": "コーヒーとパズル？最高の組み合わせ。さあ、始めよう！",
      "title7": "チャレンジ受けて立つ？ 🎮",
      "body7": "新しい日、新しい言葉、ランキングを上げる新しいチャンス。"
    }
  },
  "unsubscribe": {
    "processing": "作業中...",
  ...
  "brain": {
    ...
    "playAgain": "もう一度",
    "briefing": {
      "missionLabel": "今回のミッション",
      "goalLabel": "このラウンド",
      "benefitLabel": "脳トレの効果",
      "howToLabel": "遊び方",
      "coachLabel": "コーチのコツ",
      "letsTrain": "トレーニング開始！",
      "participationLabel": "いっぱい挑戦",
      "performanceLabel": "あなたのパフォーマンス",
      "bonusLabel": "ボーナス"
    },
    "drills": {
      "title": "脳トレドリル",
  ...
  "admin": {
    ...
    "insights": {
      ...
      "gamesToday": "今日のゲーム",
      "vsYesterday": "昨日と比較",
      "vsYesterdayNew": "昨日 0 と比較",
      "bestDayEver": "最高の日",
      "fastestGrowing": "最も成長しているモード",
      "thisWeek": "今週",
      "byDayOfWeek": "最も忙しい日",
      "isPeakDay": "がピークの日です",
      "byHour": "最も忙しい時間（UTC）",
      "isPeakHour": "がピークの時間です",
      "crossPlay": "Xをプレイするプレイヤーも、Yをプレイします",
      "noShowRate": "参加したがスコアなし",
      "noShowHint": "0ポイント＆0単語で記録されたゲームの割合 — 参加したがプレイしなかったプレイヤー。",
      "wordQuality": "言語別の単語品質",
      "wordQualityHint": "却下 vs 承認された単語提案（30日間）。却下率が高いと、その言語の辞書ギャップを示しています。",
      "rejected": "却下",
      "dow": {
        "sun": "日曜日",
        "mon": "月曜日",
    ...
    "teacherAccess": {
      ...
      "preview_subject": "件名",
      "copy_email": "メールのHTMLをコピー",
      "copy_success": "メールのHTMLをクリップボードにコピーしました",
    ...
    "wordBank": {
      ...
      "filters": {
        ...
        "allValidationStatuses": "すべての検証ステータス",
        "allSources": "すべてのソース",
        "searchLabel": "検索",
        "search": "単語を検索...",
        "active": "アクティブ",
      ...
      "bulkImport": {
        "button": "一括インポート",
        "title": "単語の一括インポート",
        "description": "複数の単語を一度にインポートします。1行に1単語、またはカンマで区切って入力してください。",
        "instructions": "インポートする単語を入力:",
        "formatPlain": "プレーンテキスト: 1行に1単語",
        "formatCsv": "CSV: 最初の列が単語として使用されます",
        "lengthFilter": "有効な文字数範囲外の単語はスキップされます",
        "source": "ソース",
        "inputLabel": "インポートする単語",
        "placeholder": "改行またはカンマで区切って単語を入力...",
        "options": "インポートオプション",
        "validationStatus": "検証ステータス",
        "wordsLabel": "単語",
        "noContent": "インポートする単語を入力してください",
        ...
        "errors": "エラー",
        "showErrors": "エラー詳細を表示...",
        "successMessage": "{{count}}件の単語をインポートしました",
      ...
      "bulkActions": {
        ...
        "approving": "承認中...",
        "rejecting": "却下中...",
        "successMessage": "{{count}}件の単語を{{action}}しました",
        "errorMessage": "一括操作に失敗しました",
        "clearSelection": "選択をクリア"
      },
      "wikipediaSync": {
        "title": "Wikipedia同期",
        "description": "Wikipedia単語をレビュー用に単語バンクに同期",
        "currentLanguage": "現在の言語",
        "syncButton": "Wikipedia単語を同期",
        "syncNow": "今すぐ同期",
        "syncing": "同期中...",
        "success": "{{files}}ファイルを同期、{{words}}件の単語をインポートしました",
        "successMessage": "{{count}}件の単語を同期しました",
    ...
    "acquisition": {
      ...
      "campaigns": "キャンペーン",
      "referrers": "リファラー",
      "empty": "この次元にデータはありません",
      "error": "獲得データの読み込みに失敗しました"
    },
    "authSessions": {
      "title": "認証済みアクティビティ",
      "totalGames": "ゲーム",
      ...
      "byMode": "モード別",
      "byLanguage": "言語別",
      "empty": "この期間に認証済みゲームはありません",
      "error": "認証済みデータの読み込みに失敗しました"
    },
    "guests": {
      "title": "ゲスト活動",
      "totalGames": "ゲーム数",
      "uniqueGuests": "ユニークゲスト",
      "avgScore": "平均スコア",
      "byMode": "モード別",
      "byLanguage": "言語別",
      "windowDays": "{{days}}日間",
      "empty": "この期間にゲストのゲームはありません",
      "error": "ゲストデータの読み込みに失敗しました"
    },
    "player": {
      "title": "プレイヤー詳細",
      "back": "戻る",
      "notFound": "プレイヤーが見つかりません",
      "loadError": "プレイヤーの読み込みに失敗しました",
      "joined": "参加日",
      "lastGame": "最終プレイ",
      "recentGames": "最近のゲーム",
      "avgScore": "平均スコア",
      ...
      "utmCampaign": "キャンペーン",
      "referrer": "リファラー",
      "noAcquisitionData": "獲得データなし",
      "byLanguage": "プレイ言語",
      "byMode": "モード別（直近200セッション）",
      "sessions": "セッション",
      "completed": "完了",
      "ranked": "ランク",
      "casual": "カジュアル",
      "noGames": "最近のゲームはありません",
      "gameCode": "ゲーム",
      "score": "スコア",
      "words": "単語",
      "placement": "#",
  ...
  "adminGifts": {
    ...
    "selectAtLeast": "少なくとも1人のプレイヤーを選択してください",
    "playerSelected": "人のプレイヤーを選択",
    "playersSelected": "人のプレイヤーを選択",
    ...
    "presetLarge": "大",
    "template": {
      "topPlayer": "トッププレイヤー認定",
      "topPlayerDesc": "プレイヤーの優れたパフォーマンスを称える",
      "feedback": "フィードバックリクエスト",
      "feedbackDesc": "プレイヤーにフィードバックと提案を求める",
      "thankYou": "ありがとう",
  ...
  "adventure": {
    ...
    "bosses": {
      ...
      "msGrammar": {
        ...
        "taunts": {
          "start1": "授業開始！勉強してきたか見せてもらいましょう...",
          "start2": "抜き打ちテストの時間！準備はいいかしら？",
          "goodWord1": "合格点よ。でも最低限で満足しないでね。",
          "goodWord2": "ふーん、悪くないわね。受かるかもしれないわ。",
          "badWord1": "それは単語じゃないわ！内申書に書くからね。",
          "badWord2": "勉強したの？減点よ。",
          "mechanic1": "課題を読んだの？{requirement}を求めたのよ！",
          "mechanic2": "要件に従いなさい！自由時間じゃないのよ！",
          "lowTime1": "時間切れ間近！勉強しなかった生徒みたいね...",
          "victory": "あら...指示に従えるじゃない。金星をあげるわ！",
          "defeat": "放課後に来なさい...語彙の補習よ。"
        }
      },
      "spellingBee": {
        "name": "スペリングビー",
        ...
        "taunts": {
          ...
          "goodWord1": "ハチじゃないにしては悪くないわ。許してあげる。",
          "goodWord2": "あら、類義語を見つけたの？なんてハチ的に十分なの。",
          "badWord1": "その単語？ハニー、お願いよ。",
          "badWord2": "うちの働きバチの方がいい単語見つけるわ。脳みそ小さいのに。",
          "mechanic1": "粘着タイルを外すには類義語を見つけて、スイートハート！",
          "mechanic2": "巣は類義語を要求してるの！意味のある大きな単語を！",
          "lowTime1": "チクタク！私のハチミツだってそんなに時間かからないわ！",
          "victory": "私に...勝った？女王に？また来るわよ。（わかった？ビー？ハチだから。）",
          "defeat": "また一人刺された！私の巣の記録は無敗のまま。"
        }
      },
      "professorThesaurus": {
        "name": "シソーラス教授",
        ...
        "taunts": {
          ...
          "goodWord1": "十分だ。いや、満足、許容、適切と言うべきか...",
          ...
          "defeat": "語彙が...成熟してから戻ってきたまえ。発展。開花。"
        }
      },
      "captainMetaphor": {
        "name": "キャプテン・メタファー",
      ...
      "baronBuildaword": {
        ...
        "taunts": {
          ...
          "start2": "ワード組立マシン3000準備完了！君の工学力を見せてもらおう！",
          "goodWord1": "悪くない！でも複合語か？すべて複合すべきだ！",
          "goodWord2": "許容範囲の出力だ！マシンが承認した。ギリギリだが。",
          "badWord1": "複合語じゃない！ただの...単語だ。なんて非工学的！",
          "badWord2": "ワード組立マシン3000がこれを拒否した！もっと頑張れ！",
          "mechanic1": "コンベアが動いてる！通り過ぎる前に文字を捕まえろ！",
          "mechanic2": "複合だ！複合だ！ひまわり！蝶！ブレインストーム！",
          "lowTime1": "組立ラインは誰も待たない！もっと速く！",
          "victory": "俺より...いい工学だと？不可能だ！もっといいマシンを作る！",
          "defeat": "また非効率な挑戦者を倒した！マシンの勝ちだ！"
        }
      },
      "puzzleMaster": {
        "name": "パズルマスター",
        ...
        "taunts": {
          ...
          "goodWord1": "一つ見つけたわね。でもそのアナグラムが隠れてるの、見えた？",
          "goodWord2": "賢いわね。でも「CARE」には仲間がいるの：RACE、ACRE。全部見つけた？",
          "badWord1": "直接的な答え？退屈ね。",
          "badWord2": "どう並べてもそれは単語じゃないわ。信じて、全部チェックしたから。",
          "mechanic1": "現実が歪む！文字が移動してる！ついていける？",
          "mechanic2": "アナグラムペアを見つけて！待ってるわよ！",
          "lowTime1": "時間切れ間近...それとも時間が入ってくる？アナグラム次第ね。",
          "victory": "私のパズルを解いた？！実は...感心してるわ。誰にも言わないで。",
          "defeat": "パズルは未解決のまま！横に考えられるようになったら戻ってきて。"
        }
      },
      "reflectionKing": {
        "name": "リフレクションキング",
        ...
        "taunts": {
          ...
          "badWord1": "我が氷を割るとは？悲劇だ！...実は、もう一度やれ。",
          "badWord2": "その言葉は我が鏡の宮殿にふさわしくない！もっと努力せよ！",
          "mechanic1": "鏡が反射する！お前の動きは両側に影響する！",
          "mechanic2": "回文を見つけて完璧な反射を！",
          "lowTime1": "我が美しささえ時を止められぬ！急げ！",
          "victory": "我が映り姿を...曇らせたと？！少し時間が必要だ。鏡も。",
          "defeat": "もちろん我が勝った！我を見よ。完璧は不可避なのだ！"
        }
      },
      "cosmicWordsmith": {
        "name": "コズミック・ワードスミス",
        ...
        "taunts": {
          ...
          "goodWord1": "その言葉？私は17バージョン作った。どういたしまして。",
          "goodWord2": "私の創造物の許容範囲内の使用だ。存在を許そう。",
          "badWord1": "星がその言葉の試みよりも雄弁に死ぬのを見てきた。",
          "badWord2": "ブラックホールでさえその...非言葉よりは中身がある。",
          "mechanic1": "文字が進化する！AがEになりIになる！宇宙は適応を要求する！",
          "mechanic2": "Q、X、Zでスーパーノヴァ！レア文字には宇宙の力がある！",
          "lowTime1": "私でさえ時間を遅くできない。文字通り宇宙的なのに。",
          "victory": "私の言葉を...マスターした？！人間も完全に絶望的ではないようだ。",
          "defeat": "千年後に戻ってこい。もっと...練習が必要だ。永劫の練習が。"
        }
      },
      "linguistSage": {
        "name": "言語学の賢者",
        ...
        "taunts": {
          ...
          "goodWord1": "美しい言葉だ！英語でも使える、そして...ふむ、メモを確認中...",
          "goodWord2": "マニフィーク！ヴンダバー！素晴らしい！...また言語を混ぜてるかも。",
          "badWord1": "その言葉はゼロの言語に存在する。全部チェックした。",
          "badWord2": "ヤギの友達でももっといい言葉を見つける。缶を食べるのに。",
          "mechanic1": "言語が変わる！語彙を新しい言語に合わせて！",
          "mechanic2": "複数の言語で通じる言葉を見つけて万国共通の理解を！",
          "lowTime1": "すべての言語で時間切れ！シュネル！速く！ラピド！",
          "victory": "勝利の万国共通語を話すとは！なんと...啓発的な。",
          "defeat": "頂はまだ未踏のまま。もっと言語を学んでから戻ってきなさい。"
        }
      },
      "lexiconDragon": {
        "name": "レキシコンドラゴン",
        ...
        "taunts": {
          ...
          "goodWord1": "「ドラゴン」見つけた！それ僕！次は「すごい」を見つけて、それも僕だから！",
          "goodWord2": "すごい言葉！日記に書く！48巻目！",
          "badWord1": "それは言葉じゃない！...それとも？1巻から47巻まで確認させて...",
          "badWord2": "すごく受け入れたいけど内なる言葉オタクがダメって言ってる！",
          "mechanic1": "フェーズシフト！新しいメカニクスが登場！全部対処できる？",
          "mechanic2": "レキシコンストライク充電中！すごい言葉を見つけ続けて！",
          "lowTime1": "うわあ時間切れ！でもすごく楽しかったのに！",
          "victory": "勝った！これで友達ってこと？！最高の日！",
  ...
  "blast": {
    ...
    "helpIceLabel": "アイス",
    "helpIce": "壊すには2回のヒットが必要。最初の使用でひび割れ。",
    "helpLightningLabel": "ライトニング",
    "helpLightning": "単語に使用すると列全体をクリア。",
    "helpMagnetLabel": "マグネット",
    "helpMagnet": "クリア時に近くのタイルを引き寄せる。",
    "helpMirrorLabel": "ミラー",
    "helpMirror": "パートナーの特殊効果を倍増、または2倍スコア。",
    "helpSilverLabel": "シルバー",
    "helpSilver": "単語のスコア4倍。",
    "helpDiamondLabel": "ダイヤモンド",
    "helpDiamond": "スコア5倍。最高価値タイル。",
    ...
    "objective": {
      ...
      "colorCyan": "シアン",
      "colorLime": "ライム",
      "clearJelly": "ゼリーをすべて取り除こう",
      "killCake": "ケーキを破壊しよう",
      "stopChocolate": "チョコレートを止めよう",
      "bannerTitle": "目標",
      "pathRoute": "◯と◉を1単語でつなぐ",
      "pathRouteSuccess": "ルート完成！",
      "cascadeChain": "{target}単語を連続で",
      "cascadeChainProgress": "🔥 ×{streak}",
      "cascadeChainSuccess": "連続成功！",
      "tileSniper": "印のマスを単語に含める",
      "tileSniperSuccess": "命中！",
      "longWordLockup": "{minWordLength}文字以上の単語を1つ",
      "longWordLockupSuccess": "傑作！"
    },
    "insight": {
      "label": "本日のハイライト",
    ...
    "combo": {
      ...
      "bomb_prism": "シャッターストーム！",
      "bomb_rainbow": "レインボー爆発！",
      "bomb_mirror": "ミラーボム！",
      "bomb_magnet": "磁気爆発！",
      "bomb_gem": "結晶粉砕！",
      "bomb_frozen": "解凍爆発！",
      "lightning_lightning": "チェーンライトニング！",
      "lightning_prism": "クロスサンダー！",
      "lightning_rainbow": "レインボーストーム！",
      "lightning_mirror": "ダブルストライク！",
      "lightning_magnet": "サージプル！",
      "lightning_gem": "スパーク結晶！",
      "lightning_frozen": "衝撃波解凍！",
      "prism_prism": "完全破壊！",
      "prism_rainbow": "スペクトルノバ！",
      "prism_mirror": "無限クロス！",
      "prism_magnet": "渦クロス！",
      "prism_gem": "結晶プリズム！",
      "prism_frozen": "プリズム解凍！",
      "rainbow_mirror": "ミラーレインボー！",
      "rainbow_magnet": "レインボープル！",
      "rainbow_gem": "レインボー結晶！",
      "rainbow_frozen": "レインボー解凍！",
      "mirror_magnet": "ダブル渦！",
      "mirror_gem": "結晶ミラー！",
      "mirror_frozen": "エコーフリーズ！",
      "magnet_gem": "結晶プル！",
      "magnet_frozen": "凍結渦！",
      "gem_frozen": "氷結晶！",
  ...
  "student": {
    "practiceFun": {
      ...
      "starsEarned": "星 {{count}}／3",
      "scoreLine": "{{total}}問中 {{correct}}問正解・{{percent}}%",
      "xpGain": "+{{xp}} XP",
      "xpRate": "{{xp}} XP",
      "next": "次のゲーム",
      "nextMode": "次は{{mode}}",
  ...
  "teacher": {
    "nav": {
      ...
      "me": "マイページ",
      "studentPlay": "プレイ",
      "studentPractice": "れんしゅう",
      "studentAchievements": "トロフィー",
      "sidebarLabel": "先生メニュー",
      "tabsLabel": "メインメニュー"
    },
    "emptyClassroom": {
      "title": "クラスはまだなくて大丈夫",
      "body": "「ライブ開始」を押すだけ。参加コードを黒板に映している間にクラスを用意します。",
      "getCode": "参加コードをもらう"
    },
    "shell": {
    ...
    "lastGame": {
      ...
      "emptyHint": "上の「いますぐプレイ」から対戦を始めると、クラスが見つけた単語・見つけられなかった単語がここに表示されます。",
      "previousGames": "過去の対戦",
    ...
    "proWelcome": {
      ...
      "paidBody": "Teacher Pro のサブスクリプションが有効になりました。教師プロフィールからいつでも管理・解約できます。",
      "manage": "サブスクリプションを管理",
      "cta": "はじめる"
    },
    "plan": {
  ...
  "education": {
    "whatsNew": {
      "entries": {
        "sep2026": {
          "packs": "スペイン語・スウェーデン語・日本語・ロシア語のスターターパックを用意しました。",
          "reports": "レポートがより正確に:ゲスト生徒も記録され、再戦でも生徒は1回だけカウント、宿題の完了も表示されます。",
          "rematch": "クイズ後はワンタップで再戦。選んだゲームモードが必ずそのままプレイされます。",
          "join": "参加がかんたんに:コード入力は1つだけ、本物のQRコード付き。早く参加した生徒はエラーではなく待機画面で待ち、遅れて参加した生徒は現在の問題から始められます。",
          "wordcraft": "Word Craftを宿題として出せるようになりました。レッスンの単語が盤面に登場し、実際にプレイしたラウンドだけが完了として記録されます。",
          "leaderboard": "プロジェクターにライブランキングを表示。追い抜きのたびに順位が入れ替わり、生徒は自分の位置を確認できます。",
          "chests": "語彙クイズに宝箱が登場:正解すると3つの宝箱から1つを開けられます(獲得・2倍・奪取・入れ替え)。初期設定でオン、ゲーム設定でオフにできます。",
          "title": "クラスのゲームがもっと楽しく",
        },
      },
      "close": "OK",
      "subtitle": "クラスのゲームの改善点を、リリースごとにお知らせします。",
      "title": "先生向けの新機能",
      "button": "新機能",
    },
    "subscription": {
    ...
    "homework": {
      ...
      "exit": "ゲームを閉じる",
      "promptMeaning": "どんな意味？",
      "promptSpelling": "正しいつづりはどれ？",
      "promptSpellingHint": "この中のひとつが正しいつづりです。",
      "promptSpell": "つづってみよう",
      "timeLeft": "残り{{seconds}}秒",
      "correct": "せいかい！",
      "almost": "正解は {{word}}",
      "finishTitle": "宿題おわり！",
      "finishTitlePerfect": "全問せいかい！",
      "wordsRight": "正解した語",
      "bestRun": "最高連続",
      "starsEarned": "3つ中{{stars}}つの星",
      "playAgain": "もう一回",
    ...
    "modePicker": {
      "title": "ゲームを選ぶ",
      "subtitle": "ポスターをタップするだけ。1秒後にはクラスが遊んでいます。",
      "recommended": "いちばん合う",
      "recommendedHint": "この単語には{{mode}}がぴったり。リストに意味が入っているので出題できます。",
      "minutes": "{{count}}分",
      "playing": "プレイ中",
      "change": "ゲームを変える",
      "sheetTitle": "ゲームを切り替える",
      "sheetHint": "別のポスターをタップすれば、そちらで部屋を開きます。",
      "close": "このままでいい",
      "settings": "こまかい設定",
      "settingsHide": "設定を閉じる",
      ...
      "fewerModes": "とじる",
      "sameCode": "コードはそのまま。入り直さなくて大丈夫です。",
      "switched": "{{mode}}に切り替えました。コードはそのままです。",
      "switchFailed": "切り替えできませんでした。もう一度タップしてください。",
      "switchMidRound": "このラウンドを終えてからゲームを変えてください。",
      "how": {
        "classic": "みんな同じ文字盤で、見つけた単語をどんどんなぞる。",
    ...
    "intentCta": {
      "forTeachers": "先生向け / 英語を学ぶ",
      "eslBody": "授業を回す、あるいは遊びながら英語を学ぶなら、ESL単語ゲームのページへ。教師主導のラウンド、6つの辞書、生徒アカウントは不要です。",
      "eslLink": "教室向けESL単語ゲーム",
      "teachersBody": "先生と英語学習者向け。無料の教室ゲーム、テーマ別リスト、プロジェクターで回すクラス全体の盤です。",
      "hubLink": "教育ハブ",
      "elementaryLink": "小学校向け英語ゲーム"
    },
    "classroomModeBlurb": {
    ...
    "liveControls": {
      "studentsCount": "{{count}}人がプレイ中",
      "idleCount": "{{count}}人が手つかず",
      "rosterTitle": "クラスの様子",
      "rosterEmpty": "まだ誰も参加していません",
      "idleBadge": "手つかず",
      "wordsFound": "{{count}}語",
      "remove": "退出させる",
      "removeAria": "{{name}}をゲームから退出させる",
      "removeConfirm": "{{name}}を退出",
      "removeCancel": "やめる",
      "removeWarning": "このゲームには再参加できません",
      "removing": "退出中…",
      "removeFailed": "もう一度",
      "title": "先生用コントロール",
      "pause": "一時停止",
    ...
    "results": {
      ...
      "you": {
        ...
        "words": "レッスン単語 {{found}}/{{total}}",
        "gapToNext": "{{name}}まであと{{points}}点"
      },
      "moment": {
        "winnerBanner": "優勝者が決定！",
        "drumroll": "ドラムロール…",
        "sweepTag": "全単語制覇！",
        "classSweptTag": "クラス全員で{{total}}語すべて発見！",
        "sweepStreak": "{{count}}回連続で全制覇",
        "roundOfSession": "このセッション{{round}}ラウンド目",
        "deltaUp": "前回より+{{points}}点",
        "deltaDown": "前回より{{points}}点ダウン",
        "deltaSame": "前回と同じ点数",
        "personalBest": "自己ベスト！",
        "climbed": "{{places}}位アップ"
      },
      ...
      "teamTilesChooseTeams": "チーム数は？",
      "teamTilesTeamName": "チーム {{number}}",
      "teamTilesActiveTeam": "チーム {{number}} の番",
      "teamTilesFlipHint": "タイルをめくる",
      "teamTilesFaceDown": "裏向きの miss-gap タイル",
      "teamTilesGotIt": "チームできた！",
      "teamTilesExit": "Team Tiles を終了",
      ...
      "startClassicUnplugged": "Classic Unplugged を開始",
      "classicUnpluggedProgress": "単語 {{current}} / {{total}}",
      "classicUnpluggedClassScore": "クラススコア",
      "classicUnpluggedChooseMode": "クラスかチーム？",
      "classicUnpluggedClassMode": "クラス",
      "classicUnpluggedTeamName": "チーム {{number}}",
      "classicUnpluggedActiveTeam": "チーム {{number}} の番",
      "classicUnpluggedDiscussHint": "話し合ってから公開",
      "classicUnpluggedReveal": "単語を公開",
      "classicUnpluggedSubmitGotIt": "送信：できた",
      "classicUnpluggedSubmitNotYet": "送信：まだ",
      "classicUnpluggedExit": "Classic Unplugged を終了",
      ...
      "unpluggedGameScore": "クラスのスコア",
      "unpluggedGameStreak": "連続正解",
      "unpluggedGameStart": "タイマースタート",
      "unpluggedGameRevealNow": "答えを見る",
      "unpluggedGameGotIt": "クラス正解！",
      "unpluggedGameNotYet": "まだまだ",
      ...
      "unpluggedGameWinSub": "{{total}}語のうち{{cleared}}語を、ひとつのチームでクリア。",
      "unpluggedGamePerfectHeadline": "パーフェクトクリア！",
      "unpluggedGamePerfectSub": "全部の単語を、みんなでミスなく。",
      "unpluggedGamePerfectBadge": "全問クリア",
      "unpluggedGameCleared": "クリアした単語",
      ...
      "unpluggedReteachPackFooter": "LexiClash · Unplugged再指導パック",
    },
    "classroomAddon": {
    ...
    "duels": {
      ...
      "comboAria": "コンボ {{count}} 連鎖",
      "comboBonus": "コンボボーナス、プラス {{points}} 点",
      "comboNone": "準備完了",
      "comboSpark": "スパーク",
      "comboBlaze": "ブレイズ",
      "comboInferno": "インフェルノ",
      "comboSupernova": "スーパーノヴァ",
      "aheadBy": "{{points}} 点リード",
      ...
      "revealDraw": "引き分け！",
      "xpEarned": "+{{count}} XP",
      "bestChain": "最高連鎖 {{count}}",
      "coinsEarned": "{{count}} コイン",
      "backToLobby": "ロビーへ",
      "newSeries": "新しいシリーズ",
      "seriesWon": "シリーズ制覇",
      "seriesLost": "シリーズ敗退",
    ...
    "analytics": {
      ...
      "completionRate": "達成率",
      "connecting": "接続中...",
      "connectionError": "接続が切れました",
      "createReviewLesson": "復習レッスンを作成",
      "daysAgo": "{{count}}日前",
      "error": "データの読み込みに失敗",
      ...
      "subtitle": "クラスのパフォーマンスを追跡",
      "title": "分析ダッシュボード",
      "today": "今日",
      "updatedAgo": "{{time}}前に更新",
      "viewAssignments": "課題を見る",
      "viewLessons": "レッスンを見る",
      "viewStudents": "生徒を見る",
    ...
    "landing": {
      ...
      "studentFeature3": "友達と競い合う",
      "tagline": "言葉は力。遊びながら身につける。",
      "teacher": "先生向け",
      "teacherCta": "クラスを作る",
      "teacherDesc": "語彙授業をゲーム化",
      "teacherFeature1": "生徒の成長を可視化",
      "teacherFeature2": "カスタムレッスン",
      "teacherFeature3": "ライブゲーム＆分析",
      "title": "LexiClash 教育",
      "startGame": "ゲーム開始",
      "hero": {
      ...
      "moat": {
        "title": "先生たちが選ぶ、3つの理由",
        "subtitle": "言葉じゃなく、実装で証明してます。",
        "native_multilingual": {
          "tag": "ネイティブ設計",
          "title": "翻訳じゃなく、その言語で設計した",
          "body": "ヘブライ語のRTL・日本語IME・スウェーデン語複合語・スペイン語アクセント。全部、エンジンの根っこで正しく処理。Google翻訳で済ませてません。"
        },
        "local_inventory": {
          "tag": "あなたの国の言葉",
          "title": "生徒の身近な語彙を集めた",
          "body": "各国のWikipediaとネイティブ辞書から。教科書の単語じゃなく、生徒の生活に近い言葉。ヘブライ語はMilog、英語は地域別。"
        },
        "ad_free": {
          "tag": "広告ゼロ宣言",
      ...
      "modes": {
        ...
        "spelling_bee": {
          "tag": "スペル",
          "title": "スペリング",
          "body": "音声ガイド付きで正確な綴りを身につける。複数言語対応",
          "teaches": "正しい綴り"
        }
      },
      "compare": {
        "title": "他のツールとの違い",
        "subtitle": "事実だけを比較。誇張なし。",
        "col": {
          "lexiclash": "LexiClash",
          "kahoot": "Kahoot!",
          "quizlet": "Quizlet",
        ...
        "row": {
          "native_multilingual": "ネイティブ多言語（RTL・IME完全対応）",
          "ad_free_students": "教育ページに広告ゼロ",
      ...
      "faq": {
        ...
        "q3": {
          ...
          "a": "はい。翻訳ではなくネイティブ設計。ヘブライ語のRTL、日本語のIME、スウェーデン語の複合語。全部、エンジンで正しく処理します。"
        },
        "q4": {
          "q": "生徒のデータは安全ですか？",
        ...
        "q5": {
          "q": "登録なしでプレイできますか？",
          "a": "はい。ほぼすべてのモードでゲスト参加が可能です。登録は不要です。"
        },
        "q6": {
        ...
        "q7": {
          "q": "生徒の成績が見られますか？",
          "a": "はい。先生ダッシュボードで、生徒一人ひとりの詳細な進捗分析を確認できます。"
        },
        "q8": {
          "q": "Chromebook・タブレット・スマホで動きますか？",
          "a": "はい。ウェブアプリなのでインストール不要。どのブラウザでも動きます。"
        }
      },
      "cta": {
        "title": "さあ、始めましょう",
    ...
    "vsGimkit": {
      "proExclusiveModes": {
        "eyebrow": "無料プランの Pro Exclusive — honesty foil",
...
"vsBlooket": {
    ...
    "practice": {
      ...
      "gotIt": "わかった",
      "hints": "ヒント",
      "hintsUsed": "ヒント{{count}}回使用",
      "incorrect": "おしい！",
      "matchPairs": "ペアを合わせよう",
      "matching": "マッチング",
      "matchingDefinitions": "定義を合わせよう",
      "matchingWords": "単語を合わせよう",
      "maxStreak": "最高連続：{{count}}",
      "more": "もっと見る",
      "moreOptions": "その他",
      "noDefinition": "定義なし",
      "noResults": "見つかりません",
      ...
      "streak": "{{count}}連続",
      "submit": "送信",
      "swipeExplain": "右スワイプで「わかった」、左スワイプで「わからない」",
      "swipeHint": "スワイプで回答",
      "tapCard": "タップして答えを見る",
      "tapToFlip": "タップして裏返す",
      "time": "時間",
    ...
    "template": {
      ...
      "allowLateJoinDesc": "ゲーム開始後もプレイヤーが参加できます",
      "boardPreview": "ボードプレビュー",
      "boardSize": "ボードサイズ",
      "create": "テンプレート作成",
      "description": "ゲーム設定をカスタマイズ",
      "difficulty": "難易度",
      "edit": "テンプレート編集",
      "lateJoin": "途中参加",
      "minWordLength": "最短ワード長",
      "name": "テンプレート名",
    ...
    "access": {
      "h1": "先生アクセス申請",
      "lede": "あなたのクラスのこと、簡単に教えてください。アクセスは即時付与 — 審査待ちはありません。",
      "redirect_title": "そのページには教師アクセスが必要です",
      "redirect_body": "{{dest}}へ移動しようとしていました。承認は即時 — 下の短いフォームで開けます。",
      "redirect_dest_fallback": "教室ツール",
      "full_name": "お名前",
      "email": "メールアドレス",
      "role": "あなたは？",
      "role_teacher": "学校教員",
      "role_tutor": "個別指導・家庭教師",
      "role_admin": "学校管理職",
      "role_parent": "保護者・ホームスクール",
      "role_researcher": "研究者",
      "role_other": "その他",
      "school_or_org": "学校名・機関（任意）",
      "country": "国（任意）",
      "use_case": "LexiClashをどう使いたいですか？（自由に書いてください）",
      "submit": "申請を送信する",
      "submitting": "送信中…",
      "submit_error": "送信に失敗しました。もう一度お試しください。",
      "rate_limited": "しばらく待ってから試してください（24時間以内に次の申請ができます）。",
      ...
      "verify_email_title": "まずメールアドレスを認証してください",
      ...
      "greeting_sub": "お名前とメールはアカウントから取得済みです。あと2つだけ教えてください。",
      "applying_as": "申請者",
      "role_q": "まずは、あなたに一番近いのは？",
      "use_case_q": "ここからが楽しいところ 🎯",
      "use_case_hint": "LexiClashを生徒とどう使いますか？一言二言でOKです。",
      "use_case_placeholder": "例：中1のESLクラスと毎週金曜に単語バトル…",
      "use_case_spark": "ヒントが必要？",
      "use_case_ex1": "クラスで毎週の単語バトル",
      ...
      "next": {
        "step1_title": "申請フォームを記入",
        "step1_body": "簡単な質問に答えるだけ。60秒で完了。",
        "step2_title": "即時承認",
        "step2_body": "手動レビューなし — 認証済みの先生は申請した瞬間にアクセスできます。",
        "step3_title": "認可完了 — さあ始めよう",
        "step3_body": "ダッシュボードがすぐ開きます — Ohadからのメモも届きます。"
      },
      "regular_game_title": "先生以外の方へ",
      "regular_game_body": "LexiClashは誰でも無料で遊べます。まずはゲームで遊んでみて、教室機能が必要になったときに戻ってきてください。",
      "try_mp": "マルチプレイヤーを試す",
  ...
  "passAndPlay": {
    "title": "回してプレイ",
    "subtitle": "同じ画面、同じボード、順番に。",
    "playerCount": "プレイヤー",
    "playerName": "名前",
    "playerNameDefault": "プレイヤー {n}",
    "color": "色",
    "avatar": "アバター",
    "addPlayer": "プレイヤーを追加",
    "removePlayer": "削除",
    ...
    "resume": "続きから",
    "discard": "新しいゲーム",
    "resumePrompt": "進行中のパーティーゲームがあります。",
    "passTo": "{name} に渡して",
    "ready": "準備OK",
    "yourTurn": "{name} の番です",
    "timeLeft": "残り時間",
    ...
    "found": "単語",
    "unique": "ユニーク",
    "alreadyFound": "すでに見つけた",
    "notOnBoard": "ボードにない",
    "notInDict": "辞書にない",
    "tooShort": "短すぎる",
    "timesUp": "時間切れ！",
    "roundN": "ラウンド {n} / {total}",
    "roundBreakdown": "ラウンド得点",
    "nextRound": "次のラウンド",
    "seePodium": "表彰台へ",
    "podium": "最終スコア",
    "winner": "{name} の勝ち！",
    ...
    "seconds": "{n}秒",
    "stolen": "すでに取られた",
    "emptyName": "全員に名前が必要です",
    "minPlayers": "2人以上必要です",
    "maxPlayers": "最大6人まで",
    "nameTaken": "名前は重複できません",
    "langEn": "英語",
    "langHe": "ヘブライ語",
    "langSv": "スウェーデン語",
    "langJa": "日本語",
  ...
  "faq": {
    ...
    "hereToHelp": "お気軽にお問い合わせください。いつでもお手伝いします。",
    "contactUs": "お問い合わせ",
    "learnMore": "もっと知りたいですか？",
    "blogCta": "ブログでヒント、戦略、ワードゲームの科学をチェック。",
    "categories": {
      "gettingStarted": "はじめに",
      "gameplay": "ゲームプレイ",
      "technical": "技術的な質問",
    ...
    "q": {
      "whatIs": "LexiClashとは何ですか？",
      "createAccount": "アカウントの作成方法は？",
      "isFree": "LexiClashは無料ですか？",
      "scoring": "ポイントの獲得方法は？",
      "gameModes": "どのゲームモードがありますか？",
      "dailyChallenge": "デイリーチャレンジの仕組みは？",
      "multipleLanguages": "複数の言語でプレイできますか？",
      "devices": "対応デバイスは？",
      "internet": "プレイにインターネット接続は必要ですか？",
      "reportBug": "バグや技術的な問題の報告方法は？",
      "changeProfile": "ユーザー名やプロフィールの変更方法は？",
      "multipleDevices": "複数のデバイスでプレイできますか？",
      "deleteAccount": "アカウントの削除方法は？",
      "dataSafe": "データは安全ですか？",
      "ads": "LexiClashには広告がありますか？",
      "optOut": "データ収集をオプトアウトできますか？"
    },
    "a": {
  ...
  "asyncChallenge": {
    ...
    "theirScore": "相手のスコア: {{score}}",
    "playNow": "今すぐプレイ",
    "challengeFriend": "友達にチャレンジ",
    "challengeFriendDesc": "ボードをプレイして、友達にスコアを超えるよう送ろう",
    "sendChallenge": "チャレンジを送信",
    "selectFriend": "対戦相手を選ぶ",
    "yourScore": "あなたのスコア: {{score}}",
    "won": "{{points}}ポイント差で勝利！",
    "lost": "{{points}}ポイント差で敗北",
    "tied": "引き分け！",
    "expired": "チャレンジの期限切れ",
    "declined": "チャレンジが辞退されました",
    "noMessage": "メッセージなし",
    "addMessage": "メッセージを追加（任意）",
    "empty": "保留中のチャレンジはありません",
  ...
  "wordClub": {
    ...
    "weeklyXp": "今週{{xp}} XP",
    "gamesPlayed": "{{count}}ゲーム",
    "bestWord": "ベスト: {{word}}",
    "createClub": "クラブを作成",
    "createClubDesc": "クラブを作って友達を招待し、毎週競い合おう",
    "joinClub": "クラブに参加",
    "joinByCode": "招待コードを入力",
    "joinButton": "参加",
    "leaveClub": "クラブを退会",
  ...
  "rankedTier": {
    ...
    "diamond": "ダイヤモンド",
    "master": "マスター",
    "progress": "次のティアまで{{percent}}%",
    "gamesPlayed": "{{count}}ランクマッチ",
    "winRate": "勝率{{percent}}%",
    "ratingChange": "{{change}}",
  ...
  "reengagement": {
    ...
    "socialTrigger": "あなたがいない間に{{friendCount}}人の友達がプレイしました！",
    "longTimeNoSee": "久しぶり！",
    "goodToSeeYou": "お帰りなさい！",
    "lossAversion": "リーグランクが下がっています！1ゲームで回復できます。",
    "incentive": "おかえりなさい！{{coins}}コインとストリークフリーズをプレゼント。",
    "majorIncentive": "進捗を保存しました！3日間のプレミアム機能を無料でお試し。",
    "emailOnly": "メールで特別オファーをご確認ください！",
    "claimBonus": "ボーナスを受け取る",
    "daysAway": "{{count}}日間不在",
    "bonusRewards": "復帰報酬:",
    "coins": "{{count}}コイン",
    "streakFreeze": "ストリークフリーズ×{{count}}",
    "premiumDays": "プレミアム{{count}}日間",
    "dismiss": "後で"
  },
  "party": {
    ...
    "join": "参加",
    "roomCode": "ルームコード",
    "scanOrEnter": "QRをスキャンまたはlexiclash.liveでコードを入力",
    "players": "プレイヤー",
    "spectators": "観客",
    "playersJoined": "人が参加",
    ...
    "spectating": "観戦中...",
    "gameOver": "ゲーム終了！",
    "checkYourPhone": "スマホを確認！",
    "dealingRoles": "役割を配布中...",
    "dontShowAnyone": "誰にも見せないで！",
    "captionClash": {
      "name": "キャプションクラッシュ",
      "description": "ミーム画像に最も面白いキャプションを書こう"
    },
    "pixelClash": {
      "name": "ピクセルクラッシュ",
      "description": "一緒にピクセルアートを描いて推測して再構築"
    },
    "shadowClash": {
      "name": "シャドウクラッシュ",
    ...
    "tapToLaugh": "タップで笑おう！",
    "writePrompt": "描くものを書いて",
    "promptPlaceholder": "スケボーに乗った猫...",
    "done": "完了",
    "whatIsThis": "これは何？",
    "typeGuess": "推測を入力...",
    "isDrawing": "が描いています...",
    "drawingInProgress": "描画中...",
    "rebuilding": "再構築中！",
    "rebuilt": "再構築",
    "original": "オリジナル",
    "drawnBy": "描いた人",
    "similarity": "一致度",
    "everyoneWriting": "みんな書いています...",
    "everyoneDrawing": "みんな描いています...",
    "everyoneGuessing": "みんな推測中...",
    "nightFalls": "夜が来る...",
    "shadowsAwaken": "シャドウが目覚める...犠牲者を選べ。",
    "seerInvestigates": "予言者が目を開く...",
    "medicProtects": "医者が守りを広げる...",
    "someoneWasSaved": "誰かが救われた！",
    "medicSaved": "医者がターゲットを守った。",
    "wasEliminated": "が脱落",
    "peacefulNight": "平穏な夜...",
    "discuss": "議論！",
    "whoIsTheShadow": "シャドウは誰だ？",
    "theVotes": "投票結果...",
    "isEliminated": "が脱落！",
    "noConsensus": "合意なし。誰も脱落せず。",
    "citizensWin": "市民の勝利！",
    "shadowsWin": "シャドウの勝利！",
    "roleShadow": "シャドウ",
    "roleSeer": "予言者",
    "roleMedic": "医者",
    "roleCitizen": "市民",
    "shadowDesc": "バレずに市民を排除せよ",
    "seerDesc": "毎晩一人を調査できる",
    "medicDesc": "毎晩一人を守れる",
    "citizenDesc": "シャドウを見つけて排除せよ",
    "speedRound": "スピードラウンド！",
    "roastPrefix": "ロースト：",
    "youWere": "あなたは：",
    "skip": "スキップ",
    "eliminatedTitle": "脱落",
    "bestLabel": "ベスト",
    "funniestLabel": "一番おもしろい",
    "yourPartner": "パートナー：",
    "choiceMade": "選択完了。夜明けを待て...",
    "nightIsDark": "夜は暗い...",
    "isShadow": "シャドウ！",
    "isCitizen": "シャドウではない",
  ...
  "wordForge": {
    ...
    "chooseRune": "ルーンを選べ",
    "yourRunes": "所持ルーン",
    "replaceWhich": "どのルーンを入れ替える？",
    "cancel": "キャンセル",
    "skip": "スキップ",
    "bonusPoints": "次ラウンドのボーナスポイント",
    "bossRound": "ボスラウンド",
    "ready": "準備OK",
    "victory": "勝利！",
    "runOver": "ラン終了",
    ...
    "forgeXp": "フォージXP",
    "rune": {
      "vowelMiner": "母音1つにつき+3ポイント",
      "rareFinder": "レア文字(J,K,Q,X,Z)1つにつき+5ポイント",
      "doubleDown": "同じ文字が含まれていれば+8ポイント",
      "firstBlood": "各ラウンドの最初の単語に+15ポイント",
    ...
    "boss": {
      "censor": "母音はすべて0ポイント",
      "abbreviator": "3〜4文字の単語のみ有効",
      "purist": "6文字以上の単語のみ有効",
      "banisher": "よく使う文字が1つグリッドから除去",
      "fog": "タイルの半分が裏向き",
      "rot": "15秒ごとに3つのタイルが石化",
      "shuffle": "20秒ごとにグリッドが再配置",
      "shrink": "グリッドが5×5ではなく4×4",
      "wall": "目標スコアが2倍",
      "clock": "タイマーが30秒のみ",
      "thief": "単語ごとに5ポイント消費",
  ...
  "connections": {
    ...
    "level": "レベル",
    "outOfLives": "ライフ切れ！",
    "reviveDescription": "ライフは時間で回復します。すぐに続けるには短い広告をご覧ください。",
    "reviveAd": "広告を見てライフ3つ",
    "adminRefill": "ライフ補充（管理者）",
    "quitToMenu": "メニューに戻る",
    "noAdAvailable": "現在広告がありません。後でもう一度お試しください。",
    "continueWithRegenLife": "続ける",
  ...
  "curator": {
    ...
    "levels": {
      ...
      "subtitle": "3つの独立した役割 — ユーザーは任意の組み合わせを持てます。",
      "note": "キュレーターがライブコンテンツを直接編集することはありません。すべての操作は、管理者が承認して初めて反映される提案です。",
      "toggle": "各レベルの意味は？",
      "admin": {
        "title": "管理者",
        "scope": "全体",
        "desc": "全ダッシュボード：プレイヤー・コンテンツ・モデレーションの管理と、他の全役割の付与。全言語で最上位キュレーター扱い。"
      },
      "teacher": {
        "title": "教師",
        "scope": "教育",
        "desc": "教室ダッシュボード：レッスン作成、ライブ授業ゲームの実施、生徒の進捗管理。コンテンツ管理権限はありません。"
      },
      "curator": {
        "title": "言語キュレーター",
        "scope": "言語ごと",
        "desc": "1つ以上の言語のコンテンツ品質を確認する、信頼された母語話者。権限はレベルで決まり、活動で名声を得ます。"
      },
      "capabilityHeading": "権限レベル — できること",
      "rewardsHeading": "名声報酬 — 得られるもの",
      "rewardsDesc": "管理者がキュレーターの提案を承認したときのみ付与され、量ではなく正確さが報われます。",
      "ranksLabel": "ランク",
      "coinsLabel": "コインボーナス",
      "coinMilestone": "{points}pt → {coins}コイン"
    },
    "assignInline": {
      "heading": "言語キュレーター",
      "none": "キュレーターではない",
      ...
      "assign": "割り当て",
      "cancel": "キャンセル",
      "assigned": "キュレーターを割り当てました",
      "revoke": "取り消し",
      "revoked": "キュレーターを取り消しました",
