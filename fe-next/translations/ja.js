...
"createForm": {
  ...
  "blog": {
    "wordGamesForKidsEducation": {
      "teachersTitle": "教師向け単語ゲーム",
      "eslTitle": "オンラインESL単語ゲーム",
      "vocabTitle": "教室向け語彙ゲーム", "heroAlt": "教室で単語ゲームをして遊ぶ子どもたち" },
    "backToBlog": "ブログに戻る",
    "dailyChallenge": "デイリーチャレンジ",
    "date": "公開日",
    "experience": "体験記",
  ...
  "student": {
    "achievements": { "emptyHint": "レッスンやデュエルをプレイして、最初のバッジを手に入れよう!" },
    "practiceFun": {
      "headline": {
        "perfect": "パーフェクト！",
        "gold": "やったね！",
  ...
  "teacher": {
    ...
    "lesson": {
      "bulkImportDropCsv": "CSVファイルをここにドロップするか、クリックして選択してください",
  ...
  "education": {
    ...
    "classroomGame": {
      "forSchoolsCta": "学校向けLexiClashを見る",
      "forSchoolsFooter": "学校や地域全体でLexiClashを使いませんか？",
      "questions": "問題数",
      "perQuestion": "1問あたり",
      "namePrompt": {
        "eyebrow": "クラスゲーム",
    ...
    "milestones": {
      "levelTooltipWithTitle": "レベル{{level}} - {{title}}",
      "coinBonus": "+{{coins}}コイン",
      "continue": "つづける",
      "level": "レベル{{level}}",
      "reached": "マイルストーン達成！",
