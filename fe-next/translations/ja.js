...
"game": {
  ...
  "blast": {
    ...
    "tile": {
      ...
      "locked":    { "name": "ロック",      "desc": "封鎖タイル — 単語に使えない。ペアのカギを消すと解除される。" },
      "key":       { "name": "カギ",        "desc": "単語で消すと隣接する8方向のロックタイルを解除。解除ごとに+20点。" },
  ...
  "education": {
    ...
    "landing": {
      ...
      "studentFeature1": "進捗をトラッキング",
      "studentFeature2": "XP＆バッジをゲット",
      "studentFeature3": "クラスメートに挑戦",
      "tagline": "ことばは力だ",
      "teacher": "先生",
      "teacherCta": "クラスをセットアップ",
      "teacherDesc": "語彙レッスンをゲーム化",
      ...
      "startGame": "ゲーム開始",
      "hero": {
        "eyebrow": "英語・ヘブライ語・スウェーデン語・日本語・スペイン語の教室で使える",
        "h1": "翻訳じゃなく、あなたの言語ネイティブで作ったワードゲーム",
        "sub": "リアルタイム対戦、脳トレ、6つの遊び方。生徒は広告なし。先生は完全無料—申請は60秒。",
        "cta_primary": "先生向けアクセスを申請",
        "cta_secondary": "デモを見る"
      },
      "moat": {
        "title": "5言語の先生たちがLexiClashを選ぶ、3つの理由",
        "subtitle": "ただの主張じゃなく、本当に守り抜いてます。",
        "native_multilingual": {
          "tag": "ネイティブ対応",
          "title": "あなたの言語に本当に対応している",
          "body": "ヘブライ語の右から左、日本語の かな・IME、スウェーデン語の複合語、スペイン語のアクセント—全部エンジンで正しく処理。Google翻訳なんか使ってません。"
        },
        "local_inventory": {
          "tag": "その国の言葉",
          "title": "あなたの国のWikipediaから引いた単語",
          "body": "アメリカの教科書なんて要りません。あなたの国のWikipedia + ヘブライ語Milog辞書から、生徒の生活に近い言葉を集めました。"
        },
        "ad_free": {
          "tag": "広告なし宣言",
          "title": "生徒には永遠に広告なし",
          "body": "Kahoot・Quizlet・Blooketは生徒に広告を見せてます。僕たちは教育のすべてのページで広告ゼロを約束します。COPPA・GDPR対応済み。"
        }
      },
      "modes": {
        "title": "6つの遊び方、1つのプラットフォーム—飽きさせない工夫",
        "teaches": "身につく",
        "classroom_game": {
          "tag": "ライブ",
          "title": "クラス対戦ゲーム",
          "body": "教室全体でリアルタイム対戦のワードハント",
          "teaches": "語彙・綴り・反応力"
        },
        "vocab_duels": {
          "tag": "1対1",
          "title": "語彙デュエル",
          "body": "友達といつでも、リアルタイムでも、気が向いたときでも対戦",
          "teaches": "語彙の定着・想起"
        },
        "brain_drills": {
          "tag": "脳トレ",
          "title": "脳トレドリル",
          "body": "記憶力・注意力・処理速度のトレーニング",
          "teaches": "認知スキル"
        },
        "daily_wordhunt": {
          "tag": "毎日",
          "title": "毎日のワードハント",
          "body": "毎日新しいパズル。同じ国の人ランキング",
          "teaches": "毎日の習慣づけ"
        },
        "adventure": {
          "tag": "ストーリー",
          "title": "アドベンチャーモード",
          "body": "テーマのある世界を舞台にしたワードパズル",
          "teaches": "語彙の応用力"
        },
        "spelling_bee": {
          "tag": "スペル",
          "title": "スペリング練習",
          "body": "音声ガイド付きの綴り練習—複数言語対応",
          "teaches": "正確な綴り"
        }
      },
      "compare": {
        "title": "他とどう違うのか",
        "subtitle": "言えることだけ言う、正直な比較です。",
        "col": {
          "lexiclash": "LexiClash",
          "kahoot": "Kahoot!",
          "quizlet": "Quizlet",
        ...
        "row": {
          "native_multilingual": "RTL・IME対応のネイティブ多言語",
          "ad_free_students": "生徒に広告なし",
          "live_multiplayer": "リアルタイム対戦",
          "brain_training": "脳トレドリル",
          "game_variety": "6以上のゲームモード",
          "free_for_teachers": "認定教師は完全無料"
        }
      },
      "trust": {
        "title": "信頼されるために作ってます",
        "bullet1": "教育ページすべてに広告なし",
        "bullet2": "GDPR・COPPA対応。データは安全に扱い、計測はオプトイン制。",
        "bullet3": "13歳未満の生徒利用で法的に守られています"
      },
      "faq": {
        "title": "よくある質問",
        "q1": {
          "q": "先生向けアクセスはどうやって申請するの？",
          "a": "/education/accessから申請すると、メールで確認。通常24時間以内に返信します。"
        },
        "q2": {
          "q": "本当にずっと無料ですか？",
          "a": "はい。認定教師なら無料。生徒のページにも広告ナシです。"
        },
        "q3": {
          "q": "ヘブライ語・日本語・スウェーデン語・スペイン語で動きますか？",
          "a": "はい。ヘブライ語RTL・日本語IME完全対応のネイティブサポート。翻訳じゃありません。"
        },
        "q4": {
          "q": "生徒のプライバシーは大丈夫ですか？",
          "a": "COPPA・GDPR対応です。教育ページに広告追跡なし。計測はオプトイン制。"
        },
        "q5": {
          "q": "アカウントなしでプレイできますか？",
          "a": "はい。ゲスト参加はほぼすべてのモードで対応してます。"
        },
        "q6": {
          "q": "Kahoot・Quizlet・Wordwallと何が違いますか？",
          "a": "ネイティブな多言語対応の深さ、生徒への広告なし宣言、1つのプラットフォームで6モード、あなたの国のWikipediaから引いた語彙—これらの組み合わせです。"
        },
        "q7": {
          "q": "生徒の進捗が見られますか？",
          "a": "はい。先生ダッシュボードで学生一人ひとりの分析を確認できます。"
        },
        "q8": {
          "q": "Chromebook・タブレット・スマホで動きますか？",
          "a": "はい。ウェブベースなのでインストール不要です。"
        }
      },
      "cta": {
        "title": "LexiClashをあなたの教室に—始めませんか？",
        "body": "先生向け無料アクセスを申請。60秒で完了、通常24時間以内に承認。",
        "button": "先生向けアクセスを申請"
      },
      "esl-word-games": {
        "course_name": "LexiClash ESL英単語ゲーム",
        "course_desc": "ESLクラス向け。語彙・綴り・リアルタイム対戦ゲームが5言語で使えます。"
      },
      "vocabulary-games-classroom": {
        "course_name": "教室の語彙ゲーム",
        "course_desc": "リアルタイム対戦とマイペース練習。先生向け分析付き、生徒は広告なし。"
      },
      "welcomeBack": "おかえりなさい",
    ...
    "teacher": {
      ...
      "welcome_banner_title": "ようこそ！認可完了です 🎉",
      "welcome_banner_body": "これからクラスを作って、ゲームを出題して、生徒の成長を見守れます。",
    ...
    "access": {
      "h1": "LexiClash—先生向けアクセス申請",
      "lede": "あなたのクラスのこと、簡単に教えてください。24時間以内に確認メールを送ります。",
      "full_name": "お名前",
      "email": "メールアドレス",
      "role": "あなたは？",
      "role_teacher": "学校教員",
      ...
      "submit": "申請を送信",
      "submitting": "送信中…",
      "submit_error": "申請の送信に失敗しました。もう一度試してください。",
      "rate_limited": "しばらく待ってからもう一度お試しください（24時間以内）。",
      ...
      "pending_body": "申請をお受け取りしました。間もなくご連絡します。",
      "declined_title": "申し訳ありません。今回はお断りさせていただきました",
      "declined_reapply": "いつでも再申請できます。ご質問があればお気軽にお問い合わせください。",
      "submitted_on": "申請日",
      "already_approved_title": "すでに認可済みです！",
      "go_to_teacher": "先生ダッシュボードへ",
      "next": {
        "step1_title": "申請フォームを記入",
        "step1_body": "簡単な質問に答えるだけ。60秒で完了。",
        "step2_title": "確認作業中",
        "step2_body": "スタッフが1件ずつ丁寧に確認。通常24時間以内。",
        "step3_title": "認可完了！",
        "step3_body": "確認メール到着。その時点からすぐに使えます。"
      },
      "regular_game_title": "先生じゃない方へ",
      "regular_game_body": "LexiClashは誰でも無料で楽しめます。まずは普通のゲームで遊んでみて、教室機能が必要になったときに戻ってきてください。",
      "try_mp": "マルチプレイヤーで遊ぶ",
      "try_blast": "Blastを試す",
      "try_daily": "毎日のチャレンジ"
    }
