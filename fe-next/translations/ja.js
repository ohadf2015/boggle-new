...
"createForm": {
  ...
  "adventure": {
    ...
    "hubWelcome": {
      "title": "やったね！",
      "description": "ここがあなたのハブ — ストリーク、デイリークエスト、次のレベルへジャンプ。遊ぶほど良くなるよ！",
      "exploreButton": "レッツゴー"
    },
    "story": {
      "lexi": "レキシ",
    ...
    "endlessMode": {
      ...
      "events": {
        "doubleGold": "ゴールドラッシュ！",
        "doubleGoldDesc": "このフロアのゴールド報酬が2倍",
        "timeSurge": "タイムサージ！",
        "timeSurgeDesc": "+30秒のボーナスタイム",
        "gemRush": "ジェムラッシュ！",
        "gemRushDesc": "ボードに特殊タイルが追加",
        "dualMechanic": "デュアルメカニック！",
        "dualMechanicDesc": "2つのワールドメカニックが同時発動",
        "scoreFrenzy": "スコアフィーバー！",
        "scoreFrenzyDesc": "このフロアのスコアが2倍"
      }
    },
    "bossRush": {
      "backToHub": "ハブに戻る",
    ...
    "prestige": {
      "title": "プレステージ",
      "available": "プレステージ可能！",
      "description": "ワールドをリセットして永久ボーナスを獲得",
    ...
    "gameError": {
      "title": "エラーが発生しました",
      "description": "ゲームでエラーが発生しました。進捗は保存されています。",
      "returnToLevels": "レベル選択に戻る",
      "retry": "もう一度試す"
    },
    "cinematics": {
      "victory": "勝利！",
    ...
    "game": {
      ...
      "wordsYouMissed": "見落とした単語",
      "showMore": "もっと見る",
      "showLess": "隠す",
      "missedWordsSummary": "見落とした単語: {{count}}個",
      "more": "あと",
      "hint": "ヒント",
      "hintCost": "ヒント ({{cost}}g)",
    ...
    "upgrades": {
      ...
      "gemDetector": {
        "name": "ジェムディテクター",
        "desc": "グリッドに特殊タイルが多く出現",
        "t1": "ゴールドタイル+20%",
        "t2": "レインボーとチェーンタイル追加",
        "t3": "カスケードごとにゴールドタイル確定"
      },
      "fuelTank": {
        "name": "燃料タンク",
        "desc": "単語を見つける時間が増加",
      ...
      "luckyPickaxe": {
        "name": "ラッキーピッケル",
        "desc": "すべてのレベルでより多くのゴールドを獲得",
        "t1": "ゴールド+10%",
        "t2": "ゴールド+25%",
        "t3": "6文字以上の単語でボーナスゴールド",
        "t4": "初回クリアでゴールド2倍"
      },
      "cargoBay": {
        "name": "カーゴベイ",
      ...
      "wordDynamite": {
        "name": "ワードダイナマイト",
        "desc": "グリッドを爆破して新しい単語を発見",
        "t1": "レベルごとに1行シャッフル",
        "t2": "任意の3×3エリアをシャッフル",
        "t3": "単語を爆破して周囲のタイルをクリア"
      },
      "timeFreeze": {
        "name": "タイムフリーズ",
        "desc": "時計を止めて考える",
