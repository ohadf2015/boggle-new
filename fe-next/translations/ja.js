...
const ja = {
  ...
  "wordTower": {
    ...
    "hud": { "floors": "{n} 階", "combo": "{n} 連鎖", "scramble": "シャッフル", "backspace": "削除", "build": "建てる", "restart": "やり直す", "restartConfirm": "本当に？", "best": "ベスト {m} m", "possible": "{n} 単語", "clue": "ヒント", "cluesLeft": "残り{n}", "collapse": "閉じる", "expand": "開く", "rivalPassed": "{name} を抜いた！", "stuck": "詰まった？新しい文字", "backToTop": "上へ", "pickLetters": "文字を選ぶ", "dragToBuild": "なぞるかタップして綴る", "chaseGap": "+{m} m", "chaseAria": "次のライバル: {name}、抜くまであと {m} m" },
