...
const ja = {
  ...
  "academy": {
    ...
    "hq": {
      ...
      "modes": {
        "vocabQuiz": "単語クイズ",
        "vocabQuizBlurb": "正しい意味を早押し",
        "classic": "ワードアリーナ",
        "classicBlurb": "みんなで同じボードから単語探し",
        "blast": "ブラスト",
    ...
    "modes": {
      "workshop": {
        ...
        "rival": {
          "name": "コトバクミ男爵",
          "open": "さあ君の番だ、見習い！",
          "gloat": "吾輩の工房では吾輩がルールだ！",
          "intro": "吾輩より多く作れるとでも？",
          "taunt1": "チクタク！吾輩の番だ。",
          "taunt2": "これを超えてみろ、見習い！",
          "taunt3": "吾輩の歯車に狂いはない。",
          "taunt4": "この工房は吾輩のものだ！",
          "hurt1": "レッスン単語だと！？ネジが飛ぶ！",
          "hurt2": "いてっ！キラッと光ったぞ！",
          "enraged1": "フン、まぐれだ。",
          "enraged2": "ぐぬぬ…やるな。"
        },
      ...
      "review": {
        "title": "ミスした単語の復習",
        "signedOutTitle": "クラスに参加して復習を解放しよう",
        ...
        "start": "スタート",
        "score": "{correct} / {total}",
        "bestStreak": "最高連続 {streak} · {points}pt",
        "xpNotSaved": "今回はXPを保存できなかったけど、単語ボックスはちゃんと進んだよ。",
        "streak": "{count}連続",
        "progress": "{n} / {total}",
        "pickMeaning": "意味はどれ？",
        "unscramble": "文字を並べかえよう",
        "perfect": "パーフェクト！",
        "runDone": "クリア！",
        "outOf": "/{total}",
        "statCorrect": "正解",
      ...
      "xpEarned": "+{xp} XP",
      "tapToOpen": "タップで開ける",
      "errorTitle": "おっと、エラーが起きたよ。もう一回やる？",
      "tryAgain": "もう一度",
      "playAgain": "もう一回",
      "xpNotSaved": "今回はXPを保存できなかった。もう一回遊んで再チャレンジしてね。",
      "startFailed": "スタートできなかったよ。通信状況を確認して、もう一度試してね。",
      "openForXp": "宝箱を開けてXPをゲット！"
    },
    "student": {
      "liveNow": "ライブ中",
      "ctaReview": "復習",
      ...
      "ctaPlay": "プレイ",
      "ctaLive": "ライブに参加",
      "ctaReviewTitle": "ミスした単語 {count}個",
      "ctaBossTitle": "ボスに挑む",
      "ctaJoinSub": "先生からもらったコードを入力",
      "dockLabel": "アカデミー",
      "dockLessons": "レッスン",
      "reviewDueAria": "復習する単語：{count}個",
      "dockClass": "クラス",
      "solo": "ソロ",
      "mapLabel": "アカデミーマップ",
      "title": "ことばアカデミー",
      "rewardXp": "+{xp} XP",
      "arenaWaiting": "先生はまだライブゲームを始めていないよ。始まるとこの島が光るよ。",
      "bossLockedNote": "あと{count}語マスターするとボスが解放されるよ。",
      "level": "レベル{level}",
      "xpToNext": "次のレベルまでのXP",
      "xpLine": "{xp} / {need} XP",
      "stars": "スター",
    ...
    "launch": {
      "title": "ライブゲームを始める",
      "subtitle": "ゲームを選ぶだけ。クラス全員がひとつのコードで参加できます。",
      "questions": "{{count}}問",
      "pace": "1問{{seconds}}秒",
      "minLetters": "{{count}}文字以上"
    },
    "live": {
      "getReady": "準備はいい？",
      "warmUpHint": "ウォームアップ：光る文字をタップ！",
      "warmUpTapThis": "これをタップ",
      "warmUpTitle": "ウォームアップ"
    },
    "projector": {
      "joined": "人参加中",
    ...
    "results": {
      "classChest": "クラス宝箱",
      "classChestWords": "{{total}}語中 発見",
      "playAgain": "もう一回",
      "playAgainHint": "同じ単語、同じコード。参加し直す必要はありません。"
    },
    "waiting": {
      "classmates": "参加中のクラスメイト",
      "editAvatar": "アバターを変更",
      "forTeacher": "先生のスタートを待っています",
      "inClass": "人参加中",
      "classmateHere": "人のクラスメイトが来てるよ",
      "classmatesHere": "人のクラスメイトが来てるよ",
      "firstIn": "一番乗り！クラスメイトはここに現れるよ。"
    },
    "homework": {
  ...
  // @academy:end
  // @home-fresh:start (generated by /tmp/home-gauntlet/merge-i18n.mjs)
  "homeFresh": {
    "hero": {
      "kicker": "みんなで遊べるマルチプレイ単語ゲーム",
      "title": "言葉を見つけて、\n友だちに勝とう。",
      "sub": "となり合う文字をつないで、時間内に単語を作ろう。無料、ダウンロード不要。",
      "play": "今すぐプレイ",
      "account": "アカウントをお持ちの方",
      "gridLabel": "練習ボード。{word} の文字を順番にタップしてね。",
      "hint": "やってみよう: {letters} の順にタップ",
      "found": "{word}!これで遊び方はバッチリ。",
      "miss": "まだ単語じゃないよ。{letters} を試してみて"
    },
    "modes": {
      "title": "ゲームを選ぼう",
      "line": "スピード勝負から、のんびりパズルまで。",
      "prev": "前のゲーム",
      "next": "ほかのゲーム",
      "items": {
        "arena": {
        ...
        "wordTower": {
          "title": "ワードタワー",
          "line": "グラつく前に、言葉を高く積み上げよう。"
        },
        "wordCraft": {
          "title": "ワードクラフト",
          "line": "盤面を制して、ボットを出し抜こう。"
        },
        "connections": {
          "title": "ワードチェーン",
          "line": "2つの言葉をつなぐ1語を見つけよう。"
        },
        "brainGym": {
          "title": "脳トレーニング",
          "line": "短いドリルで頭をシャキッと。"
    ...
    "sections": {
      "daily": {
        "title": "1日1問。連続記録をつなごう。",
        "line": "毎朝新しいボード。全員が同じ文字なので、スコアを比べられます。",
        "cta": "今日のパズルへ",
        "streak": "日連続"
      },
      "friends": {
        "title": "友だちとリアルタイムで対戦",
        "line": "ルームコードを共有して、同じボードを同時にプレイ。",
        "cta": "ルームを作る",
        "room": "ルーム",
        "you": "あなた",
        "rival": "ゆい"
      ...
      "languages": {
        "title": "あなたの言語でプレイ",
        "line": "英語、ヘブライ語、スウェーデン語、日本語、スペイン語、ロシア語。言語ごとに専用の辞書があります。"
      },
      "classrooms": {
        "title": "教室でも遊べる",
        "line": "クラスでライブの単語ゲーム。生徒はどの端末からでもコードで参加できます。",
        "cta": "無料でクラスを作る"
      }
    },
    "close": {
      "title": "準備はいい？ボードが待ってる。",
      "line": "ダウンロードも登録もなしで始められます。",
      "play": "今すぐプレイ",
      "blogTitle": "ブログの最新記事",
      "blogAll": "記事一覧",
...
"createForm": {
  ...
  "profile": {
    "showcase": {
      ...
      "emptyStats": "1試合プレイしてショーケースを埋めよう",
      "emptyStatsPublic": "デビューしたて",
      "editAvatar": "アバターを編集",
      "share": "シェア",
      ...
      "parts": "{owned}/{total} パーツ",
      "collection": "コレクション",
      "rarest": "いちばんレアな装備",
      "nextUnlock": "次の解放",
      "unlocksAt": "Lv {level}で解放",
      "levelShort": "Lv",
      "xpToNext": "Lv {level}まであと{xp} XP",
      "maxLevel": "最大レベル",
      "unnamed": "なぞのプレイヤー",
      "setName": "名前を決めよう",
      "settings": "設定",
      "pinned": "ピン留めした実績",
      "seeAll": "すべて見る",
      "noBadges": "1勝して最初のバッジをピン留めしよう",
      "avatarCollection": {
        "title": "アバターコレクション",
        "body": "レベルを上げてプレイするとパーツが解放されます。レアな装備ほどステージが派手に。",
        "byRarity": "レア度別"
      },
      "account": "アカウントと設定",
      "memberSince": "{date}から",
...
"vsBlooket": {
  ...
  "revealUnlock": {
    ...
    "guestTitle": "登録してキープしよう",
    "guestBody": "無料アカウントでずっと自分のものに。",
    "chip": "新アイテム！",
    "chipMany": "新アイテム{count}個！",
    "nextHint": "次のアンロックはLv{level}",
    "profileEntry": "プロフィール",
    "levelShort": "Lv{level}",
    "share": "シェア",
    ...
    "voice": {
      ...
      "kawaii": "かわいさMAX。ライバルに勝ち目なし。",
      "cottonCandy": "ふわふわ甘くて、カロリーゼロ。",
      "cowboyHat": "ヒーハー！ボードに新しい保安官が登場。",
      "bg4B0082": "深くて気高い、あなただけの色。",
      "heartEye": "愛されすぎ注意報、発令中。",
      "fangs": "あなたの言葉に、キバが生えた。",
      "duckHat": "ガーガー！言葉たち、覚悟して。",
      "vaporwave": "エモい。とにかくエモい。",
      "frogHat": "ケロッと一段、レベルアップ。",
      "bg000000": "ダークモード、でも最高にクール。",
      "slime": "外はぷるぷる、中身は天才。",
      "starEye": "目の中に、きらきら星。",
      "lightning": "注意：高電圧ボキャブラリー。",
      "butterflyWings": "蝶のように舞い、王者のように綴る。",
      "neonSmile": "ボードを照らす、まぶしい笑顔。",
      "ghostFace": "ばあっ！ライバルがおばけを見た。",
      "rainbowMohawk": "派手な髪に、もっと派手な勝利。",
      "iceCrown": "クールに決めて、王冠をかぶる。"
    },
    "parts": {
      "headphones": "ビートヘッドホン",
      "kawaii": "カワイイ目",
      ...
      "fangs": "ヴァンパイアの牙",
      "duckHat": "アヒル帽子",
      "vaporwave": "ヴェイパーウェイヴヘア",
      "frogHat": "カエル帽子",
      "bg000000": "漆黒",
      "slime": "スライムフェイス",
      "starEye": "星の目",
      "lightning": "イナズマヘア",
      "butterflyWings": "チョウの羽",
      "neonSmile": "ネオンスマイル",
      "ghostFace": "おばけフェイス",
      "rainbowMohawk": "レインボーモヒカン",
      "iceCrown": "氷の王冠"
    }
  },
  "avatarLab": {
    "title": "アバターラボ",
    "subtitle": "スクリーンショット用のテストデータです（実在のプレイヤーではありません）。",
    "showcase": "キャラクター一覧",
    "level": "レベル{level}",
    "views": {
      "editor": "エディター",
    ...
    "openBuilder": "アバターを編集する",
    "placeholder": {
      "title": "準備中",
      "profile": "ここにプロフィールのショーケースが入ります。",
      "reveal": "ここにレベルアップ時の解放演出が入ります。"
    },
    "collection": "レアパーツ {owned}/{total} 個をコレクション",
    "unlocksAtLevel": "レベル{level}で解放",
    "noUnlocks": "このレベルで新しく解放されるものはありません。",
    "nextUnlock": "次の解放はレベル{level}",
    "liteNote": "テスト用プレイヤーには保存済みの顔がないため、ミニアバターは色の円だけを表示します。隣にフルサイズのアバターがあります。",
    "randomAvatars": "ランダムアバター",
    "allParts": "すべてのパーツ",
    "sections": {
      "faceShapes": "顔の形",
      "eyes": "目",
