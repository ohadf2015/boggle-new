...
const ja = {
  ...
  "wordTower": {
    ...
    "upgrade": { "title": "タワーアップグレード", "subtitle": "永続強化 — コインで購入", "open": "強化", "balance": "{n}コイン", "buy": "購入", "max": "最大", "level": "Lv {n}/{max}", "owned": "所持", "close": "完了", "broke": "コインが足りません", "steadyCable": { "name": "安定ケーブル", "desc": "クレーンの揺れを抑えてタイミングを取りやすく" }, "wideFooting": { "name": "ワイド基礎", "desc": "パーフェクト着地の判定を広げる" }, "windbreak": { "name": "防風", "desc": "高高度の風を和らげる" }, "masterArchitect": { "name": "マスター建築家", "desc": "ドロップごとのコイン報酬が増加" }, "reinforcedCore": { "name": "強化コア", "desc": "崩れる前にもう一度ぐらつきに耐える" }, "quickRecovery": { "name": "クイック回復", "desc": "タワーが早く立て直す" }, "tailwind": { "name": "追い風", "desc": "各フロアが少し高く積み上がる" }, "salvage": { "name": "サルベージ", "desc": "崩落で失うフロアが減る" }, "momentum": { "name": "モメンタム", "desc": "パーフェクト連続の報酬がさらに増加" }, "centerMagnet": { "name": "重力コア", "desc": "失敗しても塔が中央に引き戻される" } },
    "verdict": { "perfect": "パーフェクト！", "good": "ナイス！", "sloppy": "ぐらっ", "miss": "ミス！" },
    "sabotage": { "chip": "鉄球", "tokens": "{n}", "pickTarget": "ライバルを選ぶ", "noTargets": "まだ標的がいません", "confirm": "{name}に鉄球を送る？", "send": "送る", "cancel": "キャンセル", "sentTo": "💥 {name}に命中 — −1m", "incoming": "🚨 {name}から妨害が来ます！", "recovered": "塔は健在。登り続けよう。", "earned": "🎯 鉄球を獲得！", "earnedHint": "新エリアまたは実績！", "watchAd": "📺 広告を見る +1", "adEarned": "🎯 広告でトークンゲット！", "smashTitle": "玉を放て！", "smashCta": "スマッシュ！", "smashReleasing": "放つ…", "floorsDestroyed": "−{n} 階破壊！", "newHeight": "新しい高さ:", "done": "完了" },
...
"game": {
  ...
  "education": {
    ...
    "access": {
      "h1": "先生アクセス申請",
      "lede": "あなたのクラスのこと、簡単に教えてください。スタッフが確認して、24時間以内にメールします。",
      "full_name": "お名前",
      "email": "メールアドレス",
      "role": "あなたは？",
      "role_teacher": "学校教員",
      ...
      "success_title": "申請ありがとうございます！",
      "success_body": "確認メールを1～2営業日以内にお送りします。",
      "success_next": "申請の確認を進めています。1～2営業日以内にメールをお送りします。このページは閉じてください。",
      ...
      "next": {
        ...
        "step2_title": "スタッフが確認",
        "step2_body": "1件ずつていねいに確認。通常24時間以内。",
        "step3_title": "認可完了 — さあ始めよう",
        "step3_body": "確認メール到着。その時点からすぐに使えます。"
      },
  ...
  "wordcraft": {
    ...
    "modifier": { "bingo_bonanza": "ビンゴ祭り", "long_words": "ロングワード", "rich_letters": "高得点タイル", "land_grab": "陣取り", "none": "", "desc": { "bingo_bonanza": "ビンゴは+90点", "long_words": "5文字以上の語に+15", "rich_letters": "レアタイルは2倍", "land_grab": "占領が隣のマスへ広がる" } },
    "squares": "マス",
