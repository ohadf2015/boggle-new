...
const ja = {
  "wordTower": {
    ...
    "hud": { "floors": "{n} 階", "combo": "{n} 連鎖", "scramble": "シャッフル", "backspace": "削除", "build": "建てる", "restart": "やり直す", "best": "ベスト {m} m" },
  ...
  "seo": {
    ...
    "educationHub": {
      "title": "教育ハブ — 先生のためのワードゲーム教室",
      "description": "先生向けの教室管理ハブ。カスタムレッスン作成、ライブゲーム起動、生徒の進捗リアルタイム分析。先生は無料。",
      "ogTitle": "教育ハブ — 先生のためのワードゲーム管理",
      "ogDescription": "レッスン・ゲーム・分析が一つに。先生向け完全無料。"
    },
    "educationDuels": {
...
"game": {
  ...
  "education": {
    ...
    "landing": {
      ...
      "hero": {
        ...
        "h1": "翻訳ゲームじゃない。あなたの言語で、ネイティブに設計したワードゲーム",
        "sub": "リアルタイム対戦、脳トレドリル、6つのモード。生徒は広告ゼロ。先生は永遠に無料。60秒で申請完了。",
  ...
  "showcase3d": {
    "heroBadge": "言葉の世界",
    "cap0Title": "言葉をトレース",
    "cap0Body": "ボード上をドラッグ — 進むにつれて文字が光ります。",
    "cap1Title": "コンボをチェーン",
    "cap1Body": "言葉を連鎖させてスコアマルチプライヤーをチャージ。",
    "cap2Title": "部屋を制覇",
    "cap2Body": "リアルタイムボードで最大3人のライバルを出し抜く。",
    "cap3Title": "王冠を手に",
    "cap3Body": "スコアボードの頂点に立ち、勝利を手に — 大声で。",
    ...
    "rail3": "王冠",
    "modesTitle": "3つの対戦方法",
    "modesSub": "リアルラウンド、リアルボード — スクロールするたびに各モードが滑り込む。",
    "mode1Tag": "ソロ · デイリー",
    "mode1": "1つのボード。1回のチャンス。",
    "mode1Body": "全員が同じデイリーグリッドで対戦。真夜中までにグローバルランキングを上り詰める。",
    "mode2Tag": "最大1v3",
    "mode2": "リアルタイムパーティー対戦",
    "mode2Body": "4つのキューブ、1つのライブボード、容赦なし。最も大きな声のスコアボードが勝ち。",
    "mode3Tag": "5言語",
    "mode3": "あなたの言語でプレイ",
    "mode3Body": "日本語、英語、スウェーデン語、日本語、スペイン語 — あなたの言葉、あなたのテリトリー。",
    "bottomTitle": "あなたのターン。音を立てて。",
    "bottomCta": "LexiClashを無料でプレイ",
    "floatCta": "無料でプレイ"
  }
};
