...
const ja = {
  ...
  "seo": {
    ...
    "daily": {
      "title": "今日の単語パズル — 無料デイリーチャレンジ | LexiClash",
      "description": "毎日無料の単語パズルに挑戦！世界中で同じボード。単語を見つけて絵文字で結果をシェア。ダウンロード不要、登録不要。今すぐプレイ！",
      "ogTitle": "今日の単語パズル — 世界に挑戦しよう！",
      "ogDescription": "世界中で同じパズル。単語を見つけて結果をシェア。無料・登録不要で今すぐプレイ！"
    },
    "multiplayer": {
