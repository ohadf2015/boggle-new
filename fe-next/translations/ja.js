    ...
    "landing": {
      ...
      "moat": {
        ...
        "native_multilingual": {
          "tag": "ネイティブ",
          "title": "あなたの言語のために構築",
          "body": "ヘブライ語の右から左、日本語のかな・IME、スウェーデン語の複合語、スペイン語のアクセント — すべてエンジンレベルで処理。Google翻訳ではない。"
        },
        "local_inventory": {
          "tag": "ローカル",
          "title": "ローカルで調達された単語リスト",
          "body": "あなたのロケールのWikipedia +ヘブライ語Milog辞書から引き出される単語リスト。生徒は米国K-12の教科書の遺物ではなく、自分の国から文化的に関連のある単語を見る。"
        },
        "ad_free": {
          "tag": "広告なし",
          "title": "生徒向け広告なし。常に。",
          "body": "Kahoot、Quizlet、Blooket — すべて生徒に広告を表示。私たちはすべての教育ルートで広告なしを誓う。COPPA + GDPR対応。"
        }
      },
      "modes": {
        ...
        "classroom_game": {
          "tag": "ライブ",
          "title": "クラスルームゲーム",
          "body": "クラス全体向けのライブマルチプレイヤーワードハント。",
          "teaches": "語彙、綴り、速度"
        },
        "vocab_duels": {
          "tag": "デュエル",
          "title": "語彙デュエル",
          "body": "非同期またはライブ1v1語彙チャレンジ。",
          "teaches": "保持、思い出す"
        },
        "brain_drills": {
          "tag": "脳",
        ...
        "daily_wordhunt": {
          "tag": "毎日",
          "title": "毎日ワードハント",
          "body": "毎日新しいパズル、ロケール別ランキング。",
          "teaches": "毎日の練習"
        },
        "adventure": {
          "tag": "ストーリー",
          "title": "アドベンチャーモード",
          "body": "テーマ別の世界を横断するストーリー駆動のワードパズル。",
          "teaches": "語彙の深さ"
        },
        "spelling_bee": {
          "tag": "ビー",
          "title": "スペリングビー練習",
          "body": "音声主導のスペリング訓練、複数言語。",
          "teaches": "綴り"
        }
      },
      "compare": {
      ...
      "faq": {
        ...
        "q1": {
          "q": "先生がアクセスをどう取得しますか？",
          "a": "/education/accessで申請 — メールで確認し、通常24時間以内に返信。"
        },
        "q2": {
          "q": "本当にクラスルーム向け無料ですか？",
          "a": "はい。認証済み先生向け無料、生徒向けルートに広告なし。"
        },
        "q3": {
          "q": "ヘブライ語、日本語、スウェーデン語、スペイン語で機能しますか？",
          "a": "はい — ヘブライ語RTLと日本語かな/IMEを含むネイティブサポート。翻訳ではない。"
        },
        "q4": {
          "q": "生徒のプライバシーをどのように取り扱いますか？",
          "a": "COPPA + GDPR認識。教育ルートに広告追跡なし。オプトインテレメトリーのみ。"
        },
        "q5": {
          "q": "生徒はアカウントなしでプレイできますか？",
          "a": "はい。ゲストプレイはほとんどのモードで対応。"
        },
        "q6": {
          "q": "Kahoot、Quizlet、Wordwallとどう異なりますか？",
          "a": "ネイティブマルチリンガルの深さ、広告なしの誓約、1つのプラットフォーム上の6ゲームモード、ロケール別のローカルで調達された単語リスト。"
        },
        "q7": {
          "q": "生徒の進捗を追跡できますか？",
          "a": "はい。先生は先生ダッシュボードで生徒ごとの分析を見る。"
        },
        "q8": {
          "q": "Chromebook、タブレット、携帯電話で機能しますか？",
          "a": "はい。ウェブファースト、インストール不要。"
        }
      },
      "cta": {
