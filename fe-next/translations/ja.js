...
const ja = {
  ...
  "legal": {
    ...
    "about": {
      ...
      "whoWeAre": {
        "title": "私たちについて",
        "content": "LexiClashは、LexiClash Ltdが開発したリアルタイムマルチプレイヤーワードストラテジーゲームです。世界中のプレイヤー向けに、複数の言語で魅力的で教育的、かつ競争的なワードゲームを作成しています。"
      },
      "mission": {
        "title": "私たちの使命",
        "content": "私たちの使命は、言語学習を楽しく競争的にすることです。ゲームは、友達や世界中のプレイヤーとつながりながら、語彙力、スペル、素早い思考を向上させる最良の方法だと信じています。"
      },
      "whatWeDo": {
        "title": "私たちがすること",
        "content": "スピード、戦略、語彙スキルを組み合わせたマルチプレイヤーワードゲームを開発しています。LexiClashは、ヘブライ語、英語、スウェーデン語、日本語、スペイン語をサポートしており、世界中のプレイヤーがアクセスできます。"
      },
      "team": {
        "title": "私たちのチーム",
        "content": "LexiClashは、情熱的なワードゲーム愛好家とソフトウェアエンジニアのチームによって設立されました。最高のマルチプレイヤーワードゲーム体験を作ることに専念しています。"
      },
      "contact": {
        "title": "お問い合わせ",
        "content": "ご質問やフィードバックはありますか？ぜひお聞かせください！"
      },
      "businessInfo": {
        "title": "事業情報",
        "companyLabel": "会社名",
