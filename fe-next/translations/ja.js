...
const ja = {
  ...
  "wordTowerV2": {
    ...
    "collapsed": "タワー崩壊！",
    "newBest": "自己ベスト更新！",
    "hud": {"floor": "階", "floorA11y": "{n}階、{m}メートル", "effect": "{name}：残り{n}", "exit": "やめる（この回の記録は保存されます）"},
...
"createForm": {
  ...
  "teacher": {
    ...
    "subscription": {
      ...
      "usagePromptStudentsBody": "1つのクラスに{{count}}人の生徒がいるね。Teacher Proなら全員カバーできるよ — クラスも生徒数も無制限、進捗分析と印刷できるレポートつき。",
      "usagePromptAssignmentsBody": "1つのクラスに{{count}}件の課題を作ったね。Teacher Proで上限解除 — 課題無制限、進捗分析とレポートつき。",
