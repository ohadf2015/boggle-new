...
const ja = {
  ...
  "practice": {
    "instructions": {
      "title": "あそびかた",
      "classic": {
        "line1": "つながった文字をドラッグして単語を作ろう。",
        "line2": "ななめもOK — 角もつながりとみなされます。",
        "line3": "3つの実在する単語を見つければクリア。"
      },
      "wordHunt": {
        "line1": "盤面の上に表示された目標の単語を探そう。",
        "line2": "正しい順序で、つながった文字をドラッグ。",
        "line3": "ボーナス単語もカウント — どんどん集めよう。"
      },
      "wheelRush": {
        "line1": "すべての単語に中央の文字を含めること。",
        "line2": "ホイールのまわりの好きな文字をドラッグ。",
        "line3": "3つの実在する単語を見つければクリア。"
      }
    },
    "modifier": {
