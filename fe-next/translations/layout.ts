  ...
  "ru": {
    ...
    "seo": {
      ...
      "about": {
        ...
        "description": "Узнай о LexiClash, многопользовательской словесной игре в реальном времени. Открой нашу миссию сделать изучение языка веселым и конкурентным, нашу технологию, образовательные инструменты и растущее сообщество на 6 языках.",
