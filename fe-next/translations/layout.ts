export const layoutTranslations: Record<string, any> = {
  ...
  "he": {
    ...
    "seo": {
      ...
      "daily": {
        "title": "המילה היומית | אתגר מילים יומי - לקסיקלאש",
        "description": "פתרו את המילה היומית! אותו פאזל לכולם בעולם. שתפו תוצאות כמו וורדל, עקבו אחר הרצף ותתחרו גלובלית. חינם, ללא הורדה.",
        "ogTitle": "המילה היומית - אתגר יומי לכולם | לקסיקלאש",
        "ogDescription": "פתרו את המילה היומית! אותו לוח לכולם בעולם. שתפו תוצאות והתחרו גלובלית. חינם!"
      },
      "multiplayer": {
