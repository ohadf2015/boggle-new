...
const he = {
  ...
  "seo": {
    "title": "לקסיקלאש - משחק מילים מרובה משתתפים בעברית | קרב מילים אונליין בזמן אמת",
    "description": "משחק מילים מרובה משתתפים בעברית! צרו חדר, הזמינו חברים והתחרו בזמן אמת. 10,000+ מילים בעברית, ללא הרשמה, חינם לגמרי. מושלם לערבי משפחה, מסיבות וגיבוש. פותח בישראל 🇮🇱",
    "keywords": "משחק מילים מרובה משתתפים, משחק מילים בעברית, משחק מילים אונליין, משחק מילים בזמן אמת, קרב מילים, משחק מילים לחברים, משחק מילים למסיבות, משחק מילים תחרותי, משחק מילים ישראלי, אליאס אונליין, משחק כמו בוגל, ערב משפחתי, משחק מסיבה, משחק קבוצתי, תחרות מילים, משחק מילים חי, משחק אוצר מילים, משחק חינם בעברית, משחק לילדים, משחק משפחתי, פעילות גיבוש, משחק מילים ללא הורדה",
