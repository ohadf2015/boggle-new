...
const he = {
  ...
  "academy": {
    "teacher": {
      "classesTitle": "הכיתות שלך",
      "hqTitle": "חמ״ל המורה",
      "classActions": "פעולות לכיתה",
      "orTypeCode": "או פתחו את הקישור והקלידו את הקוד"
    },
    "hq": {
      "startTitle": "התחלת משחק",
      "pickGame": "בחירת משחק",
      "getStudentsIn": "הכניסו את התלמידים",
      "classCode": "קוד הכיתה",
      "showQr": "הצגת קוד QR",
      "qr": "QR",
      "qrLabel": "קוד QR להצטרפות",
      ...
      "modes": {
        ...
        "vocabQuizBlurb": "מרוץ אל הפירוש הנכון",
        "classic": "זירת מילים",
        "classicBlurb": "מוצאים מילים על לוח משותף אחד",
        "blast": "בלאסט",
    ...
    "modes": {
      "workshop": {
        "title": "סדנת מילים",
        "noLessonTitle": "עוד אין מילים מהשיעור",
        "noLessonBody": "ברגע שיתווסף שיעור מהמורה, המילים שלו יהיו הכוכבות של הסדנה.",
        "unsupportedTitle": "הסדנה עוד לומדת את השפה הזו",
        "unsupportedBody": "לסדנת מילים עוד אין אריחי אותיות בשפה של השיעור הזה. נסו את המשחקים האחרים של השיעור!",
        "lessonWord": "מילה מהשיעור!",
        "hiddenLessonWord": "מילה נסתרת מהשיעור!",
        "stars": "★ {count}",
        "won": "ניצחתם את הבוט!",
        "tie": "תיקו!",
        "lost": "הפעם הבוט ניצח",
        "resultLine": "מילים מהשיעור: {count} · ★ {stars}",
        "chest": "תיבת הסדנה",
        "nudge": "כדי לזכות בתיבה, בנו לפחות מילה אחת מהשיעור (או 3 מילים). אתם יכולים!",
        "introTitle": "בנו יותר מהבוט!",
        "introBody": "שבצו מילה מהשיעור — או מילה שמסתתרת בה מילה כזו — ותקבלו בונוס זהב. בערך 5 דקות.",
        "play": "שחקו",
        "rival": {
          "name": "הברון בנה־מילה",
          "open": "תורכם, טירונים!",
          "gloat": "הסדנה שלי, החוקים שלי!",
          "intro": "חושבים שתבנו יותר ממני?",
          "taunt1": "טיק־טק! תורי.",
          "taunt2": "נצחו את זה, טירונים!",
          "taunt3": "גלגלי השיניים שלי אף פעם לא מפספסים.",
          "taunt4": "הסדנה הזו שלי!",
          "hurt1": "מילה מהשיעור?! הברגים שלי!",
          "hurt2": "איי! המילה הזו נצצה!",
          "enraged1": "הממף. אריח של מזל.",
          "enraged2": "גרר… לא רע."
        },
        "wonBaron": "ניצחתם את הברון!",
        "lostBaron": "הפעם הברון ניצח",
        "statLessonWords": "מילים מהשיעור",
        "starsValue": "★{count}",
        "statStars": "כוכבים",
        "statWords": "מילים שנבנו",
        "lessonWords": "מילים מהשיעור",
        "panelHint": "בנו אחת מהן (או מילה שאחת מהן מסתתרת בה) וקבלו בונוס זהב.",
        "you": "אתם",
        "vs": "VS",
        "introTitleBaron": "בנו יותר מהברון!",
        "stakes": "מילים מהשיעור = זהב",
        "battle": "לקרב!"
      },
      "review": {
        "title": "חזרה על מילים שפוספסו",
        "signedOutTitle": "הצטרפו לכיתה כדי לפתוח חזרות",
        "signedOutBody": "המילים שפוספסו נשמרות בחשבון התלמיד. קודם צריך להתחבר או להצטרף לכיתה.",
        "loadErrorTitle": "לא הצלחנו לטעון את המילים",
        "loadErrorBody": "בדקו את החיבור ונסו שוב.",
        "emptyTitle": "אין על מה לחזור!",
        "emptyBody": "שחקו משחק כיתתי או שיעור, והמילים שתפספסו יחכו כאן לרוונש.",
        "introTitle": "מילים שרוצות רוונש: {count}",
        "introBody": "10 כרטיסים מהירים. שמרו על הרצף ופתחו את התיבה.",
        "start": "מתחילים!",
        "score": "{correct} / {total}",
        "bestStreak": "רצף שיא {streak} · {points} נק׳",
        "xpNotSaved": "הפעם לא הצלחנו לשמור XP, אבל המילים שלכם כן התקדמו בקופסאות.",
        "streak": "רצף {count}",
        "progress": "{n} / {total}",
        "pickMeaning": "מה זה אומר?",
        "unscramble": "סדרו את האותיות",
        "perfect": "סיבוב מושלם!",
        "runDone": "הסיבוב הושלם!",
        "outOf": "/{total}",
        "statCorrect": "נכון",
        "statStreak": "רצף שיא",
        "statPoints": "נקודות",
        "mascot": {
          "think": "את זה אתם יודעים!",
          "cheer": "בול!",
          "fire": "אתם באש!",
          "oops": "אופס! המילה הזו עוד תחזור."
        },
        "vaultTitle": "מילים נעולות בכספת: {count}",
        "crack": "פצחו את הכספת",
        "chest": {
          "bronze": "תיבת ארד",
          "silver": "תיבת כסף",
      ...
      "errorTitle": "אופס, משהו השתבש. לנסות שוב?",
      "tryAgain": "לנסות שוב",
      "playAgain": "לשחק שוב",
      "xpNotSaved": "הפעם לא הצלחנו לשמור XP. שחקו שוב כדי לנסות עוד פעם.",
      "startFailed": "לא הצלחנו להתחיל. בדקו את החיבור ונסו שוב.",
      "openForXp": "פתחו את התיבה וקבלו XP!"
    },
    "student": {
      "liveNow": "לייב עכשיו",
      "ctaReview": "חזרה",
      "ctaBoss": "הבוס נפתח",
      "ctaStart": "מתחילים כאן",
      "ctaSoloOver": "חימום",
      "ctaPlay": "שחקו",
      "ctaLive": "למשחק הלייב",
      "ctaReviewTitle": "מילים לחזרה: {count}",
      "ctaBossTitle": "קרב נגד הבוס",
      "ctaJoinSub": "הקלידו את הקוד מהמורה",
      "dockLabel": "אקדמיה",
      "dockLessons": "שיעורים",
      "reviewDueAria": "מילים לחזרה: {count}",
      "dockClass": "כיתה",
      "solo": "סולו",
      "mapLabel": "מפת האקדמיה",
      "title": "אקדמיית המילים",
      "rewardXp": "+{xp} XP",
      "arenaWaiting": "עוד לא התחיל משחק לייב בכיתה. האי הזה יידלק ברגע שזה יקרה.",
      "bossLockedNote": "כדי לפתוח את הבוס, צריך ללמוד עוד מילים: {count}.",
      "level": "רמה {level}",
      "xpToNext": "XP לרמה הבאה",
      "xpLine": "{xp} / {need} XP",
      "stars": "כוכבים",
      "workshop": "סדנת מילים",
      "review": "מילים שפוספסו",
      "arena": "זירת הכיתה",
      "boss": "בוס",
      "bossLockedAria": "הבוס נעול — נלמדו {have} מתוך {need} מילים",
      "bossOpenAria": "קרב נגד הבוס",
      "nodeDoneAria": "{name}: הושלם, כוכבים: {stars}",
      "arenaWaitingAria": "{name}: מחכים למורה",
      "nodePlayAria": "לשחק: {name}",
      "liveTag": "לייב",
      "bossNeed": "נלמדו {have}/{need} מילים",
      "bossReady": "פתוח",
      "chestReady": "תיבה יומית — הקישו לפתיחה",
      "chestTomorrow": "התיבה הבאה מחר",
      "chestTag": "חינם",
      "chestDone": "נפתחה",
      "chestTitle": "תיבה יומית",
      "chestFailed": "לא הצלחנו לשמור את ה-XP — הקישו על התיבה כדי לנסות שוב",
      "chestComeBack": "חזרו מחר לעוד תיבה",
      "chestCollect": "לאסוף"
    },
    "classes": {
      "pagerLabel": "עמודי כיתות",
      "prevPage": "הכיתות הקודמות",
      "pageOf": "{{page}} מתוך {{pages}}",
      "nextPage": "עוד כיתות",
      "proUnlocks": "עם Pro: ניתוח נתוני הכיתה + דוחות להדפסה",
      "proCta": "שדרוג ל־Pro — {{price}} לחודש",
      "nextUp": "הצעד הבא"
    },
    "launch": {
      "title": "התחלת משחק לייב",
      "subtitle": "בוחרים משחק. כל הכיתה מצטרפת עם קוד אחד.",
      "questions": "שאלות: {{count}}",
      "pace": "{{seconds}} שנ׳ לשאלה",
      "minLetters": "{{count}}+ אותיות"
    },
    "live": {
      "getReady": "מתכוננים!",
      "warmUpHint": "חימום: הקישו על האות הזוהרת!",
      "warmUpTapThis": "הקישו כאן",
      "warmUpTitle": "חימום"
    },
    "projector": {
      "joined": "בפנים",
    ...
    "results": {
      "classChest": "תיבת הכיתה",
      "classChestWords": "נמצאו מתוך {{total}}",
      "playAgain": "עוד סיבוב",
      "playAgainHint": "אותן מילים, אותו קוד. אף אחד לא צריך להצטרף מחדש."
    },
    "waiting": {
      "classmates": "חברים לכיתה שכבר כאן",
      "editAvatar": "החלפת אווטאר",
      "forTeacher": "מחכים לאות הפתיחה מהמורה",
      "inClass": "בכיתה",
      "classmateHere": "מהכיתה כבר כאן",
      "classmatesHere": "מהכיתה כבר כאן",
      "firstIn": "הגעתם ראשונים! החברים לכיתה יופיעו כאן."
    },
    "homework": {
      "noGame": "שחקו משחק לייב — המילים שפוספסו יגיעו לכאן, לכל תלמיד בנפרד.",
      "noMisses": "במשחק האחרון אף אחד לא פספס מילה. אין מה להקצות!",
      "summary": "תלמידים: {students} · מילים שפוספסו: {words}. כל אחד ואחת מתרגלים רק את המילים שלהם.",
      "more": "ועוד {count}",
      "assigned": "הוקצה! זה מחכה להם באי של המילים שפוספסו.",
      "assign": "הקצאה לכל התלמידים",
      "due": "להגשה עד {date}",
  ...
  "homeFresh": {
    "hero": {
      "kicker": "משחק המילים מרובה המשתתפים",
      "title": "מוצאים מילים.\nמנצחים חברים.",
      "sub": "מחברים אותיות סמוכות למילים לפני שהזמן נגמר. בחינם, בלי הורדה.",
      "play": "שחקו עכשיו",
      "account": "יש לי חשבון",
      "gridLabel": "לוח תרגול. הקישו על האותיות של {word} לפי הסדר.",
      "hint": "נסו: הקישו {letters}",
      "found": "{word}! ככה משחקים.",
      "miss": "עוד לא מילה. נסו {letters}"
    },
    "modes": {
      "title": "בחרו משחק",
      "line": "סבבים מהירים, חידות רגועות וכל מה שביניהם.",
      "prev": "משחקים קודמים",
      "next": "עוד משחקים",
      "items": {
        "adventure": {
        ...
        "arena": {
          "title": "מולטיפלייר",
          "line": "אותן אותיות, יריבים בזמן אמת. המהיר מנצח."
        },
        "wordTower": {
          "title": "מגדל מילים",
          "line": "ערמו מילים לגובה לפני שהכול מתנדנד."
        },
        "wordCraft": {
          "title": "וורדקראפט",
          "line": "כבשו את הלוח ותגברו על הבוט."
        },
        "connections": {
          "title": "ראש זנב",
          "line": "מצאו את המילה שמחברת בין שתיים."
        },
        "brainGym": {
          "title": "אימון קוגניטיבי",
          "line": "תרגילים קצרים שמחדדים את הראש."
        },
        "blast": {
          "title": "מצב פיצוץ",
          "line": "שרשרו מילים, נקו את הלוח ובום!"
        }
      }
    },
    "sections": {
      "daily": {
        "title": "חידה אחת ביום. שמרו על הרצף.",
        "line": "לוח חדש כל בוקר. לכולם אותן אותיות, אז אפשר להשוות ניקוד.",
        "cta": "לחידה של היום",
        "streak": "ימי רצף"
      },
      "friends": {
        "title": "מתחרים בחברים, בזמן אמת",
        "line": "משתפים קוד חדר ומשחקים על אותו לוח באותו רגע.",
        "cta": "פתחו חדר",
        "room": "חדר",
        "you": "אני",
        "rival": "נועה"
      ...
      "languages": {
        "title": "משחקים בשפה שלכם",
        "line": "אנגלית, עברית, שוודית, יפנית, ספרדית ורוסית, ולכל שפה מילון משלה."
      },
      "classrooms": {
        "title": "הביאו את המשחק לכיתה",
        "line": "הפעילו משחק מילים חי לכיתה. התלמידים מצטרפים עם קוד מכל מכשיר.",
        "cta": "פתחו כיתה בחינם"
      }
    },
    "close": {
      "title": "מוכנים? הלוח מחכה.",
      "line": "בלי הורדה ובלי הרשמה כדי להתחיל.",
      "play": "שחקו עכשיו",
      "blogTitle": "החדש בבלוג",
      "blogAll": "כל המאמרים",
      ...
      "teacherPages": "כל העמודים למורים"
    }
  },
  // @home-fresh:end
  "adventurePlay": {
    ...
    "loot": {
      ...
      "showMoreRelics": "הצגת עוד {n} שרידים",
    ...
    "guest": {
      "pitch": "כבשו 10 עולמות של כבוד רוגלייק",
  ...
  "wordTowerV2": {
    ...
    "rescue": {"crumbled":"איבדתם {n} קומות! ממשיכים לבנות","counterweight":"משקל נגד! המגדל התייצב","braced":"חיזקתם! הפלדה מחזיקה","craneSaved":"שדרוג המנוף! חלון רחב, נחיתה מושלמת"},
    ...
    "results": {
        "home": "לדף הבית",
        "close": "סגירה","floorsA11y": "הגעתם לקומה {n}", "combo": "רצף שיא", "tenants": "דיירים", "crates": "ארגזים", "badges": "תגים שהושגו", "nextGoal": "היעד הבא", "coinsLoading": "מטבעות בדרך…"},
...
"leaveDaily": {"title": "לצאת מהטיפוס של היום?", "desc": "הטיפוס יסתיים, והגובה שלך יחושב בטבלה של היום. טיפוס חדש ייפתח מחר."},
"leaveFree": {"title": "לצאת מהטיפוס?", "desc": "הריצה תסתיים והמטבעות שלך ייכנסו לארנק. אפשר להתחיל ריצה חדשה בכל עת."},
    "leaveKeep": "להמשיך לטפס",
    "leaveGo": "לצאת",
  ...
  "seo": {
    ...
    "wordTowerV2": {
      "title": "מגדל מילים - ערמו מילים, בנו מגדל | משחק חינם",
      "description": "ערמו מילים כדי לבנות את המגדל הגבוה ביותר! מגדל מילים הוא משחק פאזל מילים עם פיזיקה. שרשרו קומבואים, פתחו כוחות על, וטפסו בטבלת המובילים. חינם, ללא הורדה.",
      "ogTitle": "מגדל מילים - משחק פאזל מילים עם פיזיקה",
      "ogDescription": "ערמו מילים כדי לבנות את המגדל שלכם! שרשרו קומבואים, פתחו כוחות על, והתחרו. משחק חינם!",
      "playLabel": "שחק"
    },
    "blast": {
...
"createForm": {
  ...
  "profile": {
    "showcase": {
      ...
      "emptyStats": "שחקו משחק אחד והתצוגה תתמלא",
      "emptyStatsPublic": "עוד בתחילת הדרך",
      "editAvatar": "עריכת דמות",
      "share": "שיתוף",
      "shareProfile": "שיתוף פרופיל",
      "linkCopied": "הקישור הועתק!",
      "shareTitle": "{name} ב-LexiClash",
      "shareTextOwn": "תציצו בפרופיל שלי ב-LexiClash ובואו לנצח אותי!",
      "shareTextPublic": "תציצו ב-{name} ב-LexiClash",
      "parts": "{owned}/{total} פריטים",
      "collection": "אוסף",
      "rarest": "הפריט הכי נדיר",
      "nextUnlock": "הפריט הבא",
      "unlocksAt": "נפתח ברמה {level}",
      "levelShort": "רמה",
      "xpToNext": "עוד {xp} XP לרמה {level}",
      "maxLevel": "רמה מקסימלית",
      "unnamed": "שחקן מסתורי",
      "setName": "בחרו שם",
      "settings": "הגדרות",
      "pinned": "הישגים נבחרים",
      "seeAll": "לכל ההישגים",
      "noBadges": "נצחו משחק כדי להצמיד את התג הראשון",
      "avatarCollection": {
        "title": "אוסף הדמות",
        "body": "עלו רמות ושחקו כדי לפתוח פריטים. ככל שהציוד נדיר יותר, הבמה שלכם צועקת חזק יותר.",
        "byRarity": "לפי נדירות"
      },
      "account": "חשבון והגדרות",
      "memberSince": "מאז {date}",
      "shareFailed": "השיתוף לא הצליח. נסו שוב."
    },
    "xpByMode": {
  ...
  "brain": {
    "check": {
      "cooldownGate": "כבר עשית היום את הבדיקה של התרגיל הזה. הבאה בעוד {h} שע׳ — בינתיים אפשר להתאמן, האימון לא משפיע על המגמה שלך.",
      "trainInstead": "להתאמן במקום",
      "title": "בדיקת מוח",
      "subtitle": "מבחן של דקה בתנאים קבועים, פעם ביום לכל תרגיל. אותם כללים בכל פעם — אז המגמה שלך אמיתית, ולא רק שלב קשה יותר.",
      "start": "לבדיקה",
      "nextIn": "הבאה בעוד {h} שע׳",
      "howItWorks": "איך אנחנו מודדים",
      "method": {
        "fixed": "כל בדיקה רצה עם אותם כללים ואותה רמת קושי — לכולם, תמיד. רמות האימון לא נוגעות בה.",
        "warmup": "הבדיקה הראשונה היא חימום: היא מלמדת אותך את המשימה ולא נכנסת לנקודת הבסיס.",
        "noise": "נקודת הבסיס שלך היא בדיקות 2–3. אנחנו קוראים לזה שינוי רק כשהבדיקות האחרונות זזות יותר מהתנודות הרגילות שלך מיום ליום (מדד שינוי מהימן), לאורך שבוע לפחות.",
        "transfer": "גבול כן: זה מודד את הביצועים שלך במשימות המילים האלה. זה לא מוכיח שהזיכרון או האינטליגנציה הכלליים שלך השתנו — אף אפליקציית אימון מוח לא יכולה לטעון את זה."
      },
      "loadFailed": "לא הצלחנו לטעון את הבדיקות. הקש לנסות שוב.",
      "guestPitch": "התחבר כדי לעקוב אחרי בדיקות מוח — מבחנים קצרים וקבועים שמראים אם אתה באמת מתחדד, עם מבחן סטטיסטי אמיתי מאחורי כל תוצאה.",
      "rejected": "כבר בדקת את התרגיל הזה היום, אז הסיבוב נספר כאימון. חזור מחר לבדיקה הבאה.",
      "fixedConditions": "תנאים קבועים — אפשר להשוות בין ימים.",
      "warmupDone": "החימום הושלם",
      "needMoreRuns": "עוד {n} כדי לראות מגמה",
      "needMoreDays": "מגמה בעוד {n} ימים",
      "verdict": {
        "improved": "שיפור מהימן",
        "stable": "יציב",
        "declined": "מתחת לבסיס"
      }
    },
    ...
    "drills": {
      "levelEased": "ירדנו שלב — חוזרים לזרום",
      "levelLabel": "שלב {level}",
...
"vsBlooket": {
  ...
  "revealUnlock": {
    "kicker": "פתחת משהו חדש!",
    "dialog": "פריט חדש לאווטאר",
    "counter": "{current} מתוך {total}",
    "tapNext": "הקש לפריט הבא",
    "equip": "ללבוש עכשיו",
    "equipping": "מלבישים…",
    "equipped": "עליך!",
    "equipError": "לא הצלחנו להלביש. נסה שוב.",
    "later": "אחר כך",
    "unlockedAt": "פרס רמה {level}",
    "guestTitle": "הירשם כדי לשמור אותו",
    "guestBody": "חשבון חינמי, והוא נשאר שלך לתמיד.",
    "chip": "פריט חדש!",
    "chipMany": "{count} פריטים חדשים!",
    "nextHint": "הפריט הבא ברמה {level}",
    "profileEntry": "הפרופיל שלך",
    "levelShort": "רמה {level}",
    "share": "שיתוף",
    "shareText": "הרגע פתחתי {part} ({rarity}) ב-LexiClash!",
    "copied": "הקישור הועתק!",
    "newTag": "חדש",
    "voice": {
      "headphones": "כל מילה שתמצא עכשיו נוחתת כמו ביט.",
      "kawaii": "חמידות ברמה מקסימלית. ליריבים אין סיכוי.",
      "cottonCandy": "מתוק, רך ובלי גרם סוכר.",
      "cowboyHat": "יי-הא! יש שריף חדש על הלוח.",
      "bg4B0082": "עמוק, מלכותי ולגמרי שלך.",
      "heartEye": "אזהרה: רמת החמידות שלך מסוכנת.",
      "fangs": "למילים שלך צמחו שיניים.",
      "duckHat": "קוואק! מילים, לתפוס מחסה.",
      "vaporwave": "אסתטי. אסתטי ברמות.",
      "frogHat": "קפיצת מדרגה, בסגנון צפרדע.",
      "bg000000": "מצב כהה, אבל אייקוני.",
      "slime": "דביק מבחוץ, גאון מבפנים.",
      "starEye": "לראות כוכבים אף פעם לא היה כזה יפה.",
      "lightning": "אזהרה: אוצר מילים במתח גבוה.",
      "butterflyWings": "לרחף כמו פרפר, לאיית כמו אלוף.",
      "neonSmile": "חיוך שמאיר את כל הלוח.",
      "ghostFace": "בו! היריבים שלך ראו רוח רפאים.",
      "rainbowMohawk": "שיער רועש. ניצחונות רועשים יותר.",
      "iceCrown": "קר, רגוע ומוכתר."
    },
    "parts": {
      "headphones": "אוזניות ביט",
      "kawaii": "עיני קוואיי",
      "cottonCandy": "שיער שערות סבתא",
      "cowboyHat": "כובע קאובוי",
      "bg4B0082": "לילה אינדיגו",
      "heartEye": "עיני לב",
      "fangs": "ניבי ערפד",
      "duckHat": "כובע ברווז",
      "vaporwave": "שיער וייפורווייב",
      "frogHat": "כובע צפרדע",
      "bg000000": "שחור תהום",
      "slime": "פרצוף סליים",
      "starEye": "עיני כוכבים",
      "lightning": "שיער ברק",
      "butterflyWings": "כנפי פרפר",
      "neonSmile": "חיוך ניאון",
      "ghostFace": "פרצוף רוח רפאים",
      "rainbowMohawk": "מוהוק קשת",
      "iceCrown": "כתר קרח"
    }
  },
  "avatarLab": {
    "title": "מעבדת אווטארים",
    "subtitle": "נתוני בדיקה לצילומי מסך — זה לא שחקן אמיתי.",
    "showcase": "גלריית דמויות",
    "level": "רמה {level}",
    "views": {
      "editor": "עורך",
      "profile": "פרופיל",
    ...
    "openBuilder": "לפתוח את עורך האווטאר",
    "placeholder": {
      "title": "בקרוב",
      "profile": "כאן יוצג חלון הראווה של הפרופיל.",
      "reveal": "כאן תופיע חשיפת הפריטים בעליית רמה."
    },
    "collection": "נאספו {owned} מתוך {total} פריטים נדירים",
    "unlocksAtLevel": "חדש ברמה {level}",
    "noUnlocks": "ברמה הזו לא נפתח שום דבר חדש.",
    "nextUnlock": "הפריט הבא נפתח ברמה {level}",
    "liteNote": "לשחקן הבדיקה אין פרצוף שמור, אז האווטאר המוקטן מציג רק עיגול צבעוני. האווטאר המלא מופיע לידו.",
    "randomAvatars": "אווטארים אקראיים",
    "allParts": "כל החלקים",
    "sections": {
      "faceShapes": "צורות פנים",
      "eyes": "עיניים",
      "mouths": "פיות",
      "hair": "שיער",
      "accessories": "אביזרים"
