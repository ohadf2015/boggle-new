  ...
  "brain": {
    ...
    "drills": {
      ...
      "lightning-round": {
        ...
        "persona": "זאפ",
        "mission": "מצא כמה שיותר מילים לפני שהשעון יתם.",
        "benefit": "מילים צצות לראשך יותר מהר ככל שתרוץ יותר.",
        "coachTip": "מילים קצרות גם כן סופרות — אתגר נפח, מהירות משפרת על פני דיוק.",
        "step1": "הקש או החלק אצבעות על אותיות כדי לבנות מילה.",
        "step2": "הגש אותה והמשך לציד — מהירות זה הכל.",
        "step3": "שיידור כמה שאתה יכול לפני שנגמר הזמן."
      },
      "memory-hunt": {
        "name": "ציד זיכרון",
        ...
        "benefit": "הזיכרון הטווח קצר שלך לפרטים הופך חד יותר בכל סיבוב.",
        "coachTip": "לחש את המילים לעצמך תוך כדי הלימוד — זה יותר טוב דבוק.",
        "step1": "שנן את המילים המודגשות בזמן שאתה יכול.",
        "step2": "הגריד מתאפס והתאורה נעלמת.",
      ...
      "combo-master": {
        ...
        "persona": "להבה",
        "mission": "שרשור מילים זו אחר זו לפני שנגמר הטיימר למילה.",
        "benefit": "אתה הופך טוב יותר להישאר נעול תחת לחץ.",
        "coachTip": "שמור את העיניים שלך נעות — הצבע את המילה הבאה שלך לפני שתגיש.",
        "step1": "מצא מילה כדי להתחיל את הרצף שלך.",
        "step2": "כל קיום מאפס את הטיימר — להיות מהיר.",
        "step3": "שמור את הרצף בחיים כדי לגדול את הקומבו שלך."
      },
      "pattern-switcher": {
        "name": "מחליף דפוסים",
        "description": "מצא מילים ברצפי אורך נדרשים",
        "persona": "הנדה",
        "mission": "מצא מילה באורך הנדרש — היעד משתנה ברציפות.",
        "benefit": "המוח שלך הופך מהיר יותר בהחלפת כללים תוך כדי תזוזה.",
        "coachTip": "בדוק את אורך היעד קודם, ואז סרוק — אל תנעל עצמך לרעיון אחד.",
        "step1": "קרא את אורך המילה הנדרש.",
        "step2": "מצא מילה באורך בדיוק זה.",
        "step3": "היעד משתנה — התאם וחזור על ההליך."
      },
      "rare-gems": {
        "name": "אבנים נדירות",
        "description": "מלא את שק האבנים — ככל שהמילה ארוכה יותר, האבן נדירה יותר",
        "persona": "זעזוע",
        "mission": "ציד מילים ארוכות וטובות יותר — מילים גדולות יותר הן אבנים גדולות יותר.",
        "benefit": "אתה מתחיל להבחין ולהשתמש במילים יותר מפוארות בחיים היומיומיים.",
        "coachTip": "הגע ל-5+ אותיות מילים — הם מלאים את השק שלך הרבה יותר מהר.",
        "step1": "מצא מילים מוסתרות בגריד.",
        "step2": "מילים ארוכות יותר נופלות אבנים נדירות יותר, זוהרות יותר.",
        "step3": "מלא את השק שלך לפני שנגמר הזמן."
      },
      "locked": "נעול",
      ...
      "firstMissFree": "טעות חימום — ללא הכשל. אתה כבר זה!",
      "badge": {
        "bronze": { "name": "ברונזה", "title": "הרפטיציות שמורות!" },
        "silver": { "name": "כסף", "title": "עבודה מוצקה!" },
        "gold": { "name": "זהב", "title": "בוערת!" },
