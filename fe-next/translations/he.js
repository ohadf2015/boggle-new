  ...
  "wordcraft": {
    ...
    "cascade": {
      "intro": {
        ...
        "howTo": "החלק דרך אותיות סמוכות כדי לשרטט מילה. שרוף אריחים, הפעל cascades, הימלט מן שורת האש.",
        "start": "התחל Cascade"
      },
      "endRound": "סיים סבב",
      "combo": {
      ...
      "fireWarning": "אש עולה — צא עם מילה ארוכה!",
      "error": {
        "TOO_SHORT": "מילה צריכה 3 אותיות לפחות.",
        "NOT_CONTIGUOUS": "אותיות חייבות להיות סמוכות.",
        "REUSED_CELL": "כל אות יכולה להשתמש פעם אחת בלבד.",
        "UNKNOWN_CELL": "האריח הזה לא קיים.",
        "EMPTY_CELL": "הנתיב עובר דרך אריח שרוף.",
        "INVALID_WORD": "זו לא מילה."
      },
      "card": {
        "pyro": { "name": "פיירו", "desc": "מילים של 5+ אותיות שורפות אריח אקראי נוסף." },
        "frost": { "name": "קרח", "desc": "מילים של 6+ אותיות עוצרות את האש למשך 8 שניות." },
        "diagonal": { "name": "אלכסון", "desc": "נתיבי החלקה עשויים לכלול צעדים אלכסוניים." },
        "echo": { "name": "הד", "desc": "ה-cascade האוטומטי הראשון בסבב משולש הניקוד." },
        "emberBoost": { "name": "דחיפת גחלים", "desc": "מילים מקבלות ניקוד כפול כשהאש חצתה את חציו." },
        "staticSpark": { "name": "ניצוץ סטטי", "desc": "כל מילה מקבלת +5 חיפים קבועים." }
      }
    }
  },
  mp: {
