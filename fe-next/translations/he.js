...
const he = {
  "adventurePlay": {
    ...
    "loot": {
      ...
      "runOver": "הריצה נגמרה",
      "runOverSub": "מפה חדשה, ריצה חדשה מהקומה הראשונה. הכוכבים והאוסף נשארים אצלכם.",
      "newRun": "ריצה חדשה",
  ...
  "wordTowerV2": {
    ...
    "rescue": {"crumbled":"איבדתם {n} קומות! ממשיכים לבנות","counterweight":"משקל נגד! המגדל התייצב","braced":"חיזקתם! הפלדה מחזיקה"},
