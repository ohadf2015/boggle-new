...
const he = {
  ...
  "seo": {
    ...
    "multiplayer": {
      "title": "משחק מילים מרובה משתתפים אונליין · בעברית חינם | LexiClash",
      "description": "קרבות מילים בזמן אמת עם חברים — ללא הרשמה. צרו חדר, שלחו לינק, התחרו בלייב. 6 מצבי משחק, 10,000+ מילים בעברית, לוח מובילים יומי. שחקו עכשיו ←",
      "ogTitle": "קרבות מילים בזמן אמת עם חברים — חינם",
      "ogDescription": "צרו חדר, שלחו לינק, התחרו על מילים בלייב. 6 מצבים, 5 שפות. חינם בדפדפן 🇮🇱"
    },
    "about": {
    ...
    "faq": {
      "title": "שאלות נפוצות לקסיקלאש - איך משחקים, ניקוד, חדרים | מדריך 2026",
      "description": "20+ תשובות על לקסיקלאש: איך פותחים חדר, איך מנקדים, האם זה באמת חינם, מה הגיל המתאים, האם עובד בנייד. משחק מילים חינם בדפדפן - בלי הורדה.",
      "ogTitle": "שאלות ותשובות לקסיקלאש - 20+ תשובות מהירות",
      "ogDescription": "איך משחקים? איך מנקדים? האם חינם? כל השאלות הכי נפוצות עם תשובות ברורות."
    },
    "blog": {
