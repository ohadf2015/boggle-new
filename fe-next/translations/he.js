...
const he = {
  ...
  "seo": {
    ...
    "daily": {
      "title": "פאזל המילים של היום — אתגר יומי חינם | LexiClash",
      "description": "שחקו את פאזל המילים של היום בחינם — אותו לוח בכל העולם. מצאו מילים, שתפו תוצאות אמוג׳י וטפסו בטבלת המובילים. ללא הורדה, ללא הרשמה. פאזל חדש כל יום!",
      "ogTitle": "פאזל המילים של היום — תנצחו את העולם?",
      "ogDescription": "אותו פאזל, כל העולם. מצאו מילים, שתפו תוצאות, התחרו גלובלית. חינם וללא הורדה!"
    },
    "multiplayer": {
    ...
    "faq": {
      "title": "שאלות נפוצות על לקסיקלאש - משחק המילים",
  ...
  "cookieConsent": {
    ...
    "categories": {
      ...
      "advertising": "פרסום",
      "advertisingDesc": "הצגת פרסומות רלוונטיות דרך Google AdSense"
    }
  },
  "common": {
    "email": "אימייל",
  ...
  "tvResults": {
    ...
    "spotlight": {
      ...
      "andMorePlural": "ועוד {count} שחקנים",
      "archetypes": {
        "the-ghost": { "title": "הרוח", "stat": "מילים ייחודיות", "quip1": "מצא מילים שלא קיימות אפילו בסיוטים של שחקנים אחרים.", "quip2": "פועל במימד שרק הוא יכול לראות.", "quip3": "בלתי נראה למתחרים. קטלני בטבלה.", "quip4": "אם מילה נמצאת בלוח ורק שחקן אחד מוצא אותה... האם היא באמת הייתה שם?" },
        "the-sniper": { "title": "הצלף", "stat": "דיוק", "quip1": "שחקנים אחרים מנחשים. הזה יודע.", "quip2": "לא מפספס. לא מהסס. לא שולח זבל.", "quip3": "כל מילה בול בעין. כל הקשה מכוונת.", "quip4": "דיוק כירורגי. בלי מהלכים מיותרים." },
        "the-philosopher": { "title": "הפילוסוף", "stat": "אורך ממוצע", "quip1": "למה להשתמש במילה קצרה כשארוכה עושה את העבודה טוב יותר?", "quip2": "שחקן החשיבה. מילים גדולות, מוח גדול.", "quip3": "בזמן שאחרים כתבו 'חתול', הזה כתב 'קטסטרופה'.", "quip4": "איכות על כמות. תמיד." },
        "the-one-hit-wonder": { "title": "פלא חד פעמי", "stat": "מילה הכי טובה", "quip1": "מילה אחת לשלוט בכולם.", "quip2": "בא בשביל מילה אחת. גרם לה לספור.", "quip3": "לפעמים צריך רק יריה מושלמת אחת.", "quip4": "מעט מילים, אבל איזו מילה זה היה." },
        "the-silent-assassin": { "title": "המתנקש השקט", "stat": "נק'/מילה", "quip1": "פחות מילים, נזק מקסימלי.", "quip2": "שקט אבל קטלני. הטבלה מספרת את הסיפור.", "quip3": "כלכלה של תנועה. כל מילה מכה מדויקת.", "quip4": "מדבר בשקט, נושא אוצר מילים ענק." },
        "the-sleeping-giant": { "title": "הענק הישן", "stat": "נק' מחצית שנייה", "quip1": "התחיל לישון, ואז התעורר ובחר באלימות.", "quip2": "התחלה איטית? לא. סבלנות אסטרטגית.", "quip3": "הקאמבק שאף אחד לא ציפה לו.", "quip4": "כמו רקטה... רק צריך ספירה לאחור ארוכה יותר." },
        "the-frontrunner": { "title": "הרץ בראש", "stat": "נק' מחצית ראשונה", "quip1": "יצא לתקוף ולא הסתכל אחורה.", "quip2": "רץ בזמן שאחרים עוד התחממו.", "quip3": "ראשון לתקוף את הלוח. ראשון לשלוט.", "quip4": "קבע את הקצב. השאר רדפו." },
        "the-speed-runner": { "title": "רץ המהירות", "stat": "מילים/דקה", "quip1": "אצבעות מהירות מהעין.", "quip2": "ירי מהיר. פרצים קצרים. תוצאות הרסניות.", "quip3": "מקליד במהירות המחשבה.", "quip4": "מילים מהירות, ניצחונות מהירים." },
        "the-machine-gun": { "title": "המקלע", "stat": "סה\"כ מילים", "quip1": "כמות היא איכות בפני עצמה. שאלו את האגדה הזו.", "quip2": "יותר מילים ממילון. תפוקה בלתי נעצרת.", "quip3": "ללוח לא היה סיכוי מול הנפח הזה.", "quip4": "בררררט. זה הצליל של מילים שנשלחות." },
        "the-metronome": { "title": "המטרונום", "stat": "קצב", "quip1": "טיק. מילה. טוק. מילה. כמו שעון.", "quip2": "עקביות היא כלי הנשק הסודי שאף אחד לא מדבר עליו.", "quip3": "קצב כל כך יציב, אפשר לכוון לפיו שעון.", "quip4": "בלי לחץ. בלי פאניקה. סתם תפוקה יציבה ונקייה." },
        "the-wildcard": { "title": "הג'וקר", "stat": "מגוון אורכים", "quip1": "מילים קצרות, ארוכות, בינוניות — כל המילים.", "quip2": "בלתי צפוי. בלתי ניתן לסיווג. בלתי ניתן לעצירה.", "quip3": "האסטרטגיה היחידה היא שאין אסטרטגיה.", "quip4": "מאסטר של כל האורכים, מלך הבלבול." },
        "the-marathon-runner": { "title": "רץ המרתון", "stat": "כיסוי", "quip1": "ראשון להתחיל, אחרון להפסיק. אלוף הסיבולת.", "quip2": "עדיין רץ בזמן שאחרים לקחו הפסקה.", "quip3": "מהשנייה הראשונה ועד האחרונה. לא עצר.", "quip4": "הצב שגם במקרה היה ארנב." },
        "the-combo-master": { "title": "מאסטר הקומבו", "stat": "קומבו מקסימלי", "quip1": "ק-ק-ק-קומבו בראייקר! רגע, לא, קומבו בילדר.", "quip2": "שרשר מילים כמו מכונה.", "quip3": "כשאתה על גל, למה לעצור?", "quip4": "רמת קומבו: אגדית. התחרות: רועדת." },
        "the-fire-walker": { "title": "הולך על אש", "stat": "בונוס אש", "quip1": "משגשג כשהחום עולה. פשוטו כמשמעו.", "quip2": "סיבוב אש? יותר כמו הסיבוב שלהם.", "quip3": "שחקנים מפחדים מהאש. הזה רוקד בתוכה.", "quip4": "ידיים חמות, ניקוד חם יותר." },
        "the-social-butterfly": { "title": "הפרפר החברתי", "stat": "בחירות פופולריות", "quip1": "מוחות גדולים חושבים אותו דבר — והזה חושב כמו כולם.", "quip2": "מצא את כל המילים שכולם מצאו, בתוספת וייבס.", "quip3": "מילים פופולריות? לשחקן הזה יש את המועדפות של הקהל.", "quip4": "תמיד על אותו גל עם הקבוצה." },
        "the-underdog": { "title": "הצפרדע", "stat": "דיוק", "quip1": "נמוך בדירוגים, גבוה בדיוק. כבוד.", "quip2": "הניקוד לא מספר את כל הסיפור.", "quip3": "לא מקום ראשון, אבל בהחלט ראשון בלב.", "quip4": "הוכחה שדירוגים זה לא הכל." },
        "the-participant": { "title": "המשתתף", "stat": "מילים", "quip1": "לא כל גיבור לובש גלימה. חלקם פשוט שולחים מילים.", "quip2": "הגיע. שיחק את המשחק. זה מה שחשוב.", "quip3": "שחקן מסתורי. אגדה בהתהוות.", "quip4": "מסע של אלף מילים מתחיל באחת." }
      }
    }
  },
  "playerView": {
  ...
  "legal": {
    ...
    "privacy": {
      ...
      "advertising": {
        ...
        "intro": "אנו מציגים מודעות לא מותאמות אישית באמצעות Google AdSense. מכיוון ש-LexiClash מיועד לשחקנים מכל הגילאים, כולל ילדים, הצגת המודעות שלנו פועלת במצב טיפול בתוכן מכוון לילדים (TFCD) של Google.",
        "googleAdsense": "Google AdSense: כל המודעות המוצגות ב-LexiClash אינן מותאמות אישית. הפעלנו את תגית הטיפול בתוכן מכוון לילדים (TFCD), אשר מונעת התאמה אישית של מודעות, פרסום מבוסס תחומי עניין ושיווק מחדש.",
      ...
      "advertisingPartners": {
        ...
        "yourChoices": {
          ...
          "partnerPolicy": "למד על מדיניות שותפי AdSense",
    ...
    "cookies": {
      ...
      "cookiesWeUse": {
        ...
        "advertising": {
          "title": "עוגיות פרסום",
          "adsense": "Google AdSense — מציג פרסומות כדי לעזור לתמוך במשחק. במצב תוכן מכוון לילדים (TFCD), לא מוגדרות עוגיות פרסום מותאמות אישית",
      ...
      "thirdPartyCookies": {
        ...
        "google": "Google AdSense — להצגת פרסומות לא מותאמות אישית. Google עשויה להשתמש בעוגיות להגבלת תדירות ודיווח. ראו את מדיניות הפרטיות של Google לפרטים.",
    ...
    "about": {
      ...
      "whatMakesUsDifferent": {
        ...
        "education": {
          "title": "שילוב חינוכי",
          "content": "מצב החינוך שלנו מאפשר למורים ליצור שיעורי מילים מותאמים, לשייך אתגרים לתלמידים ולעקוב אחר התקדמות לאורך זמן. כיתות ברחבי העולם משתמשות בלקסיקלאש ככלי למידה משלים שתלמידים באמת נהנים להשתמש בו."
        },
        "design": {
    ...
    "disclaimer": {
      ...
      "advertising": {
        "title": "תוכן פרסומי",
        "content": "לקסיקלאש מציג פרסומות המסופקות על ידי רשתות פרסום של צדדים שלישיים כולל Google AdSense. פרסומות אלו אינן המלצות של לקסיקלאש. תוכן הפרסומות נקבע על ידי רשתות הפרסום על בסיס גורמים שונים ואינו בהכרח משקף את השקפות או ערכי לקסיקלאש. אנו אינם אחראים לדיוק או תוכן הפרסומות המוצגות באתר."
      },
      "liability": {
        "title": "הגבלת אחריות",
  ...
  "landing": {
    ...
    "seo": {
      ...
      "educationTitle": "נבנה ללמידה",
      "educationContent": "משחקי מילים הם אחת הדרכים היעילות ביותר לבניית אוצר מילים ושיפור כתיב. מחקר שפורסם ב-AIMS Neuroscience מראה שחידות מילים מפעילות אזורי מוח מרובים בו-זמנית — כולל אזורים האחראים על עיבוד שפה, זיכרון עבודה ותפקודים ניהוליים. לקסיקלאש לוקח את זה צעד קדימה עם משחק בחמש שפות, מה שהופך אותו לכלי מעשי ללומדי שפה. מורים משתמשים בלקסיקלאש בכיתות בשלוש יבשות כדי להפוך תרגילי אוצר מילים למעניינים. הפורמט הרב-משתתפים יוצר תחרויות בריאה שמניעה תלמידים להרחיב את ידע המילים שלהם באופן טבעי.",
...
"wordHunt": {
      ...
      "desc": "פצחו את המילה החבויה עם רמזי צבע!",
      "feature1": "90 שניות",
  ...
  "adventure": {
    ...
    "prestige": {
      ...
      "cancel": "עדיין לא",
      "ranks": { "bronze": "ארד", "silver": "כסף", "gold": "זהב", "platinum": "פלטינה", "diamond": "יהלום" },
      "titles": { "wordSmith": "צורף מילים", "lexiconAdept": "מומחה לקסיקון", "wordMaster": "אדון המילים", "grandLexicon": "לקסיקון גדול", "eternalWordsmith": "צורף מילים נצחי" },
...
"game": {
    ...
    "collection": {
      ...
      "bossTrophy": { "w1": "גביע שומר היער", "w2": "גביע פרעה המדבר", "w3": "גביע לוויתן האוקיינוס", "w4": "גביע טיטאן ההר", "w5": "גביע נחש הג׳ונגל", "w6": "גביע יטי הטונדרה", "w7": "גביע דרקון הר הגעש", "w8": "גביע גריפון השמיים", "w9": "גביע רוח הצללים", "w10": "גביע השליט הקוסמי" },
      "bossTrophyDesc": { "w1": "ניצחת את שומר היער", "w2": "ניצחת את פרעה המדבר", "w3": "ניצחת את לוויתן האוקיינוס", "w4": "ניצחת את טיטאן ההר", "w5": "ניצחת את נחש הג׳ונגל", "w6": "ניצחת את יטי הטונדרה", "w7": "ניצחת את דרקון הר הגעש", "w8": "ניצחת את גריפון השמיים", "w9": "ניצחת את רוח הצללים", "w10": "ניצחת את השליט הקוסמי" },
      "loreScroll": { "w1": "מגילת היער", "w2": "מגילת המדבר", "w3": "מגילת האוקיינוס", "w4": "מגילת ההר", "w5": "מגילת הג׳ונגל", "w6": "מגילת הטונדרה", "w7": "מגילת הר הגעש", "w8": "מגילת השמיים", "w9": "מגילת הצללים", "w10": "מגילת הקוסמוס" },
      "worldEssence": { "w1": "תמצית היער", "w2": "תמצית המדבר", "w3": "תמצית האוקיינוס", "w4": "תמצית ההר", "w5": "תמצית הג׳ונגל", "w6": "תמצית הטונדרה", "w7": "תמצית הר הגעש", "w8": "תמצית השמיים", "w9": "תמצית הצללים", "w10": "תמצית הקוסמוס" },
      "worldEssenceDesc": { "w1": "רוח היער הקסום", "w2": "הלב הבוער של המדבר", "w3": "טיפה מהאוקיינוס הקדמון", "w4": "הליבה הבלתי שבירה של ההר", "w5": "הדופק הפראי של הג׳ונגל", "w6": "גביש קפוא של חורף נצחי", "w7": "ניצוץ מלב הר הגעש", "w8": "נוצה מהעננים הגבוהים", "w9": "לחישה ממלכות הצללים", "w10": "שבר מהקוסמוס עצמו" },
      "ancientRelic": { "w5": "פסל הג׳ונגל", "w6": "מצפן קפוא", "w7": "מסכת אובסידיאן", "w8": "פעמון רוח", "w9": "מראה צללים", "w10": "מפת כוכבים" },
      "ancientRelicDesc": { "w5": "פסל עתיק ממעמקי הג׳ונגל", "w6": "מצפן שתמיד מצביע למקום הקר ביותר", "w7": "מסכה שנוצרה בלב הר הגעש", "w8": "פעמון שמנגן את שיר הרוח", "w9": "מראה שמשקפת את מה שהיה", "w10": "מפה שמראה נתיבים בין הכוכבים" }
    },
    "later": "אחר כך",
    "nextLevel": "הבא: שלב",
    "play": "שחק",
  ...
  "education": {
    "landing": {
      ...
      "tagline": "איפה שלמידה פוגשת משחק",
      "socialProof": "הצטרפו ל-1000+ כיתות ברחבי העולם שמשפרות את אוצר המילים שלהן יחד!",
      "teacherFeature1": "יצירת רשימות מילים מותאמות",
      "teacherFeature2": "ניהול מספר כיתות",
      "teacherFeature3": "ניתוח ביצועים בזמן אמת",
      "studentFeature1": "הצטרפות לכיתות אינטראקטיביות",
      "studentFeature2": "אתגרי אוצר מילים מהנים",
      "studentFeature3": "טבלאות מובילים שבועיות",
    ...
    "template": {
      ...
      "name": "שם התבנית",
      "namePlaceholder": "לדוגמה: חזרה מהירה",
      ...
      "saved": "התבנית נשמרה!",
      "startGame": "התחל משחק",
      "roomSettings": "הגדרות משחק"
    },
    "practice": {
      "title": "מצב תרגול",
      "flashcards": "כרטיסיות",
      "flashcardsDesc": "סקירת מילים עם כרטיסיות",
      "soloBoard": "תרגול עצמאי",
      "soloBoardDesc": "מצא מילים בקצב שלך",
      "wordList": "רשימת מילים",
      "wordListDesc": "צפה בכל מילות האוצר",
      "warmup": "סבב חימום",
      "warmupDesc": "תרגול עם רמזים",
      "matching": "התאמת מילים",
      "matchingDesc": "גרור והתאם מילים להגדרותיהן",
      "spelling": "אתגר כתיב",
      "spellingDesc": "הקלד את המילה הנכונה מההגדרה שלה",
      "blitz": "בליץ מתוזמן",
      "blitzDesc": "סבב של 60 שניות - כמה תצליח?",
      "gotIt": "ידעתי!",
      "dontKnow": "לא ידעתי",
      ...
      "definition": "הגדרה",
      "tapToFlip": "הקש להפוך",
      "tapCard": "הקש על הכרטיס לראות תשובה",
      ...
      "matchingWords": "מילים",
      "matchingDefinitions": "הגדרות",
      "matchPairs": "התאם את הזוגות",
      "pairsMatched": "זוגות שהותאמו",
      "dragToMatch": "גרור מילה להגדרה שלה",
      "tapToSelect": "הקש על מילה, ואז הקש על ההגדרה שלה",
      "correctMatch": "נכון!",
      "wrongMatch": "נסה שוב",
      "spellTheWord": "איית את המילה",
      "typeTheWord": "הקלד את המילה שמתאימה להגדרה זו",
  ...
  "education": {
    ...
    "achievements": {
      ...
      "featured": "תג מומלץ",
      "locked": "נעול 🔒",
      "maxPinsReached": "הגעת למקסימום הצמדות",
      "maxTier": "דרגה מקסימלית",
      "newBadge": "תג חדש נפתח! 🏅",
      "pin": "הצמד לפרופיל",
      "pinLimit": "בטל הצמדה כדי להצמיד אחר",
      "progress": "{{current}}/{{total}}",
      "secret": "הישג סודי 🤫",
      "secretRemaining": "{{count}} סודות נותרו",
      "tierUpgrade": "עליית דרגה! 🚀",
      "tiers": {
        "bronze": "ארד",
        "gold": "זהב",
        "platinum": "פלטינה",
    ...
    "landing": {
      ...
      "roleStudent": "תלמיד",
      "roleTeacher": "מורה",
      "socialProof": "הצטרפו ל-{{count}} לומדים",
      "student": "תלמיד",
  ...
  "blast": {
    ...
    "words": "מילים",
    "help": "עזרה",
    "stuck": "אין מילים נוספות!",
    "shuffle": "ערבוב",
    "generating": "יוצר לוח...",
    "ready": {
      "title": "מצב בלאסט",
      "subtitle": "נקו את הלוח, שרשרו קומבואים, שרדו את הגלים",
      "play": "שחק"
    },
    ...
    "objective": {
      ...
      "collectType": "אספו {target} {tileType}",
      "clearAllType": "נקו את כל ה-{tileType}",
      "wordLength": "מצאו {target} מילים עם {minWordLength}+ אותיות"
    }
  }
};
