  ...
  "legal": {
    ...
    "privacy": {
      ...
      "advertising": {
        ...
        "intro": "אנו משתמשים בחברות פרסום צד שלישי להצגת מודעות בעת ביקורך באתר שלנו. חברות אלו עשויות להשתמש במידע על הביקורים שלך כדי לספק מודעות על מוצרים ושירותים שעשויים לעניין אותך.",
        "googleAdsense": "Google AdSense: אנו מציגים מודעות באמצעות Google AdSense, אשר עשוי להשתמש בעוגיות ובאותות רשת לאיסוף מידע על התנהגות הגלישה שלך לצורך התאמה אישית של מודעות.",
        "cookies": "עוגיות פרסום: מפרסמי צד שלישי עשויים למקם עוגיות במכשיר שלך כדי לעקוב אחר הגלישה שלך באתרים ולהציג מודעות רלוונטיות.",
        "personalization": "התאמת מודעות: מודעות עשויות להיות מותאמות אישית על בסיס תחומי העניין שלך, היסטוריית הגלישה ומידע דמוגרפי שנאסף על ידי שותפי פרסום.",
        "thirdPartyAccess": "גישת צד שלישי: שותפי פרסום עשויים לגשת לנתונים על הביקור שלך, כולל דפים שנצפו, זמן ששהית ולחיצות על מודעות, בהתאם למדיניות הפרטיות שלהם.",
        "optOut": "תוכל לבטל את ההסכמה לפרסום מותאם אישית על ידי ביקור בהגדרות המודעות של Google בכתובת https://www.google.com/settings/ads או על ידי שימוש בכלי ביטול מסחריים.",
        "learnMore": "למידע נוסף על אופן השימוש של Google בנתונים כשאתה משתמש באתר שלנו, בקר בכתובת https://policies.google.com/technologies/partner-sites"
      },
      "advertisingPartners": {
        "title": "שותפי פרסום",
        "intro": "אנו משתפים פעולה עם רשתות פרסום להצגת מודעות באתר שלנו. שותפים אלה עוזרים לשמור על LexiClash חינמי לכל השחקנים.",
        "howItWorks": {
          "title": "איך הפרסום עובד",
          "cookies": "שותפי פרסום עשויים להשתמש בעוגיות כדי לעקוב אחר פעילות הגלישה שלך באתרים",
          "control": "יש לך שליטה על פרסום מותאם אישית דרך הדפדפן והגדרות המודעות שלך",
          "noSale": "אנחנו לעולם לא מוכרים את המידע האישי שלך למפרסמים",
          "revenue": "הכנסות מפרסום עוזרות לנו לשמור על LexiClash חינמי לשחק",
          "thirdParty": "למפרסמי צד שלישי יש מדיניות פרטיות משלהם"
        },
        "yourChoices": {
          "title": "הבחירות שלך",
          "intro": "יש לך כמה אפשרויות לשלוט באופן שבו הפרסום עובד עבורך:",
          "optOut": "בטל הסכמה לפרסום מותאם אישית",
          "googlePrivacy": "סקור את נהלי הפרטיות של Google",
          "partnerPolicy": "למד על מדיניות שותפי AdSense"
        },
        "important": {
          "title": "חשוב:",
          "content": "גם אם תבטל הסכמה לפרסום מותאם אישית, ייתכן שעדיין תראה מודעות, אך הן לא יתבססו על תחומי העניין שלך. תוכל גם לנהל את העדפות המודעות שלך דרך"
        }
      },
      "cookies": {
