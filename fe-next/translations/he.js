...
const he = {
  "adventurePlay": {
    ...
    "map": {
      ...
      "primerTitle": "איך עובדת ריצה",
      "primerMap": "מטפסים במפה תחנה אחרי תחנה: קרבות, חנויות, מנוחה, תיבות ואירועי ?. הבוס מחכה למעלה.",
      "primerFight": "בקרב, כל מילה שאתם מאייתים פוגעת ביריב. מילה של 5 אותיות ומעלה מרימה מגן. נגמרו הלבבות? הריצה נגמרת.",
      "primerKeep": "שרידים ושיקויים נשארים לכל הריצה ועוברים איתכם לריצה הבאה. את הזהב מוציאים בחנויות; חצי ממה שנשאר בסוף נשמר כמטבעות.",
    ...
    "variety": {
      ...
      "rule": {
        "classic": "צברו מספיק נקודות לפני שהזמן נגמר.",
        "hunt": "מצאו את המילים הנסתרות. האות הראשונה היא הרמז.",
        "chain": "כל מילה חייבת להתחיל באות האחרונה של המילה הקודמת.",
        "fog": "ערפל מכסה את הלוח. רק האותיות ליד המילה האחרונה גלויות.",
        "bomb": "השתמשו באות עם פצצה לפני שהפתיל נגמר, אחרת תפסידו 4 שניות.",
        "elite": "אויב קשוח שמחזיר מכות. הורידו לו את החיים לפני שהזמן נגמר.",
        "boss": "הבוס של העולם. כל מילה היא התקפה, אז תמשיכו להכות ותשרדו."
      },
      "twist": {
        "hunt": "מילים נסתרות! מצאו אותן על הלוח. האות הראשונה היא הרמז.",
        "chain": "שרשרת! כל מילה מתחילה באות האחרונה של המילה הקודמת.",
        "fog": "ערפל! רואים רק את האותיות ליד המילה האחרונה.",
        "bomb": "פצצות! השתמשו באות עם פצצה לפני שהפתיל נגמר, אחרת תפסידו 4 שניות.",
        "long-words": "רק מילים ארוכות: לפחות 4 אותיות.",
        "rush": "מירוץ: רק 60 שניות על השעון.",
        "grand-hunt": "ציד ענק: לוח 6x6 עם יותר מילים למצוא.",
        "ambush": "מארב! אויב עילית קופץ עליכם מוקדם. פחות חיים, אותה נשיכה.",
        "blackout": "האפלה: רק האותיות סביב האות האחרונה במילה נשארות מוארות. לפחות 4 אותיות.",
        "finale": "גמר: מילים של 4+ אותיות ורק 75 שניות."
      },
      "newRule": "חוק חדש",
      "chapterTag": "פרק {world}",
      "chapterGo": "יוצאים לדרך",
      "worldNewRule": "חדש בעולם הזה",
      "threat": "רמת סכנה {threat} מתוך 5",
      "goalScore": "צברו לפחות",
      "goalHunt": "מילים למצוא",
      "goalDamage": "נזק לגרום",
      "secondsShort": "{seconds} שנ׳",
      "eliteName": "עילית {world}",
      "pathLabel": "שלב {level} מתוך {total}",
      "demoLetters": "שלמכבגדהו",
      "huntTitle": "מילים נסתרות",
      "huntCount": "{found}/{need}",
      "huntMasked": "מילה נסתרת: מתחילה ב־{first}, {count} אותיות",
      "chainStart": "כל מילה פותחת את השרשרת",
      "chainNext": "המילה הבאה מתחילה ב־",
      "chainBroken": "השרשרת נשברה! התחילו ב־{letter}",
      "chainLinks": "שרשרת: {count}",
      "fogHelp": "הערפל מתפזר סביב המילה האחרונה",
      "fogThinning": "תקועים? הערפל מתחיל להתפזר…",
      "bombHelp": "השתמשו באותיות עם פצצה לפני שהן מתפוצצות!",
      "bombBoom": "בום −{seconds} שנ׳",
      "bombDefused": "נוטרל!",
      "bombDefusedCount": "{count} נוטרלו",
      "youAreHere": "אתם כאן",
      "pathCleared": "עברתם בריצה הזאת",
      "rampTitle": "רמת קושי",
      "worldRoute": "שלבים: {kinds}"
    },
    "combat": {
      "boss": "בוס",
      "elite": {
      ...
      "ruleTag": "חוק",
      "rule": {
        "w1": "כתבו מילה של 5 אותיות ומעלה בזמן שהבוס מתכונן, והמתקפה תתבטל.",
        "w2": "העוקצים עפים בזוגות. הקישו על שניהם לפני שהם נוחתים.",
        "w3": "קללות שנשארות על הלוח נוגסות 2 לבבות.",
        "w4": "הערבוב מסתיר את הלוח לזמן כפול.",
        "w5": "רק מילים של 6 אותיות ומעלה טוענות את המגן.",
        "w6": "הקפאות תופסות אריח נוסף, והרסיסים עפים בזוגות.",
        "w7": "רק מילה של 6 אותיות ומעלה עוצרת את הבוס הזה.",
        "w8": "הקליעים מגיעים במטחים של שלושה.",
        "w9": "הקפאות וקללות תופסות 2 אריחים נוספים, וקללות נוגסות 2.",
        "w10": "רק 6 אותיות ומעלה עוצרות, קללות נוגסות 2, והקליעים עפים בזוגות."
      },
      "eliteRule": {
        "freeze": "מקפיא לכם אריחים. הקישו עליהם כדי להפשיר.",
        "projectile": "זורק כדורי אש. הקישו עליהם לפני שהם נוחתים.",
        "curse": "מקלל אריחים. נקו אותם בהקשה לפני שהם נוגסים.",
        "shuffle": "מערבב את הלוח. המשיכו לאיית מהזיכרון.",
        "drain": "כל פגיעה שואבת טעינת מגן. הרימו מגן בזמן."
      },
      "move": {
        "hit": "מכה",
        "hit-heavy": "מהלומה כבדה",
        "freeze": "נשימת כפור",
        "freeze-heavy": "הקפאה עמוקה",
        "curse": "קללה",
        "curse-heavy": "קללת מגפה",
        "projectile": "כדור אש",
        "projectile-heavy": "מטח",
        "shuffle": "ערבוב",
        "shuffle-heavy": "ערבוב כאוטי",
        "drain": "יניקה",
        "drain-heavy": "יניקת נשמה"
      },
      "status": {
        "death": "הובסת!",
        "defeated": "ניצחון!",
      ...
      "consequence": {
        "freeze": "{count} אריחים קפאו. הקישו כדי להפשיר!",
        "curse": "{count} אריחים קוללו. הקישו לנקות לפני שהם נושכים!",
        "hit": "-{count} חיים! הרימו מגן בפעם הבאה.",
        "drain": "-{count} חיים ומטען מגן נגנב!",
        "shuffle": "הלוח התערבב. אייתו מהזיכרון!",
        "blocked": "המגן ספג את כל המכה!"
      },
      "incomingIn": "מתקפה · {seconds} שנ׳",
      "nextMove": "המהלך הבא",
      ...
      "shieldUp": "מגן מורם!",
      "raiseShield": "חסמו!",
      "shieldEarn": "{count}+ אותיות = טעינה",
      "shieldAria": "הרמת מגן ({count} טעינות)",
      "skip": "המשך",
      "bossBattle": "קרב בוס!",
      "eliteFight": "קרב עילית!",
      "tapToFight": "הקישו כדי להילחם",
      "phaseTwo": "שלב שני!",
      "enraged": "משתולל!",
      "phaseTaunt1": "החימום נגמר. עכשיו זה רציני!",
      "phaseTaunt2": "די! תרגישו את כל הזעם שלי!",
      "kill": {
        "squashed": "נמעך!",
        "whomped": "חוסל!",
        "crushed": "נרסק!",
        "destroyed": "הושמד!",
        "obliterated": "נמחק מהמפה!",
        "damage": "{points} נזק",
        "overkill": "+{points} נזק עודף",
        "trophy": "שלל: שריד",
        "addedToRun": "נוסף למסע שלך",
        "bossTrophy": "גביע העולם שלך!",
        "bossStars": "כוכבים שהרווחתם"
      },
      "defeat": {
        "slainBy": "הופלת ע״י {move}",
        "hpLeft": "ל{name} נשארו {percent}% חיים",
        "continue": "הקישו כדי להמשיך"
      },
      "bossDefeated": "הבוס הובס!",
      "eliteDefeated": "העילית נפל!",
      "youFell": "נפלתם!",
      "thawTile": "הפשרת אריח קפוא",
      "cleanseTile": "ניקוי אריח מקולל",
      "tap": "הקישו!",
      "deflect": "הסטת הקליע"
    },
    "ledger": {
    ...
    "loot": {
      ...
      "chestTitle": "שלל",
      "newItem": "חדש",
      "continueToDraft": "בחרו פרס",
      "levelsCleared": "שלבים שעברתם",
      "goldEarned": "זהב",
      "bestWord": "המילה הכי טובה",
      "noRelics": "אין שרידים בריצה הזאת",
      "runOver": "הריצה נגמרה",
      "runOverSub": "מפה חדשה מהקומה הראשונה. השרידים והשיקויים באים איתכם, והכוכבים והאוסף נשארים שלכם.",
      "newRun": "ריצה חדשה",
      ...
      "kindHeal": "ריפוי",
      "kindGold": "זהב",
      "healDesc": "מחזירים לבבות עכשיו",
      "goldDesc": "זהב לריצה הזאת",
      "tapCard": "הקישו על קלף כדי לראות מקרוב",
      "take": "לוקחים",
      "currentRun": "ריצה פעילה",
      "runStep": "שלב {step} מתוך {total}",
      "continueRun": "ממשיכים",
      "levelUp": "עלית שלב!",
      "levelUpCleared": "שלב {step} מתוך {total} הושלם",
      ...
      "stackPerLevel": "נק׳ לשלב, לפי המילים בריצה הזאת",
      "contribAria": "{name}: ‎+{n} נקודות בשלב הזה",
      "value": {
        "label": "בריצה הזו",
        "hitsLine": "פוגע ב-{hits} מתוך {total} המילים שלך",
        "synergy": "קומבו",
        "synergyHint": "מתחבר לשריד שכבר יש לך",
        "ptsPerLevel": "נקודות לשלב",
        "goldPerLevel": "זהב לשלב",
        "seconds": "שניות בכל שלב",
        "shield": "מגן בכל קרב",
        "frost": "זמן קללה",
        "revive": "חיים נוספים",
        "longWords": "ריפויים מהמילים הארוכות שלך",
        "fullHints": "רמזים מראים מילה שלמה",
        "hearts": "לבבות",
        "heartsFull": "הלבבות כבר מלאים",
        "goldTo": "זהב",
        "carry": "בתיק שלך",
        "maxHearts": "מקסימום לבבות",
        "hints": "רמזים לשלב",
        "cards": "קלפים בבחירה",
        "noData": "עדיין אין מילים",
        "stackLine": "לבד ← עם השרידים שלך",
        "timePts": "נק׳ לשלב מ-‎+{secs} שנ׳"
      }
    },
    "juice": {
      "nice": "יפה!",
      ...
      "astonishing": "מדהים!",
      "whomped": "חבטה!",
      "newBest": "המילה הארוכה ביותר!",
      "ko": "נוקאאוט!",
      "tooShort": "קצר מדי",
      "notAWord": "לא מילה",
      "alreadyFound": "כבר נמצאה",
      "breaksChain": "שובר את השרשרת",
      "hint": "רמז",
      "hintAria": "רמז, נשארו {count}",
      "foeTag": "יריב",
      "foeHp": "{hp}/{max} חיים",
      "foeDown": "הובס!",
      "foeGoal": "גרמו {max} נזק ל-3 כוכבים"
    },
    "draftTitle": "בחרו פרס",
    "draftSub": "הוא נשאר איתכם עד סוף העולם הזה.",
    "skip": "דלגו",
    "hp": "חיים",
    "gold": "{gold} זהב",
    "shield": "מגן ({count})",
    ...
    "incoming": "התקפה בדרך!",
    "deflect": "הדפו!",
    "huntGoal": "מצאו מילים נסתרות: {count} · נמצאו {found}",
    "chainGoal": "המילה הבאה מתחילה ב־{letter}",
    "eliteLevel": "קרב עילית",
    "eliteGoal": "הנחיתו {hp} נזק תוך {seconds} שניות — הוא מחזיר מכות!",
    "runOver": "הריצה נגמרה — העולם מתחיל מחדש.",
    "offerHeal": "ריפוי {amount} חיים",
    "offerGold": "+{amount} זהב",
    "relic": {
      "sharp-quill": "נוצה חדה",
      "long-bow": "קשת ארוכה",
      ...
      "sage-scroll": "מגילת החכם",
      "iron-bookmark": "סימנייה מברזל",
      "frost-ward": "קמע כפור",
      "vampire-fang": "ניב ערפד",
      "gold-tooth": "שן זהב",
      "lucky-clover": "תלתן מזל",
      "phoenix-feather": "נוצת עוף החול"
    },
    "relicDesc": {
      "sharp-quill": "מילים של 6+ אותיות מקבלות +50%",
      "long-bow": "מילים של 7+ אותיות שוות כפול",
      "short-sword": "מילים של 3 אותיות: +2 נקודות",
      "storm-rune": "מילים של 5 אותיות: +5 נקודות",
      "twin-ink": "המילה הראשונה בכל שלב שווה כפול",
      "echo-stone": "+1 על כל מילה שכבר נמצאה (עד +10)",
      "magnet": "כל המילים +20%",
      "heart-locket": "+1 חיים מקסימליים",
      "hourglass": "+10 שניות בכל שלב",
    ...
    "potionDesc": {
      "heal": "+2 חיים",
      "time": "+15 שניות",
      "cleanse": "מנקה אריחים קפואים ומקוללים ומשתק את האויב",
      "insight": "+2 רמזים"
    },
    "longerWords": "מילים ארוכות יותר",
    "title": "הרפתקה",
    "start": "מתחילים",
    "fight": "להילחם!",
    "goal": "צברו {score} נקודות ב-{seconds} שניות כדי לקבל כוכב ראשון.",
    "bossGoal": "הורידו {hp} נקודות חיים ב-{seconds} שניות. כל מילה פוגעת. היזהרו מאריחים קפואים!",
    "worldLevel": "עולם {world} · שלב {level}",
    "bossLevel": "קרב בוס",
    "saving": "סופרים את המילים…",
    "loading": "מחלקים את הלוח…",
    "loadError": "לא הצלחנו לטעון את השלב.",
    "tryAgain": "לנסות שוב",
    "backToMap": "חזרה למפה",
    "backHome": "בית",
    "next": "הבא",
    ...
    "cleared": "השלב הושלם!",
    "failed": "כמעט!",
    "newItems": "חדש באוסף שלך",
    "skinUnlocked": "עיצוב אריחים חדש נפתח!",
    "equipSkin": "להלביש",
    "equipped": "בשימוש",
    "skinVault": "כספת העיצובים",
    "skinVaultHint": "נצחו את הבוס של כל עולם כדי לזכות באריחים שלו. הם עובדים בכל המצבים.",
    "beatBoss": "לנצח את {boss}",
    "beatPrevBoss": "נצחו את הבוס הקודם",
    "foundWords": "מילים שנמצאו",
    "signInRequired": "התחברו כדי לשחק בהרפתקה",
    "achievements": "הישגים",
    "starsEarned": "{stars} מתוך 3 כוכבים"
  },
  "vocabQuiz": {
    "correctShort": "יש!",
    "lockedInCount": "{locked} מתוך {total} ענו",
    "rank": "מקום {position} מתוך {total}",
    "score": {
      "label": "הניקוד שלך: {score}"
    },
    "mascot": {
      "alt": "לקסי מגיבה לתשובה שלך"
    },
    "sweep": {
      "title": "כל הכיתה!",
      "subtitle": "אף אחד לא פספס."
    },
    "nextUp": {
      "label": "המילה הבאה",
      "finalScores": "הניקוד הסופי!",
      "tease": "המילה הבאה מתחילה ב-{letter} ויש בה {count} אותיות"
    },
    "progress": "שאלה {current} מתוך {total}",
    "timeLeft": "נותרו {seconds} שניות",
    "paused": "המורה עצר/ה את החידון",
    "waiting": "מתכוננים — השאלה הראשונה בדרך.",
    "lockedIn": "התשובה נקלטה. רגע, מחכים לשאר הכיתה.",
    "streak": {
      "label": "{count} ברצף"
    },
    "answers": {
      "label": "בחרו תשובה",
      "option": "{option}",
      "correctOption": "{option} — התשובה הנכונה"
    },
    "focus": {
      "any": "מעורב",
      "definition": "הגדרות",
      "synonym": "מילים נרדפות",
      "antonym": "הפכים",
      "context": "רמזים מההקשר",
      "multiple_meaning": "מילים רב־משמעיות",
      "roots_affixes": "שורשים ותחיליות"
    },
    "feedback": {
      "correct": "יפה! צברתם {points} נקודות",
      "wrong": "כמעט — התשובה הנכונה היא {answer}",
      "noAnswer": "נגמר הזמן — התשובה הנכונה היא {answer}",
      "breakdown": "בסיס {base} · מהירות {speed} · רצף {streak}"
    },
    "standings": {
      "title": "טבלת מובילים",
      "empty": "עוד אין נקודות."
    },
    "finished": {
      "title": "וזהו, סיימנו!",
    ...
    "host": {
      ...
      "waiting": "ממתינים לשאלה הראשונה…"
    },
    "setup": {
      "focusTitle": "על מה נתאמן בחידון?",
      "focusDescription": "ליד כל אפשרות כתוב כמה שאלות אפשר באמת לבנות מהמילים שבחרתם.",
      "questionsAvailable": "{count} שאלות",
      "focusLocked": "חסרים נתונים למילים",
      "noQuestions": "מהמילים האלה עדיין אי אפשר לבנות חידון. הוסיפו הגדרה לארבע מילים לפחות בעורך רשימת המילים, ואז חזרו לכאן.",
      "enrichHint": "האפשרויות המעומעמות דורשות נתונים שעדיין אין ברשימת המילים. הוסיפו מילים נרדפות, הפכים או משפט דוגמה בעורך רשימת המילים כדי לפתוח אותן.",
    ...
    "practice": {
      "title": "מילים לתרגול",
      "stillIn": "אתם עדיין בכיתה. המשחק הבא יחזיר אתכם ישר פנימה.",
      "close": "חזרה לתוצאות שלי"
    }
  },
  "pricing": {
    ...
    "month": "חודש",
    "recommended": "מומלץ",
    "free_1": "עד 50 תלמידים בכיתה",
    "free_2": "עד 3 כיתות",
    "free_3": "מצבי משחק בסיסיים",
    "pro_1": "תלמידים ללא הגבלה בכיתה",
    "pro_2": "כיתות ללא הגבלה",
    "pro_3": "מצבי משחק מתקדמים + מילים משלכם",
    "pro_4": "דוחות התקדמות וניתוח נתונים לתלמידים",
    "current_plan": "התוכנית הנוכחית",
    "sign_up_free": "הרשמה חינם",
  ...
  "crossword": {
    ...
    "prevClue": "רמז קודם",
    "nextClue": "הרמז הבא",
    "noClue": "הקישו על משבצת כדי להתחיל",
    "check": "בדיקה",
    "revealLetter": "אות",
    "revealWord": "מילה",
    "restart": "התחלה מחדש",
  ...
  "wordTowerV2": {
    "gear": {"foundation":"יסודות","craneYard":"מנוף","vault":"עיטורי זהב","insurance":"קורות חיזוק","landmark":"גג המגדל","see":{"foundation":"במגדל: בסיס אבן מתחת לקומת הקרקע. בסיס רחב יותר ופחות נדנוד.","craneYard":"במגדל: מנוף בצבע חדש עם תנופה איטית ונוחה יותר.","vault":"במגדל: עיטורי זהב על הקומות. יותר מטבעות בכל משחק.","insurance":"במגדל: קורות פלדה לאורך הצדדים. חיזוקי חירום בחינם ויותר מגנים.","landmark":"במגדל: גג שגדל מאנטנה ועד כתר זהב. ניקוד גבוה יותר."}},
    "rescue": {"crumbled":"איבדתם {n} קומות! ממשיכים לבנות","counterweight":"משקל נגד! המגדל התייצב","braced":"חיזקתם! הפלדה מחזיקה","craneSaved":"שדרוג העגורן! חלון רחב, נחיתה מושלמת"},
    "brace": {"button":"חיזוק","freeTag":"חינם","explain":"מקבעים את כל הקומות חוץ מהעליונה, והמגדל מפסיק להתנדנד. משלמים במטבעות מהמשחק הזה, או מרוויחים את זה עם מילת הצלה.","useFree":"חיזוק בחינם","buy":"לחזק · {n} מטבעות","poor":"אין מספיק מטבעות במשחק הזה","rescue":"מילת הצלה: {n}+ אותיות","rescueLeft":"נשארו {n} הצלות במשחק","rescueNow":"כתבו מילה של {n}+ אותיות כדי לחזק את המגדל!","cancel":"ביטול ההצלה","short":"קצרה מדי להצלה"},
    "rivals": {
      "rattled": "ניערתם אותם!",
      "rattledBody": "אף קומה לא נפלה — אבל {coins} מטבעות של {name} נשרו בכל זאת.",
      "missed": "החטאה מוחלטת!",
      "scrap": "{coins}+ גרוטאות",
      "banked": "{coins} מטבעות על הניסיון",
      "pickFloor": "בחרו את הקומה שתיעלם.",
      "aimAt": "לכוון אל {word}",
      "floorsDown": "{n} מתוך {total} קומות קרסו",
      "shieldDown": "המגן שלהם נשבר",
      "reclaimed": "החזרתם {coins}",
      "prizeShield": "לשבור את המגן · ‎+{n} מטבעות",
      "prizeLoot": "‎+{n} מטבעות ועוד השלל שלהם",
      "floorOf": "קומה {n} מתוך {total}",
      "wreckFloor": "להרוס את {word}",
      "calledShot": "הוכרז: {word}",
      "title": "מי בנה גבוה יותר?",
      "you": "שלך",
      "someone": "יריב",
      "loading": "מחפשים יריבים…",
      "none": "אין עדיין יריבים בשכונה. תטפסו גבוה יותר ונמצא לכם.",
      "emptyTower": "עוד לא נבנה כלום",
      "wreck": "להרוס",
      "wreckName": "להרוס את המגדל של {name}",
      "district": "רובע {n}",
      "floors": "{n} קומות",
      "charges": "מוכנים להרוס ×{n}",
      "noCharges": "סיימו משחק כדי להרוויח הריסה",
      "target": "המגדל של {name}",
      "taunt": "{name} צוחק על המגדל שלכם. הזמן להחזיר — על המגדל שלו.",
      "tauntRevenge": "{name} התחיל. אתם מסיימים.",
      "revengeCta": "לנקום",
      "revengeName": "להחזיר ל{name}",
      "ledgerThem": "{name} לקח {n}",
      "ledgerYou": "החזרת {n}",
      "ledgerAhead": "אתם {n} מעל {name} עכשיו.",
      "ledgerSquare": "סגרתם חשבון עם {name}. בינתיים.",
      "ledgerShort": "{name} עדיין {n} מעליכם.",
      "ledgerBlocked": "המגן של {name} בלע את הנקמה — החוב הזה נסגר.",
      "revengeBonus": "50%+ נקמה",
      "revengeFree": "בחינם — הם התחילו",
      "revengePill": "נקמה ×{n}",
      "blocked": "המגן חסם!",
      "blockedBody": "המגן של {name} בלע את כל המכה. בכל זאת יצאתם עם משהו.",
      "smashed": "נהרס!",
      "grazed": "רק שריטה!",
      "smashedBody": "{n} קומות ירדו מהמגדל של {name}.",
      "plotDown": "{plot} יצא מכלל פעולה",
      "stole": "גנבתם {coins}",
      "earned": "{coins}+ מטבעות",
      "nothing": "אפילו לא שריטה. {name} ישן טוב הלילה.",
      "pickAnother": "לבחור יריב אחר",
      "back": "חזרה",
      "raidFailed": "הפשיטה לא הצליחה",
      "raidError": "משהו השתבש. נסו שוב.",
      "revengeTitle": "זמן לנקמה",
      "revengeBody": "{name} ריסק לכם את {plot} וברח עם {coins} מטבעות.",
      "revengeBodyBlocked": "{name} ניסה לתקוף — המגן שלכם עמד.",
      "revenge": "נקמה",
      "dismiss": "לא עכשיו",
      "moreRaids": "עוד {n} פשיטות מחכות",
      "guestTitle": "תראו מי עומד מולכם",
      "guestBody": "התחברו כדי להתמודד מול מגדלים אמיתיים, להרוס אותם ולסגור חשבון.",
      "signIn": "התחברות",
      "plot": {
        "foundation": "יסודות",
        "craneYard": "מגרש מנופים",
        "vault": "כספת",
        "insurance": "ביטוח",
        "landmark": "ציון דרך",
        "lot": "מגרש ריק"
    ...
    "streak": { "a11y": "רצף מושלם ×{n}", "toRare": "עוד {n} מושלמים לארגז נדיר", "crate": "ארגז", "meterA11y": "רצף מושלם {n}, משלם ×{mult}. עוד {rare} לארגז נדיר." },
    ...
    "chest": {
      ...
      "skip": "דלג",
      "continue": "אסוף",
      "guest": "התחברו ליריבים ולפשיטות",
      "item": { "shield": "{n} מגן", "brick": "{n} לבנת זהב", "blueprint": "{n} שרטוט" },
      "tease": { "perfects": "עוד {n} הנחתות מושלמות ← סיכוי טוב יותר ל{tier}", "floors": "עוד {n} קומות ← סיכוי טוב יותר ל{tier}" }
    },
    "estate": {
      "art": {
        "bakery": "מאפייה",
        "apartments": "בניין דירות",
        "library": "ספרייה",
        "clocktower": "מגדל השעון",
        "garden": "גן",
        "fishmarket": "שוק הדגים",
        "lighthouse": "מגדלור",
        "boathouse": "בית סירות",
        "warehouse": "מחסן",
        "ferry": "מסוף מעבורת",
      ...
      "need": "חסרים {n} מטבעות",
      "damaged": "ניזוק",
      "progress": "{done}/{total} רמות",
      "coins": "{n} מטבעות",
      "built": "נבנה!",
      "repaired": "תוקן!",
      "guest": "נשמר במכשיר הזה. התחברו כדי לפשוט ולהיפשט.",
      "perksTitle": "הרובע שלכם עובד בשבילכם",
      "perksNone": "בנה את הרובע כדי לייצב את המגדל",
      "newsRaids": "{n} פשיטות עליכם בזמן שלא הייתם",
      "newsAffordable": "{n} שדרוגים אפשריים עכשיו",
      "newsDamaged": "{n} מגרשים צריכים תיקון",
      "newsNone": "הכול שקט ברובע",
      "completeTitle": "{name} הושלם!",
      "completeSub": "חמישה מבנים, רובע שלם.",
      "completeNext": "{name} נפתח",
      "completeCta": "פתח את {name}",
      "reward": "+{coins} מטבעות, +1 שרטוט, +1 מגן",
      "shields": "מגנים",
      "bricks": "לבני זהב",
      "blueprints": "שרטוטים",
      "perkLine": {
        "foundation": "המגדל מתנדנד ב-{n}% פחות",
        "craneYard": "חלון המושלם רחב ב-{n}%",
        "vault": "+{n}% מטבעות למשחק",
        "insurance": "+{n} מקומות למגן",
        "landmark": "+{n}% ניקוד",
      },
      "chip": {
        "foundation": "{n}% יציב יותר",
        "craneYard": "{n}% מושלם רחב",
        "vault": "+{n}% מטבעות",
        "insurance": "+{n} מגנים",
        "landmark": "+{n}% ניקוד",
      },
      "district": {
        ...
        "market-row": "רחוב השוק",
        "garden-heights": "גבעת הגנים",
        "rail-yard": "מסילות",
        "neon-strip": "רצועת הניאון",
        "harbor-lights": "אורות הנמל",
        "glass-quarter": "רובע הזכוכית",
        "sky-gardens": "גני שמיים",
        "summit": "הפסגה",
      },
      "building": {
        "pier-footings": "יסודות המזח",
        "dock-crane": "מנוף הנמל",
        "fish-market": "שוק הדגים",
        "lighthouse": "המגדלור",
        "ferry-terminal": "תחנת המעבורת",
        "stone-cellar": "מרתף האבן",
        "timber-hoist": "מנוף העץ",
        "guild-bank": "בנק הגילדה",
        "watch-house": "בית המשמר",
        "clock-tower": "מגדל השעון",
        "brick-arcade": "שדרת הלבנים",
        "cargo-lift": "מעלית מטען",
        "bazaar": "הבזאר",
        "fire-station": "תחנת הכיבוי",
        "grand-bazaar-dome": "כיפת הבזאר",
        "terrace-walls": "קירות הטרסה",
        "garden-crane": "מנוף הגן",
        "greenhouse-bank": "בנק החממה",
        "rain-shelter": "מחסה הגשם",
        "botanic-spire": "צריח בוטני",
        "rail-bed": "מצע המסילה",
        "gantry-crane": "מנוף הגשר",
        "freight-depot": "מסוף המטען",
        "signal-box": "תא האיתות",
        "central-station": "התחנה המרכזית",
        "steel-piles": "כלונסאות פלדה",
        "neon-rig": "מתקן ניאון",
        "arcade-vault": "כספת הארקייד",
        "security-hub": "מרכז האבטחה",
        "neon-tower": "מגדל הניאון",
        "sea-wall": "חומת הים",
        "container-crane": "מנוף מכולות",
        "customs-house": "בית המכס",
        "coast-guard": "משמר החופים",
        "harbor-bridge": "גשר הנמל",
        "deep-caissons": "כלונסאות עומק",
        "tower-crane": "מנוף הצריח",
        "trading-floor": "רצפת המסחר",
        "insurance-tower": "מגדל הביטוח",
        "glass-pyramid": "פירמידת הזכוכית",
        "sky-anchors": "עוגני שמיים",
        "sky-hoist": "מנוף שמיים",
        "cloud-bank": "בנק העננים",
        "storm-shield": "מגן הסופה",
        "hanging-gardens": "הגנים התלויים",
        "bedrock-core": "ליבת הסלע",
        "summit-crane": "מנוף הפסגה",
        "golden-vault": "הכספת הזהובה",
        "aegis-dome": "כיפת המגן",
        "word-spire": "צריח המילים",
      },
    },
    "unitM": "מ'",
    "tenants": "{n} דיירים",
    "wreck": {
      "floorDown": "קומה אחת פחות",
      "directHit": "פגיעה ישירה!",
      "floorsDown": "{n}- קומות",
    ...
    "collapsed": "המגדל קרס!",
    "newBest": "שיא חדש!",
    "hud": {"floor": "קומה", "floorA11y": "קומה {n}, {m} מטר", "effect": "{name}: נשארו {n}", "exit": "לסיים ולאסוף"},
    ...
    "newSky": "שמיים חדשים",
    "call": {"perfect": {"0": "מושלם!", "1": "בול!", "2": "בדיוק!", "3": "ללא רבב!"}, "good": {"0": "יפה!", "1": "סולידי!", "2": "נקי!", "3": "חלק!"}, "sloppy": {"0": "מתנדנד…", "1": "היה קרוב!", "2": "מחזיק מעמד!"}, "miss": {"0": "אופס!", "1": "אוי!", "2": "נופל!"}, "combo": {"double": "כפול!", "triple": "משולש!", "quad": "מרובע!", "unstoppable": "בלתי ניתן לעצירה ×{n}", "legendary": "אגדי ×{n}"}, "word": {"big": "מילה גדולה!", "mega": "מגה מילה!"}},
    "reward": {"crate": "ארגז!", "steady": {"name": "מנוף יציב", "desc": "3 הקומות הבאות מתנדנדות לאט יותר"}, "plumb": {"name": "אנך", "desc": "2 הקומות הבאות נופלות ישר למטה"}, "wide": {"name": "מטען רחב", "desc": "הקומה הבאה תיבנה רחבה יותר"}, "rebar": {"name": "מוטות פלדה", "desc": "הקומות התחתונות רותכו — הן לא יכולות ליפול"}, "scramble": {"name": "אותיות חדשות", "desc": "‎+2 ערבובים"}, "jackpot": {"name": "ג׳קפוט", "desc": "נקודות בונוס!"}},
    "ach": {"unlocked": "תג נפתח", "groundbreaker": {"name": "פורץ דרך", "desc": "הניחו את הקומה הראשונה"}, "fiveStory": {"name": "בניין חמש קומות", "desc": "בנו 5 קומות במשחק אחד"}, "highRise": {"name": "רב־קומות", "desc": "בנו 10 קומות במשחק אחד"}, "skyscraper": {"name": "גורד שחקים", "desc": "בנו 20 קומות במשחק אחד"}, "megatower": {"name": "מגה־מגדל", "desc": "בנו 30 קומות במשחק אחד"}, "steadyHands": {"name": "יד יציבה", "desc": "3 הנחות מושלמות ברצף"}, "surgeon": {"name": "מנתח", "desc": "6 הנחות מושלמות ברצף"}, "flawless": {"name": "ללא רבב", "desc": "10 הנחות מושלמות ברצף"}, "perfectionist": {"name": "פרפקציוניסט", "desc": "15 הנחות מושלמות במשחק אחד"}, "wordsmith": {"name": "אמן מילים", "desc": "הרימו מילה בת 6 אותיות"}, "lexicon": {"name": "מילון מהלך", "desc": "הרימו מילה בת 8 אותיות"}, "fullHouse": {"name": "בית מלא", "desc": "50 דיירים במשחק אחד"}, "cityPlanner": {"name": "מתכנן ערים", "desc": "150 דיירים במשחק אחד"}, "lucky": {"name": "רצף מזל", "desc": "פתחו 5 ארגזים במשחק אחד"}, "welder": {"name": "רתך", "desc": "חיזקתם את המגדל במוטות פלדה"}, "sunsetView": {"name": "נוף לשקיעה", "desc": "טפסו אל שמי השקיעה"}, "aboveClouds": {"name": "מעל העננים", "desc": "טפסו מעבר לעננים"}, "orbiter": {"name": "במסלול", "desc": "בנו עד המסלול בחלל"}},
    "results": {
        "home": "לדף הבית",
        "close": "סגירה","floorsA11y": "הגעתם לקומה {n}", "combo": "רצף שיא", "tenants": "דיירים", "crates": "ארגזים", "badges": "תגים שהושגו", "nextGoal": "היעד הבא"},
    "hint": {"spell": "אייתו מילה כדי לבנות את הקומה הבאה", "drop": "הקישו להפלה כשהקומה מעל המגדל"},
    "changeWord": "החלף מילה",
    "editHint": "הקישו על אות שבחרתם כדי לערוך את המילה",
    "bestFlag": "שיא",
  ...
  "wordTower": {
    ...
    "skin": {
      ...
      "cobalt": {
        "name": "קובלט",
        "blurb": "פלדה כחולה, מחושלת לעומק."
      },
      "crimson": {
        "name": "ארגמן",
        "blurb": "פלדת אודם, מחושלת באדום."
      },
      "aurora": {
        "name": "זוהר קוטבי",
  ...
  "seo": {
    "teacherUpgrade": {
      "title": "Teacher Pro — כיתות ותלמידים ללא הגבלה | LexiClash",
      "description": "שדרגו ל-Teacher Pro לכיתות ותלמידים ללא הגבלה בכל כיתה. $9 לחודש. נהלו את כל תוכנית אוצר המילים של בית הספר במנוי אחד.",
      "ogTitle": "שדרוג ל-Teacher Pro — כיתות ללא הגבלה",
      "ogDescription": "נהלו כיתות ותלמידים ללא הגבלה ב-$9 לחודש. הרחיבו את הוראת אוצר המילים עם LexiClash Pro."
    },
    ...
    "daily": {
      "title": "המילה היומית & מילת היום — פאזל מילים חינמי, ללא הרשמה | LexiClash",
      "description": "מחפשים מילת היום בעברית? המילה היומית ומילה יומית — חינם, ללא הרשמה. 10 ניסיונות לנחש, אותו לוח לכולם. שתפו, בנו רצף.",
      "ogTitle": "המילה היומית & מילת היום — חינם, ללא הרשמה | LexiClash",
      "ogDescription": "מחפשים מילה יומית בעברית? פאזל המילה היומית — 10 ניסיונות, אותו לוח לכולם, חינם לגמרי. שתפו, בנו רצף!"
    },
    "multiplayer": {
    ...
    "educationHub": {
      ...
      "description": "משחקי מילים ואוצר מילים חינמיים לכיתה — בלי חשבונות לתלמידים, בלי פרסומות, בלי הורדות. הביאו רשימות מילים משלכם, שחקו רב-משתתפים לכל הכיתה, ב-6 שפות.",
      "ogTitle": "משחקי אוצר מילים חינמיים לכיתה",
      "ogDescription": "בלי חשבונות לתלמידים, בלי פרסומות — רשימות מילים משלכם ומשחקי מילים לכל הכיתה ב-6 שפות."
    },
    "educationDuels": {
    ...
    "wordCraft": {
      "title": "וורדקראפט - משחק אסטרטגיה של בניית מילים חינמי",
      "description": "שחקו וורדקראפט חינם - בנו מילים על לוח, תפסו שטח והשתלטו על יריבים. מרוצי כרטיסים, ציד אבנים, משחקים בחברים. ללא הורדה, ללא הרשמה.",
      "ogTitle": "וורדקראפט - בנו מילים, תפסו שטח, ניצחו",
      "ogDescription": "משחק אסטרטגיה של בניית מילים עם טוויסט של שליטה בשטח. חינם, מיידי, ללא הורדה. מרוצי כרטיסים וציד אבנים."
    }
  },
  "cookieConsent": {
    "title": "בא לכם עוגייה? 🍪",
    "mascotAlt": "הקמע של LexiClash זולל עוגייה בהנאה",
    "message": "הקמע שלנו כבר חוטף ביסים. אנחנו משתמשים בעוגיות לאנליטיקה ולהצגת פרסומות שבאמת מתאימות — אשרו הכול ונצא לשחק. מעדיפים לבחור? אפשר להתאים למטה.",
    "accept": "אישור הכל",
    "decline": "דחיית הכל",
  ...
  "hiddenAchievement": {
    "unlockedBanner": "סוד נחשף!",
    "board_sweep": {
      "title": "סריקה מושלמת",
      "desc": "עברת על כל המשבצות בלוח במשיכה אחת!"
    },
    "palindrome": {
      "title": "מילה בראי",
      "desc": "מצאת מילה שנקראת אותו דבר משני הכיוונים."
    },
    "speed_demon": {
      "title": "שד המהירות",
      "desc": "חמש מילים בעשר השניות הראשונות. ברק!"
    },
    "triple_threat": {
      "title": "שלישייה מנצחת",
      "desc": "מילה אחת, אותה אות שלוש פעמים."
    }
  },
  "easterEgg": {
  ...
  "share": {
    ...
    "emojiCard": {
      ...
      "connectionsHeader": "LexiClash גשר מילים · {date}",
      "bridges": "גשרים",
      "share": "שתף",
      "copy": "העתק",
  ...
  "errors": {
    ...
    "tooManyAttempts": "רגע, לאט! חכו שנייה ונסו שוב",
  ...
  "avatar": {
    "nudge": {
      "title": "תנו לדמות שלכם נגיעה אישית",
      "body": "בחרו צבעים וסטייל משלכם — לוקח רגע.",
      "cta": "להתאמה אישית",
      "dismiss": "לא עכשיו"
    },
    "dailyPart": {
  ...
  "multiplayerFlow": {
    ...
    "rateLimited": "לאט לאט!",
    "crazyGamesFriends": "שחקו עם חברים ב־CrazyGames",
    "roomList": {
...
"createForm": {
  ...
  "playerView": {
    ...
    "autoStartingSoon": "כולם מוכנים! מתחילים בעוד {seconds}…",
    "readyUp": "מוכן!",
    "readyConfirmed": "מוכן!",
    "editName": "שנה שם",
  ...
  "onboarding": {
    ...
    "quickStart": {
      "play": "שחק",
      "playSub": "משחק זריז של דקה-שתיים · בלי הרשמה",
      "howToPlay": "איך משחקים",
      "haveAccount": "יש לי חשבון"
    },
    "style": {
      "title": "בחרו את הסגנון שלכם",
      "subtitle": "בחרו אווירה למוזיקה ולצבעים. אפשר לשנות בכל עת בהגדרות.",
      "confirm": "יאללה מתחילים!",
      "skip": "אולי אחר כך"
    },
    "header": "מדריך מהיר",
    "loading": "טוען...",
    ...
    "crazygames": {
      ...
      "title": "אייתו.",
      "titleAccent": "נצחו.",
      "howTo": "הקישו על אותיות צמודות וצרו מילים. מילים ארוכות = יותר נקודות. אתגר יומי ומולטיפלייר חי בשש שפות.",
      "playDaily": "אתגר יומי",
      "playPractice": "אימון",
  ...
  "results": {
    ...
    "streakIgnition": {
      ...
      "body": "שיחקת היום. חזור מחר כדי לשמור על הלהבה — פספסת יום, והיא כבתה.",
      "bodyLost": "נצח משחק אחד והרצף שלך מתחיל. אתה קרוב יותר ממה שאתה חושב.",
      "day": "יום {n}"
    },
    "tomorrowCard": {
      "title": "מחר: אתגר יומי חדש",
      "countdown": "פאזל חדש בעוד {time}"
    },
    "saveStreak": {
      "title": "שמור את הרצף שלי",
      "body": "רצפים חיים על המכשיר הזה. צור חשבון חינם כדי לשמור אותם בכל מקום."
    },
    "mpGapNudge": "רק {gap} נקודות מאחור — קח את הסיבוב הבא!",
    "rivals": {
      "aria": "אתה מול היריבים",
      "header": "ראש בראש",
      "headerWon": "ניקית את השולחן!",
      "of": "מתוך",
      "you": "אתה",
      "aheadBy": "עוד {n} ותפסת",
      "youBeatBy": "{n} נק' מאחוריך",
      "tie": "תיקו",
    ...
    "crownDesc": {
      "sniper": "הכי הרבה נקודות למילה. כירורגי.",
      "speedDemon": "מצא יותר מילים מכולם.",
      "explorer": "חפר מילים שאף אחד לא ראה.",
      "scholar": "המילים הכי ארוכות בממוצע. ראוותן.",
      "clutch": "הפיל את המילה הכי גדולה.",
      "tank": "לא פספס פעימה. יציב כמו סלע."
    },
    ...
    "wordsFound": "מילים שנמצאו",
    "score": "ניקוד",
    "matchResults": "הפודיום",
    "ordinal1": "מקום ראשון",
    "ordinal2": "מקום שני",
    "ordinal3": "מקום שלישי",
    "ordinal4": "מקום רביעי",
    "ordinalN": "מקום {n}",
    "soClose": "כואב כמה שקרוב — {points} נק' מהכתר.",
  ...
  "tutorial": {
    ...
    "wordHunt": {
      ...
      "step2ImageAlt": "הקמע המוכתר חוגג: שורת אריחים ארוכה מנצלת ניסיון, ושורה קצרה מקפיצה לב שמעניק חיים בחינם",
    ...
    "about": {
      ...
      "whatMakesUsDifferent": {
        ...
        "multilingual": {
          ...
          "content": "אנחנו תומכים ב-6 שפות כולל עברית עם תמיכה מלאה בפריסה מימין לשמאל. כל מצב משחק, כל רכיב ממשק וכל פיסת משוב עובדים בצורה מושלמת בכל השפות הנתמכות. שחקנים יכולים להחליף שפות מיידית ואף לתרגל אוצר מילים בשפות שונות."
        },
        "education": {
          "title": "מובנה לכיתה",
  ...
  "wordMastery": {
    "title": "שליטה במילים",
    "subtitle": "מילים שכבר שלטת בהן — ואלה שעדיין באימון.",
    "mastered": "נשלטו",
    "learning": "באימון",
    "emptyMastered": "עדיין אין מילים נשלטות. מצאו מילים מהר, בלי רמזים.",
    "emptyLearning": "עדיין אין מילים באימון. פסילות ורמזים יופיעו כאן.",
    "emptyAll": "שחקו כמה סיבובים ונתחיל לעקוב אחרי המילים שאתם מוצאים.",
    "practiceCta": "תרגלו את אלה",
    "practiceHint": "סיבוב מותאם עם המילים החלשות ביותר שלכם.",
    "signIn": "התחברו כדי לראות את שליטת המילים שלכם.",
    "gated": "שליטת מילים עדיין בהשקה. כדאי לחזור בקרוב.",
    "error": "לא הצלחנו לטעון את שליטת המילים. נסו שוב.",
    "count": "{count} מילים"
  },
  "playerProfile": {
    "title": "פרופיל שחקן",
  ...
  "landing": {
    ...
    "classroomHeroTitle": "משחקי מילים לכיתה שלכם",
    "classroomHeroSubtitle": "בלי התחברות לתלמידים. משתפים קוד בן 6 תווים. כל הכיתה משחקת בחינם.",
    "forTeachers": "למורים",
    ...
    "seo": {
      ...
      "whatIsContent": "לקסיקלאש הוא משחק מילים מרובה משתתפים חינמי ומהיר שאפשר לשחק ישירות בדפדפן. התחרו עם חברים בזמן אמת על לוח אותיות משותף — מצאו מילים, בנו קומבו וטפסו בטבלת המובילים. זה כמו בוגל וסקראבל, אבל מרובה משתתפים. ללא הורדות, ללא הרשמה. זמין בעברית, אנגלית, שוודית, יפנית, ספרדית ורוסית.",
      ...
      "feature4Title": "6 שפות",
      "feature4Desc": "שחקו בעברית, אנגלית, שוודית, יפנית, ספרדית או רוסית. החליפו בכל זמן ואתגרו חברים בין שפות.",
      ...
      "faq3A": "לקסיקלאש תומך באנגלית, עברית, שוודית, יפנית, ספרדית ורוסית. לכל שפה יש מילון מותאם, אתגרים יומיים וטבלאות מובילים. אפשר להחליף שפה בכל עת מתפריט ההגדרות.",
      ...
      "communityContent": "שחקני לקסיקלאש מגיעים מיותר מ-40 מדינות ושש שפות. הצטרפו לקהילה כדי להתחרות בטבלאות מובילים גלובליות, לשתף תוצאות אתגר יומי ולגלות אסטרטגיות מילים חדשות. עקבו אחרינו באינסטגרם @lexi.clash לטיפים, עדכונים ואירועי קהילה.",
      "showcase3d": {
        "title": "לקסיקלאש — עולם של מילים | משחק מילים מרובה משחקנים חינמי",
        "description": "גללו לעולם של מילים: גררו מילים על הלוח, שרשרו קומבו, הביסו את החדר בקרבות 1v3 בזמן אמת, וקחו את הכתר. חינם, מבוסס דפדפן, 6 שפות - ללא הורדה."
      }
    },
    "firstTimer": {
  ...
  "practice": {
    ...
    "helper": {
      "nudge": "גררו על האותיות כדי לאיית מילה",
      "reveal": "תקועים? התחילו מהמשבצת הזוהרת"
    },
    "riddle": {
      "answerHint": "מצאו את המילה הזו בלוח",
      "label": "חידה",
      "solved": "פתרתם את החידה!"
    },
    "coach": {
      "dismiss": "סגור",
      "label": "מאמן"
  ...
  "daily": {
    ...
    "chaseChasing": "{points} נקודות מאחורי {name}",
    "chaseChasingCta": "מילה טובה אחת ואתם עוקפים",
    "chaseLeading": "אתם מובילים על {name} ב-{points}",
    "chaseLeadingCta": "שמרו על המקום הראשון",
    "chaseRank": "{rank} מתוך {total}",
    "chaseChasingNoGap": "{name} הבא בתור",
    "chaseLeadingNoGap": "{name} ממש מאחוריכם",
  ...
  "wordWheel": {
    ...
    "results": {
      ...
      "nextUpBadge": "הבא בתור",
      "playConnectionsTitle": "הבא בתור: גשר מילים",
      "playConnectionsDesc": "פתרו את חידת גשר המילים של היום כדי להשלים את הסט היומי",
    ...
    "signup": {
      ...
      "rankLeaderTitle": "אתם במקום הראשון היום — קבעו את הבכורה!",
      "rankPodiumTitle": "אתם במקום ה-{rank} היום — שמרו על הפודיום!",
  ...
  "wordHunt": {
    ...
    "mp": {
      "quality": {
        "degraded": "חיבור התדרדר",
        "weak": "חיבור חלש",
        "reconnecting": "מתחברים…"
      },
      "reconnect": {
        "title": "מתחברים…",
        "attempt": "ניסיון",
      ...
      "abort": {
        "title": "המשחק הסתיים",
        "body": "המילים שלכם נספרו לתוצאה הסופית. מילים שמצאתם:",
        "continueSolo": "המשיכו לבד",
    ...
    "survival": {
      ...
      "findWordsToReveal": "טייל מילים על הלוח כדי לחשוף את האותיות האלה",
    ...
    "results": {
      ...
      "newPersonalBest": "שיא אישי חדש!",
      "vsYourBest": "{delta} מול השיא שלך",
      "firstDailyPlay": "משחק הצייד־מילים הראשון שלך היום — התחלה נהדרת!",
      "flourishOnFire": "על האש!",
      "flourishNailedIt": "קלעת בול!",
      "flourishSolidRun": "משחק יציב!",
    ...
    "leaderboard": {
      ...
      "myLanguage": "השפה שלי",
      "countries": "{count} מדינות",
      "countrySingular": "מדינה אחת",
      "live": "חי",
      "movedUp": "עלה {count}",
      "movedDown": "ירד {count}",
      "newEntry": "חדש",
      "seasonPts": "נק׳ עונה",
      "daysPlayed": "{count} ימים",
      "dayPlayed": "יום אחד",
      "seasonNoPlayers": "עדיין אין ניקוד עונתי — החידה של היום היא הצעד הראשון",
      "seasonEndsIn": "מסתיימת בעוד {days} ימים ו-{hours} שעות",
      "seasonEnded": "העונה הסתיימה",
      "seasonHint": "כל אתגר יומי שמשחקים מצטבר לניקוד העונה",
      "currentSeason": "עכשיו",
      "seasonPicker": "בחירת עונה",
      "languageScope": "סינון לפי שפה"
    },
    "shareMessage": {
  ...
  "newsletter": {
    "title": "קבלו את גלגל המילים היומי ישירות למייל"
  },
  "pwa": {
  ...
  "bugReport": {
    ...
    "fabLabel": "שליחת משוב",
    "titleFeature": "יש לך רעיון?",
    "titleGeneral": "דברו איתנו",
    "typeLabel": "סוג המשוב",
    "typeBug": "באג",
    "typeFeature": "רעיון לפיצ'ר",
    "typeGeneral": "כללי",
    "whatFeature": "מה נבנה?",
    "placeholderFeature": "תארו את הפיצ'ר — איך הוא יעזור לך במשחק?",
    "attachScreenshot": "צרף צילום מסך",
    "capturingScreenshot": "מצלם…",
    "removeScreenshot": "הסר",
    "screenshotAttached": "צילום מסך צורף",
    "screenshotFailed": "הצילום נכשל",
    "viewport": "חלון תצוגה",
    "screen": "מסך",
    "connection": "רשת"
  },
  "brain": {
    ...
    "insights": {
      "title": "הזיכרון שלך השבוע",
      "memoryUp": "הזיכרון שלך חד ב-{pct}% יותר מהשבוע שעבר 🧠",
      "wordsUp": "אתם זוכרים {n} מילים יותר בכל סבב מהשבוע שעבר",
      "firstWeek": "השבוע הראשון נרשם! חזרו לשחק בשבוע הבא כדי לראות התקדמות.",
      "comeback": "קצת מתחת לשבוע שעבר — סבב מהיר יחזיר אתכם.",
      "steady": "שומרים על יציבות — המשיכו את הרצף!",
      "memoryScore": "ציון זיכרון: {score}"
    },
    "nav": {
      "profile": "פרופיל",
      "home": "בית",
    ...
    "playAgain": "שחק שוב",
    "briefing": {
      "missionLabel": "המשימה שלך",
      "goalLabel": "הסיבוב הזה",
      "benefitLabel": "למה זה עוזר",
      "howToLabel": "איך משחקים",
      "coachLabel": "טיפ מאמן",
      "letsTrain": "בואו נתרגל!",
      "participationLabel": "הופעה",
      "performanceLabel": "המשחק שלך",
      "bonusLabel": "בונוס"
    },
    "drills": {
      ...
      "lightning-round": {
        ...
        "persona": "זאפ",
        "mission": "מצא כמה שיותר מילים לפני שייגמר הזמן.",
        "benefit": "ככל שתשחק מהר יותר, מילים יעלו לך לראש מהר יותר.",
        "coachTip": "גם מילים קצרות נחשבות — כוון לכמות, מהירות חשובה יותר מדיוק.",
        "step1": "הקש או החלק על האותיות כדי לבנות מילה.",
        "step2": "שלח אותה והמשך לחפש — המהירות היא הכול.",
        "step3": "צבור כמה שיותר מילים לפני שייגמר הזמן."
      },
      "memory-hunt": {
        "name": "ציד זיכרון",
        ...
        "readyToStart": "מוכן!",
        "persona": "הד",
        "mission": "שנן את המילים המודגשות, ואז מצא אותן שוב מהזיכרון.",
        "benefit": "הזיכרון לטווח קצר שלך מתחדד בכל סיבוב.",
        "coachTip": "לחש את המילים לעצמך תוך כדי השינון — ככה הן נצרבות טוב יותר.",
        "step1": "שנן את המילים המודגשות כל עוד הן מוצגות.",
        "step2": "הלוח מתאפס וההדגשה נעלמת.",
        "step3": "מצא את אותן מילים מהזיכרון."
      },
      "combo-master": {
        "name": "אלוף הקומבו",
        "description": "שמור על רצפי קומבו בלי הפסקות",
        "targetCombo": "יעד: קומבו x{combo}",
        "timerPerWord": "טיימר: {time} שנ' למילה",
        "persona": "להבה",
        "mission": "שרשר מילים זו אחר זו לפני שייגמר הטיימר של כל מילה.",
        "benefit": "אתה משתפר ביכולת להישאר מרוכז תחת לחץ.",
        "coachTip": "שמור על עיניים נעות — אתר את המילה הבאה עוד לפני ששלחת.",
        "step1": "מצא מילה כדי להתחיל את הרצף.",
        "step2": "כל מילה שתמצא מאפסת את הטיימר — היה מהיר.",
        "step3": "שמור על הרצף כדי להגדיל את הקומבו."
      },
      "pattern-switcher": {
        "name": "מחליף דפוסים",
        "description": "מצא מילים ברצפי אורך נדרשים",
        "persona": "שיפט",
        "mission": "מצא מילה באורך הנדרש — היעד משתנה כל הזמן.",
        "benefit": "המוח שלך לומד להחליף כללים מהר יותר תוך כדי משחק.",
        "coachTip": "בדוק קודם את אורך היעד, ואז סרוק — אל תיתקע על רעיון אחד.",
        "step1": "בדוק מה אורך המילה הנדרש.",
        "step2": "מצא מילה בדיוק באורך הזה.",
        "step3": "היעד משתנה — התאם ונסה שוב."
      },
      "rare-gems": {
        "name": "אבנים נדירות",
        "description": "מלא את שק האבנים — ככל שהמילה ארוכה יותר, האבן נדירה יותר",
        "persona": "ניצוץ",
        "mission": "צוד מילים ארוכות ונדירות יותר — מילה גדולה יותר היא אבן גדולה יותר.",
        "benefit": "אתה מתחיל לשים לב ולהשתמש במילים עשירות יותר ביומיום.",
        "coachTip": "כוון למילים של 5 אותיות ומעלה — הן ממלאות את השק הרבה יותר מהר.",
        "step1": "מצא מילים מוסתרות בלוח.",
        "step2": "מילים ארוכות יותר מפילות אבנים נדירות וזוהרות יותר.",
        "step3": "מלא את השק לפני שייגמר הזמן."
      },
      "locked": "נעול",
    ...
    "tips": {
      "tip1": "שלושה שבועות אימון מילים = חשיבה מהירה ב-15%.",
      "tip2": "תשבצים מנצחים אפליקציות מוח בשמירה על הזיכרון — דיוק עקבו 78 שבועות.",
      "tip3": "קצת משחק במילים מעלה את כימיקל הריכוז ב-2.3%.",
      "tip4": "16 מחקרים, מסקנה אחת: אימון מוח עובד.",
      "tip5": "כמעט חצי מבריאות המוח תלוי בך. תשמור עליו פעיל.",
      "source1": "NIH",
      "source2": "אוניברסיטת דיוק",
      "source3": "מחקר כימיית המוח",
      "source4": "מטא-אנליזה NIH",
  ...
  "admin": {
    "teacherPro": {
      "title": "להעניק Teacher Pro במתנה",
      "subtitle": "מעניקים למורה Pro לפי אימייל — בלי כרטיס, בלי ניסיון, בלי שום דבר לממש.",
      "form": {
        "email": "אימייל המורה",
        "fullName": "שם (לא חובה)",
        "fullNameHint": "השאירו ריק כדי להשתמש בשם מבקשת הגישה או מהפרופיל",
        "duration": "לכמה זמן",
        "until": "בתוקף עד {date}",
        "locale": "שפת האימייל",
        "note": "הערה אישית (לא חובה)",
        "noteHint": "שורה או שתיים כנות. נכנס לאימייל בדיוק כפי שנכתב.",
        "reason": "סיבה פנימית (לא חובה)",
        "reasonHint": "למשל: שיעור שנהרס ב-4.9.2026 — לא נשלח במייל",
        "submit": "להעניק Pro ולשלוח אימייל",
        "submitting": "מעניק…",
        "preview": "תצוגה מקדימה של האימייל",
        "previewTitle": "תצוגה מקדימה",
        "help": "Pro מופעל מיד. אם עדיין אין חשבון עם האימייל הזה, הוא יופעל בהתחברות הראשונה.",
        "days": {
          "30": "30 יום",
          "90": "3 חודשים",
          "180": "6 חודשים",
      ...
      "result": {
        "toast": "Pro הוענק",
        "active": "בוצע — {email} ב-Teacher Pro עד {date}.",
        "pending_signup": "שמור — ל-{email} עדיין אין חשבון. Pro יופעל ברגע ההתחברות עם הכתובת הזו (עד {date}).",
        "emailSent": "אימייל המתנה נשלח.",
        "emailFailed": "ההענקה פעילה, אבל האימייל לא נשלח — כתבו להם ידנית."
      },
      "error": {
        "already_paid": "המורה הזה כבר משלם על Pro. שום דבר לא השתנה — טפלו בזיכויים ב-Polar.",
        "invalid_email": "זו לא כתובת אימייל תקינה.",
        "generic": "לא ניתן להעניק Pro:"
      },
      "status": {
        "active": "פעיל",
      ...
      "list": {
        ...
        "refresh": "רענון",
        "loading": "טוען…",
        "empty": "עדיין אין הענקות.",
        "loadError": "לא ניתן לטעון את ההענקות.",
        "col": {
          "teacher": "מורה",
          "status": "סטטוס",
          "until": "עד",
        ...
        "sent": "נשלח",
        "notSent": "לא נשלח",
        "seenInApp": "נצפה באפליקציה",
        "revoke": "לבטל",
        "revokeConfirm": "לסיים את ה-Pro של {email} עכשיו? הם יחזרו לתוכנית החינמית.",
    ...
    "insights": {
      ...
      "vsYesterdayNew": "מול 0 אתמול",
      "bestDayEver": "היום הטוב ביותר",
      "fastestGrowing": "מצב בקצב גדילה מהיר",
      "thisWeek": "השבוע",
      "byDayOfWeek": "יום הכי עסוק",
      "isPeakDay": "הוא יום השיא שלך",
      "byHour": "שעה כי עסוקה (UTC)",
      "isPeakHour": "היא שעת השיא שלך",
      "crossPlay": "שחקנים ששחקים X גם משחקים Y",
      "noShowRate": "הצטרפו אך לא השיגו ניקוד",
      "noShowHint": "חלק ממשחקים שהוקלטו עם 0 ניקוד ו-0 מילים — שחקנים שהצטרפו אך לא שיחקו.",
      "wordQuality": "איכות המילים לפי שפה",
      "wordQualityHint": "מילים שנדחו מול מילים שקובלו (30 יום אחרונים). שיעור דחייה גבוה מעיד על פערים במילון לאותה שפה.",
      "rejected": "נדחתה",
      "dow": {
        "sun": "ראשון",
        "mon": "שני",
    ...
    "teacherAccess": {
      ...
      "admin_note": "הערה לפונה (לא חובה)",
      "note_hint": "באישור, ההערה תיכלל באימייל הברכה לפונה. בדחייה, היא תשמש כסיבה.",
      "show_preview": "תצוגה מקדימה של האימייל",
      "hide_preview": "הסתר תצוגה מקדימה",
      "preview_title": "תצוגה מקדימה של האימייל",
      "preview_subject": "נושא",
      "copy_email": "העתק את ה-HTML של האימייל",
      "copy_success": "ה-HTML של האימייל הועתק ללוח",
      "copy_error": "העתקת האימייל נכשלה",
      "approve": "אשרו",
      "decline": "דחו",
      "close": "סגרו",
      "approveSuccess": "הבקשה אושרה בהצלחה",
      "resend": "שלח שוב את מייל האישור",
      "resend_hint": "שולח שוב למבקש את מייל קבלת הפנים (עם ההערה שלמעלה). לא משנה את ההרשאות שלו.",
      "resendSuccess": "מייל האישור נשלח שוב",
      "resendError": "שליחת מייל האישור נכשלה",
  ...
  "quickPlay": {
    "solo": {
      ...
      "random": "אקראי",
      "dragMe": "לגרור אותי",
      "dragHint": "גוררים את הכפתור אל מצב משחק — או משאירים על אקראי",
      "selected": "נבחר:",
      "play": "משחקים!",
      "subCaption": "סיבוב של 60 שניות · שלושה יריבים · אתם מול התוצאה המושלמת",
      "loading": "מכינים את הלוח…",
      "blurb": {
        "classic": "מותחים קו בין האותיות ובונים מילים. ככל שהמילה ארוכה יותר — הניקוד גדול יותר.",
        "blast": "משרשרים אותיות ומפוצצים אריחים. לנקות את הלוח לפני שהזמן נגמר.",
        "word-hunt": "מילה אחת מתחבאת בלוח. מצאו אותה — ואת כל מה שבדרך.",
        "wheel-rush": "כל מילה חייבת להשתמש באות שבמרכז. סובבו את הטבעת כדי למצוא עוד.",
        "random": "תנו לגלגל להחליט. 60 שניות, שלושה יריבים, אתם מול הניקוד המושלם."
      },
      "mode": {
        "classic": "קלאסי",
        "blast": "פיצוץ",
      ...
      "challengeFriend": "אתגרו חברים — אותו לוח",
      ...
      "rankLadder": "דרגה",
      "rankToNext": "{pts} עד {rank}",
      "rankToTop": "{pts} לראש",
      "raceStandings": "בסיבוב זה",
      "rivalsPassed": "הדפתם {passed} מתוך {total}",
      "passed": "הדפו",
      "wordsCollected": "{count} מילים",
      "wordsNew": "{count} חדשות",
      "wordsTotal": "{count} אסופות",
      "bestWord": "הטובה",
  ...
  "adventure": {
    ...
    "achievements": {
      ...
      "wordStreak10": {
        "name": "בלתי עציר",
        "desc": "בנו קומבו של 10"
      },
      "longWord6": {
        "name": "צורף מילים",
        "desc": "מצאו מילה עם 6+ אותיות"
      },
      "longWord8": {
        "name": "בלשן",
        "desc": "מצאו מילה עם 8+ אותיות"
      },
      "perfectLevel": {
        "name": "כוכב מושלם",
        "desc": "סיימו שלב עם 3 כוכבים"
      },
      "bossSlayer": {
        "name": "צייד בוסים",
        "desc": "נצחו בוס"
      ...
      "bossSpeedrun": {
        "name": "שד מהירות",
        "desc": "נצחו בוס עם 30+ שניות שנותרו"
      },
      "bossNoDamage": {
        "name": "בלתי ניתן לנגיעה",
        "desc": "נצחו בוס בלי לפספס מילה"
      },
      "allBosses": {
        "name": "אלוף",
        "desc": "נצחו את כל הבוסים"
      },
      "worldComplete": {
        "name": "מטייל עולמי",
        "desc": "סיימו עולם"
      ...
      "starCollector100": {
        "name": "קונסטלציה",
        "desc": "אספו 100 כוכבים"
      },
      "levelMaster": {
        "name": "אדון השלבים",
        "desc": "קבלו 3 כוכבים ב-10 שלבים"
      }
    },
    "loading": "טוען הרפתקה...",
    ...
    "worlds": {
      ...
      "mechanicHint2": "מצאו זוגות מילים נרדפות לניקוד בונוס!",
      "mechanicHint3": "מילים עם שורשים משותפים מזכות בנקודות נוספות!",
      "mechanicHint4": "בנו ביטויים ממילים קטנות!",
      "mechanicHint5": "צרו מילים מורכבות לבונוסים גדולים!",
      "mechanicHint6": "מצאו זוגות אנגרמות בין המילים שלכם!",
      "mechanicHint7": "פלינדרומים מזכים בפרסים נוספים!",
      "mechanicHint8": "צרו מילים נדירות ויוצאות דופן!",
      "mechanicHint9": "מילים ממספר שפות מזכות בניקוד גבוה יותר!",
      "mechanicHint10": "שלטו בכל המכניקות לאתגר הסופי!"
    },
    "objectives": {
      ...
      "surviveBattle": "שרדו עם {{target}}% חיים",
    ...
    "lexi": {
      ...
      "tapToDismiss": "הקישו לסגירה",
      "tapToSpeedUp": "הקישו להאצה"
    },
    "bosses": {
      "fightBoss": "הילחמו בבוס",
      "bossIntro": "קרב בוס!",
      "bossDefeated": "הבוס הובס!",
      "bossWins": "הבוס ניצח...",
      "nearMiss": "כמעט!",
      ...
      "cinematics": {
        "skip": "דלגו",
        "skipIn": "דלגו בעוד {seconds}...",
        "progress": "התקדמות הסרטון",
        "loading": "טוען...",
        "victory": "ניצחון!",
        "defeated": "{bossName} הובס!",
        "bossApproaches": "מתמודד מתקרב...",
        "prepareForBattle": "התכוננו לקרב!",
        "guardianOfWorld": "שומר עולם {worldNumber}",
        "errorTitle": "שגיאת וידאו",
        "errorDescription": "משהו השתבש בהפעלת הסצנה. נסו שוב או דלגו להמשך.",
        "errorTapToSkip": "לחצו על דלגו כדי להמשיך",
        "errorPressEscToSkip": "טעינת הסצנה נכשלה. לחצו ESC או המתינו כדי לדלג.",
        "retry": "נסו שוב",
        "fallbackTitle": {
          "victory": "ניצחון!",
          "defeat": "נגמר הזמן!",
      ...
      "captainMetaphor": {
        ...
        "taunts": {
          ...
          "badWord1": "זה מרדף אווזים פראי של מילה! עוף לא נכון לגמרי!",
      ...
      "puzzleMaster": {
        ...
        "taunts": {
          ...
          "goodWord2": "חכם. אבל ל'רצה' יש חברים: צרה, הרץ. מצאתם את כולם?",
      ...
      "cosmicWordsmith": {
        ...
        "taunts": {
          ...
          "mechanic1": "אותיות מתפתחות! כל אות הופכת לאחרת! הקוסמוס דורש התאמה!",
          "mechanic2": "השתמשו באותיות נדירות לסופרנובה! יש להן כוח קוסמי!",
    ...
    "collection": {
      ...
      "bossTrophyDesc": {
        "w1": "ניצחתם את שומר היער",
        "w2": "ניצחתם את פרעה המדבר",
        "w3": "ניצחתם את לוויתן האוקיינוס",
        "w4": "ניצחתם את טיטאן ההר",
        "w5": "ניצחתם את נחש הג׳ונגל",
        "w6": "ניצחתם את יטי הטונדרה",
        "w7": "ניצחתם את דרקון הר הגעש",
        "w8": "ניצחתם את גריפון השמיים",
        "w9": "ניצחתם את רוח הצללים",
        "w10": "ניצחתם את השליט הקוסמי"
      },
      "loreScroll": {
        "w1": "מגילת היער",
        "w2": "מגילת המדבר",
  ...
  "blast": {
    ...
    "tile": {
      ...
      "mystery": {
        "name": "תעלומה",
        "desc": "הפתעה אקראית - התפרצות ניקוד, יצרן מיוחד, קופץ קטן, או מגה +150."
      }
    },
    "title": "מצב פיצוץ",
    ...
    "hint": {
      ...
      "label": "רמז",
      "revealAria": "חשוף מילה — עולה כוכב"
    },
    "undo": "בטל",
    ...
    "waveIntro": {
      ...
      "go": "קדימה!",
      "moves": "{moves} מהלכים",
      "dragHint": "גרור אותיות כדי להרכיב מילים",
      "tapToStart": "הקש כדי להתחיל"
    },
    "objective": {
    ...
    "tileGuide": {
      ...
      "chocolate": {
        "name": "שוקולד",
        "desc": "מתפשט לאריח שכן בכל תור — השתמש באריח שוקולד כדי לעצור אותו"
      },
      "cake": {
        "name": "עוגה",
        "desc": "גוש רב-אריחים עם נקודות חיים משותפות — פגע בו שוב ושוב כדי להשמיד"
      }
    },
    "highlight": {
      "captions": {
    ...
    "concept": {
      ...
      "tag": "חדש",
      "anyRow": {
        "title": "מילים יכולות להופיע בכל שורה",
        "body": "לא רק בשורה התחתונה — סרקו את כל הלוח לחיפוש מילים."
      },
      "verticalWords": {
        "title": "מילים יכולות להיות גם אנכיות",
        "body": "גררו ישר למטה (או למעלה) כדי לאיית מילים אנכיות."
      }
    },
    "store": {
      "title": "חנות שדרוגים",
      ...
      "extraMoves": {
        "name": "תנועות נוספות",
        "desc": "התחל עם +1 תנועות לכל רמה"
      },
      "luckySpawn": {
        "name": "ספוון מזל",
        "desc": "+3% סיכוי לאריחים מיוחדים לרמה"
      },
      "comboSurge": {
        "name": "גל קומבו",
        "desc": "+25% בונוס קומבו לרמה"
      },
      "safetyNet": {
        "name": "רשת הצלה",
        "desc": "+1 הצלה חינם כשנתקעת לרמה"
      }
    },
    "settings": {
  ...
  "student": {
    "practiceFun": {
      ...
      "starsEarned": "{{count}} מתוך 3 כוכבים",
      "scoreLine": "{{correct}} מתוך {{total}} · {{percent}}%",
      "xpGain": "+{{xp}} נק׳",
      "xpRate": "{{xp}} נק׳",
      "next": "המשחק הבא",
      "nextMode": "הבא: {{mode}}",
    ...
    "activeGame": {
      ...
      "joinFailed": "לא הצלחנו להכניס אותך — ייתכן שהמשחק נגמר. בקשו מהמורה את הקוד."
    },
    "playWithClass": {
      "title": "שחק עם הכיתה",
      "joinNow": "הצטרף עכשיו!",
    ...
    "profileStalled": {
      "title": "לא הצלחנו לטעון את הפרופיל שלכם",
      "body": "משהו השתבש אצלנו. נסו שוב — הכיתה וההתקדמות שלכם שמורות.",
      "retry": "נסו שוב"
    },
  ...
  "teacher": {
    "nav": {
      ...
      "me": "שלי",
      "studentPlay": "משחק",
      "studentPractice": "תרגול",
      "studentAchievements": "הישגים",
      "sidebarLabel": "אזורי המורה",
    ...
    "wordDetails": {
      ...
      "synonymsPlaceholder": "מילים נרדפות, מופרדות בפסיקים (למשל: שמח, עליז)",
      ...
      "meaningsHelp": "שתי משמעויות או יותר הופכות את המילה לשאלת רב-משמעות.",
      "morphology": "חלקי מילה",
      "morphologyHelp": "מלאו שורש או תחילית והמילה תוכל לשמש לתרגול שורשים ותחיליות.",
      "prefix": "תחילית",
      "prefixPlaceholder": "מ",
      "root": "שורש",
      "rootPlaceholder": "כ.ת.ב",
      "rootMeaning": "פירוש השורש",
      "rootMeaningPlaceholder": "כתיבה",
      "suffix": "סיומת",
      "suffixPlaceholder": "ון",
      "summarySkills": "{{meanings}} עם שתי משמעויות · {{morphology}} עם חלקי מילה",
      "importFormatHelp": "תוספות אופציונליות אחרי קו אנכי |: syn: למילים נרדפות, ant: למילים הפוכות, ex: למשפט לדוגמה (כתבו ___ במקום המילה), level: support / core / challenge, mean: למשמעויות נוספות מופרדות ב-;, וכן root: / pre: / suf: לחלקי מילה (root: כ.ת.ב = כתיבה קובע גם את השורש וגם את פירושו).",
      "importFormatExample": "שמח - מרגיש שמחה | syn: עליז, מאושר | ant: עצוב | ex: הכלב ה___ כשכש בזנבו. | level: core\nקרן - סכום כסף | mean: חלק בולט בראש של חיה; סכום כסף שהופרש למטרה | root: ק.ר.ן = בליטה"
    },
    "levels": {
      "label": "רמה",
      "support": "תמיכה",
    ...
    "lastGame": {
      ...
      "coverage": "מילות השיעור שהכיתה מצאה",
      ...
      "found": "נמצאו",
      "missed": "פוספסו",
      "lessonWords": "מילות השיעור",
      "practiceCta": "לתרגל את המילים האלה",
      "mode": {
        "classic": "קלאסי",
        "blast": "בלאסט",
        "wordHunt": "ציד מילים",
        "wheelRush": "גלגל המזל",
        "vocabQuiz": "חידון מילים"
      }
    },
    "classReport": {
      ...
      "accuracy": "דיוק",
      "didNotPlay": "לא שיחק",
      "quizCaveat": "חידון שואל רק חלק ממילות השיעור, והמילים שלא נשאלו נספרות כאן כפספוס. בדקי את הרשימה לפני שאת חוזרת עליהן.",
      "empty": "אף אחד לא שיחק במשחק הזה",
      "emptyHint": "ברגע שתלמידים יצטרפו למשחק כיתתי, המילים שלהם יופיעו כאן אחת אחת.",
      "copy": "העתקה לרשימות שלי",
      "copied": "הועתק",
      "copyFallback": "העתיקי את הטקסט הזה:",
      "print": "הדפסה",
      "trendTitle": "לאורך המשחקים האחרונים",
      "trendEmpty": "שחקי את השיעור הזה שוב כדי לראות אם הכיתה משתפרת במילים האלה.",
      "trendBarsLabel": "{word}: פספוס של {first}% במשחק הראשון, {last}% באחרון.",
      "state": {
        "found": "מצא",
        "missed": "פספס",
        "absent": "לא שיחק",
        "quizFound": "ענה נכון",
        "quizMissed": "לא ענה נכון"
      },
      "drilldown": {
        "title": "פירוט תלמיד",
        "missedCount": "{count} מילים שפוספסו",
        "noneMissed": "מצא את כל מילות השיעור.",
        "absentHint": "אין לתלמיד הזה תוצאה במשחק הזה. השלימי איתו לפני המשחק הבא.",
        "suggested": "הצעד הבא:",
        "assign": "תרגול המילים האלה",
        "close": "סגירה"
      },
      "practice": {
      ...
      "notes": {
        "title": "משחק כיתתי",
        "playedAt": "שיחקו",
        "reteach": "לחזור קודם על",
        "checkIn": "לבדוק מה שלום",
        "absent": "לא שיחקו",
        "nobodyFound": "אף אחד לא מצא",
        "allFound": "הכיתה מצאה את כל מילות השיעור.",
        "everyoneOk": "אף אחד לא ירד מתחת למחצית.",
        "missedBy": "פוספסה על ידי"
      }
    },
    "proWelcome": {
      ...
      "perk": {
        ...
        "unlimited": "כיתות ותלמידים ללא הגבלה"
      },
      "noCard": "כשזה מסתיים פשוט חוזרים לתוכנית החינמית. לעולם לא נחייב בלי שתבחר/י בכך.",
      "paidBody": "מנוי Teacher Pro פעיל. אפשר לנהל או לבטל אותו בכל רגע מפרופיל המורה.",
      "manage": "ניהול המנוי",
      "cta": "יאללה"
    },
    "plan": {
    ...
    "subscription": {
      ...
      "usagePromptTitle": "הכיתה שלך באמת עובדת",
      "usagePromptStudentsBody": "יש לך {{count}} תלמידים בכיתה. Teacher Pro מכסה את כולם — כיתות ותלמידים ללא הגבלה, וגם ניתוח התקדמות ודוחות להדפסה.",
      "usagePromptAssignmentsBody": "יצרת {{count}} משימות לכיתה. Teacher Pro מוריד את התקרה — משימות ללא הגבלה, וגם ניתוח התקדמות ודוחות.",
      "assignmentLimitTitle": "הגעת למגבלת המשימות",
      "assignmentLimitMessage": "יצרת {{current}} מתוך {{limit}} משימות בחינם לכיתה הזו. שדרגו ל-Pro למשימות ללא הגבלה.",
      "upgradeProDescription": "Pro מעניק כיתות ותלמידים ללא הגבלה בכל כיתה — בלי מגבלות לצמיחת ההוראה שלכם.",
      "trialExpiredTitle": "תקופת הניסיון הסתיימה",
      "trialExpiredMessage": "14 ימי הניסיון כמורה הסתיימו. המשיכו להצמיח את הכיתה עם Pro — כיתות ללא הגבלה, משחקים חיים ודוחות התקדמות.",
      "continueFree": "להמשיך בגרסה החינמית",
      ...
      "trustReminder": "מייל תזכורת לפני כל חיוב",
      "freePlanName": "חינם",
      "freeForever": "תוכנית חינמית, ללא תפוגה",
      ...
      "popular": "הכי פופולרי",
      "faqTitle": "שאלות נפוצות",
      "faqCancel": "אפשר לבטל בכל עת?",
      "faqCancelAnswer": "בהחלט! אפשר לבטל את המנוי בכל עת דרך פורטל החיובים. הגישה ל-Pro נמשכת עד סוף החודש הנוכחי.",
      "faqAutoRenew": "האם אחויב אוטומטית?",
      "faqAutoRenewAnswer": "כן, המנוי מתחדש מדי חודש. תקבלו מייל תזכורת לפני כל חידוש. בטלו בכל עת כדי לעצור חיובים עתידיים.",
      "faqDataLoss": "אאבד את הנתונים שלי אם אבטל?",
      "faqDataLossAnswer": "לא. אם תבטלו, הכיתות, השיעורים ונתוני התלמידים יישמרו. פשוט תחזרו למגבלות המסלול החינמי (3 כיתות, 50 תלמידים בכיתה).",
      "legalNote": "בשדרוג אתם מסכימים לתנאי השימוש ומבינים את מדיניות ההחזרים שלנו.",
    ...
    "districtBanner": {
      "text": "מנהלים מספר כיתות או בית ספר שלם?",
      "cta": "קבלו תמיכה לבתי ספר ומחוזות →"
    },
    "upgradePro": {
      "cta": "שדרגו לפרו",
      "body": "שחררו כיתות ותלמידים ללא הגבלה"
    },
    "dashboard": {
      "title": "לוח המורה",
      ...
      "reviewEmptyHint": "צרו את הכיתה הראשונה כדי לפתוח אנליטיקה, משימות ודוחות.",
      "analytics": "אנליטיקה",
      "insights": "תובנות",
    ...
    "lesson": {
      ...
      "reviewSetName": "מילים שפספסנו",
      "reviewSetDescription": "המילים שהכיתה מצאה הכי פחות במשחק האחרון.",
    ...
    "assignment": {
      "focus": {
        "label": "מיקוד אוצר מילים",
        "help": "בחרו מיומנות אחת לתרגול, או תנו לתלמידים לבחור. זמינות רק מיומנויות שיש בשיעור מספיק מילים עבורן.",
        "any": "כל תרגול",
        "anyHint": "התלמידים בוחרים מצב בעצמם",
        "questionCount": "{{count}} שאלות · {{skill}}"
      },
    ...
    "reports": {
      ...
      "selectClassroom": "בחר כיתה",
      "loading": "טוען דוח...",
      "loadingClassrooms": "טוען כיתות...",
      "noClassroomsFound": "לא נמצאו כיתות",
  ...
  "education": {
    "whatsNew": {
      "entries": {
        "sep2026": {
          "packs": "חבילות פתיחה מוכנות בספרדית, שוודית, יפנית ורוסית.",
          "reports": "דוחות מדויקים יותר: תלמידים אורחים נרשמים, משחק חוזר סופר כל תלמיד פעם אחת, והשלמת שיעורי בית מופיעה.",
          "rematch": "משחק חוזר בלחיצה אחת אחרי חידון, והמצב שבחרתם הוא תמיד המצב שמשוחק.",
          "join": "הצטרפות קלה יותר: שדה קוד אחד, קוד QR אמיתי, מי שמצטרף מוקדם מחכה לכם במקום לקבל שגיאה, ומי שמאחר נוחת ישר בשאלה הנוכחית.",
          "wordcraft": "אפשר להקצות את Word Craft כשיעורי בית. מילות השיעור מופיעות על הלוח, וסבב נספר רק כשהתלמיד באמת משחק.",
          "leaderboard": "טבלת מובילים חיה על המקרן שמתעדכנת כשתלמידים עוקפים זה את זה, וכל תלמיד רואה איפה הוא עומד.",
          "chests": "תיבות פרסים בחידוני אוצר מילים: תשובה נכונה פותחת אחת מ־3 תיבות (רווח, כפול, גניבה או החלפה). פועל כברירת מחדל; אפשר לכבות בהגדרות המשחק.",
          "title": "משחקי הכיתה – בנויים מחדש בשביל הכיף",
        },
      },
      "close": "הבנתי",
      "subtitle": "כל שיפור במשחקי הכיתה שלכם, ברגע שהוא יוצא.",
      "title": "מה חדש למורים",
      "button": "מה חדש",
    },
    "subscription": {
    ...
    "homework": {
      ...
      "promptSpelling": "איזה כתיב נכון?",
      "promptSpellingHint": "אחת מהאפשרויות כתובה נכון.",
      "promptSpell": "לאיית",
      "timeLeft": "נותרו {{seconds}} שניות",
      "correct": "בול!",
      "almost": "המילה הייתה {{word}}",
      "finishTitle": "סיימת את שיעורי הבית!",
      "finishTitlePerfect": "סיבוב מושלם!",
      "wordsRight": "מילים נכונות",
      "bestRun": "הרצף הארוך ביותר",
      "starsEarned": "{{stars}} כוכבים מתוך 3",
      "playAgain": "עוד פעם",
    ...
    "modePicker": {
      ...
      "change": "החלפת משחק",
      "sheetTitle": "מחליפים משחק",
      "sheetHint": "נגעו בפוסטר אחר ונפתח את החדר איתו במקום.",
      "close": "נשארים עם זה",
      ...
      "how": {
        "classic": "מסמנים כל מילה שמזהים על לוח אותיות משותף אחד.",
    ...
    "intentCta": {
      ...
      "eslBody": "מריצים כיתה, או לומדים אנגלית דרך משחק? דף משחקי האנגלית לכיתה: סיבובים בהובלת המורה, שישה מילונים, בלי חשבונות תלמידים.",
      "eslLink": "משחקי מילים באנגלית לכיתה",
      "teachersBody": "מורים ולומדי אנגלית: משחקי כיתה בחינם, רשימות לפי נושא, ולוח לכל הכיתה שרץ מהמקרן.",
      "hubLink": "מרכז ההוראה",
      "elementaryLink": "משחקי אנגלית לכיתות יסוד"
    },
    "classroomModeBlurb": {
      "classic": "חיבור אותיות סמוכות על לוח משותף",
    ...
    "wordTowerPractice": {
      ...
      "height": "{{height}} מ׳ · {{floors}} קומות",
      "hit": "מילה מהרשימה! {{word}}"
    },
    "practicePicker": {
      "name": {
      ...
      "skill": {
        ...
        "matching": "מתאימים כל מילה לפירוש שלה",
        "spelling": "שומעים את המילה וכותבים אותה",
        "flashcard": "מדפדפים בין המילה לפירוש שלה",
        "word_list": "קוראים את כל הרשימה לפני שמתחילים",
        "definition": "קוראים את הפירוש ובוחרים מילה",
        "synonym": "מילים באותה משמעות",
      ...
      "locked": {
        ...
        "matching": "צריך לפחות 4 מילים כדי ליצור זוגות",
    ...
    "wordcraftAssignment": {
      ...
      "needLessonWord": "כדי לסיים, בנו לפחות מילה אחת מהשיעור — או {count} מילים כלשהן.",
      "tryAgain": "עוד סיבוב"
    },
    "vocabFocus": {
      ...
      "focus": {
        "definition": "התאמת הגדרה",
        "synonym": "מילים נרדפות",
        "antonym": "מילים הפוכות",
        "context": "רמזים מההקשר",
        "multiple_meaning": "מילים רב-משמעיות",
        "roots_affixes": "שורשים ותחיליות"
      },
      "instructions": {
        "definition": "קראו את הפירוש ובחרו את המילה",
        "synonym": "בחרו את המילה עם אותה משמעות",
        "antonym": "בחרו את המילה עם המשמעות ההפוכה",
        "context": "בחרו את המילה שמתאימה לחסר",
        "multiple_meaning": "בחרו את המילה שמתאימה לשתי המשמעויות",
        "roots_affixes": "בחרו מה הפירוש של חלק המילה"
      },
      "promptLabel": {
        "definition": "איזו מילה פירושה…",
        "synonym": "אותה משמעות כמו…",
        "antonym": "ההפך מ…",
        "context": "השלימו את החסר",
        "multiple_meaning": "איזו מילה מתאימה לשתיהן?",
        "roots_affixes": "חלקי מילה"
      },
      "unlock": {
        "definition": "הוסיפו הגדרות ל-{{min}} מילים לפחות כדי לפתוח",
        "synonym": "הוסיפו מילים נרדפות ל-{{min}} מילים לפחות כדי לפתוח",
        "antonym": "הוסיפו מילים הפוכות ל-{{min}} מילים לפחות כדי לפתוח",
        "context": "הוסיפו משפטי דוגמה ל-{{min}} מילים לפחות כדי לפתוח",
        "multiple_meaning": "הוסיפו משמעות שנייה ל-2 מילים לפחות כדי לפתוח",
        "roots_affixes": "הוסיפו שורש או תחילית ל-2 מילים לפחות כדי לפתוח"
      },
      "notEnough": {
        "definition": "לתרגול הזה צריך הגדרות לפחות ל-4 מילים בשיעור. בקשו מהמורה להוסיף!",
        "synonym": "לתרגול הזה צריך מילים נרדפות לפחות ל-4 מילים בשיעור. בקשו מהמורה להוסיף!",
        "antonym": "לתרגול הזה צריך מילים הפוכות לפחות ל-4 מילים בשיעור. בקשו מהמורה להוסיף!",
        "context": "לתרגול הזה צריך משפטי דוגמה לפחות ל-4 מילים בשיעור. בקשו מהמורה להוסיף!",
        "multiple_meaning": "לתרגול הזה צריך שתי משמעויות לכמה מילים בשיעור. בקשו מהמורה להוסיף!",
        "roots_affixes": "לתרגול הזה צריך חלקי מילה לכמה מילים בשיעור. בקשו מהמורה להוסיף!"
      },
      "progress": "{{current}} מתוך {{total}}",
      "progressLabel": "התקדמות בשאלות",
      "correct": "יפה! נכון.",
      "wrong": "לא בדיוק.",
      "answerWas": "התשובה היא: {{answer}}",
      "next": "הבא",
      "finish": "לתוצאות",
    ...
    "wordBank": {
      ...
      "challengeBadge": "אתגר: חפשו מילים של {{min}}+ אותיות"
    },
    "studentPreview": {
      "button": "תצוגה מקדימה של מסך התלמידים",
      "buttonHint": "עברו על מסך ההצטרפות, חדר ההמתנה ולוח לדוגמה לפני השיעור.",
      "disabledHint": "בחרו כיתה ולפחות שיעור אחד כדי לצפות בתצוגה המקדימה.",
      "title": "תצוגה מקדימה לתלמידים",
      "subtitle": "בדיוק מה שהתלמידים רואים בטלפון, שלב אחרי שלב.",
      "close": "סגירת התצוגה המקדימה",
      "stepsLabel": "שלבי התצוגה המקדימה",
      "stepOf": "שלב {current} מתוך {total}:",
      "steps": {
        "join": "הצטרפות",
        "waiting": "חדר המתנה",
      ...
      "done": "סיום",
      "join": {
        "caption": "התלמידים פותחים את הקישור הזה, או מקלידים את קוד הכיתה בדף ההצטרפות:",
        "classroomHint": "זהו הקוד הקבוע של {name}. אחרי תחילת המשחק המקרן מציג גם קוד חדר שעובד באותה צורה."
      },
      "waiting": {
        "title": "מחכים שהמורה יתחיל",
        "subtitle": "השאירו את המסך פתוח. המשחק יתחיל לבד.",
        "settingsTitle": "הסבב הזה",
        "teacherHint": "התלמידים ממתינים כאן עד שתלחצו על התחלה. הם כבר רואים את המצב, הזמן וגודל הלוח שבחרתם."
      },
      "settings": {
        "mode": "מצב",
        "timer": "זמן",
        "board": "לוח",
        "minLength": "המילה הקצרה ביותר",
        "minutes": "{count} דק׳",
        "letters": "{count} אותיות"
      },
      "game": {
        "timeLeft": "זמן שנותר",
        "boardLabel": "לוח אותיות לדוגמה",
        "samplePath": "מודגש: {word}",
        "minLength": "מילים חייבות להכיל לפחות {count} אותיות.",
        "hiddenWords": "מילים שמוסתרות בלוח הזה",
        "noneHidden": "אף אחת מהמילים שנבחרו לא נכנסת בלוח בגודל הזה."
      },
      "shuffle": "ערבוב הלוח לדוגמה",
      "freshBoardNote": "זו רק דוגמה. הלוח האמיתי נוצר מחדש כשמתחילים את המשחק, עם שילוב אחר של המילים שלכם.",
      "skipped": {
        "title": "מילים שלא יופיעו בלוח",
        "subtitle": "התלמידים עדיין מתרגלים אותן בשיעורים; פשוט אי אפשר לסמן אותן על רשת אותיות.",
        "none": "כל המילים שנבחרו יכולות להסתתר בלוח.",
        "reason": {
          "empty": "שורה ריקה",
          "multiWord": "מכילה רווח או מקף",
          "tooShort": "קצרה מ־3 אותיות",
          "tooLong": "ארוכה מ־12 אותיות",
          "notInDictionary": "לא נמצאת במילון המשחק",
          "tooLongForBoard": "ארוכה מדי ללוח בגודל הזה (עד {max} אותיות). בחרו לוח גדול יותר.",
          "notInSample": "לא נכנסה בדוגמה הזו. היא עשויה להופיע בלוח האמיתי."
        }
      }
    },
    "results": {
      "title": "סיכום השיעור",
      "yourMastery": "מצאתם {{found}} מתוך {{total}} מילות השיעור",
      ...
      "moment": {
        "winnerBanner": "יש לנו מנצחת!",
        "drumroll": "רול תופים…",
        "sweepTag": "כל המילים!",
        "classSweptTag": "הכיתה מצאה את כל {{total}} המילים!",
        "sweepStreak": "{{count}} סיבובים רצופים עם כל המילים",
        "roundOfSession": "סיבוב {{round}} במפגש",
        "deltaUp": "+{{points}} מהסיבוב הקודם",
        "deltaDown": "{{points}} פחות מהסיבוב הקודם",
        "deltaSame": "בדיוק כמו בסיבוב הקודם",
        "personalBest": "שיא אישי!",
        "climbed": "עלית {{places}} מקומות"
      },
      ...
      "startTeamTilesUnplugged": "התחל Team Tiles ללא מכשירים",
      "teamTilesProgress": "אריחים {{judged}} מתוך {{total}}",
      "teamTilesClassScore": "ניקוד הכיתה",
      "teamTilesChooseTeams": "כמה קבוצות?",
      "teamTilesTeamName": "קבוצה {{number}}",
      "teamTilesActiveTeam": "תור של קבוצה {{number}}",
      "teamTilesFlipHint": "הפוך אריח",
      "teamTilesFaceDown": "אריח miss-gap הפוך",
      "teamTilesGotIt": "הקבוצה הצליחה!",
      "teamTilesExit": "יציאה מ-Team Tiles",
      ...
      "unpluggedGameScore": "ניקוד הכיתה",
      "unpluggedGameStreak": "רצף",
      "unpluggedGameStart": "להתחיל את השעון",
      "unpluggedGameRevealNow": "לחשוף",
      "unpluggedGameGotIt": "הכיתה צדקה!",
      "unpluggedGameNotYet": "עוד לא",
      "unpluggedGameHands": "ידיים למעלה",
      "unpluggedGameHandsMore": "יד אחת נוספת",
      "unpluggedGameHandsFewer": "יד אחת פחות",
      "unpluggedGameWriteNow": "כתבו את המילה בדף!",
      "unpluggedGameChooseTime": "בחרו זמן כתיבה ולחצו התחלה",
      "unpluggedGameLetters": "{{count}} אותיות",
      "unpluggedGameSecondsUnit": "שנ׳",
      "unpluggedGameTimerLabel": "נותרו",
      "unpluggedGameExit": "יציאה מהוראה מחדש ללא מכשירים",
      ...
      "unpluggedGameCleared": "מילים שנוצחו",
      ...
      "unpluggedReteachPackFooter": "LexiClash · חבילת Unplugged reteach",
    },
    "classroomAddon": {
    ...
    "duels": {
      ...
      "comboAria": "שרשרת קומבו של {{count}}",
      "comboBonus": "בונוס שרשרת, ועוד {{points}} נקודות",
      "comboNone": "מוכנים",
      "comboSpark": "ניצוץ",
      "comboBlaze": "בוער",
      "comboInferno": "תופת",
      "comboSupernova": "סופרנובה",
      ...
      "revealDraw": "תיקו!",
      "xpEarned": "+{{count}} XP",
      "bestChain": "שרשרת שיא {{count}}",
      "coinsEarned": "{{count}} מטבעות",
      "backToLobby": "ללובי",
      "newSeries": "סדרה חדשה",
      "seriesWon": "ניצחתם בסדרה",
      "seriesLost": "הפסדתם בסדרה",
      "seriesTied": "הסדרה בתיקו",
      "seriesGameOf": "משחק {{game}} מתוך {{total}}",
      "turnBeatThem": "תנצחו את {{name}}",
      "turnFirstMove": "התור שלכם מול {{name}}",
      "turnToBeat": "לנצח",
    ...
    "analytics": {
      "accuracy": "דיוק",
      "activityAttemptedWord": "ניסה מילה",
      "activityCompletedLesson": "השלים שיעור",
      "activityGainedXp": "קיבל XP",
    ...
    "landing": {
      "pro": {
        ...
        "freeForever": "התוכנית החינמית לא פגה. בלי כרטיס אשראי, בלי שעון ניסיון.",
        "proTier": "Teacher Pro",
      ...
      "compare": {
        ...
        "row": {
          ...
          "free_for_teachers": "מסלול בסיסי חינם למורים"
        }
      },
      "trust": {
        "title": "בנוי על אמון",
      ...
      "esl-word-games": {
        ...
        "course_desc": "משחקי אוצר מילים, איות, וריבוי משתתפים חיים לכיתות ESL ב-6 שפות."
      },
    ...
    "leaderboard": {
      "allTime": "כל הזמנים",
      "ariaLabel": "דירוג כיתתי המציג תלמידים מובילים",
      "inactive": "לא פעיל",
      "level": "רמה {{level}}",
      "monthly": "חודשי",
      "newEntry": "חדש!",
    ...
    "vsWayground": {
      "starterLimit": {
        "eyebrow": "ספריית תוכנית חינם — foil כנות",
...
"vsBlooket": {
    ...
    "access": {
      ...
      "success_title": "אתם בפנים! 🎉",
      "success_body": "גישת המורה אושרה מיד.",
      "success_next": "מעבירים אתכם ללוח הבקרה למורה…",
      ...
      "hero_alt": "הקמע של LexiClash מקבל בברכה כיתה של קוביות אותיות",
      "verify_email_title": "קודם אמתו את האימייל",
      ...
      "use_case_spark": "צריכים השראה?",
      "use_case_ex1": "קרבות אוצר מילים שבועיים עם הכיתה",
    ...
    "packages": {
      ...
      "school": {
        ...
        "price": "צרו קשר",
        "blurb": "הטמעה, ניהול וצרכי רשות. אותו טופס, מסומן כליד בית ספר.",
        "cta": "צרו קשר"
      },
      "feature": {
        "reports": "כל דוחות הכיתה",
        "homework": "שיעורי בית על פערי פיספוס",
        "reteach": "כלי הוראה מחדש",
        "wholeClass": "כל הכיתה, לא רק מושב מורה אחד",
        "proPlus": "כל יכולת Teacher Pro כלולה",
        "streaks": "רצפי כיתה",
        "priority": "תמיכה בעדיפות",
        "district": "הטמעה לבית ספר ולרשות"
      }
    }
  },
  "crazygames": {
  ...
  "notifications": {
    ...
    "prompt": {
      ...
      "firstWinTitle": "ניצחון יפה!",
      "firstWinBody": "הפעל התראות כדי לשמור על הרצף ולא לפספס את האתגר היומי",
      "enable": "הפעל התראות",
      "notNow": "לא עכשיו"
    },
    "preferences": {
  ...
  "passAndPlay": {
    "title": "העבירו ושחקו",
    "subtitle": "מסך אחד, לוח אחד, בתורות.",
    "playerCount": "שחקנים",
    "playerName": "שם",
    "playerNameDefault": "שחקן {n}",
    "color": "צבע",
    "avatar": "דמות",
    "addPlayer": "הוסיפו שחקן",
    "removePlayer": "הסירו",
    "rounds": "סיבובים",
    "boardSize": "לוח",
    "language": "שפה",
    ...
    "resume": "המשיכו משחק",
    "discard": "משחק חדש",
    "resumePrompt": "יש משחק מסיבה באמצע.",
    "passTo": "העבירו ל{name}",
    "ready": "מוכנים",
    "yourTurn": "התור שלך, {name}",
    "timeLeft": "זמן",
    "score": "ניקוד",
    "found": "מילים",
    "unique": "ייחודיות",
    ...
    "tooShort": "קצר מדי",
    "timesUp": "הזמן נגמר!",
    "roundN": "סיבוב {n} מתוך {total}",
    "roundBreakdown": "ניקוד הסיבוב",
    "nextRound": "סיבוב הבא",
    "seePodium": "לפודיום",
    "podium": "ניקוד סופי",
    "winner": "{name} ניצח!",
    ...
    "seconds": "{n} שנ׳",
    "stolen": "כבר נלקחה",
    "emptyName": "לכל שחקן צריך שם",
    "minPlayers": "צריך לפחות 2 שחקנים",
    "maxPlayers": "עד 6 שחקנים",
    "nameTaken": "השמות חייבים להיות ייחודיים",
    "langEn": "אנגלית",
    "langHe": "עברית",
    "langSv": "שוודית",
    "langJa": "יפנית",
  ...
  "quests": {
    ...
    "done": "בוצע!",
    "feed": {
      "title": "ניצחונות אחרונים",
      "pvp": "{{name}} ניצח יריב אנושי",
      "grandSlam": "{{name}} סיים את כל 3 המשימות היומיות"
    },
    "daily": {
      "long_word_6": {
        "title": "אדריכל מילים",
        "desc": "מצאו מילה בת 6+ אותיות"
      },
      "long_word_7": {
        "title": "ענק מילים",
        "desc": "מצאו מילה בת 7+ אותיות"
      },
      "score_300": {
        "title": "קלע מדויק",
        "desc": "צברו 300+ נקודות במשחק אחד"
      },
      "score_500": {
        "title": "מהמר כבד",
        "desc": "צברו 500+ נקודות במשחק אחד"
      },
      "words_15": {
        "title": "מכונת מילים",
  ...
  "wordHuntTips": {
    ...
    "spellWordsFirst": "ראשית טייל מילים על הלוח — כל אחת חושפת אות מהמילה הנסתרת.",
    "fastSolveFarmMore": "פתרת ב-{{attempts}} ניסיונות! מהיר כברק. בפעם הבאה אסוף עוד מילים לבונוס נוסף.",
    "trustCluesSooner": "לקח לך {{attempts}} ניחושים — בטח ברמזים וקחו סיכון יותר מהר לקבל יותר נקודות."
  },
  "wordHuntDeathRecap": {
  ...
  "boardCoach": {
    "dragToConnect": "גררו כדי לחבר אותיות — לכל כיוון"
  },
  "directionsTutorial": {
    "badge": "טיפ מהיר",
    "title": "אפשר לכל כיוון",
    "subtitle": "אותיות מתחברות אם הן נוגעות — גם באלכסון.",
    "tryPrompt": "תורך — מתחו את המילה באלכסון",
    "donePrompt": "יופי! גם אלכסונים נחשבים 🎉",
    "cta": "מתחילים לשחק",
    "ctaWait": "{{seconds}} שנ׳"
  },
  "modeCoach": {
    ...
    "classic": {
      "title": "גרור מילים",
      "step1": "גרור על אותיות צמודות",
      "step2": "מילים ארוכות = יותר נקודות",
      "scoreTip": "רצף מהיר = קומבו!"
    },
    "wordHunt": {
      "title": "פצח את המילה",
    ...
    "wheelRush": {
      "title": "סובב וכתוב",
      "step1": "האות המרכזית חייבת בכל מילה",
      "step2": "תפוס מילים לפני היריבים",
      "scoreTip": "מילים ארוכות = הכי הרבה נקודות!"
    },
    "blast": {
      "title": "פוצץ אריחים",
      "step1": "גרור אותיות ובנה מילים",
      "step2": "נקה מילים והפעל מפולת",
      "scoreTip": "מפולת אחרי מפולת = קומבו ענק!"
    },
    "wordTower": {
      "title": "בנה מגדל",
      "step1": "הקש כדי להפיל בלוק",
      "step2": "נחת במרכז כדי לבנות גבוה",
      "scoreTip": "כל מילה = עוד קומה!"
    },
    "connections": {
      "title": "מצא את הקשרים",
      "step1": "קבץ ארבע מילים מאותו נושא",
      "step2": "כל טעות עולה לך ניסיון",
      "scoreTip": "פתור בלי טעויות!"
    },
    "wordCraft": {
      "title": "בנה מילים",
      "step1": "החלק אריחים למקומם",
      "step2": "הרכב מילים כדי לנקות את הלוח"
    },
    "wordAlchemy": {
      "title": "שנה את המילה",
      "step1": "שנה אות אחת בכל פעם",
      "step2": "הוסף, החלף או הסר אות"
    },
    "crossword": {
      "title": "מלא את התשבץ",
      "step1": "הקש על רמז והקלד תשובה",
      "step2": "פתור מאוזן ומאונך"
    },
    "sealedBid": {
      "title": "הצעה סודית",
    ...
    "adventure": {
      ...
      "step2": "הפל בוסים עם מילים ארוכות!"
    }
  },
  "gameModes": {
    "classic": {
    ...
    "crossword": {
      "name": "תשבץ",
      "description": "מירוץ לפתור את אותו תשבץ — הפותר המהיר מנצח!"
    },
    "intro": {
      "cta": "בוא נתחיל",
      "skip": "דלג על המדריך"
  ...
  "avatarBuilder": {
    ...
    "randomize": "אקראי",
    "undo": "בטל שינוי",
    "restorePrevious": "שחזר אווטאר קודם",
    "download": "הורדה",
    "save": "שמירה",
    "cancel": "ביטול",
    "buildCustom": "בנו דמות משלכם",
  ...
  "party": {
    ...
    "youWere": "היית:",
    "skip": "דלג",
    "eliminatedTitle": "הודחו",
    "bestLabel": "הכי טוב",
    "funniestLabel": "הכי מצחיק",
  ...
  "wordForge": {
    ...
    "heat": {
      "label": "חום הפיתוח",
      "masterForge": "!פיתוח מושלם",
      "aria": "{{heat}} מתוך 3 מלאכות מושלמות"
    },
    "scoreTier": {
      "good": "!יפה",
      "great": "!מצוין",
  ...
  "connections": {
    "daily": {
      ...
      "yourRank": "אתם: #{rank}",
      "cta": "אתגר יומי",
      "questTitle": "גשר מילים",
      "questDesc": "מצאו את המילה שמתחברת לשני הצדדים — 5 גשרים ביום.",
      "nextIn": "הגשר הבא בעוד",
      "triesLeft": "נשארו {count} ניסיונות",
      "lastTry": "ניסיון אחרון!",
      "completeTough": "יום קשה!",
    ...
    "community": {
      "title": "חידות הקהילה",
      "suggest": "הציעו חידה",
      "suggestHint": "שתי מילים + מילת גשר שמחברת בין שתיהן. נבדוק לפני הפרסום.",
      "word1": "מילה",
      "word2": "מילה",
      "bridge": "גשר",
      "submitBtn": "שלחו חידה",
      "submitted": "נשלח לבדיקה — תודה!",
      "submitFailed": "השליחה נכשלה. בדקו את המילים ונסו שוב.",
      "top": "חידות הקהילה המובילות",
      "empty": "אין עדיין חידות קהילה — היו הראשונים להציע!",
      "upvote": "הצבעה",
      "cta": "קהילה"
    },
    "title": "ראש זנב",
    ...
    "pyramid": {
      ...
      "finale": "סיום",
      "explainer": "פתרו את שלוש החידות למטה — התשובות שלהן פותחות את המילה שבראש.",
    ...
    "reviveDescription": "החיים מתחדשים מעצמם — או צפה בפרסומת קצרה כדי להמשיך עכשיו.",
    ...
    "continueWithRegenLife": "המשך",
    "nextLifeIn": "חיים נוספים בעוד {{time}}",
    "revealHint": "הצג רמז",
  ...
  "wordcraft": {
    ...
    "gems": {
      ...
      "dice": {
        ...
        "subtitle": "סיכון גבוה יותר, תגמול גדול יותר — הבחירה שלך",
        "skip": "שחק ללא בונוס",
  ...
  "familiesSafety": {
    "ageGateTitle": "בן כמה אתה?",
    "ageGateMessage": "אנחנו שואלים כדי לשמור על שחקנים צעירים. בחרו את שנת הלידה שלכם.",
    "birthYearLabel": "שנת לידה",
    "birthYearPlaceholder": "בחרו שנה",
    "ageGateError": "משהו השתבש. נסו שוב.",
    "ageGateConfirm": "המשך",
    "saving": "שומר…",
    "reminderTitle": "שמרו על עצמכם ברשת",
    "reminderIntro": "לפני שמתחילים לשוחח, תזכורת קצרה:",
    "tipNoPersonalInfo": "לעולם אל תשתפו מידע אישי — שם אמיתי, כתובת, בית ספר, מספר טלפון או סיסמאות.",
    "tipStrangers": "אנשים ברשת לא תמיד מי שהם טוענים. היזהרו עם מי שאינכם מכירים.",
    "tipReport": "אם משהו מרגיש לא בסדר, הפסיקו לשוחח וספרו למבוגר שאתם סומכים עליו.",
    "reminderConfirm": "הבנתי",
    "chatNeedsAge": "ספרו לנו את גילכם כדי להשתמש בצ'אט.",
    "chatRestricted": "הצ'אט כבוי בחשבון הזה. מבוגר יכול לשנות זאת בבקרת ההורים.",
    "chatAddAge": "הוסיפו את הגיל שלי",
    "pcTitle": "בקרת הורים",
    "pcIntro": "בחרו אילו תכונות חברתיות יהיו זמינות בחשבון הזה. אשרו שאתם מבוגרים כדי לבצע שינויים.",
    "pcAdultGateLabel": "שנת לידה של מבוגר",
    "pcUnlock": "פתחו את ההגדרות",
    "pcAdultError": "הזינו שנת לידה של מבוגר כדי להמשיך.",
    "pcChatLabel": "צ'אט במשחק עם שחקנים אחרים",
    "pcFriendMsgLabel": "הודעות פרטיות עם חברים",
    "pcFriendMgmtLabel": "הוספת חברים וחיפוש שחקנים",
    "pcSave": "שמרו הגדרות",
    "pcSaved": "ההגדרות נשמרו.",
    "pcSaveError": "השמירה נכשלה. נסו שוב.",
    "pcDisplayNameLabel": "שם תצוגה מותאם אישית",
  ...
  "curator": {
    ...
    "levels": {
      ...
      "subtitle": "שלושה תפקידים עצמאיים — משתמש יכול להחזיק בכל שילוב.",
      "note": "אוצרים אף פעם לא עורכים תוכן חי ישירות. כל פעולה היא הצעה שמנהל בודק לפני שהיא נכנסת לתוקף.",
      "toggle": "מה המשמעות של הרמות?",
      "admin": {
        "title": "מנהל",
        "scope": "כללי",
        "desc": "לוח בקרה מלא: ניהול שחקנים, תוכן ומודרציה, והענקת כל תפקיד אחר. נחשב לאוצר ברמה הגבוהה ביותר בכל השפות."
      },
      "teacher": {
        "title": "מורה",
        "scope": "חינוך",
        "desc": "לוח כיתה: בניית שיעורים, הפעלת משחקי כיתה חיים ומעקב אחר התקדמות תלמידים. ללא הרשאות אוצרות תוכן."
      },
      "curator": {
        "title": "אוצר/ת שפה",
        "scope": "לפי שפה",
        "desc": "דובר/ת שפת אם מהימן/ה שבודק/ת איכות תוכן בשפה אחת או יותר. העוצמה נקבעת לפי רמה; פעילות מזכה ביוקרה."
      },
      "capabilityHeading": "רמות יכולת — מה מותר להם",
      "rewardsHeading": "תגמולי יוקרה — מה הם מרוויחים",
      "rewardsDesc": "מוענק רק כשמנהל מאשר הצעה של אוצר, כך שמתוגמל הדיוק — לא הכמות.",
      "ranksLabel": "דרגות",
      "coinsLabel": "בונוס מטבעות",
      "coinMilestone": "{points} נק׳ → {coins} מטבעות"
    },
    "assignInline": {
      "heading": "אוצר/ת שפה",
      "none": "לא אוצר/ת",
      ...
      "assign": "מנה/י",
      "cancel": "ביטול",
      "assigned": "אוצר/ת מונה/תה",
      "revoke": "בטל/י",
      "revoked": "אוצרות בוטלה",
      "error": "הפעולה נכשלה — נסה/י שוב",
      "current": "אוצר/ת",
      "languageLabel": "שפה",
      "tierLabel": "רמה"
    },
  ...
  "splash": {
    "loadingText1": "מחדדים את העפרונות…",
    "loadingText2": "מערבבים את האותיות…",
    "loadingText3": "מחממים את המילון…",
    "loadingText4": "מזמנים מילים נדירות…",
    "loadingText5": "משחדים את התנועות…",
    "loadingText6": "מצחצחים את הגביעים…",
  ...
  "vs": {
    ...
    "fiveLanguages": "6 שפות עם מילונים מקומיים",
  ...
  "sealedBid": {
    ...
    "potentialPayout": "תמורה פוטנציאלית {amount}",
    "lockBid": "נעל הימור",
    "needWord": "קודם תבנה מילה",
    "needStake": "קבע הימור כדי לנעול",
    "pass": "דלג",
    "unique": "ייחודי",
    "clash": "התנגשות",
    "busted": "התפוצץ",
