...
const he = {
  ...
  "seo": {
    ...
    "daily": {
      "title": "מילת היום — פאזל המילים של היום, אתגר יומי חינם | LexiClash",
      "description": "מילת היום — שחקו את פאזל המילים של היום בחינם. אותו לוח בכל העולם. מצאו מילים, שתפו תוצאות אמוג׳י וטפסו בטבלת המובילים. ללא הורדה, ללא הרשמה. פאזל חדש כל יום!",
      "ogTitle": "מילת היום — פאזל המילים, תנצחו את העולם?",
      "ogDescription": "מילת היום: אותו פאזל, כל העולם. מצאו מילים, שתפו תוצאות, התחרו גלובלית. חינם וללא הורדה!"
    },
    "multiplayer": {
      "title": "משחק כמו סקרבל בעברית — מרובה משתתפים חינם | LexiClash",
      "description": "מחפשים לשחק סקרבל אונליין בעברית? לקסיקלאש היא האלטרנטיבה החינמית: בנו מילים בזמן אמת נגד חברים, בלי תורות, בלי הורדה. 6 מצבי משחק, 10,000+ מילים בעברית. שחקו עכשיו!",
      "ogTitle": "אלטרנטיבה לסקרבל בעברית — מרובה משתתפים חינם",
      "ogDescription": "כמו סקרבל אבל בזמן אמת ⚡ בלי תורות, בלי הורדה. צרו חדר, שלחו לינק, שחקו! 🇮🇱"
    },
    "about": {
