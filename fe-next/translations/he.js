...
const he = {
  ...
  "validation": {
    "usernameRequired": "בחרו שם ובואו נתחיל!",
    "hostUsernameRequired": "איך נקרא לך?",
    "roomNameRequired": "תנו שם לחדר!",
    ...
    "usernameInvalidChars": "אותיות, מספרים, רווחים וקו תחתון עובדים מצוין",
    "roomNameTooShort": "צריך לפחות 2 תווים",
    "roomNameTooLong": "עד 30 תווים",
    "roomNameInvalidChars": "אותיות, מספרים, רווחים וקו תחתון עובדים מצוין",
    "gameCodeRequired": "צריך קוד להצטרף",
    "gameCodeInvalid": "הקוד לא נמצא - בדקו שוב ונסו שנית",
    "wordRequired": "כתבו מילה",
    "wordTooLong": "ארוך מדי",
    "wordInvalidChars": "רק אותיות",
  ...
  "playerView": {
    ...
    "hostValidating": "המארח בודק מילים...",
    "clickToSelect": "לחץ על אותיות כדי לבחור מילים",
    "me": "אני",
    "noWordsYet": "לא נמצאו מילים עדיין",
    "swipeHintWithMin": "החליקו על אותיות מחוברות ליצירת מילים ({min}+ אותיות)",
  ...
  "onboarding": {
    ...
    "skip": "דלג",
    "letsPlay": "בואו נשחק!",
    "step1Title": "החליקו על האותיות",
    "step1Text": "גררו על אותיות סמוכות כדי ליצור מילים. שחררו כדי לשלוח!",
    "step2Title": "צברו נקודות",
    "step2Text": "מילים ארוכות = הרבה יותר נקודות. נסו למצוא מילים של 5+ אותיות!",
    "step3Title": "בנו קומבו",
    "step3Text": "מצאו מילים מהר ברצף כדי לבנות מכפילי קומבו!",
    "step4Title": "היו ייחודיים",
    "step4Text": "מילים שנמצאו על ידי אחרים מקבלות אפס. חשבו יצירתי!",
    "timingHint": "תרגלו בזמן ההמתנה למשחק! 🎮"
  },
  "tips": {
    ...
    "longerText": "מילים ארוכות שוות הרבה יותר נקודות. מילת 6 אותיות מנצחת שתי מילים של 3 אותיות!",
    "comboTitle": "בנו קומבו",
    "comboText": "שרשרו מילים מהר לבניית מכפילי קומבו לנקודות בונוס!",
    "uniqueTitle": "היו ייחודיים",
    "uniqueText": "מילים משותפות שוות אפס! חשבו יצירתי כדי למצוא מילים ייחודיות.",
  ...
  "nextStep": {
    ...
    "challengeBotsAgain": "שחקו שוב!",
    "challengeBotsAgainDesc": "התחילו משחק חדש מול בוטים",
  ...
  "archetypes": {
    "strategist": "האסטרטג",
    "strategistDesc": "אתה מתכנן שלושה צעדים קדימה בזמן שאחרים עדיין מוצאים את המילה הראשונה שלהם",
    "speedster": "המהיר",
    "speedsterDesc": "האצבעות שלך נעות מהר יותר ממה שהיריבים יכולים לחשוב",
    "scholar": "המלומד",
    "scholarDesc": "אתה רואה 'מילה מתוחכמת' שם שאחרים רואים 'מילה ארוכה'",
    "explorer": "החוקר",
    "explorerDesc": "בזמן שאחרים דבקים במובן מאליו, אתה חושף אוצרות מוסתרים",
    "perfectionist": "הפרפקציוניסט",
    "perfectionistDesc": "אפס תנועות מבוזבזות. כל החלקה מכוונת.",
    "maverick": "החריג",
    "maverickDesc": "כללים הם הצעות. אתה משחק את המשחק שלך.",
    "workhorse": "הסוס הפרא",
    "workhorseDesc": "אתה עדיין מוצא מילים כשכולם כבר ויתרו",
    "closer": "הסוגר",
    "closerDesc": "10 שניות אחרונות? זה הרגע שלך.",
    "trailblazer": "הפורץ דרך",
    "trailblazerDesc": "משחק בטוח משעמם אותך. אתה הולך על המילים הבלתי אפשריות.",
  ...
  "howToPlay": {
    ...
    "findWordsDesc": "חברו אותיות בכל כיוון (אלכסונים גם!) ליצירת מילים.",
  ...
  "onboarding": {
    ...
    "step2Title": "צברו נקודות",
    "step2Text": "מילים ארוכות = הרבה יותר נקודות. נסו למצוא מילים של 5+ אותיות!",
    "step3Title": "בנו קומבואים",
    "step3Text": "מצאו מילים במהירות ברצף כדי לבנות מכפילי קומבו!",
    "step4Title": "היו ייחודיים",
    "step4Text": "מילים שמצאו אחרים מקבלות אפס. חשבו יצירתית!",
  ...
  "landing": {
    ...
    "tutorial": "מדריך",
    "seoHeadline": "משחק מילים מרובה משתתפים חינם",
    "seoSubheadline": "כמו וורדל ובוגל - אבל משחקים עם חברים בזמן אמת!",
    "valueProps": {
      "realTime": "קרבות בזמן אמת",
      "realTimeDesc": "תתחרו נגד חברים חי",
      "noDownload": "שחקו מיד",
      "noDownloadDesc": "ללא התקנת אפליקציה",
      "freeForever": "100% חינם",
      "freeForeverDesc": "בלי מנויים לעולם",
      "multiLanguage": "5 שפות",
      "multiLanguageDesc": "עברית, אנגלית, שוודית, יפנית, ספרדית"
    },
    "socialProof": {
      "playersDaily": "1,000+",
      "playersDailyLabel": "שחקנים ביום",
      "wordsFound": "500K+",
      "wordsFoundLabel": "מילים נמצאו",
      "rating": "4.8★",
      "ratingLabel": "דירוג שחקנים"
    },
    "altComparison": "האלטרנטיבה החינמית הטובה ביותר לבוגל, סקראבל ווורדל לקבוצות"
  },
  "modeDiscovery": {
    "title": "מוכנים לעוד? 🚀",
  ...
  "daily": {
    ...
    "boardWillBeGenerated": "לוח ייחודי בגודל {size}x{size} ייווצר באמצעות מילון {language}.",
    "enterTargetWord": "הזינו את מילת האתגר שלכם",
    "wordPlaceholder": "{min}-{max} אותיות",
    "errorWordRequired": "נא להזין מילה",
    "errorWordTooShort": "המילה חייבת להיות לפחות {minLen} אותיות",
    "errorWordTooLong": "המילה יכולה להיות עד {maxLen} אותיות",
