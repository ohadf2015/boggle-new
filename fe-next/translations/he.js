...
const he = {
  ...
  "wordTower": {
    ...
    "upgrade": { "title": "שדרוגי מגדל", "subtitle": "שיפורים קבועים — בזבזו את המטבעות", "open": "שדרוגים", "balance": "{n} מטבעות", "buy": "קנה", "max": "מקסימום", "level": "דרגה {n}/{max}", "owned": "ברשותך", "close": "סיום", "broke": "אין מספיק מטבעות", "steadyCable": { "name": "כבל יציב", "desc": "מאט את תנופת המנוף לתזמון קל יותר" }, "wideFooting": { "name": "בסיס רחב", "desc": "מרחיב את חלון הנחיתה המושלמת" }, "windbreak": { "name": "שובר רוח", "desc": "מרגיע את הרוח בגובה רב" }, "masterArchitect": { "name": "אדריכל-על", "desc": "תגמול מטבעות גדול יותר בכל הנחה" }, "reinforcedCore": { "name": "ליבה מחוזקת", "desc": "שרדו רעידה אחת נוספת לפני קריסה" }, "quickRecovery": { "name": "התאוששות מהירה", "desc": "המגדל מתיישר מהר יותר" } },
  ...
  "modeCoach": {
    ...
    "wordHunt": {
      "title": "פצח את המילה",
      "step1": "הקש אותיות כדי לנחש",
      "step2": "הצבעים מראים כמה קרוב",
      "scoreTip": "תנחש ראשון = ניקוד גדול!"
    },
    "wheelRush": {
      "title": "סובב וכתוב",
