...
const he = {
  ...
  "seo": {
    ...
    "daily": {
      "title": "המילה היומית בעברית — נחשו מילה ב-10 ניסיונות | LexiClash",
      "description": "נחשו את המילה היומית בעברית ב-10 ניסיונות — אותו לוח לכולם. שתפו תוצאות, בנו רצף יומי, עלו בדירוג. חינם, ללא הרשמה. שחקו עכשיו ←",
      "ogTitle": "המילה היומית בעברית — נחשו את המילה | LexiClash",
      "ogDescription": "נחשו את המילה היומית בעברית ב-10 ניסיונות — אותו לוח לכולם. שתפו, בנו רצף, התחרו גלובלית. חינם!"
    },
    "multiplayer": {
  ...
  "modeCoach": {
    ...
    "classic": {
      "title": "גררו מילים",
      "step1": "גררו דרך אותיות סמוכות",
      "step2": "מילים ארוכות = יותר נקודות",
      "scoreTip": "שרשרו מילים בחיש קובץ!"
    },
    "wordHunt": {
      "title": "צופו במילה",
      "step1": "הקישו על אריחים כדי לנחש",
      "step2": "הצבעים חושפים את התשובה",
      "scoreTip": "מי שמוצא ראשון מנצח!"
    },
    "wheelRush": {
      "title": "סיבבו ותקשקשו",
      "step1": "תמיד השתמשו באות המרכזית",
      "step2": "נעלו מילה לפני שהיריבים גונבים",
      "scoreTip": "מילים ארוכות נעלות הרבה!"
    },
    "blast": {
      "title": "פוצצו אריחים",
      "step1": "גררו אותיות כדי ליצור מילה",
      "step2": "פטרו אריחים וזעזעו הנפצות",
      "scoreTip": "שרשרו הנפצות לקומבו ענק!"
    },
    "wordTower": {
      "title": "בנו את המגדל",
      "step1": "הקישו כדי להוריד את הבלוק",
      "step2": "הנחו אותו במרכז, לא בעלות",
      "scoreTip": "כל מילה = קומה — לכו גבוה!"
    },
    "connections": {
      "title": "מצאו קשרים",
      "step1": "קבצו ארבע מילים קשורות",
      "step2": "ניחוש אחד לא נכון עולה לכם",
      "scoreTip": "פתרו בלא טעויות!"
    },
    "wordCraft": {
      "title": "יוצרי מילים",
      "step1": "החליקו אריחים למקומם",
      "step2": "יוצרו מילים כדי לפטר אותם"
    },
    "wordAlchemy": {
      "title": "אלכימיה של מילים",
      "step1": "שנו אות אחת בכל שלב",
      "step2": "הוסיפו, החליפו או הסירו אות"
    },
    "crossword": {
      "title": "מלאו את הרשת",
      "step1": "הקישו על רמז, הקלידו תשובה",
      "step2": "פתרו אופקי וגם אנכי"
    },
    "sealedBid": {
      "title": "הצעה סגורה",
      "step1": "הקישו בסתר על המילה הטובה שלכם",
      "step2": "הצעות ייחודיות נותנות פי שתיים"
    },
    "shiritori": {
      "title": "שרשרת מילים",
      "step1": "התחילו בהיגד האחרון",
      "step2": "אל תסיימו בן (n)"
    },
    "adventure": {
      "title": "הרפתקה",
      "step1": "סיימו משימות כדי להתקדם",
      "step2": "כבשו בוסים בעזרת מילים ארוכות"
    }
  },
  "gameModes": {
    "classic": {
