...
"createForm": {
  ...
  "landing": {
    ...
    "seo": {
      ...
      "showcase3d": {
        ...
        "description": "גללו לעולם של מילים: גררו מילים על הלוח, שרשרו קומבו, הביסו את החדר בקרבות 1v3 בזמן אמת, וקחו את הכתר. חינם, מבוסס דפדפן, 5 שפות - ללא הורדה."
      }
    },
    "firstTimer": {
  ...
  "teacher": {
    "wordDetails": {
      ...
      "importFormatHelp": "תוספות אופציונליות אחרי קו אנכי |: syn: למילים נרדפות, ant: למילים הפוכות, ex: למשפט לדוגמה (כתבו ___ במקום המילה), level: support / core / challenge.",
    ...
    "subscription": {
      ...
      "freeStartNote": "מצוין להתנסות — כיתה אחת עם 10 תלמידים. כיתה אמיתית חורגת מזה ביום הראשון.",
      ...
      "faqDataLossAnswer": "לא. אם תבטלו, הכיתות, השיעורים ונתוני התלמידים יישמרו. פשוט תחזרו למגבלות המסלול החינמי (כיתה אחת, 10 תלמידים בכיתה).",
  ...
  "education": {
    ...
    "results": {
      ...
      "postReteachLiveGoogleClassroom": "פרסמו תרגול Live של 3 דק׳ ל-Google Classroom",
      "postReteachLiveGoogleClassroomTitle": "תרגול Live של 3 דק׳: {{lesson}}",
      "postReteachLiveGoogleClassroomBody": "לחצו לתרגול Live של 3 דקות על המילים שאף אחד לא מצא: {{missed}}",
      "startReteachLive": "התחלת תרגול Live"
    },
    "nav": {
      "section": "מורים",
      "forTeachers": "למורים",
    ...
    "landing": {
      ...
      "faq": {
        ...
        "q2": {
          "q": "יש מסלול חינם?",
          "a": "כן — מסלול בסיסי חינם למורים מאומתים: עד כיתה אחת עם 10 תלמידים, בלי פרסומות לתלמידים. מסלול Teacher Pro ($9 לחודש) פותח כיתות ותלמידים ללא הגבלה."
        },
        "q3": {
