...
const he = {
  ...
  "showcase3d": {
    ...
    "cap0Title": "גרור את המילה",
    "cap0Body": "גרור על הלוח — אותיות זוהרות בדרך.",
    "cap1Title": "שרשר את הקומבו",
    "cap1Body": "חבר מילים רצופות והדלק מכפיל נקודות.",
    "cap2Title": "תגבור על החדר",
    "cap2Body": "הביעו 3 יריבים על לוח אחד בזמן אמת.",
    "cap3Title": "תפסו את הכתר",
    "cap3Body": "קפצו לראש הלוח ותבעו את הניצחון — בקול רם.",
    ...
    "modesSub": "סיבובים אמיתיים, לוחות אמיתיים — כל אחד מחליק בעודכם גוללים.",
    "mode1Tag": "סולו · יומי",
    "mode1": "לוח אחד. זריקה אחת.",
    "mode1Body": "אותו לוח יומי לכולם. טיפסו בדירוג העולמי עד החצות.",
    "mode2Tag": "עד 1v3",
    "mode2": "קרבות מסיבה בזמן אמת",
    "mode2Body": "ארבע קוביות, לוח אחד בזמן אמת, ללא רחמים. הלוח הקולני ביותר ינצח.",
    "mode3Tag": "5 שפות",
    "mode3": "שחק בשפה שלך",
    "mode3Body": "עברית, אנגלית, שוודית, יפנית, ספרדית — המילים שלך, הטריטוריה שלך.",
    "bottomTitle": "תורך. תעשה רעש.",
    "bottomCta": "שחק ב-LexiClash בחינם",
    "floatCta": "שחק בחינם"
  }
};
