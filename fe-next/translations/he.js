...
const he = {
  ...
  "wordTower": {
    ...
    "hud": { "floors": "{n} קומות", "combo": "שרשרת {n}", "scramble": "ערבוב", "backspace": "מחיקה", "build": "בנייה", "restart": "מחדש", "restartConfirm": "בטוח?", "best": "שיא {m} מ'", "possible": "{n} מילים", "clue": "רמז", "collapse": "כיווץ", "expand": "הרחבה", "rivalPassed": "עברת את {name}!", "stuck": "תקוע? אות חדשה", "backToTop": "למעלה", "pickLetters": "בחרו אותיות" },
  ...
  "seo": {
    ...
    "educationHub": {
      "title": "מרכז החינוך — משחקי מילים לכיתה ולמורים",
      "description": "משלבים את לקסיקלאש בשיעור: בונים שיעורי מילים, עוקבים אחר אוצר המילים של כל תלמיד והופכים את הלמידה למשהו שתלמידים אוהבים.",
      "ogTitle": "מרכז החינוך של לקסיקלאש",
      "ogDescription": "משחקי מילים לכיתה — בונים שיעור, עוקבים אחר התקדמות."
    },
    "educationDuels": {
  ...
  "education": {
    ...
    "landing": {
      ...
      "hero": {
        ...
        "h1": "משחק מילים שנבנה בשפה שלכם — לא תורגם אליה.",
        "sub": "משחק רב-משתתפים חי, אימוני מוח, 6 מצבי משחק. בלי פרסומות לתלמידים. חינם למורים — הבקשה לוקחת דקה.",
