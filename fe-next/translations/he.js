...
const he = {
  ...
  "cookieConsent": {
    "title": "הסכמה לעוגיות",
    "message": "אנו משתמשים בעוגיות לניתוח נתונים ולהצגת פרסומות רלוונטיות. ניתן להתאים את ההעדפות שלך למטה.",
    "accept": "אישור הכל",
    "decline": "דחיית הכל",
  ...
  "errors": {
    ...
    "notInGame": "אתה לא במשחק הזה",
    "hostOnly": "רק המארח יכול לעשות את זה",
    "alreadyInGame": "אתה כבר במשחק",
    "kicked": "הוסרת מהמשחק",
    ...
    "validationFailed": "משהו לא בסדר. בדוק את הקלט",
    "invalidRequest": "בקשה לא תקינה",
    "missingField": "חסר מידע נדרש",
  ...
  "results": {
    ...
    "sharedWordsExplanation": "מילים אלו נמצאו גם על ידי שחקנים אחרים, אז הן שוות 0 נקודות. נסו למצוא מילים ייחודיות! 🎯",
  ...
  "wordFeedback": {
    ...
    "witty4": "וובסטר התקשר, רוצה לדעת על \"{word}\"",
...
"wordHunt": {
  ...
  "theme": {
    ...
    "mondayMotivation": "מוטיבציה של יום שני",
    "tuesdayTrivia": "טריוויה של יום שלישי",
    "wednesdayWisdom": "חוכמת יום רביעי",
    "thursdayThrowback": "נוסטלגיה של יום חמישי",
    "funFriday": "שישי שמח",
