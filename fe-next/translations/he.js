...
const he = {
  ...
  "legal": {
    ...
    "about": {
      ...
      "whoWeAre": {
        "title": "מי אנחנו",
        "content": "LexiClash הוא משחק אסטרטגיית מילים מרובה משתתפים בזמן אמת שפותח על ידי LexiClash Ltd. אנו יוצרים משחקי מילים מרתקים, חינוכיים ותחרותיים לשחקנים ברחבי העולם במספר שפות."
      },
      "mission": {
        "title": "המשימה שלנו",
        "content": "המשימה שלנו היא להפוך את לימוד שפות למהנה ותחרותי. אנו מאמינים שמשחקים הם הדרך הטובה ביותר לשפר אוצר מילים, איות וחשיבה מהירה תוך התחברות עם חברים ושחקנים ברחבי העולם."
      },
      "whatWeDo": {
        "title": "מה אנחנו עושים",
        "content": "אנו מפתחים משחקי מילים מרובי משתתפים המשלבים מהירות, אסטרטגיה ויכולות אוצר מילים. LexiClash תומך בעברית, אנגלית, שוודית, יפנית וספרדית, מה שהופך אותו לנגיש לשחקנים ברחבי העולם."
      },
      "team": {
        "title": "הצוות שלנו",
        "content": "LexiClash נוסדה על ידי צוות של חובבי משחקי מילים ומהנדסי תוכנה נלהבים. אנחנו מחויבים ליצירת חוויית משחק מילים מרובת משתתפים הטובה ביותר."
      },
      "contact": {
        "title": "צור קשר",
        "content": "יש לך שאלות או משוב? נשמח לשמוע ממך!"
      },
      "businessInfo": {
        "title": "מידע עסקי",
      ...
      "story": {
        "title": "הסיפור שלנו",
        "content": "לקסיקלאש נולד ב-2024 כפרויקט אישי מרעיון פשוט: מה אם משחקי מילים היו מרגשים כמו ספורט אלקטרוני תחרותי? הפרויקט נוסד בישראל, ויצאנו לבנות משחק מילים שמשלב את העומק האסטרטגי של סקראבל עם מהירות תחרות בזמן אמת. היום, אלפי שחקנים מיותר מ-30 מדינות מתחרים מדי יום בקרבות מילים ב-5 שפות."
      },
      "technology": {
        "title": "נבנה למהירות",
        "content": "לקסיקלאש בנוי עם טכנולוגיית אינטרנט חדשנית. המנוע בזמן אמת שלנו מספק זמני תגובה של פחות מ-100 אלפיות שנייה למשחק מרובה משתתפים חלק. המשחק רץ לגמרי בדפדפן — ללא צורך בהורדת אפליקציה. אנחנו משתמשים בחיבורי WebSocket לאימות מילים מיידי ועדכוני ניקוד חיים."
      },
      "education": {
        "title": "חינוך ולמידה",
        "content": "מעבר לבידור, לקסיקלאש הוא כלי רב-עוצמה לבניית אוצר מילים. מורים משתמשים במצב החינוך שלנו ליצירת שיעורי מילים מותאמים ומעקב אחר התקדמות תלמידים. מחקרים מראים שמשחקי מילים תחרותיים משפרים את שימור אוצר המילים עד 40% בהשוואה לשיטות כרטיסיות מסורתיות."
      },
      "community": {
        "title": "הקהילה שלנו",
        "content": "קהילת לקסיקלאש מגוונת וגדלה. מערבי משחק משפחתיים ועד טורנירים תחרותיים, השחקנים שלנו מגיעים מכל הגילאים ורמות המיומנות. אנחנו מארחים אתגרים יומיים שבהם כולם משחקים את אותו פאזל, איפוס טבלת מובילים שבועי ואירועים מיוחדים בחגים."
      },
      "values": {
        "title": "הערכים שלנו",
        "content": "אנחנו מאמינים שמשחקים צריכים להיות נגישים לכולם. לקסיקלאש חינמי ללא חסמי תשלום. אנחנו מעדיפים נגישות עם תמיכה מלאה בקוראי מסך, ניווט מקלדת ועיצוב ניגודיות גבוהה. אנחנו מגנים על פרטיות השחקנים — במיוחד לשחקנים צעירים — עם פרסום בטוח לילדים ושקיפות בנתונים."
      }
    },
    "disclaimer": {
      "title": "כתב ויתור",
