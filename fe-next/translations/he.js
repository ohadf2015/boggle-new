...
const he = {
  ...
  "seo": {
    "title": "לקסיקלאש - משחק מילים חינם | מרובה משתתפים אונליין",
    ...
    "studentProfile": {
      "title": "פרופיל תלמיד והתקדמות | לקסיקלאש חינוך",
    ...
    "multiplayer": {
      "title": "משחק מילים מרובה משתתפים בעברית - כמו בוגל וסקראבל אונליין | לקסיקלאש",
    ...
    "about": {
      "title": "אודות - הסיפור והמשימה שלנו | לקסיקלאש",
