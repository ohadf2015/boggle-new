...
const he = {
  ...
  "common": {
    ...
    "reconnected": "חזרנו לפעולה!",
    "connectionLost": "החיבור נפל",
    "notConnected": "אין חיבור",
    "connected": "מחובר",
    "connecting": "מתחבר...",
    "connectedToServer": "מוכן לשחק!",
    "connectingToServer": "מכין את הקרב...",
  ...
  "earthquake": {
    "warning": "רעידת אדמה!",
    "brace": "הנה זה בא!",
    "photosensitivity": "אורות מהבהבים! כבו בהגדרות אם רגישים",
    "fireRound": "סיבוב אש",
    "multiplier": "נקודות ×2"
  },
  "spam": {
  ...
  "share": {
    "linkCopied": "הועתק! 📋",
    "copyError": "נכשל - נסו שוב",
    "inviteMessage": "קרב מילים עכשיו - קפצו פנימה!",
    "room": "חדר",
    "code": "קוד",
    "joinViaLink": "קפצו לכאן",
    "copyLinkButton": "העתק",
    "whatsappButton": "וואטסאפ",
    "qrCodeButton": "ברקוד",
    "qrCodeTitle": "סרקו להצטרפות",
    "shareTitle": "הביאו חברים",
    "codeCopied": "הועתק! 🎯",
    "codeCopyError": "ההעתקה נכשלה",
    "buttonLabel": "הזמנה",
    "modalTitle": "הביאו תחרות",
    "scanQR": "סרקו להילחם",
    ...
    "telegram": "טלגרם",
    "more": "עוד",
    "inviteTitle": "קרב עכשיו!",
    "copied": "הועתק!",
    "shareVictory": "תתגאו!",
    "scanToJoin": "סרקו להילחם",
    "challengeFriends": "הביאו את החבר׳ה 😈",
    "beatMyScore": "חושבים שתנצחו?",
    "canYouBeatMe": "תנסו לנצח את זה."
  },
  "errors": {
    "unstableConnection": "חיבור רועד - ייתכנו בעיות במשחק",
    "slowConnection": "חיבור איטי זוהה",
    "sessionExpired": "הסשן פג. קפצו לחדר חדש!",
    "gameCodeNotExist": "הקוד הזה לא קיים. בודקים שוב?",
    "usernameTaken": "השם תפוס! בחרו אחר",
    "gameCodeExists": "הקוד בשימוש. נסו אחר",
    "somethingWentWrong": "הממ, משהו נשבר",
    "unexpectedError": "אופס! נסו לרענן את הדף",
    "errorDetails": "פרטים",
    "refreshPage": "רענון",
    "connectionTimeout": "תם הזמן",
    "rateLimited": "רגע, לאט יותר!",
    "connectionLost": "החיבור נפל",
    "notConnected": "אין חיבור"
  },
  "validation": {
