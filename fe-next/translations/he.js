...
const he = {
  ...
  "seo": {
    ...
    "daily": {
      "title": "המילה היומית בעברית — כמו Wordle, חינם ללא הרשמה | LexiClash",
      "description": "פאזל המילה היומית בעברית — כמו Wordle, חינם ומיידי. 10 ניסיונות לנחש את המילה, אותו לוח לכולם. שתפו תוצאות אמוג׳י, בנו רצף. ללא הרשמה.",
      "ogTitle": "המילה היומית בעברית — Wordle בעברית, חינם",
      "ogDescription": "נחשו את המילה העברית היומית — כמו Wordle אבל בעברית. 10 ניסיונות, אותו לוח לכולם. שתפו, בנו רצף. חינם!"
    },
    "multiplayer": {
