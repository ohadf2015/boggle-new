...
"wordHunt": {
  ...
  "brain": {
    ...
    "tips": {
      "tip1": "קיבולת זיכרון העבודה יכולה לעלות ב-15% עם שבועיים בלבד של אימון יומי במשחקי מילים.",
      "tip2": "מהירות העיבוד מגיעה לשיא עם אימון יומי עקבי - המוח שלך יוצר מסלולים עצביים מהירים יותר.",
      "tip3": "מציאת מילים נדירות מפעילה שליפת אוצר מילים עמוקה יותר - מיומנות קוגניטיבית מפתח.",
      "tip4": "שמירה על קומבו מאמנת קשב מתמשך - קריטי למיקוד בחיי היומיום.",
      "tip5": "מעבר בין אורכי מילים בונה גמישות קוגניטיבית - יכולת הסתגלות מנטלית."
    }
  },
  "levelUp": {
    "title": "עלית רמה!",
