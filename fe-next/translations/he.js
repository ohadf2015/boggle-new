...
const he = {
  ...
  "seo": {
    ...
    "education": {
      "title": "לקסי קלאש חינוך - משחקי מילים לכיתות ומורים",
      "description": "הביאו משחקי מילים לכיתה! לקסי קלאש חינוך עוזר למורים ליצור שיעורי אוצר מילים, לעקוב אחרי התקדמות תלמידים ולהפוך את הלמידה למעניינת.",
      "ogTitle": "לקסי קלאש חינוך - משחקי מילים לכיתות",
      "ogDescription": "משחקי מילים לכיתות! צרו שיעורים, עקבו אחרי התקדמות והפכו לימוד אוצר מילים לכיף."
    },
    "educationClassroomGame": {
      "title": "משחק מילים לכיתה בשידור חי - דשבורד למורים | לקסי קלאש",
      "description": "הפעילו משחק מילים חי בכיתה. לוח הבקרה למורים מריץ סבב מרובה משתתפים בזמן אמת — תלמידים מצטרפים מכל מכשיר, ללא הרשמה.",
      "ogTitle": "משחק מילים לכיתה חי - דשבורד למורים",
      "ogDescription": "התחילו סבב משחק מילים מרובה משתתפים לכיתה — מכל מכשיר, ללא הרשמה."
    },
    "dailyArchive": {
    ...
    "educationHub": {
      "title": "מרכז חינוך — משחקי מילים לכיתות ומורים",
      "description": "השתמשו בלקסי קלאש בכיתה! צרו שיעורי משחקי מילים, עקבו אחר התקדמות אוצר המילים של התלמידים והפכו את הלמידה למהנה.",
      "ogTitle": "מרכז החינוך של לקסי קלאש",
      "ogDescription": "משחקי מילים לכיתות — צרו שיעורים, עקבו אחר התקדמות!"
    },
    "educationDuels": {
      "title": "דו-קרבות אוצר מילים — תלמיד מול תלמיד",
      "description": "אתגרו חברי כיתה לדו-קרבות אוצר מילים! קרבות מילים 1 נגד 1 בזמן אמת שבודקים איות, אוצר מילים וחשיבה מהירה.",
      "ogTitle": "דו-קרבות אוצר מילים - לקסי קלאש חינוך",
      "ogDescription": "קרבות מילים 1 נגד 1 לתרגול אוצר מילים!"
    },
    "communityBoard": {
  ...
  "practice": {
    "instructions": {
      ...
      "cta": "יאללה!",
      "classic": {
        "line1": "גררו את האצבע על האותיות — לא חייב להיות בשורה.",
        "line2": "גם אלכסונים נספרים. כל כיוון עובד!",
        "line3": "מצאו 3 מילים אמיתיות כדי לנצח. בלי שעון, בלי לחץ.",
        "scoring1": "+2 נקודות לכל אות.",
        "scoring2": "רצפי קומבו = בונוס נקודות."
      },
      "wordHunt": {
        "line1": "מילה סודית מסתתרת על הלוח. הקטגוריה למעלה היא הרמז שלכם!",
        "line2": "נסו כל ניחוש — הצבעים מראים אילו אותיות קרובות לתשובה.",
        "line3": "פצחו את המילה הסודית כדי לנצח. קחו את כל הזמן שצריך."
      },
      "wheelRush": {
        "line1": "הקישו על אותיות סביב הגלגל כדי לבנות מילה.",
        "line2": "האות הזוהרת באמצע חייבת להופיע בכל מילה.",
        "line3": "מצאו 3 מילים אמיתיות כדי לסיים — אט אט!"
      }
    },
    "modifier": {
    ...
    "wordHunt": {
      ...
      "huntInstruction": "מילה בת {length} אותיות מסתתרת על הלוח. כל מילה תקפה נספרת כתגלית — רק מילים באורך {length} ייחשבו כניחוש ויחשפו רמזי צבע על המטרה.",
      "triesLeft": "ניסיונות",
      ...
      "playRealCta": "שחק במשחק האמיתי ←",
      "shortWordTip": "{word} קצרה מדי. במשחק האמיתי צריך {min}+ אותיות אחרת מאבדים חיים.",
      "discoveryHint": "מילת בונוס! נחשפו אותיות רמז.",
      "discoveryTipNoClue": "מילה חוקית — אבל לא נחשפו אותיות מהמטרה. נסי מילים ארוכות יותר!"
    },
    "complete": {
      "title": "המצב הושלם!",
    ...
    "wheelRush": {
      ...
      "reset": "אפס",
      "shuffle": "ערבוב",
      "builderHint": "הקש או גרור אותיות",
    ...
    "mistakeCoach": {
      ...
      "cta": "סבבה!",
      "notAWord": {
        "title": "אופס — זאת לא מילה!",
        "body": "נסה מילים אמיתיות מהמילון כמו כוכב, חתול או שולחן. צירופים מומצאים לא נחשבים, אבל באימון אין סכנה — תמשיך לחקור!"
      },
      "notAdjacent": {
        "title": "האותיות חייבות להיגע!",
        "body": "כל אות צריכה לשבת ממש ליד הקודמת — צדדים וגם פינות נחשבים. חבר אותן כמו שרשרת!"
      },
      "diagonalsOk": {
        "title": "אלכסונים עובדים גם!",
        "body": "אפשר לחבר אותיות בכל 8 הכיוונים — כולל אלכסונים. נסה זיגזג לגילויים מפתיעים!"
      },
      "needsCenter": {
        "title": "השתמש באות הירוקה!",
        "body": "כל מילה בגלגל חייבת לכלול את האות הבהירה במרכז. זה הלב של החידה — התחל איתה!"
      }
    }
  },
  "practiceSwipe": {
...
"wordHunt": {
  ...
  "dailyWordWheelLanding": {
    ...
    "steps": {
      ...
      "1": { "title": "פאזל חדש כל יום", "desc": "גלגל אותיות חדש מופיע כל יום בחצות UTC. כל השחקנים בעולם מקבלים את אותן אותיות." },
      "2": { "title": "מצאו מילים", "desc": "צרו מילים מאותיות הגלגל. כל מילה חייבת לכלול את האות המרכזית ולהיות באורך של 3 אותיות לפחות. מילים ארוכות = יותר נקודות." },
      "3": { "title": "נצחו את השעון", "desc": "מצאו כמה שיותר מילים לפני שהזמן נגמר. גם מהירות וגם אוצר מילים חשובים." },
      "4": { "title": "השוו גלובלית", "desc": "ראו את הדירוג שלכם בטבלת המובילים היומית. רדפו אחרי השיא העולמי ועקבו אחר הרצף." }
    },
    "faq": {
      "heading": "שאלות נפוצות",
      "items": [
        { "q": "מהו גלגל המילים היומי?", "a": "גלגל המילים היומי הוא פאזל מילים חינמי בלקסי קלאש. כל יום בחצות UTC מופיע גלגל אותיות חדש. המטרה שלכם למצוא כמה שיותר מילים. כל השחקנים בעולם משחקים את אותו פאזל." },
        { "q": "איך משחקים?", "a": "מקבלים אותיות מסודרות בגלגל עם אות מרכזית אחת. צרו מילים — כל מילה חייבת לכלול את האות המרכזית ולהיות באורך של 3 אותיות לפחות. מצאו כמה שיותר מילים לפני שהזמן נגמר." },
        { "q": "זה חינם?", "a": "כן, לגמרי חינם. בלי הורדה, בלי הרשמה, בלי פרסומות. שחקו בדפדפן בכל מכשיר." },
        { "q": "אפשר לראות את השיא העולמי?", "a": "כן! אחרי השלמת הפאזל תוכלו לראות את טבלת המובילים הגלובלית עם הציונים הגבוהים ביותר של היום." },
        { "q": "כל המילים חייבות לכלול את האות המרכזית?", "a": "כן! כל מילה שמגישים חייבת לכלול את האות המרכזית של הגלגל. זה האתגר המרכזי שהופך את הפאזל למאתגר." },
        { "q": "באילו שפות זמין?", "a": "גלגל המילים היומי זמין באנגלית, עברית, שוודית, יפנית וספרדית. לכל שפה מילון וטבלת מובילים משלה." }
      ]
    },
    "finalCta": {
  ...
  "admin": {
    ...
    "teacherAccess": {
      ...
      "count": { "pending": "בהמתנה", "approved": "אושר", "declined": "נדחה", "total": "סה״כ" },
      "filter_status": "סטטוס",
      ...
      "col": { "name": "שם", "email": "דוא״ל", "role": "תפקיד", "locale": "שפה", "country": "מדינה", "status": "סטטוס", "submitted": "הוגש" },
      "drawer_title": "פרטי בקשה",
      "field": { "name": "שם", "email": "דוא״ל", "role": "תפקיד", "locale": "שפה", "country": "מדינה", "school": "בית ספר", "status": "סטטוס", "submitted": "הוגש", "use_case": "מקרה שימוש" },
  ...
  "adventure": {
    ...
    "world": {
      "1": { "theme": "טבע וגינה" },
      "2": { "theme": "מים וזרימה" },
      "3": { "theme": "אדמה ומינרלים" },
      "4": { "theme": "אוקיינוס ומסע" },
      "5": { "theme": "בנייה ומלאכה" },
      "6": { "theme": "מסתורין וחידות" },
      "7": { "theme": "אור והשתקפות" },
      "8": { "theme": "חלל ומדע" },
      "9": { "theme": "תרבות ושפה" },
      "10": { "theme": "עוצמה וידע" }
    },
...
"game": {
  ...
  "blast": {
    ...
    "tile": {
      ...
      "ice":       { "name": "קרח",      "desc": "2 פגיעות לשבירה. אריח הגנתי רב-פגיעות." },
      ...
      "shuffle":   { "name": "ערבוב",    "desc": "מסדר מחדש את כל האותיות הנותרות בלוח בניקוי." },
      "magma":     { "name": "מגמה",     "desc": "מנקה את שתי האלכסונים (תבנית X) עם מכפיל ניקוד ×2." },
      "portal":    { "name": "פורטל",    "desc": "טלפורט מסלול המילה דרך זוגות מקושרים. מנקה שניהם. ×2 ניקוד. +5 בונוס." },
      "catalyst":  { "name": "זרז",      "desc": "+10 נק׳. משדרג אריחים רגילים סמוכים למיוחדים." },
      "crystal":   { "name": "קריסטל",   "desc": "גדל ב-×1 בכל תור שלא נעשה בו שימוש (עד ×5). מכפיל את ניקוד המילה כשמשתמשים בו." },
      "fuse":      { "name": "פתיל",     "desc": "זוג מקושר. נקה אחד כדי להדליק את בן זוגו — נטרל תוך 3 תורות ל-15+ נק׳ ו-2 מהלכים, אחרת מתפוצץ 3×3 ל-50- נק׳." },
      "locked":    { "name": "נעולה",    "desc": "אריח חסום — לא ניתן לשימוש במילים. נקה את המפתח המשויך כדי לשחרר." },
      "key":       { "name": "מפתח",     "desc": "משחרר אריחים נעולים סמוכים (8 כיוונים) כאשר נכלל במילה. 20+ נק׳ לכל שחרור." },
      "anchor":    { "name": "עוגן",      "desc": "מתגמל מילים ארוכות. מוסיף 3+ נקודות עבור כל אות במילה כאשר נוקה." }
    },
    "title": "מצב פיצוץ",
    ...
    "tileGuide": {
      ...
      "shuffle": { "name": "ערבוב", "desc": "מסדר מחדש את כל האותיות הנותרות בלוח בניקוי" },
      "magma": { "name": "מגמה", "desc": "מנקה את שתי האלכסונים (תבנית X) עם מכפיל ניקוד ×2" },
      "portal": { "name": "פורטל", "desc": "טלפורט בין זוגות — מנקה שניהם, ×2 ניקוד מילה" },
      "catalyst": { "name": "זרז", "desc": "משדרג את כל האריחים הסמוכים למיוחדים" },
      "crystal": { "name": "קריסטל", "desc": "גדל ב-×1 בכל תור שלא בשימוש (עד ×5) — מכפיל את ניקוד המילה" },
      "fuse": { "name": "פתיל", "desc": "זוג מקושר — נקה אחד כדי להדליק את בן זוגו, נטרל תוך 3 תורות או שיתפוצץ" },
  ...
  "education": {
    ...
    "duels": {
      ...
      "rematch": "משחק חוזר",
      "loading": "טוען את הדו-קרב...",
      "vs": "נגד",
      "pvp": "PVP",
      "unknownLesson": "שיעור לא ידוע",
      "online": "מחובר"
    },
    "challenges": {
      "xpReward": "+{{amount}} XP",
    ...
    "achievements": {
      ...
      "pin": "הצמד לפרופיל",
      "pinLimit": "{{current}}/{{max}} מוצמדים. בטל הצמדה כדי להצמיד אחר",
    ...
    "landing": {
      ...
      "startGame": "התחל משחק",
      "hero": {
        "eyebrow": "למורים בכיתות עברית, אנגלית, שוודית, יפנית וספרדית",
        "h1": "משחק מילים שנוצר לשפה שלך — לא תרגום.",
        "sub": "משחק חי ריבוי משתתפים, תרגילי מוח, 6 מצבים. ללא מודעות לתלמידים. חינם למורים — בקשה בעשר שניות.",
        "cta_primary": "בקשו גישת מורה",
        "cta_secondary": "ראו דוגמה"
      },
      "moat": {
        "title": "למה מורים בחמש שפות בחרו ב-LexiClash",
        "subtitle": "שלוש סיבות שאנחנו יכולים להגן עליהן — לא סתם טענות.",
        "native_multilingual": {
          "tag": "אותנטי",
          "title": "בנוי בשפה שלך",
          "body": "עברית מימין לשמאל, יפנית עם קאנה ו-IME, מילים שוודיות מורכבות, ספרדית עם דגשים — הכל במנוע. לא תרגום של גוגל."
        },
        "local_inventory": {
          "tag": "מקומי",
          "title": "מילים מהווקיפדיה של הארץ",
          "body": "עברית מוויקיפדיה בעברית ומילון מילוג. התלמידים שלך לומדים מילים שחשובות להם — לא משיעורים בחו״ל."
        },
        "ad_free": {
          "tag": "ללא פרסומות",
          "title": "אפס מודעות. תמיד.",
          "body": "Kahoot, Quizlet, Blooket הם מציגים מודעות. אנחנו לא — כל דף בחינוך נקי. COPPA + GDPR."
        }
      },
      "modes": {
        "title": "6 משחקים, פלטפורמה אחת — שנה כדי שלא יזעמו",
        "teaches": "מלמד",
        "classroom_game": {
          "tag": "חי",
          "title": "משחק כיתה",
          "body": "כל הכיתה מחזרת מילים בעת אחת.",
          "teaches": "אוצר מילים, איות, מהירות"
        },
        "vocab_duels": {
          "tag": "דו-קרב",
          "title": "דו-קרבות מילים",
          "body": "אתגר 1v1 עם חבר — בזמן אמת או מתי שהם רוצים.",
          "teaches": "זיכרון, אחזור"
        },
        "brain_drills": {
          "tag": "מוח",
          "title": "תרגילי מוח",
          "body": "זיכרון, קשב, מהירות עיבוד.",
          "teaches": "כישורים קוגניטיביים"
        },
        "daily_wordhunt": {
          "tag": "יומי",
          "title": "ציד מילים יומי",
          "body": "חידה חדשה כל יום, דירוג לאזור שלך.",
          "teaches": "תרגול קביע"
        },
        "adventure": {
          "tag": "סיפור",
          "title": "הרפתקה",
          "body": "מילים בתוך סיפור וחידות עולמיות.",
          "teaches": "עומק בשפה"
        },
        "spelling_bee": {
          "tag": "איות",
          "title": "תרגול איות",
          "body": "איות בדיבור, בכל השפות.",
          "teaches": "איות"
        }
      },
      "compare": {
        "title": "LexiClash מול השאר",
        "subtitle": "בדיקות ישירות — רק איפה שאנחנו באמת יחידים.",
        "col": {
          "lexiclash": "LexiClash",
          "kahoot": "Kahoot!",
          "quizlet": "Quizlet",
        ...
        "row": {
          "native_multilingual": "מקומי בכל שפה (עברית RTL, יפנית IME)",
          "ad_free_students": "אפס מודעות לתלמידים",
          "live_multiplayer": "משחק חי ריבוי משתתפים",
          "brain_training": "תרגילי מוח",
          "game_variety": "6 משחקים או יותר",
          "free_for_teachers": "חינם למורים אמיתיים"
        }
      },
      "trust": {
        "title": "בנוי על אמון",
        "bullet1": "אפס מודעות בכל דף חינוך.",
        "bullet2": "הנתונים שלהם בטוחים — GDPR ממלא מקום, טלמטריה רק עם הזמנה.",
        "bullet3": "COPPA — תלמידים מתחת לגיל 13 בטוחים אצלנו."
      },
      "faq": {
        "title": "שאלות שכל מורה שואל",
        "q1": {
          "q": "איך מקבלים גישה?",
          "a": "טופס מהיר ב-/education/access. אנחנו קוראים כל בקשה וחוזרים במייל, בדרך כלל ביום."
        },
        "q2": {
          "q": "זה באמת חינם?",
          "a": "כן — חינם ללא תאריך סיום. ללא מודעות לתלמידים."
        },
        "q3": {
          "q": "זה עובד בעברית, יפנית, שוודית וספרדית?",
          "a": "כן. עברית RTL, יפנית עם קאנה/IME, הכל מקומי. לא תרגום."
        },
        "q4": {
          "q": "פרטיות — מה אתם עושים עם הנתונים?",
          "a": "COPPA + GDPR. ללא מעקב מודעות. ללא מכירת נתונים. תלמידים תחת גיל 13 מוגנים."
        },
        "q5": {
          "q": "האם צריך חשבון?",
          "a": "לא — משחק אורח זמין ברוב המצבים."
        },
        "q6": {
          "q": "מה מבדיל אתכם מ-Kahoot / Quizlet / Wordwall?",
          "a": "שלנו מקומי בכל שפה (לא תרגום), אפס מודעות, 6 משחקים בפלטפורמה אחת, ומילים מוקד ההקשר שלך."
        },
        "q7": {
          "q": "אני רואה התקדמות של כל תלמיד?",
          "a": "כן. לוח מורה עם ניתוח לאחד, לכיתה, וחסמים שצריכים עזרה."
        },
        "q8": {
          "q": "עובד על Chromebook, טאבלט, סמארטפון?",
          "a": "כן. אתר בדפדפן, לא צריך להוריד שום דבר."
        }
      },
      "cta": {
        "title": "מוכנים להיכנס?",
        "body": "טופס מהיר — 60 שניות. בדרך כלל אושור ביום.",
        "button": "בקשו גישה"
      },
      "esl-word-games": {
    ...
    "teacher": {
      ...
      "welcome_banner_body": "אתם אושרו. עכשיו אתם יכולים ליצור כיתות, הטיל משחקים, ולראות איך התלמידים מתקדמים.",
    ...
    "access": {
      "h1": "בקשה לגישת מורה",
      "lede": "תגידו לנו קצת על הכיתה. אנחנו בודקים ומחזירים מייל, בדרך כלל ביום.",
      "full_name": "שם מלא",
      "email": "דוא״ל",
      "role": "מה אתה?",
      "role_teacher": "מורה",
      "role_tutor": "מנחה/אם-אמא",
      "role_admin": "מנהל בית ספר",
      "role_parent": "הורה / בית",
      "role_researcher": "חוקר",
      "role_other": "אחר",
      "school_or_org": "בית ספר/ארגון (לא חובה)",
      "country": "איזו מדינה (לא חובה)",
      "use_case": "איך תשתמשו ב-LexiClash? (10-800 תווים)",
      "submit": "שלחו",
      "submitting": "שולח…",
      "submit_error": "משהו לא קרוב. בואו תנסו שוב.",
      "rate_limited": "נסו שוב ב-24 שעות.",
      "success_title": "קיבלנו!",
      "success_body": "אנחנו בודקים. מייל יגיע בימים הקרובים.",
      "success_next": "תקבלו מייל תוך 1-2 ימים. אתם יכולים לסגור את הדף.",
      "pending_title": "בתור בדיקה",
      "pending_body": "קיבלנו. חכו למייל.",
      "declined_title": "הפעם לא עבר",
      "declined_reapply": "אתם יכולים להגיש שוב בכל עת. יש שאלות? כתבו לנו.",
      "submitted_on": "בתאריך",
      "already_approved_title": "אתם כבר אושרו! 🎉",
      "go_to_teacher": "לוח המורה",
      "next": {
        "step1_title": "טופס קצר",
        "step1_body": "60 שניות.",
        "step2_title": "אנחנו קוראים",
        "step2_body": "אדם אמיתי בודק כל בקשה. בדרך כלל ביום.",
        "step3_title": "גישה!",
        "step3_body": "מייל אישור וגישה מיד."
      },
      "regular_game_title": "לא מורה?",
      "regular_game_body": "LexiClash חינם לכל אחד. שחקו וחזרו אם אתם רוצים כלים למורים.",
  ...
  "notifications": {
    ...
    "landing": {
      "hero": {
        "eyebrow": "למורים בכיתות דיבור עברית, אנגלית, שוודית, יפנית וספרדית",
        "h1": "פלטפורמת משחקי המילים שנבנתה לשפה שלך — לא תורגמה אליה.",
        "sub": "משחק חי ריבוי משתתפים, תרגילי מוח, ו-6 מצבי משחק. ללא מודעות לתלמידים. חינם למורים — בקשו גישה ב-60 שניות.",
        "cta_primary": "בקשו גישת מורה",
        "cta_secondary": "ראו זאת בפעולה"
      },
      "moat": {
        "title": "למה מורים ב-5 שפות בוחרים ב-LexiClash",
        "subtitle": "שלוש סיבות שאנחנו יכולים להגן עליהן, לא רק לטעון אותן.",
        "native_multilingual": { "tag": "מקומי", "title": "בנוי בשפה שלך", "body": "עברית מימין לשמאל, יפנית עם קאנה ו-IME, מילים שוודיות מורכבות, ודגשים בספרדית — הכל מטופל ברמת המנוע. לא תרגום Google." },
        "local_inventory": { "tag": "מקומי", "title": "רשימות מילים מהווקיפדיה המקומית", "body": "רשימות מילים מתוך ויקיפדיה בעברית ומילון מילוג. התלמידים רואים מילים רלוונטיות תרבותית מהארץ שלהם — לא משיעורי K-12 בארה״ב." },
        "ad_free": { "tag": "ללא מודעות", "title": "ללא מודעות לתלמידים. תמיד.", "body": "Kahoot, Quizlet, Blooket — כולם מציגים מודעות לתלמידים. אנחנו מתחייבים ללא מודעות בכל נתיב חינוך. COPPA + GDPR מודעים." }
      },
      "modes": {
        "title": "6 מצבי משחק, פלטפורמה אחת — סיבוב כדי להביס עייפות",
        "teaches": "מלמד",
        "classroom_game": { "tag": "חי", "title": "משחק כיתה", "body": "ציד מילים חי ריבוי משתתפים לכל הכיתה.", "teaches": "אוצר מילים, איות, מהירות" },
        "vocab_duels": { "tag": "דו-קרב", "title": "דו-קרבות אוצר מילים", "body": "אתגרי אוצר מילים 1v1 סינכרוני או אסינכרוני.", "teaches": "שמירה בזיכרון, זיכרון" },
        "brain_drills": { "tag": "מוח", "title": "תרגילי מוח", "body": "תרגילי זיכרון, קשב, מהירות עיבוד.", "teaches": "כישורים קוגניטיביים" },
        "daily_wordhunt": { "tag": "יומי", "title": "ציד מילים יומי", "body": "חידה חדשה כל יום, טבלת דירוג למקום.", "teaches": "תרגול יומי" },
        "adventure": { "tag": "סיפור", "title": "מצב הרפתקה", "body": "חידות מילים מונחות סיפור בעולמות בעלי ערכים.", "teaches": "עומק אוצר מילים" },
        "spelling_bee": { "tag": "דבורה", "title": "תרגול איות", "body": "תרגילי איות בהנחיית קול, ריבוי שפות.", "teaches": "איות" }
      },
      "compare": {
        "title": "איך LexiClash משתווה",
        "subtitle": "בדיקות כנות — רק היכן אנחנו באמת מספקים.",
        "col": { "lexiclash": "LexiClash", "kahoot": "Kahoot!", "quizlet": "Quizlet", "wordwall": "Wordwall" },
        "row": {
          "native_multilingual": "ריבוי שפות מקומי (כולל RTL, IME)",
          "ad_free_students": "ללא מודעות לתלמידים",
          "live_multiplayer": "משחק חי ריבוי משתתפים",
          "brain_training": "תרגילי הכשרת מוח",
          "game_variety": "6+ מצבי משחק",
          "free_for_teachers": "חינם למורים מאומתים"
        }
      },
      "trust": {
        "title": "בנוי על אמון",
        "bullet1": "ללא מודעות בנתיבים חינוכיים המופנים לתלמידים.",
        "bullet2": "טיפול בנתונים המודע ל-GDPR; טלמטריה מתוך הסכמה בלבד.",
        "bullet3": "תואם ל-COPPA לשימוש בתלמידים מתחת לגיל 13."
      },
      "faq": {
        "title": "שאלות נשאלות לעתים קרובות",
        "q1": { "q": "איך מורים מקבלים גישה?", "a": "בקשו ב-/education/access — אנחנו בודקים לפי דוא״ל ובדרך כלל מגיבים תוך 24 שעות." },
        "q2": { "q": "זה באמת חינם לכיתות?", "a": "כן. חינם למורים מאומתים, ללא מודעות בנתיבים המופנים לתלמידים." },
        "q3": { "q": "זה עובד בעברית, יפנית, שוודית וספרדית?", "a": "כן — תמיכה מקומית כולל עברית מימין לשמאל וקאנה/IME יפנית. לא תרגום." },
        "q4": { "q": "איך אתם מטפלים בפרטיות של התלמידים?", "a": "COPPA + GDPR מודעים. ללא מעקב מודעות בנתיבים חינוכיים. טלמטריה מתוך הסכמה בלבד." },
        "q5": { "q": "האם התלמידים יכולים לשחק ללא חשבון?", "a": "כן. משחק כאורח נתמך ברוב המצבים." },
        "q6": { "q": "איך זה שונה מ-Kahoot, Quizlet או Wordwall?", "a": "עומק ריבוי שפות מקומי, התחייבות ללא מודעות, 6 מצבי משחק בפלטפורמה אחת, ורשימות מילים מקומיות לכל שפה." },
        "q7": { "q": "האם אני יכול לעקוב אחר התקדמות התלמידים?", "a": "כן. מורים רואים ניתוח לכל תלמיד בלוח המחוונים של המורה." },
        "q8": { "q": "זה עובד ב-Chromebooks, טאבלטים וטלפונים?", "a": "כן. ממוקד אינטרנט, לא נדרש התקנה." }
      },
      "cta": {
        "title": "מוכנים להביא LexiClash לכיתה שלכם?",
        "body": "בקשו גישת מורה חינמית — לוקח 60 שניות, בדרך כלל מאושר תוך 24 שעות.",
        "button": "בקשו גישת מורה"
      },
      "esl-word-games": {
        "course_name": "משחקי מילים ESL של LexiClash",
        "course_desc": "משחקי אוצר מילים, איות, וריבוי משתתפים חיים לכיתות ESL ב-5 שפות."
    ...
    "access": {
      "h1": "גישת מורה לקסיקלאש",
      "lede": "ספרו לנו קצת על הכיתה. נבדוק את הבקשה תוך 24 שעות.",
      "full_name": "שמך המלא",
      "email": "אימייל",
      "role": "מה אתה?",
      "role_teacher": "מורה בכיתה",
      "role_tutor": "מנחה פרטי",
      "role_admin": "מנהל בית ספר",
      "role_parent": "הורה / בית ספר ביתי",
      "role_researcher": "חוקר",
      "role_other": "אחר",
      "school_or_org": "בית ספר או ארגון (לא חובה)",
      "country": "המדינה שלכם (לא חובה)",
      "use_case": "איך אתם תשתמשו בלקסיקלאש? (10-800 תווים)",
      "submit": "שלחו בקשה",
      "submitting": "שליחה…",
      "submit_error": "משהו קרה. בואו נסיום שוב.",
      "rate_limited": "לא הצליח. חכו 24 שעות ונסו שוב.",
      "success_title": "קיבלנו את הבקשה שלכם!",
      "success_body": "אנחנו בודקים בקשות. תשובה תגיע בתוך יום-יומיים.",
      "success_next": "נבדוק את הבקשה שלכם ונשלח אימייל תוך 1-2 ימי עסקים. אתם יכולים לסגור את העמוד.",
      "pending_title": "הבקשה שלכם בתור",
      "pending_body": "קיבלנו אותה. תשימו לב לאימייל מאיתנו.",
      "declined_title": "אנחנו לא הצלחנו הפעם",
      "declined_reapply": "אתם יכולים להגיש שוב בכל עת. יש לכם שאלות? אנחנו פה.",
      "submitted_on": "הוגש",
      "already_approved_title": "אתם כבר אושרו!",
      "go_to_teacher": "תפסו את לוח המחוונים",
      "next": {
        "step1_title": "שלחו בקשה",
        "step1_body": "מלאו את הטופס להלן. זה לוקח 60 שניות.",
        "step2_title": "אנחנו בודקים",
        "step2_body": "אדם אמיתי קורא כל בקשה. תוך 24 שעות בדרך כלל.",
        "step3_title": "אתם מוכנים!",
        "step3_body": "אימייל אישור + הגישה נפתחת מיד."
      },
      "regular_game_title": "לא מורה? זה בסדר.",
      "regular_game_body": "לקסיקלאש חינם לכולם. שחקו משחק רגיל וחזרו אם אתם רוצים כלים למורים.",
      "try_mp": "שחקו מרובי משתתפים",
      "try_blast": "נסו Blast",
      "try_daily": "המילה היומית"
    },
    "teacher": {
      "welcome_banner_title": "אתה מאושר! ברוכים הבאים, מורה! 🎉",
      "welcome_banner_body": "חשבון המורה שלך מוכן. אתה יכול ליצור כיתות, להקצות משחקים ולעקוב אחר התקדמות התלמידים.",
      "welcome_banner_dismiss": "הבנתי"
    }
  },
    "prompt": {
