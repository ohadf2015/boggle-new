...
const he = {
  ...
  "tutorial": {
    ...
    "next": "הבא",
    "finish": "הבנתי!",
    "tapToContinue": "לחץ בכל מקום להמשך",
    "welcome": {
      "title": "ברוכים הבאים ל-LexiClash!",
      "description": "בואו נלמד איך לשחק בכמה צעדים קצרים. המדריך המהיר הזה יראה לך את כל מה שאתה צריך כדי לשלוט במשחק המילים!"
    },
    "grid": {
      "title": "לוח האותיות",
      "description": "זה שדה הקרב שלך! אותיות מסודרות בלוח. המטרה שלך היא למצוא כמה שיותר מילים על ידי חיבור אותיות סמוכות."
    },
    "swipe": {
      "title": "צור מילים בהחלקה",
      "description": "החלק או גרור דרך אותיות סמוכות (כולל אלכסונים) כדי ליצור מילים. שחרר כדי לשלוח. ככל שהמילה ארוכה יותר, יותר נקודות!"
    },
    "combo": {
      "title": "בנה קומבו",
      "description": "מצא מילים במהירות כדי לבנות מכפילי קומבו! כל מילה רצופה מגדילה את הקומבו שלך, מכפילה את הניקוד. שמור על הרצף!"
    },
    "timer": {
      "title": "עקוב אחר הטיימר",
      "description": "יש לך זמן מוגבל למצוא מילים. הטיימר מראה כמה זמן נשאר. כשהוא הופך אדום, מהרו!"
    },
    "leaderboard": {
      "title": "עקוב אחרי הדירוג שלך",
      "description": "ראה איך אתה מתחרה מול שחקנים אחרים בזמן אמת. טפס בטבלת המובילים על ידי מציאת מילים רבות וארוכות יותר!"
    },
    "ready": {
      "title": "אתה מוכן!",
      "description": "זה כל מה שצריך לדעת! לך מצא מילים והראה לכולם מי אדון המילים!"
    },
    "wordHunt": {
      "welcome": {
