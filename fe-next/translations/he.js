...
const he = {
  ...
  "seo": {
    ...
    "faq": {
      "title": "לקסיקלאש - שאלות ותשובות | חינם, בלי הורדה, 5 שפות",
      "description": "כל התשובות על לקסיקלאש במקום אחד: איך משחקים, ניקוד, חדרים רב-משתתפים, אתגר יומי, אבטחה ותמיכה. משחק מילים חינם בדפדפן - בלי הורדה, בלי פרסומות מעצבנות.",
      "ogTitle": "שאלות ותשובות - כל מה שצריך לדעת על לקסיקלאש",
      "ogDescription": "איך משחקים? כמה עולה? עברית תומך? כל השאלות הכי נפוצות עם תשובות מלאות."
    },
    "blog": {
    ...
    "rules": {
      "title": "איך לשחק לקסי קלאש - חוקי המשחק ומדריך אסטרטגיה",
      "description": "למדו איך לשחק לקסי קלאש, משחק המילים המרובה משתתפים בזמן אמת. מדריך מלא הכולל חוקי משחק, מערכת ניקוד, אסטרטגיות ניצחון וטיפים למתחילים.",
      "ogTitle": "חוקי המשחק ומדריך אסטרטגיה - לקסי קלאש",
      "ogDescription": "למדו איך לשחק לקסי קלאש עם מדריך חוקים ואסטרטגיות מלא."
    },
    "howToPlay": {
