...
"createForm": {
  ...
  "teacher": {
    ...
    "subscription": {
      ...
      "usagePromptStudentsBody": "יש לך {{count}} תלמידים בכיתה הזו. Teacher Pro מכסה את כולם — כיתות ותלמידים ללא הגבלה, וגם ניתוח התקדמות ודוחות להדפסה.",
      "usagePromptAssignmentsBody": "יצרת {{count}} משימות לכיתה הזו. Teacher Pro מוריד את התקרה — משימות ללא הגבלה, וגם ניתוח התקדמות ודוחות.",
