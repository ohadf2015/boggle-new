...
const he = {
  ...
  "teacher": {
    "proGate": {
      ...
      "analytics": {
        "title": "פתח ניתוח מלא",
        "body": "ראה התקדמות מפורטת לכל תלמיד, תרשימי אפקטיביות שיעור, מפות חום של אוצר מילים וייצא דוחות — כל מה שאתה צריך כדי ללמד טוב יותר."
      }
    },
    "subscription": {
      ...
      "freeStartNote": "מעולה לניסיון — עד 3 כיתות עם 50 תלמידים כל אחת. זו כיתה בגודל מלא, לגמרי חינם.",
      ...
      "faqDataLossAnswer": "לא. אם תבטלו, הכיתות, השיעורים ונתוני התלמידים נשארים בטוחים. אתם פשוט חוזרים למגבלות המסלול החינמי (3 כיתות, 50 תלמידים לכיתה).",
  ...
  "education": {
    "results": {
      ...
      "teacherMoat": "אלו היו המילים מהשיעור שלך — מוסתרות בתוך הלוח. זה מה שמייחד את LexiClash.",
    ...
    "analytics": {
      ...
      "yesterday": "אתמול",
      "previewLocked": "ניתוח מפורט להלן — שדרג ל-Pro כדי לפתוח"
    },
    "classroomGame": {
      "classCode": "קוד המשחק",
      ...
      "words": "{{count}} מילים",
      "vocabularyEmbedding": "המילים האלה יהיו מוסתרות בלוח כשהכיתה שלך משחקת"
    },
    "header": {
      "breadcrumbs": {
        "analytics": "אנליטיקה",
    ...
    "landing": {
      ...
      "faq": {
        ...
        "q2": {
          "q": "יש מסלול חינם?",
          "a": "כן — מסלול בסיסי חינם למורים מאומתים: עד 3 כיתות עם 50 תלמידים כל אחת, בלי פרסומות בדפים לתלמידים. מסלול Teacher Pro ($9 לחודש) פותח כיתות ותלמידים ללא הגבלה."
        },
        "q3": {
    ...
    "trial": {
      ...
      "expired_body": "תקופת הניסיון החינמית של 14 ימים הסתיימה. שמור על גישה בלתי מוגבלת לכיתה עם Pro — 9 דולר לחודש, ביטול בכל עת.",
