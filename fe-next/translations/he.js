...
const he = {
  ...
  "seo": {
    ...
    "language": "Hebrew",
    "showcase3d": {
      "title": "משחק מילים בעברית | LexiClash מרובי משתתפים חינם",
      "description": "משחק מילים בעברית אונליין בזמן אמת עד 4 שחקנים. בנו קומבוס, טפסו בטבלה גלובלית, והשחקו בחינם — ללא הורדה ללא הרשמה בדפדפן."
    },
    "leaderboard": {
  ...
  "showcase3d": {
    ...
    "cap0Title": "גרור המילה",
    "cap0Body": "החליקו על הלוח — אותיות מתאירות במהלך הדרך.",
    "cap1Title": "בנו שרשרת",
    "cap1Body": "חברו מילה אחרי מילה — מכפיל הניקוד מתפוצץ.",
    "cap2Title": "כבשו את החדר",
    "cap2Body": "עקפו שלוש מלכודות על לוח אחד חי.",
    "cap3Title": "תקחו את הכתר",
    "cap3Body": "טיפסו לטופ הטבלה — וצעקו על זה.",
    ...
    "rail2": "כבישה",
    "rail3": "כתר",
    "modesTitle": "שלוש דרכים להתגרות",
    "modesSub": "סיבובים אמיתיים, לוחות אמיתיים — כל דרך מחליקה בזמן שאתם גוללים.",
    "mode1Tag": "יומי · סולו",
    "mode1": "לוח אחד. סיבוב אחד.",
    "mode1Body": "אותו לוח לכל השחקנים בעולם. טיפסו בדירוג הגלובלי עד חצות.",
    "mode2Tag": "עד 1v3",
    "mode2": "קרבות מסיבה בזמן אמת",
    "mode2Body": "ארבע שחקנים, לוח אחד, ללא רחמים. הקולני ביותר ינצח.",
    "mode3Tag": "5 שפות",
    "mode3": "שחקו בשפה שלכם",
    "mode3Body": "עברית, אנגלית, שוודית, יפנית, ספרדית — המילים שלכם, המגרש שלכם.",
    "bottomTitle": "תורכם. תעשו רעש.",
    "bottomCta": "שחקו בחינם",
    "floatCta": "שחקו בחינם",
    "faqTitle": "שאלות נפוצות",
    "faqQ1": "האם LexiClash חינם?",
    "faqA1": "כן — לקסיקלאש משחק מילים חינמי אונליין שמשחקים ישירות בדפדפן. ללא הורדה וללא קיר הרשמה: פתחו את העמוד וכבר אתם בסיבוב.",
    "faqQ2": "אפשר להשחק קרבות מילים ברובי משתתפים עם חברים?",
    "faqA2": "כן. קפצו לקרב מילים בזמן אמת 1v3 כאשר עד ארבעה שחקנים מתחרים על לוח חי אחד — משחק הרובי משתתפים שקל יותר מ'סיבובים איטיים' שתמיד קורים.",
    "faqQ3": "זה כמו סקראבל?",
    "faqA3": "אותו אהב למילים, הרבה יותר מהיר. במקום להניח אריחים בתורות, אתם גוררים מילים על לוח חי כנגד השעון — סקראבל מהיר שאתם משחקים אונליין בחינם.",
    "faqQ4": "באילו שפות אני יכול להשחק?",
    "faqA4": "חמש, כל אחת עם מילון משלה: אנגלית, עברית, שוודית, יפנית וספרדית. שחקו משחק מילים בשפה שלכם.",
    "faqQ5": "צריך להוריד או להירשם?",
    "faqA5": "לא. לקסיקלאש רץ בכל דפדפן מודרני בסלולרי, טאבלט או טלוויזיה — ללא התקנה וללא חשבון.",
    "faqQ6": "יש טבלאות מובילים תחרותיות?",
    "faqA6": "כן — אתגרים יומיים וטבלאות מובילים גלובליות. טפסו בדירוג היומי, בנו קומבוס וטופו את הטבלה במשחק מילים חינם טוב אחד."
  }
};
