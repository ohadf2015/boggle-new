...
const he = {
  ...
  "teacher": {
    "proGate": {
      "analytics": {
        "title": "אנליטיקה זמינה במסלול Teacher Pro",
        "body": "לראות מי מתקשה, אילו מילים הכיתה מפספסת שוב ושוב ואילו שיעורים באמת עבדו — כולל דוחות להדפסה להורים ולהנהלה."
      },
      "cta": "שדרוג ל-Pro — {price}$ לחודש"
    },
    "subscription": {
      ...
      "priceTaxNote": "המיסים יוצגו בעת התשלום",
      "valueHeadline": "הרחיבו את ההוראה ללא מגבלות",
    ...
    "dashboard": {
      ...
      "classroomLoadError": "לא היה ניתן לטעון את הכיתות שלך",
      "classroomLoadErrorHint": "בדוק את החיבור שלך ונסה שוב",
      "retry": "נסה שוב",
      "analytics": "אנליטיקה",
      "insights": "תובנות",
      "viewReports": "צפה בדוחות",
      "viewReportsDesc": "צפה בדוחות מפורטים ואנליטיקה עבור הכיתות שלך",
      "studentsPresentTitle": "{{count}} תלמידים בכיתה {{classroom}}",
      "studentsPresentDescription": "התחל משחק כדי לקבל אותם למשחק",
      "tab": {
        "play": "שחק",
        "prepare": "הכן",
        "review": "סקור"
  ...
  "education": {
    ...
    "landing": {
      ...
      "compare": {
        ...
        "row": {
          "native_multilingual": "כל שפה כשפת אם (עברית RTL, IME יפני)",
      ...
      "faq": {
        ...
        "q3": {
          ...
          "a": "כן. עברית RTL, יפנית עם קאנה ו-IME — הכול נבנה מהיסוד לכל שפה, לא תרגום."
        },
        "q4": {
        ...
        "q6": {
          ...
          "a": "תמיכה מלאה בכל שפה כשפת אם (לא תרגום), אפס פרסומות, 6 מצבי משחק בפלטפורמה אחת, ואוצר מילים מההקשר המקומי שלכם."
        },
        "q7": {
      ...
      "pro": {
        "title": "Teacher Pro — פתח את הכיתה שלך",
        "subtitle": "חינם להתחיל. Pro גדל עם הצרכים שלך.",
        "freeTier": "תוכנית חינם",
        "proTier": "Pro",
        "perMonth": "/חודש",
        "classLimit": "עד {count} כיתה",
        "classLimitPro": "כיתות ללא הגבלה",
        "studentLimit": "עד {count} תלמידים לכיתה",
        "studentLimitPro": "תלמידים ללא הגבלה",
        "noAds": "אפס מודעות בנתיבי תלמיד",
        "everythingInFree": "כל מה שיש במסלול החינמי",
        "analytics": "אנליטיקת כיתה ודוחות להדפסה",
    ...
    "access": {
      ...
      "status_unknown_title": "לא יכולנו לקרוא את הסטטוס שלכם עכשיו",
      "status_unknown_body": "יש בעיה בקריאת סטטוס גישת המורה. אנא רעננו את הדף או פנו לתמיכה אם הבעיה נמשכת.",
