...
"game": {
  ...
  "education": {
    ...
    "landing": {
      ...
      "moat": {
        ...
        "native_multilingual": {
          "tag": "מקומי",
          "title": "בנוי בשפה שלך",
          "body": "עברית מימין לשמאל, יפנית עם קאנה ו-IME, מילים שוודיות מורכבות, ודגשים בספרדית — הכל מטופל ברמת המנוע. לא תרגום Google."
        },
        "local_inventory": {
          "tag": "מקומי",
          "title": "רשימות מילים מהווקיפדיה המקומית",
          "body": "רשימות מילים מתוך ויקיפדיה בעברית ומילון מילוג. התלמידים רואים מילים רלוונטיות תרבותית מהארץ שלהם — לא משיעורי K-12 בארה״ב."
        },
        "ad_free": {
          "tag": "ללא מודעות",
          "title": "ללא מודעות לתלמידים. תמיד.",
          "body": "Kahoot, Quizlet, Blooket — כולם מציגים מודעות לתלמידים. אנחנו מתחייבים ללא מודעות בכל נתיב חינוך. COPPA + GDPR מודעים."
        }
      },
      "modes": {
        ...
        "classroom_game": {
          "tag": "חי",
          "title": "משחק כיתה",
          "body": "ציד מילים חי ריבוי משתתפים לכל הכיתה.",
          "teaches": "אוצר מילים, איות, מהירות"
        },
        "vocab_duels": {
          "tag": "דו-קרב",
          "title": "דו-קרבות אוצר מילים",
          "body": "אתגרי אוצר מילים 1v1 סינכרוני או אסינכרוני.",
          "teaches": "שמירה בזיכרון, זיכרון"
        },
        "brain_drills": {
          "tag": "מוח",
          "title": "תרגילי מוח",
          "body": "תרגילי זיכרון, קשב, מהירות עיבוד.",
          "teaches": "כישורים קוגניטיביים"
        },
        "daily_wordhunt": {
          "tag": "יומי",
          "title": "ציד מילים יומי",
          "body": "חידה חדשה כל יום, טבלת דירוג למקום.",
          "teaches": "תרגול יומי"
        },
        "adventure": {
          "tag": "סיפור",
          "title": "מצב הרפתקה",
          "body": "חידות מילים מונחות סיפור בעולמות בעלי ערכים.",
          "teaches": "עומק אוצר מילים"
        },
        "spelling_bee": {
          "tag": "דבורה",
          "title": "תרגול איות",
          "body": "תרגילי איות בהנחיית קול, ריבוי שפות.",
          "teaches": "איות"
        }
      },
      "compare": {
      ...
      "faq": {
        ...
        "q1": {
          "q": "איך מורים מקבלים גישה?",
          "a": "בקשו ב-/education/access — אנחנו בודקים לפי דוא״ל ובדרך כלל מגיבים תוך 24 שעות."
        },
        "q2": {
          "q": "זה באמת חינם לכיתות?",
          "a": "כן. חינם למורים מאומתים, ללא מודעות בנתיבים המופנים לתלמידים."
        },
        "q3": {
          "q": "זה עובד בעברית, יפנית, שוודית וספרדית?",
          "a": "כן — תמיכה מקומית כולל עברית מימין לשמאל וקאנה/IME יפנית. לא תרגום."
        },
        "q4": {
          "q": "איך אתם מטפלים בפרטיות של התלמידים?",
          "a": "COPPA + GDPR מודעים. ללא מעקב מודעות בנתיבים חינוכיים. טלמטריה מתוך הסכמה בלבד."
        },
        "q5": {
          "q": "האם התלמידים יכולים לשחק ללא חשבון?",
          "a": "כן. משחק כאורח נתמך ברוב המצבים."
        },
        "q6": {
          "q": "איך זה שונה מ-Kahoot, Quizlet או Wordwall?",
          "a": "עומק ריבוי שפות מקומי, התחייבות ללא מודעות, 6 מצבי משחק בפלטפורמה אחת, ורשימות מילים מקומיות לכל שפה."
        },
        "q7": {
          "q": "האם אני יכול לעקוב אחר התקדמות התלמידים?",
          "a": "כן. מורים רואים ניתוח לכל תלמיד בלוח המחוונים של המורה."
        },
        "q8": {
          "q": "זה עובד ב-Chromebooks, טאבלטים וטלפונים?",
          "a": "כן. ממוקד אינטרנט, לא נדרש התקנה."
        }
      },
      "cta": {
    ...
    "teacher": {
      "activeGames": "משחקים פעילים",
      "noActiveGames": "אין משחקים פעילים",
      "welcome_banner_title": "ברוכים הבאים למורים 🎉",
      "welcome_banner_body": "זה הקשה. עכשיו אתה יכול ליצור כיתות, להטיל משחקים וגם לראות איך הילדים מתקדמים.",
      "welcome_banner_dismiss": "מובן"
    },
    "wordOfTheDay": {
      "title": "המילה היומית",
      "learnMore": "למד עוד"
