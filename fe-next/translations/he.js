...
const he = {
  ...
  "wordTowerV2": {
    "rivals": {
      ...
      "noCharges": "סיימו סיבוב כדי להרוויח הריסה",
    ...
    "chest": {
      "tier": { "common": "רגילה", "rare": "נדירה", "epic": "אפית" },
      "sealed": "חתומה",
      "tap": "הקישו לפתיחה",
      "skip": "דלג",
      "continue": "אסוף",
    ...
    "estate": {
      ...
      "built": "נבנה!",
      "repaired": "תוקן!",
      "guest": "נשמר במכשיר הזה. התחבר כדי לפשוט ולהיפשט.",
      "perksTitle": "הרובע שלך עובד בשבילך",
      "perksNone": "בנה את הרובע כדי לייצב את המגדל",
      "newsRaids": "{n} פשיטות עליך בזמן שלא היית",
    ...
    "collapsed": "המגדל קרס!",
    "newBest": "שיא חדש!",
    "hud": {"floor": "קומה", "floorA11y": "קומה {n}, {m} מטר", "effect": "{name}: נשארו {n}", "exit": "יציאה — הריצה נשמרת"},
    ...
    "reward": {"crate": "ארגז!", "steady": {"name": "מנוף יציב", "desc": "3 הקומות הבאות מתנדנדות לאט יותר"}, "plumb": {"name": "אנך", "desc": "2 הקומות הבאות נופלות ישר למטה"}, "wide": {"name": "מטען רחב", "desc": "הקומה הבאה תיבנה רחבה יותר"}, "rebar": {"name": "ברזל זיון", "desc": "הקומות התחתונות רותכו — הן לא יכולות ליפול"}, "scramble": {"name": "אותיות חדשות", "desc": "‎+2 ערבובים"}, "jackpot": {"name": "ג׳קפוט", "desc": "נקודות בונוס!"}},
    "ach": {"unlocked": "תג נפתח", "groundbreaker": {"name": "פורצי דרך", "desc": "הניחו את הקומה הראשונה"}, "fiveStory": {"name": "בניין חמש קומות", "desc": "בנו 5 קומות במשחק אחד"}, "highRise": {"name": "רב־קומות", "desc": "בנו 10 קומות במשחק אחד"}, "skyscraper": {"name": "גורד שחקים", "desc": "בנו 20 קומות במשחק אחד"}, "megatower": {"name": "מגה־מגדל", "desc": "בנו 30 קומות במשחק אחד"}, "steadyHands": {"name": "יד יציבה", "desc": "3 הנחות מושלמות ברצף"}, "surgeon": {"name": "מנתח", "desc": "6 הנחות מושלמות ברצף"}, "flawless": {"name": "ללא רבב", "desc": "10 הנחות מושלמות ברצף"}, "perfectionist": {"name": "פרפקציוניסט", "desc": "15 הנחות מושלמות במשחק אחד"}, "wordsmith": {"name": "אמן מילים", "desc": "הרימו מילה בת 6 אותיות"}, "lexicon": {"name": "מילון מהלך", "desc": "הרימו מילה בת 8 אותיות"}, "fullHouse": {"name": "בית מלא", "desc": "50 דיירים במשחק אחד"}, "cityPlanner": {"name": "מתכנן ערים", "desc": "150 דיירים במשחק אחד"}, "lucky": {"name": "רצף מזל", "desc": "פתחו 5 ארגזים במשחק אחד"}, "welder": {"name": "רתך", "desc": "רתכו את המגדל עם ברזל זיון"}, "sunsetView": {"name": "נוף לשקיעה", "desc": "טפסו אל שמי השקיעה"}, "aboveClouds": {"name": "מעל העננים", "desc": "טפסו מעבר לעננים"}, "orbiter": {"name": "במסלול", "desc": "בנו עד המסלול בחלל"}},
    "results": {
        "home": "לדף הבית",
...
"createForm": {
  ...
  "teacher": {
    ...
    "subscription": {
      ...
      "usagePromptStudentsBody": "יש לך {{count}} תלמידים בכיתה אחת. Teacher Pro מכסה את כולם — כיתות ותלמידים ללא הגבלה, וגם ניתוח התקדמות ודוחות להדפסה.",
      "usagePromptAssignmentsBody": "יצרת {{count}} משימות לכיתה אחת. Teacher Pro מוריד את התקרה — משימות ללא הגבלה, וגם ניתוח התקדמות ודוחות.",
