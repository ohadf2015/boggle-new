  ...
  "legal": {
    ...
    "privacy": {
      ...
      "advertising": {
        ...
        "optOut": "מכיוון שהמודעות כבר אינן מותאמות אישית, אין צורך בביטול הסכמה. ניתן ללמוד עוד על מדיניות המודעות של Google בכתובת https://www.google.com/settings/ads.",
      ...
      "advertisingPartners": {
        "title": "שותפי פרסום",
        "intro": "אנו משתפים פעולה עם Google AdSense להצגת מודעות לא מותאמות אישית באתר שלנו. הכנסות מפרסום עוזרות לשמור על LexiClash חינמי לכל השחקנים. כל המודעות פועלות במצב טיפול בתוכן מכוון לילדים (TFCD).",
        "howItWorks": {
          "title": "איך הפרסום עובד",
          "cookies": "כל המודעות אינן מותאמות אישית — אין מעקב אחר התנהגות גלישה לצורך מיקוד מודעות",
          ...
          "thirdParty": "הצגת המודעות של Google עומדת בדרישות COPPA לאתרים מכוונים לילדים"
        },
        "yourChoices": {
          "title": "הבחירות שלך",
          "intro": "מכיוון שכל המודעות אינן מותאמות אישית, אין צורך בפעולה. למידע נוסף:",
          "optOut": "למד על מודעות לא מותאמות אישית",
          "googlePrivacy": "סקור את נהלי הפרטיות של Google",
          "partnerPolicy": "למד על מדיניות שותפי AdSense"
        },
        "important": {
          "title": "חשוב:",
          "content": "כל המודעות ב-LexiClash אינן מותאמות אישית ועומדות בדרישות תוכן מכוון לילדים. אין מודעות מבוססות תחומי עניין או שיווק מחדש. ניתן ללמוד עוד על מדיניות המודעות של Google דרך"
        }
      },
      "cookies": {
        "title": "5. עוגיות ואחסון מקומי",
        "content": "אנו משתמשים בעוגיות חיוניות ואחסון מקומי עבור: אסימוני אימות (Supabase), שם משתמש והעדפות (localStorage), הגדרות ערכת נושא (מצב כהה/בהיר) והעדפות שפה. אנו גם משתמשים בעוגיות LogRocket למטרות אנליטיקה. הפרסום פועל במצב טיפול בתוכן מכוון לילדים (TFCD), המגביל עוגיות להגבלת תדירות מודעות ולדיווח מצטבר בלבד — אין שימוש בעוגיות פרסום מותאם אישית או מעקב חוצה אתרים."
      },
      "dataRetention": {
    ...
    "cookies": {
      ...
      "managingCookies": {
        ...
        "optOut": "ביטול הסכמה להתאמה אישית של פרסומות Google",
