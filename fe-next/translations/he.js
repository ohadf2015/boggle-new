...
"wordHunt": {
  ...
  "education": {
    ...
    "access": {
      "h1": "בקשו גישת מורה חינמית",
      "lede": "ספרו לנו קצת על הכיתה שלכם. אנחנו בודקים לפי דוא״ל, בדרך כלל תוך 24 שעות.",
      "full_name": "שמך המלא",
      "email": "כתובת דוא״ל",
      "role": "התפקיד שלך",
      "role_teacher": "מורה",
      ...
      "role_other": "אחר",
      "school_or_org": "בית ספר או ארגון (אופציונלי)",
      "country": "מדינה (אופציונלי)",
      "use_case": "איך תשתמשו ב-LexiClash? (10-800 תווים)",
      "submit": "שלחו בקשה",
      "submitting": "שליחה…",
      "submit_error": "משהו השתבש. נסו שוב.",
      "rate_limited": "יותר מדי בקשות. נסו שוב ב-24 שעות.",
      "success_title": "הבקשה נשלחה!",
      "success_body": "אנחנו נבדוק ונשלח אליכם דוא״ל תוך 24 שעות.",
      "pending_title": "הבקשה שלכם בהמתנה לבדיקה",
      "pending_body": "קיבלנו את הבקשה שלכם ונשלח אליכם דוא״ל בקרוב.",
      "submitted_on": "הוגש",
      "already_approved_title": "יש לכם כבר גישת מורה.",
      "go_to_teacher": "פתחו לוח מחוונים מורה",
      "next": {
        "step1_title": "בקשו",
        "step1_body": "מלאו את הטופס למטה — לוקח 60 שניות.",
        "step2_title": "אנחנו בודקים",
        "step2_body": "אדם אמיתי קורא כל בקשה, בדרך כלל תוך 24 שעות.",
        "step3_title": "אתם מקבלים גישה",
        "step3_body": "אנחנו שולחים אישור; כלים למורה נפתחים מיד."
      },
      "regular_game_title": "לא מורה? אל דאגה.",
      "regular_game_body": "LexiClash חינם לכל אחד. נסו את משחק רגיל וחזרו אם תרצו בתכונות כיתה.",
      "try_mp": "שחקו ריבוי משתתפים",
      "try_blast": "נסו Blast",
      "try_daily": "אתגר יומי"
    }
  },
  "admin": {
    ...
    "teacherAccess": {
      ...
      "admin_note": "הערת מנהל (אופציונלי, כלול בדוא״ל דחייה אם מולא)",
      "approve": "אשרו",
      "decline": "דחו",
      "close": "סגרו"
    },
