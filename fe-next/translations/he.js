...
const he = {
  ...
  "seo": {
    ...
    "daily": {
      "title": "המילה היומית & מילת היום — חינמי, ללא הרשמה | LexiClash",
      "description": "מחפשים מילת היום בעברית? המילה היומית — חינם, ללא הרשמה. 10 ניסיונות לנחש, אותו לוח לכולם. שתפו, בנו רצף.",
      "ogTitle": "המילה היומית & מילת היום — חינמי, ללא הרשמה | LexiClash",
