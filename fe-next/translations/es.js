...
const es = {
  ...
  "wordTowerV2": {
    ...
    "rescue": {"crumbled":"¡Perdiste {n} pisos! Sigue construyendo","counterweight":"¡CONTRAPESO! Torre estabilizada","braced":"¡REFORZADA! El acero aguanta"},
...
"createForm": {
  ...
  "teacher": {
    ...
    "windowProgress": {
      ...
      "accuracy": "Precisión",
      "activeLine": "{{active}} de {{roster}} estudiantes jugaron",
      "studentStat": "{{sessions}} partidas · {{accuracy}}",
      "noPlay": "Aún no hay partidas",
