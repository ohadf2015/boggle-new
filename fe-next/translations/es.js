...
const es = {
  ...
  "wordTowerV2": {
    ...
    "hud": {"floor": "Piso", "floorA11y": "Piso {n}, {m} metros", "effect": "{name}: quedan {n}"},
...
"createForm": {
  ...
  "teacher": {
    ...
    "subscription": {
      ...
      "usagePromptStudentsBody": "Ya tienes {{count}} estudiantes en este grupo. Teacher Pro los cubre todos — clases y estudiantes ilimitados, más análisis de progreso e informes imprimibles.",
      "usagePromptAssignmentsBody": "Creaste {{count}} tareas para este grupo. Teacher Pro quita el límite — tareas ilimitadas, más análisis de progreso e informes.",
