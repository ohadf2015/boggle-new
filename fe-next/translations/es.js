...
const es = {
  ...
  "wordTowerV2": {
    ...
    "hud": {"floor": "Piso", "floorA11y": "Piso {n}, {m} metros", "effect": "{name}: quedan {n}", "exit": "Salir — tu partida queda guardada"},
...
"createForm": {
  ...
  "teacher": {
    ...
    "subscription": {
      ...
      "usagePromptStudentsBody": "Ya tienes {{count}} estudiantes en una clase. Teacher Pro los cubre todos — clases y estudiantes ilimitados, más análisis de progreso e informes imprimibles.",
      "usagePromptAssignmentsBody": "Creaste {{count}} tareas para una clase. Teacher Pro quita el límite — tareas ilimitadas, más análisis de progreso e informes.",
