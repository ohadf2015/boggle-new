...
const es = {
  ...
  "teacher": {
    ...
    "subscription": {
      ...
      "proHeroAlt": "Una clase jugando a LexiClash junta, cada alumno en su propio dispositivo.",
    ...
    "dashboard": {
      ...
      "classroomLoadError": "No se pudieron cargar tus aulas",
      "classroomLoadErrorHint": "Comprueba tu conexión e intenta de nuevo",
      "retry": "Intenta de nuevo",
      "analytics": "Analíticas",
      "insights": "DATOS",
      "viewReports": "Ver informes",
      "viewReportsDesc": "Ver informes detallados y análisis de tus aulas",
      "studentsPresentTitle": "{{count}} estudiantes están en {{classroom}}",
      "studentsPresentDescription": "Inicia un juego para que comiencen a jugar",
      "tab": {
        "play": "Jugar",
        "prepare": "Preparar",
        "review": "Revisar"
  ...
  "education": {
    ...
    "landing": {
      ...
      "pro": {
        ...
        "comparisonAlt": "Plan gratis: un aula cerrada. Teacher Pro: todas las aulas abiertas y llenas.",
    ...
    "student": {
      "join": {
        ...
        "classroomFull": "Esta clase está llena. Habla con tu profesor.",
    ...
    "access": {
      ...
      "status_unknown_title": "No pudimos leer tu estado",
      "status_unknown_body": "No conseguimos confirmar tu estado de acceso docente. Por favor recarga la página o contacta con soporte si el problema persiste.",
