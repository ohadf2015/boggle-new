...
"createForm": {
  ...
  "blog": {
    "wordGamesForKidsEducation": {
      "teachersTitle": "Juegos de palabras para maestros",
      "eslTitle": "Juegos de palabras ESL en línea",
      "vocabTitle": "Juegos de vocabulario para el aula", "heroAlt": "Niños jugando juegos de palabras en un aula" },
  ...
  "student": {
    "achievements": { "emptyHint": "¡Juega una lección o un duelo para ganar tu primera insignia!" },
    "practiceFun": {
      "headline": {
        "perfect": "¡PERFECTO!",
        "gold": "¡GENIAL!",
  ...
  "teacher": {
    ...
    "lesson": {
      "bulkImportDropCsv": "Suelta el archivo CSV aquí o haz clic para buscarlo",
  ...
  "education": {
    ...
    "milestones": {
      "levelTooltipWithTitle": "Nivel {{level}} - {{title}}",
