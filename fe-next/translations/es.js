...
const es = {
  "adventurePlay": {
    ...
    "map": {
      ...
      "primerTitle": "Cómo funciona una partida",
      "primerMap": "Sube por el mapa parada a parada: combates, tiendas, descansos, cofres y eventos ?. El jefe espera en la cima.",
      "primerFight": "En combate, cada palabra que formas golpea al rival. Las de 5 letras o más levantan un escudo. Si te quedas sin corazones, se acaba la partida.",
      "primerKeep": "Las reliquias y pociones duran toda la partida y pasan a la siguiente. Gasta el oro en las tiendas; la mitad del que te sobre al final se guarda como monedas.",
    ...
    "variety": {
      ...
      "rule": {
        "classic": "Consigue suficientes puntos antes de que se acabe el tiempo.",
        "hunt": "Encuentra las palabras ocultas. La primera letra es tu pista.",
        "chain": "Cada palabra debe empezar por la última letra de la anterior.",
        "fog": "La niebla cubre el tablero. Solo ves las fichas junto a tu última palabra.",
        "bomb": "Usa una ficha bomba en una palabra antes de que se acabe la mecha, o pierdes 4 segundos.",
        "elite": "Un enemigo duro que contraataca. Bájale la vida antes de que se acabe el tiempo.",
        "boss": "El jefe del mundo. Cada palabra es un ataque: sigue golpeando y aguanta sus golpes."
      },
      "twist": {
        "hunt": "¡Palabras ocultas! Encuéntralas en el tablero. La primera letra es tu pista.",
        "chain": "¡Cadena! Cada palabra empieza por la última letra de la anterior.",
        "fog": "¡Niebla! Solo ves las fichas junto a tu última palabra.",
        "bomb": "¡Bombas! Usa la ficha bomba antes de que se acabe la mecha, o pierdes 4 segundos.",
        "long-words": "Solo palabras largas: 4 letras o más.",
        "rush": "Prisa: solo 60 segundos en el reloj.",
        "grand-hunt": "Gran caza: un tablero gigante de 6x6 con más palabras.",
        "ambush": "¡Emboscada! Un élite te ataca pronto. Menos vida, mismo mordisco.",
        "blackout": "Apagón: solo se iluminan las fichas junto a la ÚLTIMA letra de tu palabra. 4 letras o más.",
        "finale": "Final: palabras de 4+ letras y solo 75 segundos."
      },
      "newRule": "Nueva regla",
      "chapterTag": "Capítulo {world}",
      "chapterGo": "¡Adelante!",
      "worldNewRule": "Nuevo en este mundo",
      "threat": "Peligro {threat} de 5",
      "goalScore": "Consigue al menos",
      "goalHunt": "Palabras por encontrar",
      "goalDamage": "Daño a causar",
      "secondsShort": "{seconds} s",
      "eliteName": "Élite de {world}",
      "pathLabel": "Nivel {level} de {total}",
      "demoLetters": "GATOSOLAR",
      "huntTitle": "Palabras ocultas",
      "huntCount": "{found}/{need}",
      "huntMasked": "Palabra oculta: empieza por {first}, {count} letras",
      "chainStart": "Cualquier palabra empieza la cadena",
      "chainNext": "La siguiente empieza por",
      "chainBroken": "¡Cadena rota! Empieza por {letter}",
      ...
      "youAreHere": "Estás aquí",
      "pathCleared": "Superado en esta partida",
      "rampTitle": "Dificultad",
      "worldRoute": "Niveles: {kinds}"
    },
    "combat": {
      "boss": "Jefe",
      "elite": {
      ...
      "ruleTag": "Regla",
      "rule": {
        "w1": "Escribe una palabra de 5+ letras mientras el jefe carga para cancelar su ataque.",
        "w2": "Los aguijones vuelan en pareja. Toca los dos antes de que caigan.",
        "w3": "Las maldiciones que dejes en el tablero te quitan 2 corazones.",
        "w4": "Las mezclas ciegan el tablero el doble de tiempo.",
        "w5": "Solo las palabras de 6+ letras cargan tu escudo.",
        "w6": "Las congelaciones atrapan una casilla más y los fragmentos vuelan en pareja.",
        "w7": "Solo una palabra de 6+ letras puede interrumpir a este jefe.",
        "w8": "Los proyectiles llegan en ráfagas de tres.",
        "w9": "Congelaciones y maldiciones atrapan 2 casillas más, y las maldiciones quitan 2.",
        "w10": "Solo 6+ letras interrumpen, las maldiciones quitan 2 y los disparos vuelan en pareja."
      },
      "eliteRule": {
        "freeze": "Congela tus casillas. Tócalas para descongelarlas.",
        "projectile": "Lanza bolas de fuego. Tócalas antes de que caigan.",
        "curse": "Maldice tus casillas. Límpialas antes de que muerdan.",
        "shuffle": "Mezcla el tablero. Sigue escribiendo de memoria.",
        "drain": "Cada golpe drena una carga de escudo. Levántalo a tiempo."
      },
      "move": {
        "hit": "Golpe",
        "hit-heavy": "Golpe pesado",
        "freeze": "Aliento helado",
        "freeze-heavy": "Congelación total",
        "curse": "Maleficio",
        "curse-heavy": "Plaga maldita",
        "projectile": "Bola de fuego",
        "projectile-heavy": "Andanada",
        "shuffle": "Mezcla",
        "shuffle-heavy": "Mezcla caótica",
        "drain": "Sanguijuela",
        "drain-heavy": "Robo de alma"
      },
      "status": {
        "death": "¡Derrotado!",
        "defeated": "¡Vencido!",
      ...
      "consequence": {
        "freeze": "{count} fichas congeladas. ¡Tócalas para descongelar!",
        "curse": "{count} fichas malditas. ¡Límpialas antes de que muerdan!",
        "hit": "¡-{count} PV! Levanta el escudo la próxima vez.",
        "drain": "¡-{count} PV y te roban una carga de escudo!",
        "shuffle": "Tablero revuelto. ¡Deletrea de memoria!",
        "blocked": "¡Tu escudo aguantó todo el golpe!"
      },
      "incomingIn": "Ataque · {seconds} s",
      ...
      "raiseShield": "¡Bloquea!",
      "shieldEarn": "{count}+ letras = carga",
      "shieldAria": "Levantar escudo ({count} cargas)",
      "skip": "Continuar",
      "bossBattle": "¡Batalla de jefe!",
      "eliteFight": "¡Combate de élite!",
      "tapToFight": "Toca para luchar",
      "phaseTwo": "¡Segunda fase!",
      "enraged": "¡Furioso!",
      "phaseTaunt1": "Se acabó el calentamiento. ¡Ahora va en serio!",
      "phaseTaunt2": "¡BASTA! ¡Siente toda mi furia!",
      "kill": {
        "squashed": "¡Aplastado!",
        "whomped": "¡Zurrado!",
        "crushed": "¡Triturado!",
        ...
        "obliterated": "¡Aniquilado!",
        "damage": "{points} daño",
        "overkill": "+{points} de sobra",
        "trophy": "Reliquia trofeo",
        "addedToRun": "Añadida a tu partida",
        "bossTrophy": "¡Trofeo del mundo ganado!",
        "bossStars": "Estrellas ganadas"
      },
      "defeat": {
        "slainBy": "Derribado por {move}",
        "hpLeft": "A {name} le quedaba {percent}% de vida",
        "continue": "Toca para continuar"
      },
      "bossDefeated": "¡Jefe derrotado!",
      "eliteDefeated": "¡Élite vencido!",
      "youFell": "¡Has caído!",
      "thawTile": "Descongelar casilla",
      "cleanseTile": "Purificar casilla maldita",
      "tap": "¡Toca!",
    ...
    "loot": {
      ...
      "runOverSub": "Un mapa nuevo desde el primer piso. Tus reliquias y pociones vienen contigo, y tus estrellas y colección siguen siendo tuyas.",
      "newRun": "Nueva partida",
      ...
      "kindHeal": "Curación",
      "kindGold": "Oro",
      "healDesc": "Recupera corazones ahora",
      "goldDesc": "Oro para esta partida",
      "tapCard": "Toca una carta para verla de cerca",
      "take": "Me la quedo",
      "currentRun": "Partida en curso",
      "runStep": "Nivel {step} de {total}",
      "continueRun": "Continuar",
      "levelUp": "¡Subes de nivel!",
      "levelUpCleared": "Nivel {step} de {total} superado",
      ...
      "stackPerLevel": "pts por nivel, con las palabras de esta partida",
      "contribAria": "{name}: +{n} puntos en este nivel",
      "value": {
        "label": "En esta partida",
        "hitsLine": "activa en {hits} de tus {total} palabras",
        "synergy": "Combo",
        "synergyHint": "Se suma a una reliquia que ya tienes",
        "ptsPerLevel": "pts por nivel",
        "goldPerLevel": "oro por nivel",
        "seconds": "s cada nivel",
        "shield": "escudo por combate",
        "frost": "duración de maldición",
        "revive": "vida extra",
        "longWords": "curas de tus palabras largas",
        "fullHints": "pistas con palabra entera",
        "hearts": "corazones",
        "heartsFull": "corazones ya llenos",
        "goldTo": "oro",
        "carry": "en tu bolsa",
        "maxHearts": "corazones máx.",
        "hints": "pistas por nivel",
        "cards": "cartas por elección",
        "noData": "aún sin palabras",
        "stackLine": "sola → con tus reliquias",
        "timePts": "pts por nivel con +{secs} s"
      }
    },
    "juice": {
      "nice": "¡Bien!",
      ...
      "whomped": "¡ZAS!",
      "newBest": "¡Palabra más larga!",
      "ko": "¡K.O.!",
      "tooShort": "Muy corta",
      "notAWord": "No es palabra",
      "alreadyFound": "Ya encontrada",
      "breaksChain": "Rompe la cadena",
      "hint": "Pista",
      "hintAria": "Pista, quedan {count}",
      "foeTag": "Enemigo",
      "foeHp": "{hp}/{max} PV",
      "foeDown": "¡Derrotado!",
      "foeGoal": "Haz {max} de daño para 3 estrellas"
    },
    "draftTitle": "Elige una recompensa",
    "draftSub": "Dura el resto de este mundo.",
    "skip": "Saltar",
    "hp": "PV",
    "gold": "{gold} de oro",
    "shield": "Escudo ({count})",
    ...
    "deflect": "¡Desvía!",
    "huntGoal": "Encuentra palabras ocultas: {count} · {found} encontradas",
    "chainGoal": "La siguiente palabra empieza por {letter}",
    "eliteLevel": "Combate de élite",
    "eliteGoal": "Haz {hp} de daño en {seconds} s. ¡Devuelve los golpes!",
    "runOver": "Se acabó la aventura: el mundo empieza de cero.",
    "offerHeal": "Cura {amount} PV",
    "offerGold": "+{amount} de oro",
    "relic": {
      "sharp-quill": "Pluma afilada",
      "long-bow": "Arco largo",
      ...
      "sage-scroll": "Pergamino del sabio",
      "iron-bookmark": "Marcapáginas de hierro",
      "frost-ward": "Amuleto de escarcha",
    ...
    "relicDesc": {
      "sharp-quill": "Palabras de 6+ letras: +50 %",
      "long-bow": "Palabras de 7+ letras valen el doble",
      "short-sword": "Palabras de 3 letras: +2 puntos",
      "storm-rune": "Palabras de 5 letras: +5 puntos",
      "twin-ink": "La primera palabra de cada nivel vale el doble",
      "echo-stone": "+1 punto por cada palabra ya encontrada (máx. +10)",
      "magnet": "Todas las palabras +20 %",
      "heart-locket": "+1 PV máximo",
      "hourglass": "+10 segundos en cada nivel",
    ...
    "potion": {
      "heal": "Poción de curación",
      "time": "Poción de tiempo",
      "cleanse": "Poción purificadora",
      "insight": "Poción de perspicacia"
    },
    "potionDesc": {
      "heal": "+2 PV",
      "time": "+15 segundos",
      "cleanse": "Limpia casillas congeladas y malditas y aturde al enemigo",
      "insight": "+2 pistas"
    },
    ...
    "loading": "Repartiendo el tablero…",
    ...
    "score": "Puntos",
    "words": "Palabras",
    "victory": "¡Jefe derrotado!",
    "defeat": "El jefe sobrevivió",
    "cleared": "¡Nivel superado!",
    "failed": "¡Casi!",
    "newItems": "Nuevo en tu colección",
    "skinUnlocked": "¡Nuevo diseño de fichas desbloqueado!",
    "equipSkin": "Equipar",
    "equipped": "Equipado",
    "skinVault": "Bóveda de diseños",
    "skinVaultHint": "Vence al jefe de cada mundo para ganar sus fichas. Sirven en todos los modos.",
    "beatBoss": "Vence a {boss}",
    "beatPrevBoss": "Vence al jefe anterior",
    "foundWords": "Palabras encontradas",
    "signInRequired": "Inicia sesión para jugar Aventura",
    "achievements": "Logros",
    "starsEarned": "{stars} de 3 estrellas"
  },
  "vocabQuiz": {
    "correctShort": "¡Bien hecho!",
    "lockedInCount": "{locked}/{total} ya respondieron",
    "rank": "Puesto {position} de {total}",
    "score": {
      "label": "Tu puntuación: {score}"
    },
    "mascot": {
      "alt": "Lexi reacciona a tu respuesta"
    },
    "sweep": {
      "title": "¡Toda la clase!",
      "subtitle": "No falló ni una sola persona."
    },
    "nextUp": {
      "label": "Siguiente palabra",
      "finalScores": "¡Puntuación final!",
      "tease": "La siguiente palabra empieza por {letter} y tiene {count} letras"
    },
    ...
    "modifier": {
      ...
      "wordAlchemy": {
        "doubleCatalyst": {
          ...
          "desc": "Los catalizadores son especialmente vivos hoy."
        },
        "heatDecay": {
        ...
        "pureTransmute": {
          ...
          "desc": "Un día para transmutaciones verdaderas."
        }
      },
      "crossword": {
        "themedGrid": {
          "label": "Día de tema",
          "desc": "Un tema oculto recorre la cuadrícula de hoy."
        },
        "noCheck": {
          "label": "Sin verificación",
          "desc": "Confía en tu intuición hoy."
        },
        "timeAttack": {
  ...
  "wordAlchemy": {
    ...
    "howTo": {
      ...
      "steps": [
        ...
        "🏆 Completa toda la cadena para resolver el puzle"
      ]
    },
    ...
    "share": {
      ...
      "captionGood": "¡Buena alquimia! 🌡️",
      "captionHard": "Los elementos se resistieron hoy 😅"
    }
  },
  "gameFeedback": {
    "prompt": "¿Qué te pareció la ronda?",
    "bad": "Regular",
    "ok": "Bien",
    "great": "¡Me encantó!",
  ...
  "wordTowerV2": {
    ...
    "rivals": {
      ...
      "missed": "¡Fallo limpio!",
      "scrap": "+{coins} de chatarra",
      "banked": "{coins} monedas por el golpe",
      "pickFloor": "Elige el piso que quieres tirar.",
      "aimAt": "Apuntar a {word}",
      "floorsDown": "{n} de {total} pisos derribados",
      "shieldDown": "Escudo roto",
      "reclaimed": "Recuperaste {coins}",
      "prizeShield": "Rompe el escudo · +{n} monedas",
      "prizeLoot": "+{n} monedas y su botín",
      "floorOf": "Piso {n} de {total}",
      "wreckFloor": "Derribar {word}",
      "calledShot": "Cantado: {word}",
      "title": "¿Quién construyó más alto?",
      "you": "Tú",
      "someone": "Un rival",
      "loading": "Buscando rivales…",
      "none": "Aún no hay rivales en tu barrio. Sube más alto y te encontraremos algunos.",
      "emptyTower": "Nada construido todavía",
      "wreck": "Derribar",
      "wreckName": "Derribar la torre de {name}",
      "district": "Distrito {n}",
      "floors": "{n} pisos",
      "charges": "Listo para derribar ×{n}",
      "noCharges": "Termina una partida para ganar un derribo",
      "target": "La torre de {name}",
      "taunt": "{name} dice que tu torre se tambalea. Demuéstrale lo contrario… en la suya.",
      "tauntRevenge": "{name} empezó. Termínalo tú.",
      "revengeCta": "Vengarte",
      "revengeName": "Devuélvesela a {name}",
      "ledgerThem": "{name} se llevó {n}",
      "ledgerYou": "Recuperaste {n}",
      "ledgerAhead": "Ahora le sacas {n} a {name}.",
      "ledgerSquare": "En paz con {name}. Por ahora.",
      "ledgerShort": "{name} todavía te saca {n}.",
      "ledgerBlocked": "El escudo de {name} se tragó tu venganza: esa deuda queda saldada.",
      ...
      "plotDown": "{plot} fuera de servicio",
      "stole": "Robaste {coins}",
      "earned": "+{coins} monedas",
      "nothing": "Ni un rasguño. {name} duerme tranquilo esta noche.",
      "pickAnother": "Elegir otro rival",
      "back": "Volver",
      "raidFailed": "El ataque no cuajó",
      "raidError": "Algo salió mal. Inténtalo otra vez.",
      "revengeTitle": "Hora de la revancha",
      "revengeBody": "{name} destrozó tu {plot} y se llevó {coins} monedas.",
      "revengeBodyBlocked": "{name} atacó tu torre, pero tu escudo aguantó.",
      "revenge": "Venganza",
      "dismiss": "Ahora no",
      "moreRaids": "+{n} ataques esperando",
      "guestTitle": "Mira contra quién juegas",
      "guestBody": "Inicia sesión para enfrentarte a torres reales, derribarlas y saldar cuentas.",
      "signIn": "Iniciar sesión",
      "plot": {
        "foundation": "Cimientos",
        "craneYard": "Parque de grúas",
    ...
    "chest": {
      ...
      "skip": "Saltar",
      "continue": "Recoger",
      "guest": "Inicia sesión para rivales y asaltos",
      "item": { "shield": "{n} escudo", "brick": "{n} ladrillo de oro", "blueprint": "{n} plano" },
      "tease": { "perfects": "{n} caídas perfectas más → mejores opciones de {tier}", "floors": "{n} pisos más → mejores opciones de {tier}" }
    },
    "estate": {
      "art": {
        "bakery": "Panadería",
        ...
        "garden": "Jardín",
        "fishmarket": "Lonja de pescado",
        "lighthouse": "Faro",
        "boathouse": "Cobertizo de botes",
        "warehouse": "Almacén",
        "ferry": "Terminal del ferri",
        "arcade": "Salón recreativo",
        "hotel": "Hotel",
        "skytower": "Torre del cielo",
        "radiomast": "Antena de radio",
        "club": "Club",
      },
      "open": "Taller",
      "title": "Taller de la torre",
      ...
      "newsRaids": "{n} asaltos contra ti mientras no estabas",
      "newsAffordable": "{n} mejoras que ya puedes pagar",
      "newsDamaged": "{n} parcelas necesitan reparación",
      "newsNone": "Todo tranquilo en el barrio",
      "completeTitle": "¡{name} completo!",
      "completeSub": "Cinco monumentos, un barrio terminado.",
      "completeNext": "{name} desbloqueado",
      "completeCta": "Abrir {name}",
      "reward": "+{coins} monedas, +1 plano, +1 escudo",
      "shields": "Escudos",
      "bricks": "Ladrillos de oro",
      "blueprints": "Planos",
      "perkLine": {
        "foundation": "La torre se balancea un {n}% menos",
        "craneYard": "Ventana perfecta un {n}% más ancha",
        "vault": "+{n}% de monedas por partida",
        "insurance": "+{n} huecos de escudo",
        "landmark": "+{n}% de puntos",
      },
      "chip": {
        "foundation": "{n}% más estable",
        "craneYard": "{n}% más perfecto",
        "vault": "+{n}% monedas",
        "insurance": "+{n} escudos",
        "landmark": "+{n}% puntos",
      },
      "district": {
        "dockside": "Zona del muelle",
        "old-town": "Casco antiguo",
        "market-row": "Calle del mercado",
        "garden-heights": "Altos del jardín",
        "rail-yard": "Patio ferroviario",
        "neon-strip": "Zona neón",
        "harbor-lights": "Luces del puerto",
        "glass-quarter": "Barrio de cristal",
        "sky-gardens": "Jardines del cielo",
        "summit": "La cumbre",
      },
      "building": {
        "pier-footings": "Cimientos del muelle",
        "dock-crane": "Grúa del puerto",
        "fish-market": "Lonja de pescado",
        "lighthouse": "Faro",
        "ferry-terminal": "Terminal del ferri",
        "stone-cellar": "Bodega de piedra",
        "timber-hoist": "Montacargas de madera",
        "guild-bank": "Banco del gremio",
        "watch-house": "Casa de guardia",
        "clock-tower": "Torre del reloj",
        "brick-arcade": "Arcada de ladrillo",
        "cargo-lift": "Montacargas",
        "bazaar": "Bazar",
        "fire-station": "Parque de bomberos",
        "grand-bazaar-dome": "Cúpula del bazar",
        "terrace-walls": "Muros de terraza",
        "garden-crane": "Grúa del jardín",
        "greenhouse-bank": "Banco invernadero",
        "rain-shelter": "Refugio de lluvia",
        "botanic-spire": "Aguja botánica",
        "rail-bed": "Base de vía",
        "gantry-crane": "Grúa pórtico",
        "freight-depot": "Depósito de carga",
        "signal-box": "Caseta de señales",
        "central-station": "Estación central",
        "steel-piles": "Pilotes de acero",
        "neon-rig": "Torre de neón",
        "arcade-vault": "Cámara del salón",
        "security-hub": "Centro de seguridad",
        "neon-tower": "Torre neón",
        "sea-wall": "Dique de mar",
        "container-crane": "Grúa de contenedores",
        "customs-house": "Aduana",
        "coast-guard": "Guardacostas",
        "harbor-bridge": "Puente del puerto",
        "deep-caissons": "Cajones profundos",
        "tower-crane": "Grúa torre",
        "trading-floor": "Parqué bursátil",
        "insurance-tower": "Torre de seguros",
        "glass-pyramid": "Pirámide de cristal",
        "sky-anchors": "Anclas del cielo",
        "sky-hoist": "Grúa del cielo",
        "cloud-bank": "Banco de nubes",
        "storm-shield": "Escudo de tormentas",
        "hanging-gardens": "Jardines colgantes",
        "bedrock-core": "Núcleo de roca",
        "summit-crane": "Grúa de la cumbre",
        "golden-vault": "Cámara dorada",
        "aegis-dome": "Cúpula égida",
        "word-spire": "Aguja de palabras",
      },
    },
    "unitM": "m",
  ...
  "wordTower": {
    "mutator": {
      ...
      "goldenLetter": {
        "name": "Letra dorada",
        "desc": "Las palabras con {letter} suben un 60% más"
      },
      "vowelGale": {
        "name": "Vendaval de vocales",
        "desc": "Cada vocal da más impulso"
      },
      "longAndStrong": {
        "name": "Largas y fuertes",
        "desc": "Palabras de 6+ letras suben un 50% más"
      },
      "skylineRush": {
        "name": "Subida vertical",
        "desc": "Cada piso sube un 15% más"
      },
      "tailwind": {
        "name": "Viento a favor",
        "desc": "La grúa se mueve más rápido"
      },
      "featherday": {
        "name": "Día pluma",
        "desc": "Un bamboleo extra antes de caer"
      }
    },
    "combo": {
      "roll": "¡En racha!",
    ...
    "howTo": {
      ...
      "steps": [
        ...
        "🔤 Cada palabra válida apila un piso. ¡Construye lo más alto posible!"
      ]
    },
    ...
    "milestone": {
      "m50": "¡Sobre las copas! 🌳",
      "m150": "Zona de nubes ☁️",
      "m400": "Los pájaros tienen envidia 🐦",
      "m250": "Más alto que los drones 🛸",
      "m650": "Ambiente de nebulosa 🌌",
      "m900": "Tocando el espacio 🚀",
      "m1300": "Habitante del espacio profundo 👽",
      "m1800": "Casi astronauta ✨"
    },
    "ach": {
      "unlocked": "¡Logro!",
      "firstFloor": "Primer piso",
      "tenFloors": "Edificio",
      "skyHigh": "Por las nubes",
      "wordsmith": "Maestro de palabras",
      "comboKing": "Rey del combo",
      "rivalCrusher": "Aplasta-rivales",
      "unstoppable": "Imparable",
      "toTheMoon": "A la luna",
      "skylineKing": "Rey del horizonte",
      "centurion": "Centurión",
      "comboGod": "Dios del combo",
      "wordWizard": "Mago de palabras",
      "galaxyClass": "Clase galaxia",
      "deepSpace": "Espacio profundo"
    },
    "zone": {
      "entered": "Nueva zona",
      "next": "Siguiente: {zone} · {m}m"
    },
    "landmark": {
      "skyscraper": "Cima del rascacielos",
      "cloudBase": "Base de nubes",
      "mountainTop": "Pico de montaña",
      "jetStream": "Corriente en chorro",
      "stormTops": "Cima de tormenta",
      "weatherBalloon": "Globo meteorológico",
      "earthCurve": "Curvatura terrestre",
      "karman": "Borde del espacio",
      "meteorBelt": "Cinturón de meteoros",
      "aurora": "Aurora",
      "deepSpace": "Espacio profundo"
    },
    "hazard": {
    ...
    "surprise": {
      ...
      "surge": "¡Subidón!",
      "windfall": "¡Regalo!",
      "updraft": "¡Corriente! Próxima palabra reforzada",
      "crystal": "¡Cristal raro!",
      "echo": "¡Eco impulsor!",
      "meteorStrike": "¡Golpe de meteorito!",
      "phantomFloor": "¡Piso fantasma!",
      "goldenFloor": "¡Piso dorado!"
    },
    "daily": {
      "badge": "Diario · {date}",
    ...
    "perk": {
      ...
      "masterCrane": {
        "name": "Grúa maestra",
        "desc": "Mayor recompensa en caídas perfectas"
      },
      "tallTimber": {
        "name": "Madera alta",
        "desc": "+12% de altura en cada piso"
      },
      "featherfall": {
        "name": "Caída de pluma",
        "desc": "Los derrumbes cuestan un piso menos"
      },
      "reinforced": {
        "name": "Reforzado",
        "desc": "Más tambaleo antes del abismo"
      },
      "cushion": {
        "name": "Cojín de seguridad",
        "desc": "El vaivén de la grúa nunca tira un piso"
      }
    },
    "runPerk": {
      "hotStreak": {
        "a11y": "Racha caliente: quedan {n} caídas"
      }
    },
    "crane": {
      "drop": "Soltar",
      ...
      "steady": "Firme",
      "onFire": "En racha",
      "steadyAria": "Racha de pulso firme: {n} caídas perfectas"
    },
    "upgrade": {
      "categories": {
        "crane": "Grúa",
      ...
      "wideFooting": {
        "name": "Base ancha",
        "desc": "Amplía la ventana de aterrizaje perfecto"
      },
      "windbreak": {
        "name": "Cortavientos",
        "desc": "Calma el viento a gran altura"
      },
      "masterArchitect": {
        "name": "Maestro arquitecto",
        "desc": "Mayores recompensas de monedas en cada caída"
      },
      "reinforcedCore": {
        "name": "Núcleo reforzado",
        "desc": "Sobrevive a un tambaleo más antes de caer"
      },
      "quickRecovery": {
        "name": "Recuperación rápida",
        "desc": "La torre se endereza más rápido"
      },
      "tailwind": {
        "name": "Viento a favor",
        "desc": "Cada piso sube un poco más"
      },
      "salvage": {
        "name": "Grúa de rescate",
        "desc": "Un derrumbe tira menos pisos"
      },
      "momentum": {
        "name": "Impulso",
        "desc": "Las rachas perfectas rinden aún más"
      },
      "centerMagnet": {
    ...
    "sabotage": {
      "chip": "Bola de demolición",
      "tokens": "{n}",
      "pickTarget": "Elige un rival",
      "noTargets": "Aún no hay rivales",
    ...
    "versus": {
      ...
      "bomb": "Bombardear a {name}",
      "waiting": "Esperando rivales…",
      "incoming": "¡Bomba entrante!",
      "won": "¡Ganaste!",
      "lost": "Ganó {name}"
    },
    "a11y": {
      "height": "Altura {m} metros",
      "combo": "cadena {n}",
      "tile": "Letra {letter}",
    ...
    "skin": {
      ...
      "classic": {
        "name": "Estándar",
        "blurb": "Hormigón y acero honestos."
      },
      "copper": {
        "name": "Cobre",
        "blurb": "Calidez oxidada, forjada a mano."
      },
      "marble": {
        "name": "Mármol",
        "blurb": "Piedra pálida, veteada y fresca."
      },
      "gold": {
        "name": "Fiebre del Oro",
        "blurb": "Oro cepillado, ganado a pulso."
      },
      "onyx": {
        "name": "Ónix",
  ...
  "flag": "🇪🇸",
  "androidAppPromo": {
    "title": "Descarga la app de LexiClash",
    "subtitle": "Juega más fluido y rápido en la app gratuita de Android.",
  ...
  "seo": {
    "teacherUpgrade": {
      "title": "Teacher Pro: clases y estudiantes ilimitados | LexiClash",
      "description": "Mejora a Teacher Pro para tener aulas y estudiantes ilimitados por clase. $9/mes. Gestiona el programa de vocabulario de todo tu centro con una sola suscripción.",
      "ogTitle": "Mejora a Teacher Pro: clases ilimitadas",
      "ogDescription": "Gestiona aulas y estudiantes ilimitados por $9/mes. Haz crecer la enseñanza de vocabulario con LexiClash Pro."
    },
  ...
  "common": {
    ...
    "playerAFK": "Ausente",
    "playerIdle": "Inactivo",
    "playerReconnecting": "Reconectando...",
    "left": "restante",
    "optional": "opcional",
    "today": "Hoy",
    "yesterday": "Ayer",
  ...
  "share": {
    ...
    "emojiCard": {
      ...
      "connectionsHeader": "LexiClash Puente de palabras · {date}",
      "bridges": "puentes",
      "share": "Compartir",
      "copy": "Copiar",
  ...
  "multiplayerFlow": {
    ...
    "roomList": {
      ...
      "arenaHub": "Centro de Arena",
      "heroAlt": "Dos jugadores enfrentándose en un escenario de neón",
      "createPrivateBattle": "Crear batalla privada",
...
"createForm": {
  ...
  "hostView": {
    ...
    "presetEasy": "Fácil",
    "presetEasyDesc": "2 min en tablero fácil",
    "presetParty": "Fiesta",
  ...
  "results": {
    ...
    "revenge": {
      "header": "LA REVANCHA",
      "breathingDown": "Le rozamos la corona",
      "oneWordAway": "Una palabra más y {player} se quedaba fuera.",
      "unfinishedBusiness": "Esto no ha terminado",
      "twoWordsFromGlory": "Dos palabras nos faltaron. {player} tuvo suerte, nada más.",
      "nextTimeItsPersonal": "La próxima ronda es cosa personal con {player}.",
      "runItBack": "¡Revancha!",
      "theyGotLucky": "{player} se llevó esta. La guerra sigue.",
      "comebackArc": "La remontada empieza aquí",
      "everyVillainNeedsOrigin": "Toda gran rivalidad empieza así. {player} acaba de encender la mecha."
    },
    "defend": {
      "untouchable": "Imbatible",
      "theyNeedAPlan": "{player} va a tener que cambiar de estrategia.",
      "staySharp": "Ni te relajes, campeón",
      "theyreStudying": "{player} te está analizando.",
      "thinIce": "Te vienen pisando los talones",
      "comingForYou": "{player} está a una buena ronda. Ni pestañees."
    },
    ...
    "awards": {
      ...
      "comboKing": "Rey del Combo",
      "comboKingDesc": "Encadenó bonos como una máquina",
      "speedDemon": "Rayo",
      ...
      "lateBloomerDesc": "Se despertó al final y arrasó con puntos",
      "bigFish": "Golpe Maestro",
      "bigFishDesc": "Cazó la palabra más valiosa de la partida"
    },
    "pointsFromFirst": "{points} pts del 1°",
    "justBehind": "Solo {points} pts detrás del #1",
    "pts": "pts",
    "rematch": "REVANCHA",
    "target": "Objetivo",
  ...
  "legal": {
    "title": "Legal",
    "termsOfService": "Términos de Servicio",
    "refundPolicy": "Política de reembolsos y cancelaciones",
    "privacyPolicy": "Política de Privacidad",
  ...
  "cosmetics": {
    ...
    "items": {
      ...
      "boardGalaxyDesc": "Juega entre las estrellas.",
      "victoryConfetti": "Confeti",
      "victoryConfettiDesc": "Celebración clásica con confeti.",
      ...
      "frameBronzeDesc": "Un sólido marco de bronce para principiantes.",
      "frameSilver": "Marco de Plata",
      "frameSilverDesc": "Un marco de plata pulido.",
  ...
  "onboarding": {
    ...
    "boss": {
      "combat": {
        ...
        "ability": {
          "smite": {
            "name": "Castigo",
            "desc": "Desata una ráfaga de daño sobre el jefe"
          },
          "ward": {
            "name": "Guarda",
            "desc": "Bloquea el próximo ataque del jefe"
          },
          "focus": {
            "name": "Enfoque",
            "desc": "Tu próxima palabra golpea con daño extra"
          }
        }
      }
    },
    "surprise": {
      "doubleGold": {
        "label": "¡Oro Doble!",
        "desc": "Este nivel paga el doble de oro."
      },
      "bonusChest": {
        "label": "¡Cofre Extra!",
        "desc": "Aparece un cofre de tesoro adicional."
      },
      "luckyGems": {
        "label": "¡Gemas de la Suerte!",
        "desc": "Una lluvia de gemas."
      },
      "goldenWord": {
        "label": "¡Palabra Dorada!",
        "desc": "Una palabra oculta valía un premio gordo."
      },
      "comboFrenzy": {
        "label": "¡Frenesí de Combos!",
        "desc": "Las recompensas de combo contaron doble en este nivel."
      }
    },
    "welcome": {
  ...
  "season": {
    "twist": {
      "double-down": {
        "title": "Doble o nada",
        "blurb": "Las palabras largas brillan más esta temporada."
      },
      "crown-rush": {
        "title": "Fiebre de coronas",
        "blurb": "Cada letra es un arma. Conquista el trono."
      },
      "rare-find": {
        "title": "Hallazgo raro",
        "blurb": "Desempolva las palabras raras: este es su mes."
      },
      "combo-beat": {
        "title": "Ritmo combo",
        "blurb": "Apila sílabas, monta el combo, marca el ritmo."
      },
      "sound-wave": {
        "title": "Onda sonora",
        "blurb": "Mezcla ritmos y letras en jugadas de éxito."
      },
      "throne-climb": {
        "title": "Ascenso al trono",
        "blurb": "Construye tu trono con cada palabra que sabes."
      },
      "frostbite": {
        "title": "Mordida de hielo",
        "blurb": "Mantén tu racha caliente mientras el tablero se congela."
      },
      "afterglow": {
        "title": "Resplandor",
        "blurb": "Estelas de neón siguen cada palabra que encuentras."
      },
      "heatwave": {
        "title": "Ola de calor",
        "blurb": "Cuanto más larga tu racha, más arde el tablero."
      },
      "bloom": {
        "title": "Floración",
        "blurb": "Cada hallazgo siembra el siguiente. Mira florecer tu puntaje."
      },
      "stardust": {
        "title": "Polvo de estrellas",
        "blurb": "Las letras flotan como constelaciones por el tablero."
      },
      "final-bell": {
        "title": "Campana final",
        "blurb": "El año cierra: cada punto entra en los libros de récords."
      }
    },
    ...
    "complete": "¡Temporada completada!",
    "continue": "Continuar",
    "gamesPlayed": "Partidas jugadas",
    "newSeason": "Nueva temporada",
    "rewardCoins": "Monedas ganadas",
    "softReset": "Reinicio de rango",
    "claimRewards": "Reclamar recompensas",
    "claim": "Reclamar",
    "alreadyClaimed": "Ya reclamado",
    "rewardEarned": "¡Ganaste {{coins}} monedas!",
    "thisSeason": "Esta temporada",
    "lastSeason": "Tu temporada anterior",
    "finalDays": "¡Últimos días!",
    "yourRecap": "Tu resumen",
    "allTime": "Histórico",
  ...
  "wordFeedback": {
    ...
    "witty1": "{player} dice que \"{word}\" es una palabra real...",
    "witty2": "¿Palabra real o genio creativo? ¡Tú decides!",
  ...
  "landing": {
    ...
    "classroomHeroTitle": "Juegos de palabras para tu clase",
    "classroomHeroSubtitle": "Sin cuentas de alumnos. Comparte un código de 6 caracteres. Toda la clase juega gratis.",
    "forTeachers": "Para docentes",
    ...
    "tickerWord": "PALABRA",
    "tickerStreak": "RACHA",
    "tickerScored": "anotó {score} pts con {count} palabras",
    "tickerFoundWord": "encontró \"{word}\" ({score} pts)",
    "tickerScoredPts": "anotó {score} pts",
    ...
    "tickerFun11": "encontró una palabra larga escondida",
  ...
  "singlePlayer": {
    ...
    "preset": {
      ...
      "standard": "Estándar",
      "standardDesc": "Partida clásica de 2 min",
      "intense": "Intenso",
      "intenseDesc": "Tablero grande, 3 min",
      "friendly": "Amistoso",
      "friendlyDesc": "Modo fácil con un bot",
      "competitive": "Competitivo",
      "competitiveDesc": "Medio vs 2 bots",
      "battle": "Batalla",
      "battleDesc": "Difícil vs 3 bots",
      "explorer": "Explorador",
      "explorerDesc": "Sin tiempo, tablero fácil",
      "hunter": "Cazador",
      "hunterDesc": "Sin tiempo, tablero medio",
      "mastery": "Maestría",
    ...
    "mode": {
      ...
      "soloBotsDesc": "Compite contra IA",
      "practice": "Práctica",
  ...
  "practice": {
    ...
    "wheelRush": {
      ...
      "reset": "Reiniciar",
      "shuffle": "Mezclar",
      "builderHint": "Toca o arrastra letras",
  ...
  "daily": {
    ...
    "flow": {
      ...
      "introHint": "El Flujo Diario encadena los retos de hoy en una sola tirada — mantén pulsado el botón para saltarte las pausas.",
      "startHint": "Toca para empezar · mantén pulsado para ir directo",
      "holdingHint": "Sigue pulsando para el modo rápido…",
      "title": "Flujo Diario",
      "readyTitle": "¡Vamos allá!",
      "nextTitle": "¡Genial! Sigue con el flujo",
      "progress": "{done} de {total} superados",
      "nextUp": "Ahora sigue",
      "startCta": "Empezar",
      "continueCta": "Continuar",
      "autoAdvance": "Sigue en {n}s · toca para pausar",
      "takeBreak": "Tómate un respiro, retómalo cuando quieras",
      "barNext": "Siguiente reto",
      "barFinish": "Cierra el flujo",
      "resumeTitle": "Retoma tu flujo",
      "resumeSubtitle": "{done}/{total} hechos · sigue: {mode}",
      "resumeCta": "Retomar",
      "doneTitle": "¡Flujo completo!",
      "doneSubtitle": "Superaste todos los retos diarios. Vuelve mañana a por otra ronda.",
    ...
    "chaseLeadingCta": "Defiende el primer puesto",
    ...
    "insights": {
      ...
      "speed": {
        "headline": "¡Velocidad récord!",
        "sub": "{n}% más rápido que tu promedio"
      },
      "firstTry": {
        "headline": "¡Al primer intento!",
        "sub": "Solo el {n}% lo resolvió en 1"
      },
      "streakComplete": {
        "headline": "¡Semana completa!",
        "sub": "Tu cofre está listo para abrir"
      },
      "improved": {
  ...
  "dailyWordWheelLanding": {
    ...
    "steps": {
      "1": {
        "title": "Nuevo puzzle diario",
        "desc": "Una nueva rueda de letras aparece cada día a medianoche UTC. Todos los jugadores del mundo reciben las mismas letras."
      },
      "2": {
        "title": "Encuentra palabras",
        "desc": "Forma palabras con las letras de la rueda. Cada palabra debe incluir la letra central y tener al menos 3 letras. Palabras más largas = más puntos."
      },
      "3": {
        "title": "Vence al reloj",
        "desc": "Encuentra tantas palabras como puedas antes de que se acabe el tiempo. Velocidad y vocabulario importan."
      },
      "4": {
        "title": "Compara globalmente",
        "desc": "Ve tu posición en la tabla de clasificación diaria. Persigue el récord mundial y sigue tu racha."
      },
      ...
      "items": [
        {
          ...
          "a": "La Rueda de Palabras Diaria es un puzzle de palabras gratuito en LexiClash. Cada día a medianoche UTC aparece una nueva rueda de letras. Tu objetivo es encontrar tantas palabras como sea posible. Todos juegan el mismo puzzle."
        },
        {
          "q": "¿Cómo se juega?",
          "a": "Recibes letras dispuestas en una rueda con una letra central. Forma palabras — cada palabra debe incluir la letra central y tener al menos 3 letras. Encuentra tantas palabras como puedas antes de que se acabe el tiempo."
        },
        {
          "q": "¿Es gratis?",
          "a": "Sí, completamente gratis. Sin descargas, sin registro, sin anuncios. Juega en el navegador de cualquier dispositivo."
        },
        {
          "q": "¿Puedo ver el récord mundial?",
          "a": "¡Sí! Después de completar el puzzle, puedes ver la tabla de clasificación global con las puntuaciones más altas del día."
        },
        {
          "q": "¿Todas las palabras necesitan la letra central?",
          "a": "¡Sí! Cada palabra que envíes debe incluir la letra central de la rueda. Es la restricción principal que hace el puzzle desafiante."
        },
        {
          "q": "¿En qué idiomas está disponible?",
          "a": "La Rueda de Palabras Diaria está disponible en inglés, hebreo, sueco, japonés y español. Cada idioma tiene su propio diccionario y tabla de clasificación."
        }
      ]
    },
    "finalCta": {
  ...
  "wordWheel": {
    ...
    "results": {
      ...
      "playConnectionsTitle": "Siguiente: Puente de palabras",
      "playConnectionsDesc": "Resuelve el Puente de palabras de hoy para terminar tu serie diaria",
  ...
  "wordHunt": {
    ...
    "leaderboard": {
      ...
      "today": "Hoy",
      "allTime": "Histórico",
      "connections": "Puente de palabras",
      "played": "jugaron",
      "solved": "Resuelto",
      "failed": "Fallido",
      "you": "TÚ",
      ...
      "countrySingular": "1 país",
      "live": "En vivo",
      "movedUp": "Sube {count}",
      "movedDown": "Baja {count}",
      "newEntry": "Nuevo",
      "seasonPts": "pts de temporada",
      "daysPlayed": "{count} días",
      "dayPlayed": "1 día",
      "seasonNoPlayers": "Aún no hay puntos de temporada: el reto de hoy es el primer paso",
      "seasonEndsIn": "Termina en {days} d {hours} h",
      "seasonEnded": "Temporada terminada",
      "seasonHint": "Cada reto diario que juegas suma a tu puntuación de temporada",
      "currentSeason": "Ahora",
      "seasonPicker": "Elegir temporada",
      "languageScope": "Filtro de idioma"
    },
    "shareMessage": {
  ...
  "peerValidation": {
    ...
    "yourWordRejected": "¡Tu palabra fue rechazada!",
    "wordRejected": "Palabra rechazada",
    "communityRejected": "La comunidad votó esta palabra como inválida.",
    "pointsLost": "Puntos perdidos",
    "wasRejected": "fue rechazada",
    "invalidVotes": "Inválida",
    "validVotes": "Válida"
  },
  "email": {
  ...
  "admin": {
    ...
    "insights": {
      ...
      "gamesToday": "Juegos hoy",
      "vsYesterday": "vs ayer",
      "vsYesterdayNew": "vs 0 ayer",
      "bestDayEver": "Mejor día de todos",
      "fastestGrowing": "Modo de más rápido crecimiento",
      "thisWeek": "esta semana",
      "byDayOfWeek": "Día más ocupado",
      "isPeakDay": "es tu día de mayor actividad",
      "byHour": "Hora más ocupada (UTC)",
      "isPeakHour": "es tu hora de mayor actividad",
      "crossPlay": "Los jugadores que juegan X también juegan Y",
      "noShowRate": "Jugadores que se unieron pero no anotaron",
      "noShowHint": "Porcentaje de juegos registrados con 0 puntos y 0 palabras — jugadores que se unieron pero no jugaron.",
      "wordQuality": "Calidad de palabras por idioma",
      "wordQualityHint": "Palabras rechazadas vs aceptadas (últimos 30 días). Una tasa alta de rechazo indica brechas en el diccionario para ese idioma.",
      "rejected": "rechazada",
      "dow": {
        "sun": "Domingo",
        "mon": "Lunes",
    ...
    "teacherAccess": {
      ...
      "filter_country": "País",
      "refresh": "Actualizar",
      "row_open": "Abrir solicitud de {name}",
      "page": "Página",
      "export_csv": "Exportar CSV",
      "col": {
        "name": "Nombre",
      ...
      "preview_title": "Previsualización del correo",
    ...
    "wordBank": {
      ...
      "filters": {
        ...
        "allValidationStatuses": "Todos los Estados de Validación",
      ...
      "cancel": "Cancelar",
      "bulkImport": {
        "button": "Importación Masiva",
        "title": "Importación Masiva de Palabras",
        "description": "Importa múltiples palabras a la vez. Ingresa una palabra por línea o separadas por comas.",
        "instructions": "Ingresa las palabras a importar:",
        "formatPlain": "Texto plano: Una palabra por línea",
        "formatCsv": "CSV: Se usa la primera columna como palabra",
        "lengthFilter": "Se omitirán palabras fuera del rango de longitud válido",
        "source": "Fuente",
        "inputLabel": "Palabras a importar",
        "placeholder": "Ingresa palabras separadas por nueva línea o coma...",
        "options": "Opciones de Importación",
        "validationStatus": "Estado de Validación",
        "wordsLabel": "Palabras",
        "noContent": "Por favor ingresa palabras para importar",
        ...
        "skipped": "Omitidas",
        "errors": "Errores",
        "showErrors": "Ver detalles de errores...",
        "successMessage": "{{count}} palabras importadas exitosamente",
      ...
      "bulkActions": {
        ...
        "successMessage": "{{count}} palabras {{action}}",
        "errorMessage": "Error en acción masiva",
        "clearSelection": "Limpiar Selección"
      },
      "wikipediaSync": {
        "title": "Sincronización de Wikipedia",
        "description": "Sincroniza palabras de Wikipedia al banco para revisión",
        "currentLanguage": "Idioma actual",
        "syncButton": "Sincronizar Palabras de Wikipedia",
        "syncNow": "Sincronizar Ahora",
        "syncing": "Sincronizando...",
        "success": "Sincronizados {{files}} archivos, importadas {{words}} palabras",
        "successMessage": "{{count}} palabras sincronizadas exitosamente",
    ...
    "activity": {
      ...
      "signups": "Registros",
      "empty": "Sin actividad en este rango",
      "error": "No se pudo cargar la actividad diaria"
    },
    "geo": {
      "title": "Jugadores por país",
      "registered": "registrados",
      "guests": "invitados",
      "empty": "Aún no hay datos por país",
      "error": "No se pudieron cargar los datos por país"
    },
    "acquisition": {
      "title": "Adquisición",
      "sources": "Fuentes",
      ...
      "campaigns": "Campañas",
      "referrers": "Referidos",
      "empty": "Sin datos en esta dimensión",
      "error": "No se pudieron cargar los datos de adquisición"
    },
    "authSessions": {
      "title": "Actividad de autenticados",
      "totalGames": "Partidas",
      ...
      "empty": "Sin partidas de autenticados en esta ventana",
      "error": "No se pudieron cargar los datos de autenticados"
    },
    "guests": {
      "title": "Actividad de invitados",
      "totalGames": "Partidas",
      "uniqueGuests": "Invitados únicos",
      "avgScore": "Puntuación media",
      "byMode": "Por modo",
      "byLanguage": "Por idioma",
      "windowDays": "ventana de {{days}}d",
      "empty": "Sin partidas de invitados en esta ventana",
      "error": "No se pudieron cargar los datos de invitados"
    },
    "player": {
      "title": "Detalle del jugador",
      "back": "Volver",
      "notFound": "Jugador no encontrado",
      "loadError": "Error al cargar el jugador",
      "joined": "Se unió",
      ...
      "identity": "Identidad",
      "role": "Rol",
      "dailyEmail": "Correo diario",
      "referrals": "Referidos",
      "seasonScore": "Puntuación de temporada",
      "economy": "Economía",
      "coins": "Monedas",
      ...
      "utmCampaign": "Campaña",
      "referrer": "Referente",
      "noAcquisitionData": "Sin datos de adquisición",
      "byLanguage": "Idiomas jugados",
      "byMode": "Por modo (últimas 200 sesiones)",
      "sessions": "Sesiones",
      "completed": "Completadas",
      "ranked": "clasificada",
      "casual": "casual",
      "noGames": "Sin partidas recientes",
      "gameCode": "Partida",
      "score": "Puntos",
      "words": "Palabras",
      "placement": "#",
    ...
    "sendingTo": "Enviando a",
    "titleLabel": "Título",
    "titlePlaceholder": "Título de notificación...",
    "bodyLabel": "Mensaje",
    "bodyPlaceholder": "Mensaje de notificación...",
    "actionUrlLabel": "URL de Acción",
    "sendSuccess": "¡Notificación enviada exitosamente!",
    "sendError": "Error al enviar notificación. Por favor, intenta de nuevo."
  },
  "tvTutorial": {
    "welcome": {
  ...
  "quickPlay": {
    "solo": {
      ...
      "raceStandings": "Esta ronda",
      "rivalsPassed": "Superaste {passed} de {total}",
      "passed": "superado",
      "wordsCollected": "{count} palabras",
      "wordsNew": "{count} nuevas",
      "wordsTotal": "{count} recogidas",
      "bestWord": "Mejor",
  ...
  "theme": {
    ...
    "thursdayThrowback": "Jueves nostálgico",
    "funFriday": "Viernes divertido",
  ...
  "adminGifts": {
    ...
    "selectAtLeast": "Selecciona al menos un jugador",
    "playerSelected": "jugador seleccionado",
    "playersSelected": "jugadores seleccionados",
    "messageTitle": "Título del mensaje",
    "messageTitlePlaceholder": "Ingresa un título para tu mensaje",
    "messageBody": "Mensaje",
    "messageBodyPlaceholder": "Escribe tu mensaje personalizado...",
    "xpAmount": "Cantidad de XP",
    "coinAmount": "Cantidad de monedas",
    "rewardPresets": "Presets rápidos",
    "presetSmall": "Pequeño",
    "presetMedium": "Mediano",
    "presetLarge": "Grande",
    "template": {
      "topPlayer": "Reconocimiento de mejor jugador",
      "topPlayerDesc": "Reconoce el rendimiento excepcional de un jugador",
      "feedback": "Solicitud de comentarios",
      "feedbackDesc": "Pide comentarios y sugerencias a un jugador",
      "thankYou": "Agradecimiento",
      "thankYouDesc": "Expresa gratitud a un jugador",
      "custom": "Mensaje personalizado",
      "customDesc": "Escribe tu propio mensaje personalizado"
    },
    "previewTitle": "Vista previa de tu regalo",
  ...
  "adventure": {
    ...
    "collection": {
      ...
      "runeFragmentDesc": "Un fragmento brillante de poder antiguo",
      ...
      "bossTrophy": {
        ...
        "w3": "Trofeo del Leviatán del Océano",
        "w4": "Trofeo del Titán de la Montaña",
        "w5": "Trofeo de la Serpiente de la Selva",
        "w6": "Trofeo del Yeti de la Tundra",
        "w7": "Trofeo del Dragón del Volcán",
        "w8": "Trofeo del Grifo del Cielo",
        "w9": "Trofeo del Espectro de las Sombras",
        "w10": "Trofeo del Señor Cósmico"
      },
      "bossTrophyDesc": {
        "w1": "Derrotaste al Guardián del Bosque",
        "w2": "Derrotaste al Faraón del Desierto",
        "w3": "Derrotaste al Leviatán del Océano",
        "w4": "Derrotaste al Titán de la Montaña",
        "w5": "Derrotaste a la Serpiente de la Selva",
        "w6": "Derrotaste al Yeti de la Tundra",
        "w7": "Derrotaste al Dragón del Volcán",
        "w8": "Derrotaste al Grifo del Cielo",
        "w9": "Derrotaste al Espectro de las Sombras",
        "w10": "Derrotaste al Señor Cósmico"
      },
      "loreScroll": {
        "w1": "Pergamino del Bosque",
        "w2": "Pergamino del Desierto",
        "w3": "Pergamino del Océano",
        "w4": "Pergamino de la Montaña",
        "w5": "Pergamino de la Selva",
        "w6": "Pergamino de la Tundra",
        "w7": "Pergamino del Volcán",
        "w8": "Pergamino del Cielo",
        "w9": "Pergamino de las Sombras",
        "w10": "Pergamino Cósmico"
      },
      "worldEssence": {
        "w1": "Esencia del Bosque",
        "w2": "Esencia del Desierto",
        "w3": "Esencia del Océano",
        "w4": "Esencia de la Montaña",
        "w5": "Esencia de la Selva",
        "w6": "Esencia de la Tundra",
        "w7": "Esencia del Volcán",
        "w8": "Esencia del Cielo",
        "w9": "Esencia de las Sombras",
        "w10": "Esencia Cósmica"
      },
      "worldEssenceDesc": {
        "w1": "El espíritu del bosque encantado",
        "w2": "El corazón ardiente del desierto",
        "w3": "Una gota del océano primordial",
        "w4": "El núcleo irrompible de la montaña",
        "w5": "El pulso salvaje de la selva",
        "w6": "Un cristal congelado del invierno eterno",
        "w7": "Una chispa del corazón del volcán",
        "w8": "Una pluma de las nubes más altas",
        "w9": "Un susurro del reino de las sombras",
        "w10": "Un fragmento del cosmos"
      },
      "ancientRelic": {
        "w5": "Ídolo de la Selva",
        "w6": "Brújula Congelada",
        "w7": "Máscara de Obsidiana",
        "w8": "Campanilla del Viento",
        "w9": "Espejo de Sombras",
        "w10": "Mapa Estelar"
      },
      "ancientRelicDesc": {
        "w5": "Un ídolo antiguo de las profundidades de la selva",
        "w6": "Una brújula que siempre apunta al lugar más frío",
        "w7": "Una máscara forjada en el corazón del volcán",
        "w8": "Una campanilla que toca la canción del viento",
        "w9": "Un espejo que refleja lo que fue",
        "w10": "Un mapa que muestra caminos entre las estrellas"
      }
    },
  ...
  "blast": {
    ...
    "modifier": {
      ...
      "bombParty": {
        ...
        "desc": "Muchas más bombas en juego."
      },
      "luckyVowels": {
        "name": "Golpe de Suerte",
        "desc": "Menos obstáculos de hielo y un poco más de oro."
      },
      "megaCombo": {
        "name": "Mega Combo",
        "desc": "Los combos pegan más fuerte por puntos extra."
      },
      "gemRush": {
        "title": "AVALANCHA DE GEMAS",
        "sub": "más gemas en el tablero"
      },
      "coinBonanza": {
        "title": "LLUVIA DE MONEDAS",
        "sub": "más monedas esta ronda"
      },
      "bonusStorm": {
        "title": "TORMENTA BONUS",
        "sub": "fichas de doble bonus desatadas"
      }
    },
    "surprise": {
      "coinBurst": {
      ...
      "gemShower": {
        "title": "¡Lluvia de gemas!"
      },
      "chainCharge": {
        "title": "¡Carga en cadena!"
      },
      "luckyDouble": {
        "title": "¡Doble suerte!"
      },
      "goldenWord": {
        "title": "¡Palabra dorada!"
      },
    ...
    "tutorial": {
      ...
      "unlock": {
        "gotIt": "Entendido",
        "skipFuture": "Saltar tutoriales futuros"
      }
    },
    "adBadge": "ANUNCIO",
    ...
    "tile": {
      "gold": {
        "name": "Oro",
        "desc": "Puntos ×3 + 1 movimiento extra."
      },
      "silver": {
        "name": "Plata",
        "desc": "Puntos ×1.5. Extiende cuentas atrás en 1."
      },
      "diamond": {
        "name": "Diamante",
        "desc": "Puntos ×5. Revela contenido de escarcha por 3 turnos."
      },
      "bomb": {
        "name": "Bomba",
        "desc": "Limpia área 3×3. Encadena con bombas cercanas."
      },
      "lightning": {
        "name": "Rayo",
        "desc": "Limpia la columna entera al instante."
      },
      "prism": {
        "name": "Prisma",
        "desc": "2 golpes. Limpia fila + columna. Encadena bombas y rayos."
      },
      "rainbow": {
        "name": "Arcoíris",
        "desc": "Copia y duplica el mejor especial. Solo: puntos ×2."
      },
      "ice": {
        "name": "Hielo",
        "desc": "2 golpes para romper. Ficha defensiva de múltiples golpes."
      },
      "gem": {
        "name": "Gema",
        "desc": "3 golpes para recoger. Genera 2 especiales al completar."
      },
      "frozen": {
        "name": "Escarcha",
      ...
      "magnet": {
        "name": "Vórtice",
        "desc": "Atrae fichas cercanas y luego explota el área."
      },
      "mirror": {
        "name": "Espejo",
        "desc": "Copia el primer especial ofensivo de tu palabra. Solo: puntos ×2."
      },
      "wildcard": {
        "name": "Comodín",
        "desc": "Cualquier letra. Puntúa según valor Scrabble de la letra usada."
      },
      "countdown": {
        "name": "Cuenta atrás",
        "desc": "Cuenta movimientos. Desarma en palabra: +15 pts y 2 extras. Expira: -50 pts y explosión 3×3."
      },
      "shuffle": {
        "name": "Mezcla",
        "desc": "Reorganiza todas las letras restantes del tablero al limpiar."
      },
      "magma": {
        "name": "Magma",
        "desc": "Limpia ambas diagonales (patrón X) con multiplicador de puntos ×2."
      },
      "portal": {
        "name": "Portal",
        "desc": "Teletransporta tu camino de palabras a través de pares vinculados. Limpia ambos. ×2 puntos. +5 bonus."
      },
      "catalyst": {
        "name": "Catalizador",
      ...
      "crystal": {
        "name": "Cristal",
        "desc": "Crece +1× cada turno sin usar (máx 5×). Multiplica tu puntuación de palabra al usarlo."
      },
      "fuse": {
        "name": "Mecha",
      ...
      "anchor": {
        "name": "Ancla",
        "desc": "Recompensa palabras largas. Suma +3 puntos por cada letra de la palabra al eliminarse."
      },
      "mystery": {
        "name": "Misterio",
    ...
    "helpPrismLabel": "Prisma",
    "helpPrism": "Usa en 2 palabras para activar limpieza cruzada (fila + columna completa).",
    "helpGemLabel": "Gema",
    "helpGem": "Usa en 3 palabras para recolectar. +3 por uso, +8 al recolectar.",
    ...
    "objective": {
      ...
      "colorCyan": "Cian",
      "colorLime": "Lima",
      "clearJelly": "Elimina toda la gelatina",
      "killCake": "Destruye el pastel",
      "stopChocolate": "Detén el chocolate",
      "bannerTitle": "Objetivos",
      "pathRoute": "Conecta ◯ con ◉ en una palabra",
      "pathRouteSuccess": "¡RUTA CONECTADA!",
      "cascadeChain": "Encadena {target} palabras seguidas",
      "cascadeChainProgress": "🔥 ×{streak}",
      "cascadeChainSuccess": "¡SIN ROMPER!",
      "tileSniper": "Usa la casilla marcada en una palabra",
      "tileSniperSuccess": "¡IMPACTO!",
      "longWordLockup": "Una palabra de {minWordLength}+ letras",
      "longWordLockupSuccess": "¡OBRA MAESTRA!"
    },
    "insight": {
    ...
    "tileGuide": {
      ...
      "gold": {
        "name": "Oro",
        "desc": "×3 puntos + 1 movimiento extra"
      },
      "silver": {
        "name": "Plata",
        "desc": "×1.5 puntos + extiende cuentas regresivas en 1"
      },
      "diamond": {
        "name": "Diamante",
        "desc": "×5 puntos + revela contenido congelado por 3 turnos"
      },
      "bomb": {
        "name": "Bomba",
      ...
      "rainbow": {
        "name": "Arcoíris",
        "desc": "Copia el mejor especial en tu palabra, o ×2 puntos"
      },
      "ice": {
        "name": "Hielo",
        "desc": "2 golpes para romper. Ficha defensiva de múltiples golpes."
      ...
      "mirror": {
        "name": "Espejo",
        "desc": "Copia el primer especial ofensivo en tu palabra"
      },
      "magnet": {
        "name": "Imán",
        "desc": "Atrae fichas cercanas hacia adentro, luego explota 3×3"
      },
      "wildcard": {
        "name": "Comodín",
    ...
    "chest": {
      "avatarSuffix": "parte de avatar",
      "boostSuffix": "impulso",
      "coins": "Monedas",
      "coinsSuffix": "monedas",
      "continue": "Continuar",
      "opened": "¡Cofre Abierto!",
      "opening": "Abriendo cofre…",
      "preview": "Previsualización del Cofre",
      "tier": {
        "label": "Nivel"
      },
    ...
    "concept": {
      ...
      "verticalWords": {
        ...
        "body": "Arrastra hacia arriba o hacia abajo para deletrear palabras verticales."
      }
    },
    "settings": {
      "tutorials": "Repetir Tutoriales"
    }
  },
  "student": {
    "practiceFun": {
      "headline": {
        ...
        "gold": "¡GENIAL!",
        "silver": "¡BUENA RONDA!",
        "bronze": "¡RONDA COMPLETA!"
      },
      "starsEarned": "{{count}} de 3 estrellas",
      "scoreLine": "{{correct}} de {{total}} · {{percent}} %",
      "xpGain": "+{{xp}} XP",
      "xpRate": "{{xp}} XP",
  ...
  "teacher": {
    "nav": {
      ...
      "me": "Perfil",
      "studentPlay": "Jugar",
      "studentPractice": "Practicar",
      "studentAchievements": "Logros",
      "sidebarLabel": "Secciones del profesor",
      "tabsLabel": "Secciones principales"
    },
    "emptyClassroom": {
      "title": "Aún no hay clase, y no hace falta",
      "body": "Pulsa EN DIRECTO y creamos la clase mientras el código aparece en la pizarra.",
      "getCode": "Conseguir mi código"
    },
    "shell": {
    ...
    "playNow": {
      ...
      "changeWords": "¿Quieres otras palabras?",
    ...
    "lastGame": {
      ...
      "emptyHint": "Inicia una desde Jugar ya, arriba: aquí verás qué palabras encontró y cuáles se le escaparon a la clase.",
    ...
    "subscription": {
      ...
      "unlimitedStudents": "Estudiantes ilimitados por aula",
  ...
  "education": {
    ...
    "homework": {
      ...
      "promptSpelling": "¿Cuál está bien escrita?",
      "promptSpellingHint": "Solo una de estas está bien escrita.",
      "promptSpell": "Deletréala",
      "timeLeft": "Quedan {{seconds}} segundos",
      "correct": "¡Clavada!",
      "almost": "Era {{word}}",
    ...
    "modePicker": {
      ...
      "subtitle": "Toca un póster. Un segundo después la clase ya está jugando.",
      "recommended": "El que mejor va",
      "recommendedHint": "{{mode}} le va mejor a estas palabras: tu lista trae definiciones para preguntar.",
      "minutes": "{{count}} min",
      "playing": "En juego",
      "change": "Cambiar de juego",
      "sheetTitle": "Cambiar el juego",
      "sheetHint": "Toca otro póster y abrimos la sala con ese.",
      "close": "Me quedo con este",
      ...
      "sameCode": "El mismo código: nadie tiene que volver a entrar.",
      "switched": "Ahora toca {{mode}}, con el mismo código.",
      "switchFailed": "No se cambió. Vuelve a tocarlo.",
      "switchMidRound": "Termina la ronda y después cambia el juego.",
      "how": {
        "classic": "Traza todas las palabras que veas en un mismo tablero de letras.",
    ...
    "liveControls": {
      "studentsCount": "{{count}} jugando",
      "idleCount": "{{count}} atascados",
      "rosterTitle": "Tu clase",
      "rosterEmpty": "Todavía no se ha unido nadie",
      "idleBadge": "Atascado",
      "wordsFound": "{{count}} encontradas",
      "remove": "Expulsar",
      "removeAria": "Expulsar a {{name}} de la partida",
      "removeConfirm": "Expulsar a {{name}}",
      "removeCancel": "Dejar",
      "removeWarning": "No podrá volver a esta partida",
      "removing": "Expulsando…",
      "removeFailed": "Reintentar",
    ...
    "results": {
      ...
      "you": {
        ...
        "words": "{{found}}/{{total}} palabras de la lección",
        "gapToNext": "{{points}} por detrás de {{name}}"
      },
      "moment": {
        "winnerBanner": "¡TENEMOS GANADOR!",
        "drumroll": "Redoble de tambores…",
        "sweepTag": "¡Pleno de palabras!",
        "classSweptTag": "¡La clase encontró las {{total}}!",
        "sweepStreak": "{{count}} plenos seguidos",
        "roundOfSession": "Ronda {{round}} de esta sesión",
        "deltaUp": "+{{points}} respecto a la ronda anterior",
        "deltaDown": "{{points}} menos que la ronda anterior",
        "deltaSame": "Igual que la ronda anterior",
        "personalBest": "¡Récord personal!",
        "climbed": "Subes {{places}} puestos"
      },
      ...
      "startTeamTilesUnplugged": "Empezar Team Tiles Unplugged",
      "teamTilesProgress": "Fichas {{judged}} de {{total}}",
      "teamTilesClassScore": "Puntos de la clase",
      "teamTilesChooseTeams": "¿Cuántos equipos?",
      "teamTilesTeamName": "Equipo {{number}}",
      "teamTilesActiveTeam": "Turno del equipo {{number}}",
      "teamTilesFlipHint": "Voltea una ficha",
      "teamTilesFaceDown": "Ficha miss-gap boca abajo",
      "teamTilesGotIt": "¡El equipo lo logró!",
      "teamTilesExit": "Salir de Team Tiles Unplugged",
      ...
      "startClassicUnplugged": "Empezar Classic Unplugged",
      "classicUnpluggedProgress": "Palabra {{current}} de {{total}}",
      "classicUnpluggedClassScore": "Puntos de la clase",
      "classicUnpluggedChooseMode": "¿Clase o equipos?",
      "classicUnpluggedClassMode": "Clase",
      "classicUnpluggedTeamName": "Equipo {{number}}",
      "classicUnpluggedActiveTeam": "Turno del equipo {{number}}",
      "classicUnpluggedDiscussHint": "Debatan y luego revelen",
      "classicUnpluggedReveal": "Revelar palabra",
      "classicUnpluggedSubmitGotIt": "Enviar: lo lograron",
      "classicUnpluggedSubmitNotYet": "Enviar: aún no",
      "classicUnpluggedExit": "Salir de Classic Unplugged",
      ...
      "unpluggedGameScore": "Puntos de la clase",
      "unpluggedGameStreak": "Racha",
      "unpluggedGameStart": "Iniciar el reloj",
      "unpluggedGameRevealNow": "Revelar",
      "unpluggedGameGotIt": "¡La clase lo tiene!",
      "unpluggedGameNotYet": "Todavía no",
      "unpluggedGameHands": "Manos arriba",
      "unpluggedGameHandsMore": "Una mano más",
      "unpluggedGameHandsFewer": "Una mano menos",
      "unpluggedGameWriteNow": "¡Escríbela en tu hoja!",
      "unpluggedGameChooseTime": "Elige el tiempo de escritura y pulsa iniciar",
      "unpluggedGameLetters": "{{count}} letras",
      "unpluggedGameSecondsUnit": "s",
      "unpluggedGameTimerLabel": "restan",
      "unpluggedGameExit": "Salir del repaso sin dispositivos",
      "unpluggedGameMascotAlt": "Lexi animando a la clase",
      "unpluggedGameMascotWinAlt": "Lexi celebrando con la clase",
      "unpluggedGameWinHeadline": "¡La clase lo logró!",
      "unpluggedGameWinSub": "{{cleared}} de {{total}} palabras superadas, como un solo equipo.",
      "unpluggedGamePerfectHeadline": "¡Ronda perfecta!",
      "unpluggedGamePerfectSub": "Todas las palabras, todos juntos, sin fallos.",
      "unpluggedGamePerfectBadge": "Pleno total",
      "unpluggedGameCleared": "Palabras superadas",
      ...
      "unpluggedReteachPackFooter": "LexiClash · pack Unplugged reteach",
    },
    "classroomAddon": {
    ...
    "duels": {
      ...
      "comboAria": "Cadena de combo de {{count}}",
      "comboBonus": "Bonus de combo, {{points}} puntos más",
      "comboNone": "Listo",
      "comboSpark": "Chispa",
      "comboBlaze": "Llamarada",
      "comboInferno": "Infierno",
      "comboSupernova": "Supernova",
      ...
      "revealDraw": "¡Empate!",
      "xpEarned": "+{{count}} XP",
      "bestChain": "Mejor cadena {{count}}",
      "coinsEarned": "{{count}} monedas",
      "backToLobby": "Sala",
      "newSeries": "Nueva serie",
      "seriesWon": "Serie ganada",
      "seriesLost": "Serie perdida",
      "seriesTied": "Serie empatada",
      "seriesGameOf": "Partida {{game}} de {{total}}",
      "turnBeatThem": "Supera a {{name}}",
      "turnFirstMove": "Tu turno contra {{name}}",
      "turnToBeat": "a superar",
    ...
    "vsGimkit": {
      "proExclusiveModes": {
        "eyebrow": "Pro Exclusive del plan gratis — foil de honestidad",
...
"vsBlooket": {
    ...
    "practice": {
      ...
      "back": "Volver",
      "blitz": "Blitz",
      "canEmbed": "Incrustar en lección",
      "chooseAnswer": "Elige la respuesta",
      "combo": "¡Combo x{{count}}!",
      "complete": "¡Práctica completa!",
      "correct": "¡Correcto!",
      "correctAnswer": "Respuesta: {{word}}",
      ...
      "gotIt": "Entendido",
      "hints": "Pistas",
      "hintsUsed": "{{count}} pistas usadas",
      "incorrect": "No del todo",
      "matchPairs": "Empareja los pares",
      "matching": "Emparejar",
      "matchingDefinitions": "Emparejar definiciones",
      "matchingWords": "Emparejar palabras",
      "maxStreak": "Mejor racha: {{count}}",
      "more": "Más",
      "moreOptions": "Más opciones",
      "noDefinition": "Sin definición",
      "noResults": "Sin resultados",
      "noWords": "Sin palabras para practicar",
      "points": "{{count}} pts",
      "quickPractice": "Práctica rápida",
      ...
      "submit": "Enviar",
      "swipeExplain": "Desliza a la derecha si lo sabes, a la izquierda si no",
    ...
    "student": {
      "join": {
        "title": "Unirse al aula",
        "subtitle": "Ingresa el código de tu profe",
        "codeLabel": "Código del aula",
        "codeHint": "Pide el código de 6 caracteres a tu profe",
        "button": "Unirme",
        "joining": "Entrando...",
        "pasteButton": "Pegar código",
        "preview": {
    ...
    "template": {
      ...
      "nameRequired": "Dale un nombre a la plantilla",
      "timer": "Duración del juego",
      "difficulty": "Dificultad",
      "boardSize": "Tamaño del tablero",
      "boardPreview": "El tablero será de",
      "minWordLength": "Largo mínimo de palabra",
      "allowLateJoin": "Permitir entrada tardía",
      "lateJoin": "Entrada tardía",
      "allowLateJoinDesc": "Los jugadores pueden unirse después de empezar",
      "setDefault": "Usar por defecto",
      "setDefaultDesc": "Usar esta config por defecto para esta lección",
      "save": "Guardar",
      "saving": "Guardando...",
      "saved": "¡Guardada!",
      "startGame": "Iniciar juego"
    ...
    "access": {
      ...
      "verify_email_title": "Verifica tu correo primero",
      "verify_email_body": "Enviamos un enlace de confirmación a {email}. Confírmalo para desbloquear la solicitud de acceso docente.",
      "verify_email_resend": "Reenviar correo de confirmación",
      "verify_email_sending": "Enviando…",
      "verify_email_resent": "Enviado: revisa tu bandeja de entrada",
      "verify_email_refresh": "Ya lo verifiqué: actualizar",
      ...
      "use_case_hint": "¿Cómo usarás LexiClash con tus estudiantes? Una o dos frases bastan.",
      "use_case_placeholder": "p. ej. Batallas de vocabulario cada viernes con mi clase de inglés…",
      "use_case_spark": "¿Necesitas una idea?",
      "use_case_ex1": "Batallas de vocabulario semanales con mi clase",
      "use_case_ex2": "Tareas que mis estudiantes disfrutan de verdad",
      "use_case_ex3": "Juegos en equipo en vivo para repasar ortografía",
      "use_case_remaining": "faltan {count} caracteres",
      "use_case_ready": "¡Perfecto, con eso basta! ✨",
    ...
    "forSchools": {
      "form": {
        ...
        "school_or_district": "Escuela o distrito",
        "role": "Tu rol",
        "role_teacher": "Docente",
        "role_head_of_department": "Jefe de departamento",
        "role_curriculum_lead": "Coordinador de currícula",
        "role_school_admin": "Administrador escolar",
        "role_district_admin": "Administrador de distrito",
        "role_other": "Otro",
        "student_count": "¿Cuántos estudiantes?",
        "count_lt_50": "Menos de 50",
        "count_50_200": "50–200",
        "count_200_500": "200–500",
        "count_500_2000": "500–2.000",
        "count_gte_2000": "2.000+",
        "interests_legend": "¿Qué te interesa? (opcional)",
        "interest_district_admin_dashboard": "Panel de control del administrador de distrito",
        "interest_analytics": "Análisis y reportes entre clases",
        "interest_content_libraries": "Bibliotecas de contenidos curriculares",
        "interest_ad_free": "Modo escolar sin anuncios",
        "interest_sso": "Inicio de sesión único (Clever / ClassLink / Google)",
  ...
  "passAndPlay": {
    "title": "Pasa y juega",
    "subtitle": "Misma pantalla, mismo tablero, por turnos.",
    "playerCount": "Jugadores",
    "playerName": "Nombre",
    "playerNameDefault": "Jugador {n}",
    "color": "Color",
    "avatar": "Avatar",
    ...
    "discard": "Nueva partida",
    "resumePrompt": "Hay una partida de fiesta en curso.",
    "passTo": "Pásale a {name}",
    "ready": "Listo",
    ...
    "alreadyFound": "Ya encontrada",
    "notOnBoard": "No está en el tablero",
    "notInDict": "No está en el diccionario",
    "tooShort": "Demasiado corta",
    "timesUp": "¡Se acabó el tiempo!",
    "roundN": "Ronda {n} de {total}",
    "roundBreakdown": "Puntos de la ronda",
    "nextRound": "Siguiente ronda",
    "seePodium": "Ver podio",
    "podium": "Puntuación final",
    "winner": "¡Gana {name}!",
    "tie": "¡Empate!",
    "playAgain": "Jugar otra vez",
    ...
    "seconds": "{n}s",
    "stolen": "Ya reclamada",
    "emptyName": "Cada jugador necesita un nombre",
    "minPlayers": "Hacen falta al menos 2 jugadores",
    "maxPlayers": "Máximo 6 jugadores",
    "nameTaken": "Los nombres deben ser únicos",
    "langEn": "Inglés",
    "langHe": "Hebreo",
    "langSv": "Sueco",
    "langJa": "Japonés",
  ...
  "gameModes": {
    "classic": {
      ...
      "feature3": "Libre",
      "intro": {
        "greet": "Tómate tu tiempo. Solo palabras."
      },
      "tutorial": {
    ...
    "blast": {
      ...
      "feature3": "Cascada",
      "intro": {
        "greet": "Toca, desliza, respira. Sin prisa."
      },
      "results": {
    ...
    "wordHunt": {
      ...
      "feature3": "Pistas",
      "intro": {
        "greet": "Una palabra a la vez. Tú puedes."
      },
      "tutorial": {
  ...
  "notParticipant": "No eres participante de este duelo",
  ...
  "selectDuelType": "Seleccionar tipo de duelo",
  "turnBased": "Por turnos",
  "realTime": "Tiempo real",
  "turnBasedDesc": "Juega a tu ritmo",
  "realTimeDesc": "Compite en vivo",
  "waitingForStart": "Esperando a que el oponente se una...",
  "timeRemaining": "Tiempo restante",
  "yourScore": "Tu puntaje",
  "opponentScore": "Puntaje del oponente",
  "wordsFound": "palabras encontradas",
  "wordAccepted": "¡Palabra aceptada!",
  "wordRejected": "Palabra no válida",
  "notOnBoard": "No está en el tablero",
  "notInDictionary": "No está en el diccionario",
  "alreadyFound": "Ya encontrada",
  ...
  "forfeit": "Abandonar",
  "forfeitTitle": "¿Abandonar duelo?",
  "forfeitDescription": "Perderás este duelo y tu oponente ganará. No se puede deshacer.",
  "forfeitConfirm": "Sí, abandonar",
  "forfeitCancel": "Cancelar",
  ...
  "avatarBuilder": {
    ...
    "randomize": "Aleatorio",
    "undo": "Deshacer",
    "restorePrevious": "Restaurar avatar anterior",
    "download": "Descargar",
    "save": "Guardar",
    "cancel": "Cancelar",
    "buildCustom": "Crea el tuyo",
    ...
    "bodyStyles": {
      ...
      "suit": "Traje",
      "turtleneck": "Cuello alto",
      "offShoulder": "Hombros descubiertos",
      "cropTop": "Top corto"
    },
    "theme": {
      "classic": "Clásico",
  ...
  "wordHuntDeathRecap": {
    ...
    "causeWrongGuess": "Una respuesta incorrecta te eliminó",
    "statWords": "Palabras",
  ...
  "wordHuntRules": {
    ...
    "panel1Desc": "Una palabra secreta está escondida. Usa las casillas de pistas arriba para descubrirla.",
  ...
  "battlePass": {
    ...
    "toNext": "{{xp}} XP para subir de nivel",
    "upgrade": "Mejorar Pase"
  },
  "dailyQuests": {
  ...
  "asyncChallenge": {
    ...
    "received": {
      "title": "{sender} te retó",
      "body": "Supera {score} en {mode}"
    },
    "result": {
      "titleWin": "¡Venciste a {opponent}!",
      "titleLoss": "{opponent} te ganó",
      "titleTie": "Empataste con {opponent}",
  ...
  "party": {
    ...
    "scanOrEnter": "Escanea QR o ingresa el código en lexiclash.live",
    "players": "jugadores",
    ...
    "results": "¡Resultados!",
    "watchTheTv": "¡Mira la pantalla!",
    "starting": "Iniciando...",
    "joining": "Uniéndose...",
    "waitingForHost": "Esperando al anfitrión...",
    "spectating": "Observando...",
    "gameOver": "¡Fin del juego!",
    "checkYourPhone": "¡Revisa tu teléfono!",
    "dealingRoles": "Repartiendo roles...",
    "dontShowAnyone": "¡No se lo muestres a nadie!",
    "captionClash": {
      "name": "Caption Clash",
      "description": "Escribe el texto más gracioso para imágenes meme"
    },
    "pixelClash": {
      "name": "Pixel Clash",
      "description": "Dibuja, adivina y reconstruye arte pixel juntos"
    },
    "shadowClash": {
      "name": "Shadow Clash",
      "description": "Encuentra a las Sombras ocultas entre ustedes"
    },
    "captionSubmitted": "¡Enviado!",
    "waitingForOthers": "Esperando a los demás...",
    "writeCaptionPlaceholder": "Escribe tu texto...",
    "tapToLaugh": "¡Toca para reír!",
    "writePrompt": "Escribe algo para dibujar",
    "promptPlaceholder": "gato en patineta...",
    "done": "Listo",
    "whatIsThis": "¿Qué es esto?",
    "typeGuess": "Escribe tu respuesta...",
    "isDrawing": "está dibujando...",
    "drawingInProgress": "Dibujo en progreso...",
    "rebuilding": "¡Reconstruyendo!",
    "rebuilt": "Reconstruido",
    "original": "Original",
    "drawnBy": "Dibujado por",
    "similarity": "Similitud",
    "everyoneWriting": "Todos escriben...",
    "everyoneDrawing": "Todos dibujan...",
    "everyoneGuessing": "Todos adivinan...",
    ...
    "shadowDesc": "Elimina ciudadanos sin ser descubierto",
    "seerDesc": "Investiga un jugador cada noche",
    "medicDesc": "Protege un jugador cada noche",
    "citizenDesc": "Encuentra y elimina a las Sombras",
    ...
    "bestLabel": "Mejor",
    "funniestLabel": "Más gracioso",
    "yourPartner": "Tu compañero:",
    "choiceMade": "Elección hecha. Espera al amanecer...",
    "nightIsDark": "La noche es oscura...",
    "isShadow": "¡SOMBRA!",
  ...
  "wordForge": {
    ...
    "runs": "Partidas",
    "chooseRune": "Elige tu runa",
    "yourRunes": "Tus runas",
    "replaceWhich": "¿Qué runa reemplazar?",
    "cancel": "Cancelar",
    "skip": "Saltar",
    "bonusPoints": "pts extra en la próxima ronda",
    "bossRound": "Ronda de jefe",
    "ready": "Listo",
    "victory": "¡Victoria!",
    "runOver": "Partida terminada",
    "reached": "Alcanzaste",
    ...
    "tryAgain": "Reintentar",
    "exit": "Salir",
    "roundCleared": "Superado",
    "tapToContinue": "Toca para continuar",
    "forgeXp": "XP de Forja",
    "rune": {
      "vowelMiner": "+3 puntos por cada vocal en la palabra",
      "rareFinder": "+5 puntos por letra rara (J,K,Q,X,Z)",
      "doubleDown": "+8 puntos si la palabra tiene letras dobles",
      "firstBlood": "+15 puntos en la primera palabra de cada ronda",
      "longHaul": "+2 puntos por letra después de la 4ª",
      "wordSmith": "×1,5 para palabras de 5+ letras",
      "speedDemon": "×2 si encuentras la palabra en 3 segundos",
      "comboFire": "×1,2 por palabra consecutiva (¡acumulable!)",
      "criticalHit": "20% de probabilidad de ×3 en cualquier palabra",
      "palindromePower": "×4 para palíndromos",
      "alliteration": "×2 si empieza con la misma letra que la anterior",
      "echo": "La última letra de cada palabra puntúa doble",
    ...
    "boss": {
      "censor": "Todas las vocales valen 0 puntos",
      "abbreviator": "Solo cuentan palabras de 3-4 letras",
      "purist": "Solo cuentan palabras de 6+ letras",
      "banisher": "Una letra común se elimina del tablero",
      "fog": "La mitad de las fichas están boca abajo",
      "rot": "3 fichas se convierten en piedra cada 15 segundos",
      "shuffle": "El tablero se reorganiza cada 20 segundos",
      "shrink": "El tablero es 4×4 en lugar de 5×5",
      "wall": "La puntuación objetivo se duplica",
      "clock": "El temporizador es solo 30 segundos",
      "thief": "Cada palabra cuesta 5 puntos",
  ...
  "wordcraft": {
    ...
    "modifier": {
      ...
      "long_words": "Palabras largas",
      "rich_letters": "Fichas valiosas",
      "land_grab": "Conquista",
      "quick_draw": "Mano rápida",
      "golden_tiles": "Fichas doradas",
      "none": "",
      "desc": {
        "bingo_bonanza": "Los bingos suman +90",
        "long_words": "Palabras de 5+ letras +15",
        "rich_letters": "Las fichas raras valen el doble",
        "land_grab": "Las capturas se extienden a las vecinas",
        "quick_draw": "Atril de 5 fichas: turnos más rápidos",
        "golden_tiles": "Las fichas ✦ capturan las casillas de alrededor"
      }
    },
    "setup": {
      "title": "Prepara tu partida",
      "opponent": {
        "label": "Rival",
        "bot": "Contra el bot",
        "botDesc": "Juega contra WordBot",
        "hotseat": "Pasa y juega",
        "hotseatDesc": "Dos jugadores, un dispositivo",
        "friend": "Reta a un amigo",
        "friendDesc": "Envía un enlace de reto a distancia"
      },
      "difficulty": {
        "label": "Nivel del bot"
      },
    ...
    "squares": "casillas",
    "place": {
      "step1": "Toca una letra",
      "step2": "Toca una casilla",
      "step3": "Enviar"
    },
    "newBest": "¡Nuevo récord!",
    "bagRemaining": "Bolsa",
    ...
    "run": {
      ...
      "card": {
        "vowelPower": {
          "name": "Poder Vocal",
          "desc": "Cada vocal vale +2 fichas."
        },
        "longGame": {
          "name": "Juego Largo",
          "desc": "Las palabras de 5+ letras puntúan el doble."
        },
        "combo": {
          "name": "Cadena de Combo",
          "desc": "Cada palabra después de la primera en la ronda suma +1 al multiplicador."
        },
        "premiumHunter": {
          "name": "Cazador de Premios",
          "desc": "Cada casilla premium que uses suma +1 al multiplicador."
        },
        "wildcardStash": {
          "name": "Reserva de Comodines",
          "desc": "Empieza cada ronda con una ficha en blanco."
        },
        "quickHands": {
          "name": "Manos Rápidas",
          "desc": "Añade 4 fichas extra a la bolsa de cada ronda."
        },
        "doubleDown": {
          "name": "Doble o Nada",
          "desc": "Tu primera palabra de cada ronda puntúa el triple."
        },
        "rareLetters": {
          "name": "Letras Raras",
          "desc": "Las fichas de 4+ puntos dan +3 fichas cada una."
        },
        "shortSweet": {
          "name": "Corto y Dulce",
          "desc": "Las palabras de tres letras reciben +15 fichas."
        },
        "steadyBuild": {
          "name": "Construcción Firme",
          "desc": "Cada palabra recibe +5 fichas fijas."
        },
        "overflow": {
          "name": "Desbordamiento",
          "desc": "Los puntos por encima del objetivo dan un 10% de bonificación."
        },
        "letterHoard": {
          "name": "Reserva de Letras",
          "desc": "Tu atril tiene 10 fichas en lugar de 8."
        }
      }
    },
    "territory": {
  ...
  "connections": {
    ...
    "reviveDescription": "Las vidas se recargan solas, o mira un anuncio rápido para continuar ahora.",
    ...
    "continueWithRegenLife": "Continuar",
    ...
    "landing": {
      ...
      "compareCol4": "Habilidad probada",
      "compareRow1Name": "Puente de Palabras (este juego)",
      "compareRow1Do": "Encuentra la palabra que conecta dos palabras dadas",
      "compareRow1Len": "30 seg / puzzle",
      "compareRow1Skill": "Asociación + vocabulario",
      "compareRow2Name": "NYT Connections",
      "compareRow2Do": "Ordena 16 palabras en 4 grupos temáticos",
      "compareRow2Len": "5–15 min",
      "compareRow2Skill": "Categorización",
      "compareRow3Name": "Wordle",
      "compareRow3Do": "Adivina una palabra de 5 letras en 6 intentos",
      "compareRow3Len": "3–5 min",
      "compareRow3Skill": "Lógica de letras",
      "compareRow4Name": "Crucigrama",
      "compareRow4Do": "Completa una cuadrícula a partir de pistas",
  ...
  "curator": {
    ...
    "tier": {
      "1": {
        "label": "Moderador",
        "desc": "Marca palabras no válidas y rechaza envíos basura para revisión."
      },
      "2": {
        "label": "Editor",
        "desc": "Todo lo de Moderador, y además aprobar palabras reales al diccionario."
      },
      "3": {
        "label": "Responsable",
        "desc": "Todo lo de Editor, y además resolver disputas de calidad de puzles."
      },
  ...
  "offerwall": {
    "cta": {
      "label": "Gana monedas gratis",
      "aria": "Gana monedas gratis completando ofertas"
    },
    "modal": {
      "title": "Monedas gratis",
      "subtitle": "Completa una oferta y tus monedas se añaden automáticamente.",
      "close": "Cerrar"
    }
  },
  "offlineDownload": {
