...
const sv = {
  ...
  "common": {
    ...
    "reconnected": "Tillbaka i matchen!",
    "connectionLost": "Tappade anslutningen",
    "notConnected": "Ingen anslutning",
    "connected": "Ansluten",
    "connecting": "Ansluter...",
    "connectedToServer": "Redo att spela!",
    "connectingToServer": "Förbereder din strid...",
  ...
  "earthquake": {
    "warning": "Jordbävning!",
    "brace": "Nu kommer det!",
    "photosensitivity": "Blinkande ljus! Inaktivera i inställningar om känslig",
    "fireRound": "ELDRUNDA",
    "multiplier": "2× POÄNG"
  },
  "spam": {
  ...
  "share": {
    "linkCopied": "Kopierad! 📋",
    "copyError": "Misslyckades - försök igen",
    "inviteMessage": "Ordstrid pågår nu - hoppa in!",
    "room": "Rum",
    "code": "Kod",
    "joinViaLink": "Hoppa in här",
    "copyLinkButton": "Kopiera",
    "whatsappButton": "WhatsApp",
    "qrCodeButton": "QR-kod",
    "qrCodeTitle": "Skanna för att hoppa in",
    "shareTitle": "Ta med vänner",
    "codeCopied": "Kopierad! 🎯",
    "codeCopyError": "Kopiering misslyckades",
    "buttonLabel": "Bjud in",
    "modalTitle": "Ta med konkurrens",
    "scanQR": "Skanna för att strida",
    "orShareVia": "Eller dela via:",
    "copyLink": "Kopiera",
    "whatsapp": "WhatsApp",
    "telegram": "Telegram",
    "more": "Mer",
    "inviteTitle": "Strid pågår NU!",
    "copied": "Kopierad!",
    "shareVictory": "Skryt!",
    "scanToJoin": "Skanna för att strida",
    "challengeFriends": "Ta hit dina vänner 😈",
    "beatMyScore": "Tror du att du kan slå detta?",
    "canYouBeatMe": "Slå det. Jag utmanar dig."
  },
  "errors": {
    "unstableConnection": "Skakig anslutning - spelet kan lagga",
    "slowConnection": "Långsam anslutning upptäckt",
    "sessionExpired": "Sessionen gick ut. Gå med i ett nytt rum!",
    "gameCodeNotExist": "Den koden finns inte. Dubbelkolla?",
    "usernameTaken": "Namnet är upptaget! Välj ett annat",
    "gameCodeExists": "Koden används redan. Prova en annan",
    "somethingWentWrong": "Hmm, något gick snett",
    "unexpectedError": "Oj! Prova att uppdatera sidan",
