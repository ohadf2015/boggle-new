...
const sv = {
  ...
  "settings": {
    ...
    "deleteAccountConfirm": "Denna åtgärd är permanent och kan inte ångras. All spelframsteg, statistik och profil kommer att raderas permanent.",
  ...
  "results": {
    ...
    "comparativeInsights": {
      ...
      "scoreAbove": "Du fick {pct}% mer än genomsnittet",
      "scoreBelow": "Du fick {pct}% mindre än genomsnittet"
    },
    "sessionStats": {
  ...
  "landing": {
    ...
    "seo": {
      ...
      "whatIsShort": "Gratis multiplayer-ordstrider i din webblasare. Hitta ord, bygg kombos, krossa dina vanner. Inga nedladdningar, ingen registrering.",
      ...
      "highlightNoSignup": "Ingen registrering kravs",
