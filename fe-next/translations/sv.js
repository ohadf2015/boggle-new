...
"wordHunt": {
  ...
  "education": {
    ...
    "access": {
      "h1": "Ansök om gratis lärargång",
      "lede": "Berätta lite om ditt klassrum. Vi granskar via e-post, vanligtvis inom 24 timmar.",
      "full_name": "Ditt fullständiga namn",
      "email": "E-postadress",
      "role": "Din roll",
      "role_teacher": "Lärare",
      ...
      "use_case": "Hur kommer du att använda LexiClash? (10-800 tecken)",
      "submit": "Skicka ansökan",
      "submitting": "Skickar…",
      "submit_error": "Något gick fel. Försök igen.",
      "rate_limited": "För många förfrågningar. Försök igen om 24 timmar.",
      "success_title": "Ansökan skickad!",
      "success_body": "Vi granskar och e-postar dig inom 24 timmar.",
      "pending_title": "Din ansökan är under granskning",
      "pending_body": "Vi har mottagit din ansökan och mailar dig snart.",
      "submitted_on": "Skickad",
      "already_approved_title": "Du har redan lärargång.",
      "go_to_teacher": "Öppna lärarpanelen",
      "next": {
        "step1_title": "Ansök",
        "step1_body": "Fyll i formuläret nedan — tar 60 sekunder.",
        "step2_title": "Vi granskar",
        "step2_body": "En riktig person läser varje ansökan, vanligtvis inom 24h.",
        "step3_title": "Du får åtkomst",
        "step3_body": "Vi mailar bekräftelse; lärarverktyg låser upp direkt."
      },
      "regular_game_title": "Inte en lärare? Ingen fara.",
      "regular_game_body": "LexiClash är gratis för alla. Prova det vanliga spelet och kom tillbaka om du vill ha klassrumsfunktioner.",
      "try_mp": "Spela flerspelsspel",
...
"game": {
  ...
  "education": {
    ...
    "analytics": {
      ...
      "avgAccuracy": "Snitt precision",
      "avgXpGain": "Snitt XP-vinst",
      ...
      "connecting": "Ansluter...",
      "connectionError": "Tappade anslutningen",
      ...
      "lastActive": "Senast aktiv",
      "lessonEffectiveness": "Lektionens effekt",
      "level": "Nivå {{level}}",
      "live": "Live",
      ...
      "offline": "Offline",
      "practiceToSee": "Öva för att se statistik",
      "retry": "Försök igen",
      ...
      "subtitle": "Följ klassens resultat",
      "title": "Analysöversikt",
      "today": "Idag",
      "updatedAgo": "Uppdaterad {{time}} sedan",
      "viewAssignments": "Visa uppgifter",
    ...
    "classroomGame": {
      ...
      "gameCreated": "Spelet skapat!",
      "gameSettings": "Spelinställningar",
      "lessonsSelected": "{{count}} lektioner valda",
      "missingRequirements": "Saknar förutsättningar",
      "multiLessonHelp": "Kombinera lektioner för variation",
      "noClassrooms": "Inga klassrum än",
      "noLessonsAvailable": "Inga lektioner tillgängliga",
      "reviewAndStart": "Granska & starta",
      "scanToJoin": "Skanna för att gå med",
      "selectAllLessons": "Välj alla",
      "selectClassroom": "Välj klassrum",
      "selectClassroomAndLessons": "Förbered spelet",
    ...
    "header": {
      ...
      "studentDashboard": "Elevöversikt",
      "subtitle": "Lär genom lek",
    ...
    "landing": {
      "duelTeaser": {
        "cta": "Utmana en vän",
        "headline": "Orddueller",
        "subtext": "Tävla mot vänner i realtid"
      },
      "freeAccess": "Gratis för alla",
      "goToDashboard": "Gå till översikten",
      "premium": "Premium",
      "roleGuest": "Gäst",
      "roleStudent": "Elev",
      "roleTeacher": "Lärare",
      ...
      "studentFeature1": "Följ dina framsteg",
      "studentFeature2": "Samla XP och märken",
      "studentFeature3": "Utmana klasskamrater",
      "tagline": "Ord är makt",
      "teacher": "Lärare",
      "teacherCta": "Skapa klass",
      "teacherDesc": "Gör glosor till ett spel",
    ...
    "lesson": {
      ...
      "definition": "Definition",
      "dontKnow": "Vet inte",
      "enrichingContent": "Berikar...",
      "examples": "Exempel",
      "gotIt": "Kan det!",
      "pronounce": "Uttala",
      "pronunciationFallback": "Uttal ej tillgängligt",
      "speaking": "Talar...",
      "swipeMode": "Svep-läge",
    ...
    "milestones": {
      ...
      "titleUnlocked": "Titel upplåst!",
      "xpBonus": "+{{xp}} XP",
      "xpRemaining": "{{xp}} XP till nästa nivå"
    },
    "onboarding": {
    ...
    "practice": {
      ...
      "back": "Tillbaka",
      "blitz": "Blixt",
      "canEmbed": "Bädda in i lektion",
      "chooseAnswer": "Välj svar",
      "combo": "{{count}}x Kombo!",
      ...
      "definition": "Definition",
      "dontKnow": "Hoppa över",
      "encouragement0": "Ge inte upp!",
      "encouragement100": "Perfekt resultat!",
      "encouragement50": "Bra insats!",
      "encouragement80": "Snyggt jobbat!",
      "finish": "Avsluta",
      "flashcards": "Ordkort",
      "foundWordsLabel": "Hittade ord",
      "gotIt": "Kan det",
      "hints": "Ledtrådar",
      "hintsUsed": "{{count}} ledtrådar använda",
      "incorrect": "Inte riktigt",
      "matchPairs": "Matcha paren",
      "matching": "Matchning",
      "matchingDefinitions": "Matcha definitioner",
      "matchingWords": "Matcha ord",
      "maxStreak": "Bästa svit: {{count}}",
      "more": "Mer",
      "moreOptions": "Fler alternativ",
      "noDefinition": "Ingen definition",
      "noResults": "Inga resultat",
      "noWords": "Inga ord att öva",
      "points": "{{count}} poäng",
      "quickPractice": "Snabböva",
      "searchWords": "Sök ord",
      "sessionsCompleted": "{{count}} sessioner klara",
      "soloBoard": "Solobräde",
