...
"createForm": {
  ...
  "teacher": {
    ...
    "subscription": {
      ...
      "usagePromptStudentsBody": "Du har {{count}} elever i den här klassen. Teacher Pro täcker alla — obegränsade klasser och elever, plus progressanalys och utskriftsbara rapporter.",
      "usagePromptAssignmentsBody": "Du har skapat {{count}} uppgifter för den här klassen. Teacher Pro lyfter gränsen — obegränsade uppgifter, plus progressanalys och rapporter.",
