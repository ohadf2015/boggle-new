...
const sv = {
  "adventurePlay": {
    ...
    "map": {
      ...
      "primerTitle": "Så funkar en runda",
      "primerMap": "Klättra upp på kartan ett stopp i taget: strider, butiker, vila, kistor och ?-händelser. Bossen väntar högst upp.",
      "primerFight": "I en strid träffar varje ord du stavar motståndaren. Ord med 5+ bokstäver ger en sköld. Tar hjärtana slut är rundan över.",
      "primerKeep": "Reliker och drycker räcker hela rundan och följer med till nästa. Spendera guld i butiker; hälften av det du har kvar på slutet sparas som mynt.",
    ...
    "variety": {
      ...
      "rule": {
        "classic": "Samla tillräckligt med poäng innan tiden tar slut.",
        "hunt": "Hitta de gömda orden. Första bokstaven är din ledtråd.",
        "chain": "Varje ord måste börja på sista bokstaven i ordet innan.",
        "fog": "Dimma täcker brädet. Bara brickor bredvid ditt senaste ord syns.",
        "bomb": "Använd en bombbricka i ett ord innan stubinen brinner ut, annars förlorar du 4 sekunder.",
        "elite": "En tuff fiende som slår tillbaka. Slå ut dess HP innan tiden tar slut.",
        "boss": "Världens boss. Varje ord är en attack, så fortsätt slå och överlev."
      },
      "twist": {
        "hunt": "Gömda ord! Hitta dem på brädet. Första bokstaven är din ledtråd.",
        "chain": "Ordkedja! Varje ord börjar på sista bokstaven i ordet innan.",
        "fog": "Dimma! Bara brickor bredvid ditt senaste ord syns.",
        "bomb": "Bomber! Använd en bombbricka innan stubinen brinner ut, annars förlorar du 4 sekunder.",
        "long-words": "Bara långa ord: minst 4 bokstäver.",
        "rush": "Rusning: bara 60 sekunder på klockan.",
        "grand-hunt": "Storjakt: ett jättebräde på 6x6 med fler ord att hitta.",
        "ambush": "Bakhåll! En elit anfaller tidigt. Mindre HP, samma bett.",
        "blackout": "Mörkläggning: bara brickor runt ordets SISTA bokstav lyser. Minst 4 bokstäver.",
        "finale": "Final: ord på 4+ bokstäver och bara 75 sekunder."
      },
      "newRule": "Ny regel",
      "chapterTag": "Kapitel {world}",
      "chapterGo": "Framåt",
      "worldNewRule": "Nytt i den här världen",
      "threat": "Hot {threat} av 5",
      "goalScore": "Få minst",
      "goalHunt": "Ord att hitta",
      "goalDamage": "Skada att göra",
      "secondsShort": "{seconds} s",
      "eliteName": "Elit: {world}",
      "pathLabel": "Nivå {level} av {total}",
      "demoLetters": "KATTSNÖRA",
      "huntTitle": "Gömda ord",
      "huntCount": "{found}/{need}",
      "huntMasked": "Gömt ord: börjar på {first}, {count} bokstäver",
      "chainStart": "Vilket ord som helst startar kedjan",
      "chainNext": "Nästa ord börjar på",
      ...
      "youAreHere": "Du är här",
      "pathCleared": "Klarad i den här rundan",
      "rampTitle": "Svårighet",
      "worldRoute": "Nivåer: {kinds}"
    },
    "combat": {
      "boss": "Boss",
      "elite": {
      ...
      "rule": {
        ...
        "w2": "Gaddarna flyger i par. Tryck på båda innan de landar.",
        "w3": "Förbannelser du lämnar på brädet kostar 2 hjärtan.",
        "w4": "Blandningar gör brädet blint dubbelt så länge.",
        "w5": "Bara ord på 6+ bokstäver laddar din sköld.",
        "w6": "Frysningar tar en ruta till, och skärvorna flyger i par.",
        "w7": "Bara ett ord på 6+ bokstäver kan avbryta den här bossen.",
        "w8": "Projektilerna kommer i salvor om tre.",
        "w9": "Frysningar och förbannelser tar 2 rutor till, och förbannelser kostar 2.",
        "w10": "Bara 6+ bokstäver avbryter, förbannelser kostar 2 och skotten flyger i par."
      },
      "eliteRule": {
        "freeze": "Fryser dina rutor. Tryck på dem för att tina dem.",
        "projectile": "Kastar eldklot. Tryck på dem innan de landar.",
        "curse": "Förbannar dina rutor. Rensa dem innan de biter.",
        "shuffle": "Blandar brädet. Fortsätt stava ur minnet.",
        "drain": "Varje träff tömmer en sköldladdning. Höj skölden i tid."
      },
      "move": {
        "hit": "Slag",
        "hit-heavy": "Tungt slag",
        "freeze": "Frostandedräkt",
        "freeze-heavy": "Djupfrysning",
        "curse": "Förbannelse",
        "curse-heavy": "Pestförbannelse",
        "projectile": "Eldklot",
        "projectile-heavy": "Salva",
        "shuffle": "Blandning",
        "shuffle-heavy": "Kaosblandning",
        "drain": "Blodigel",
        "drain-heavy": "Själssug"
      },
      "status": {
        "death": "Besegrad!",
        "defeated": "Fälld!",
      ...
      "phaseTwo": "Fas två!",
      "enraged": "Rasande!",
      "phaseTaunt1": "Uppvärmningen är slut. Nu blir det allvar!",
      "phaseTaunt2": "NOG! Känn hela min vrede!",
      "kill": {
        "squashed": "Mosad!",
        "whomped": "Klubbad!",
        "crushed": "Krossad!",
        ...
        "obliterated": "Utplånad!",
        "damage": "{points} skada",
        "overkill": "+{points} överskott",
        "trophy": "Trofé-relik",
        "addedToRun": "Tillagd i din runda",
        "bossTrophy": "Världstrofé vunnen!",
        "bossStars": "Vunna stjärnor"
      },
      "defeat": {
        "slainBy": "Fälld av {move}",
        "hpLeft": "{name} hade {percent}% HP kvar",
        "continue": "Tryck för att fortsätta"
      },
      "bossDefeated": "Bossen besegrad!",
      "eliteDefeated": "Eliten fälld!",
      "youFell": "Du föll!",
      "thawTile": "Tina frusen ruta",
      "cleanseTile": "Rensa förbannad ruta",
      "tap": "Tryck!",
    ...
    "loot": {
      ...
      "levelsCleared": "Klarade nivåer",
      "goldEarned": "Guld",
      "bestWord": "Bästa ordet",
      "noRelics": "Inga reliker den här rundan",
      "runOver": "Rundan är slut",
      "runOverSub": "En ny karta från första våningen. Dina reliker och drycker följer med, och dina stjärnor och din samling är kvar.",
      "newRun": "Ny runda",
      ...
      "stackPerLevel": "poäng per nivå, från orden i den här rundan",
      "contribAria": "{name}: +{n} poäng den här nivån",
      "value": {
        "label": "Den här rundan",
        "hitsLine": "träffar {hits} av dina {total} ord",
        "synergy": "Kombo",
        "synergyHint": "Staplas med en relik du redan har",
        "ptsPerLevel": "poäng per nivå",
        "goldPerLevel": "guld per nivå",
        "seconds": "sek varje nivå",
        "shield": "sköld varje strid",
        "frost": "förbannelsetid",
        "revive": "extraliv",
        "longWords": "läkningar från dina långa ord",
        "fullHints": "ledtrådar visar hela ord",
        "hearts": "hjärtan",
        "heartsFull": "hjärtan redan fulla",
        "goldTo": "guld",
        "carry": "i din väska",
        "maxHearts": "maxhjärtan",
        "hints": "ledtrådar per nivå",
        "cards": "kort per val",
        "noData": "inga ord än",
        "stackLine": "ensam → med dina reliker",
        "timePts": "poäng per nivå från +{secs} s"
      }
    },
    "juice": {
      "nice": "Snyggt!",
      ...
      "smashing": "Krossande!",
      "critical": "KRITISKT!",
      "astonishing": "FANTASTISKT!",
      "whomped": "PANG PÅ!",
      "newBest": "Längsta ordet!",
      "ko": "K.O.!",
      "tooShort": "För kort",
      "notAWord": "Inget ord",
      "alreadyFound": "Redan hittat",
      "breaksChain": "Bryter kedjan",
      "hint": "Ledtråd",
      "hintAria": "Ledtråd, {count} kvar",
      "foeTag": "Fiende",
      "foeHp": "{hp}/{max} HP",
      "foeDown": "Besegrad!",
      "foeGoal": "Gör {max} skada för 3 stjärnor"
    },
    "draftTitle": "Välj en belöning",
    "draftSub": "Den gäller resten av den här världen.",
    "skip": "Hoppa över",
    "hp": "HP",
    "gold": "{gold} guld",
    "shield": "Sköld ({count})",
    "hint": "Ledtråd ({count})",
    "incoming": "Attack på väg!",
    "deflect": "Parera!",
    "huntGoal": "Hitta gömda ord: {count} · {found} hittade",
    ...
    "relic": {
      ...
      "sage-scroll": "Visdomsrulle",
      "iron-bookmark": "Bokmärke av järn",
      "frost-ward": "Frostskydd",
      "vampire-fang": "Vampyrtand",
      "gold-tooth": "Guldtand",
      "lucky-clover": "Fyrklöver",
      "phoenix-feather": "Fenixfjäder"
    },
    "relicDesc": {
      "sharp-quill": "Ord med 6+ bokstäver ger +50 %",
      "long-bow": "Ord med 7+ bokstäver ger dubbelt",
      "short-sword": "Ord med 3 bokstäver: +2 poäng",
      "storm-rune": "Ord med 5 bokstäver: +5 poäng",
      "twin-ink": "Första ordet på varje nivå ger dubbelt",
      "echo-stone": "+1 poäng per ord du redan hittat (max +10)",
      "magnet": "Alla ord +20 %",
      "heart-locket": "+1 max-HP",
      "hourglass": "+10 sekunder på varje nivå",
    ...
    "potion": {
      "heal": "Läkedryck",
      "time": "Tidsdryck",
      "cleanse": "Reningsdryck",
      "insight": "Insiktsdryck"
    },
    "potionDesc": {
      "heal": "+2 HP",
      "time": "+15 sekunder",
      "cleanse": "Rensar frysta och förbannade rutor och bedövar fienden",
      "insight": "+2 ledtrådar"
    },
    ...
    "loading": "Delar ut brädet…",
    "loadError": "Kunde inte ladda nivån.",
    ...
    "score": "Poäng",
    "words": "Ord",
    "victory": "Bossen besegrad!",
    "defeat": "Bossen överlevde",
    "cleared": "Nivån klar!",
    "failed": "Nästan!",
    "newItems": "Nytt i din samling",
    "skinUnlocked": "Nytt brickutseende upplåst!",
    "equipSkin": "Använd",
    "equipped": "Används",
    "skinVault": "Utseendevalvet",
    "skinVaultHint": "Besegra en världs boss för att vinna dess brickor. De funkar i alla lägen.",
    "beatBoss": "Besegra {boss}",
    "beatPrevBoss": "Besegra förra bossen",
    "foundWords": "Hittade ord",
    "signInRequired": "Logga in för att spela Äventyr",
    "achievements": "Prestationer",
    "starsEarned": "{stars} av 3 stjärnor"
  },
  "vocabQuiz": {
    "correctShort": "Snyggt!",
    "lockedInCount": "{locked}/{total} har svarat",
    "rank": "Plats {position} av {total}",
    "score": {
      "label": "Dina poäng: {score}"
    },
    "mascot": {
      "alt": "Lexi reagerar på ditt svar"
    },
    "sweep": {
      "title": "Hela klassen!",
      "subtitle": "Varenda en av er hade rätt."
    },
    "nextUp": {
      "label": "Nästa ord",
  ...
  "crossword": {
    ...
    "nextClue": "Nästa ledtråd",
    "noClue": "Tryck på en ruta för att börja",
    "check": "Kontrollera",
    "revealLetter": "Bokstav",
    "revealWord": "Ord",
    "restart": "Börja om",
    "backspace": "Radera",
    "solvedTitle": "Löst!",
  ...
  "connections": {
    ...
    "community": {
      ...
      "suggest": "Föreslå en gåta",
      "suggestHint": "Två ord + ett bryggord som länkar båda. Vi granskar innan publicering.",
      "word1": "ord",
      "word2": "ord",
      "bridge": "brygga",
    ...
    "continueWithRegenLife": "Fortsätt",
    "nextLifeIn": "Nästa liv om {{time}}",
  ...
  "wordTowerV2": {
    ...
    "rivals": {
      ...
      "missed": "Rent bom!",
      "scrap": "+{coins} skrot",
      "banked": "{coins} mynt för smällen",
      "pickFloor": "Välj våningen du vill bli av med.",
      "aimAt": "Sikta på {word}",
      "floorsDown": "{n} av {total} våningar nere",
      "shieldDown": "Deras sköld krossad",
      "reclaimed": "Tog tillbaka {coins}",
      "prizeShield": "Krossa skölden · +{n} mynt",
      "prizeLoot": "+{n} mynt och deras byte",
      "floorOf": "Våning {n} av {total}",
      "wreckFloor": "Riv {word}",
      "calledShot": "Utpekad: {word}",
      "title": "Vem byggde högst?",
      "you": "Du",
      "someone": "En rival",
      "loading": "Letar rivaler…",
      "none": "Inga rivaler i kvarteret än. Klättra högre så hittar vi några.",
      "emptyTower": "Inget byggt än",
      "wreck": "Riv",
      "wreckName": "Riv {name}s torn",
      "district": "Distrikt {n}",
      "floors": "{n} våningar",
      "charges": "Redo att riva ×{n}",
      "noCharges": "Spela en runda för att tjäna en rivning",
      "target": "{name}s torn",
      "taunt": "{name} tycker att ditt torn ser vingligt ut. Bevisa motsatsen – på deras torn.",
      "tauntRevenge": "{name} började. Du avslutar.",
      "revengeCta": "Ta hämnd",
      "revengeName": "Slå tillbaka mot {name}",
      "ledgerThem": "{name} tog {n}",
      "ledgerYou": "Du tog tillbaka {n}",
      ...
      "smashed": "Rivet!",
      "grazed": "Skrapsår!",
      "smashedBody": "{n} våningar av {name}s torn.",
      "plotDown": "{plot} är utslaget",
      "stole": "Stal {coins}",
      "earned": "+{coins} mynt",
      "nothing": "Inte en skråma. {name} sover gott i natt.",
      "pickAnother": "Välj en annan rival",
      "back": "Tillbaka",
      "raidFailed": "Räden gick inte fram",
      "raidError": "Något gick snett. Försök igen.",
      "revengeTitle": "Dags för hämnd",
      "revengeBody": "{name} krossade din {plot} och stack med {coins} mynt.",
      "revengeBodyBlocked": "{name} svingade mot ditt torn – din sköld höll.",
      "revenge": "Hämnd",
      "dismiss": "Inte nu",
      "moreRaids": "+{n} räder väntar",
      "guestTitle": "Se vilka du möter",
      "guestBody": "Logga in för att möta riktiga torn, riva dem och göra upp.",
      "signIn": "Logga in",
      "plot": {
        "foundation": "Grund",
        "craneYard": "Krangård",
    ...
    "chest": {
      ...
      "skip": "Hoppa över",
      "continue": "Hämta",
      "guest": "Logga in för rivaler & räder",
      "item": { "shield": "{n} sköld", "brick": "{n} guldtegel", "blueprint": "{n} ritning" },
      "tease": { "perfects": "{n} perfekta släpp till → bättre chans på {tier}", "floors": "{n} våningar till → bättre chans på {tier}" }
    },
    "estate": {
      "art": {
        "bakery": "Bageri",
        ...
        "library": "Bibliotek",
        "clocktower": "Klocktorn",
        "garden": "Trädgård",
        "fishmarket": "Fiskmarknad",
        "lighthouse": "Fyr",
        "boathouse": "Båthus",
        "warehouse": "Lagerhus",
        "ferry": "Färjeterminal",
      ...
      "need": "{n} mynt till",
      "damaged": "Skadad",
      "progress": "{done}/{total} nivåer",
      "coins": "{n} mynt",
      "built": "Byggt!",
      "repaired": "Lagat!",
      "guest": "Sparat på den här enheten. Logga in för att räda och rädas.",
      "perksTitle": "Ditt kvarter jobbar",
      "perksNone": "Bygg kvarteret så står tornet stadigare",
      "newsRaids": "{n} räder mot dig medan du var borta",
      "newsAffordable": "{n} uppgraderingar har du råd med",
      "newsDamaged": "{n} tomter behöver lagas",
      "newsNone": "Allt är lugnt i kvarteret",
      "completeTitle": "{name} klart!",
      "completeSub": "Fem landmärken, ett färdigt kvarter.",
      "completeNext": "{name} upplåst",
      "completeCta": "Öppna {name}",
      "reward": "+{coins} mynt, +1 ritning, +1 sköld",
      "shields": "Sköldar",
      "bricks": "Guldtegel",
      "blueprints": "Ritningar",
      "perkLine": {
        "foundation": "Tornet svajar {n}% mindre",
        "craneYard": "Perfekt-fönstret {n}% bredare",
        "vault": "+{n}% mynt per omgång",
        "insurance": "+{n} sköldplatser",
        "landmark": "+{n}% poäng",
      },
      "chip": {
        "foundation": "{n}% stadigare",
        "craneYard": "{n}% bredare perfekt",
        "vault": "+{n}% mynt",
        "insurance": "+{n} sköldar",
        "landmark": "+{n}% poäng",
      },
      "district": {
        "dockside": "Hamnkanten",
        "old-town": "Gamla stan",
        "market-row": "Torggatan",
        "garden-heights": "Trädgårdshöjden",
        "rail-yard": "Bangården",
        "neon-strip": "Neonstråket",
        "harbor-lights": "Hamnljusen",
        "glass-quarter": "Glaskvarteret",
        "sky-gardens": "Himmelsträdgårdar",
        "summit": "Toppen",
      },
      "building": {
        "pier-footings": "Pirfundament",
        "dock-crane": "Hamnkran",
        "fish-market": "Fiskmarknad",
        "lighthouse": "Fyren",
        "ferry-terminal": "Färjeterminal",
        "stone-cellar": "Stenkällare",
        "timber-hoist": "Timmerhiss",
        "guild-bank": "Gillesbank",
        "watch-house": "Vakthuset",
        "clock-tower": "Klocktornet",
        "brick-arcade": "Tegelarkad",
        "cargo-lift": "Lastkran",
        "bazaar": "Basaren",
        "fire-station": "Brandstation",
        "grand-bazaar-dome": "Basarkupolen",
        "terrace-walls": "Terrassmurar",
        "garden-crane": "Trädgårdskran",
        "greenhouse-bank": "Växthusbank",
        "rain-shelter": "Regnskydd",
        "botanic-spire": "Botanisk spira",
        "rail-bed": "Rälsbädd",
        "gantry-crane": "Portalkran",
        "freight-depot": "Godsdepå",
        "signal-box": "Signalkur",
        "central-station": "Centralstation",
        "steel-piles": "Stålpålar",
        "neon-rig": "Neonrigg",
        "arcade-vault": "Arkadvalv",
        "security-hub": "Säkerhetsnav",
        "neon-tower": "Neontornet",
        "sea-wall": "Havsmuren",
        "container-crane": "Containerkran",
        "customs-house": "Tullhuset",
        "coast-guard": "Kustbevakning",
        "harbor-bridge": "Hamnbron",
        "deep-caissons": "Djupa kassuner",
        "tower-crane": "Tornkran",
        "trading-floor": "Handelsgolv",
        "insurance-tower": "Försäkringstornet",
        "glass-pyramid": "Glaspyramiden",
        "sky-anchors": "Himmelsankare",
        "sky-hoist": "Himmelshiss",
        "cloud-bank": "Molnbank",
        "storm-shield": "Stormsköld",
        "hanging-gardens": "Hängande trädgårdar",
        "bedrock-core": "Berggrundskärna",
        "summit-crane": "Toppkran",
        "golden-vault": "Gyllene valvet",
        "aegis-dome": "Aegiskupolen",
        "word-spire": "Ordspiran",
      },
    },
    "unitM": "m",
  ...
  "seo": {
    ...
    "language": "Swedish",
    "showcase3d": {
      "title": "Ordspel på svenska | LexiClash gratis multiplayer online",
    ...
    "brain": {
      ...
      "ogDescription": "Skärp sinnet med kognitiva ordövningar. Följ dina framsteg!"
    },
    "brainComboMaster": {
    ...
    "education": {
      "title": "LexiClash för lärare — Ordspel för klassrummet",
      "description": "Lärare: skapa ordförrådslektioner, starta live-spel och spåra elevernas framsteg — helt utan annonser.",
      "ogTitle": "LexiClash för lärare — Ordspel för klassrummet",
      "ogDescription": "Ordspel för klassrummet. Skapa lektioner, starta live-spel, följ framsteg. Helt reklamfritt."
    },
    "educationClassroomGame": {
      "title": "Klassrumsspel — Lärarpanel i realtid | LexiClash",
      "description": "Starta live-ordspel för hela klassen direkt från lärarpanelen. Eleverna ansluter från vilken enhet som helst — ingen registrering krävs.",
    ...
    "educationDuels": {
      ...
      "description": "Elever kan utmana varandra i 1-mot-1-ordstrider för att träna ordförråd och stavning i realtid.",
      "ogTitle": "Orddueller för klassrummet",
      "ogDescription": "Låt elever tävla mot varandra i orddueller — engagerande ordförrådsträning."
    },
    "communityBoard": {
  ...
  "cookieConsent": {
    ...
    "decline": "Avvisa alla",
    "customize": "Anpassa",
    "learnMore": "Läs mer om vår cookiepolicy",
  ...
  "common": {
    ...
    "playerAFK": "Borta",
    "playerIdle": "Inaktiv",
    "playerReconnecting": "Återansluter...",
    "left": "kvar",
    "optional": "valfritt",
    "today": "Idag",
    "yesterday": "Igår",
    ...
    "darkMode": "Mörkt läge",
    "goToHome": "LexiClash - Gå till startsidan",
    "pending": "Kollar...",
    "selected": "Vald",
    "xpGained": "XP",
    "score": "Poäng",
  ...
  "spam": {
    ...
    "cooldown": "Ta det lugnt: ${seconds}s",
  ...
  "deleteAccountWeb": {
    ...
    "enterEmail": "Ange e-postadressen kopplad till ditt LexiClash-konto. Vi skickar en verifieringslänk.",
    "emailPlaceholder": "din@email.com",
    "sendLink": "Skicka verifieringslänk",
    "sending": "Skickar...",
  ...
  "share": {
    ...
    "emojiCard": {
      ...
      "connectionsHeader": "LexiClash Ordbro · {date}",
      "bridges": "broar",
      "share": "Dela",
      "copy": "Kopiera",
  ...
  "multiplayerFlow": {
    ...
    "roomList": {
      ...
      "arenaHub": "Arenan",
      "heroAlt": "Två spelare möts på en neonarena",
      "createPrivateBattle": "Skapa privat match",
      "openArenas": "Öppna arenor",
      "liveMatches": "Pågående matcher",
...
"createForm": {
  ...
  "hostView": {
    ...
    "kickPlayer": "Sparka",
    "kickConfirm": "Sparka {{name}} från rummet?",
  ...
  "tvResults": {
    ...
    "vocabularyVirtuoso": "ORDFÖRRÅDSVIRTUOS",
    "longestSingleWord": "Hittade det längsta ordet!",
    "speedDemon": "HASTIGHETSDEMON",
    "highestWpm": "Flest ord per minut!",
    "comebackKid": "COMEBACKKUNGEN",
    "biggestImprovement": "Störst förbättring från start till slut!",
    "explorer": "UTFORSKARE",
    ...
    "mascotComments": {
      ...
      "awardsIntro2": "Trumvirvel tack!",
      "awardsIntro3": "Vem tar hem äran?",
      "awardsIntro4": "Ögonblicket ni väntat på!",
  ...
  "onboarding": {
    ...
    "ftue": {
      ...
      "editAvatar": "Anpassa avatar",
      "yourScore": "{{score}} poäng",
      "averageScore": "Dagens snitt är {{average}}",
      "yourScoreLabel": "Din poäng",
      "averageScoreLabel": "Snitt",
      "nameHint": "2-20 tecken",
      "tryAgain": "Försök igen?",
      "continue": "Fortsätt",
  ...
  "results": {
    ...
    "noMissedWords": "Du hittade alla ord!",
    ...
    "turningPointOpponent": "{{player}} hittade {{word}} ({{score}} poäng) och tog ledningen",
    ...
    "revenge": {
      "header": "REVANSCHEN",
      "breathingDown": "Nära nu",
      "oneWordAway": "Ett ord till så hade {player} åkt ut.",
      "unfinishedBusiness": "Det här är inte över",
      "twoWordsFromGlory": "Två ord ifrån. {player} hade tur, inget annat.",
      "nextTimeItsPersonal": "Nästa omgång gör vi upp med {player}.",
      "runItBack": "En gång till",
      "theyGotLucky": "{player} tog den här rundan. Kriget pågår fortfarande.",
      "comebackArc": "Comebacken börjar här",
      "everyVillainNeedsOrigin": "Varje stor rivalitet börjar nånstans. {player} startade just den här."
    },
    "defend": {
      "untouchable": "Oslagbar",
      "theyNeedAPlan": "{player} behöver tänka om helt.",
    ...
    "awards": {
      "title": "Guldstjärnor",
      "loneWolf": "Ensamvargen",
      "loneWolfDesc": "Hittade flest ord ingen annan tänkte på",
      "wordsmith": "Ordmästaren",
      "wordsmithDesc": "Drog fram det längsta ordet",
      "comboKing": "Kombokungen",
      "comboKingDesc": "Kedjade ihop bonusar som en maskin",
      "speedDemon": "Blixtsnabb",
      ...
      "lateBloomerDesc": "Vaknade till liv i sista tredjedelen",
      "bigFish": "Storsläggan",
      "bigFishDesc": "Landade matchens fetaste ord"
    },
    "pointsFromFirst": "{points} poäng från 1:a",
    "justBehind": "Bara {points} poäng efter #1",
    "pts": "poäng",
    "rematch": "RETURMATCH",
    "target": "Mål",
    ...
    "comparativeInsights": {
      ...
      "uniqueWords": "Du hittade {count} ord som ingen annan hittade!",
      "longestWord": "Ditt längsta ord var {count} bokstäver längre än genomsnittet",
  ...
  "cosmetics": {
    "collection": "Kosmetik",
    "tileSkins": "Brickstilar",
    "boardThemes": "Brädteman",
    "victoryEffects": "Segereffekter",
    "profileFrames": "Profilramar",
    "equipped": "Utrustad",
    "locked": "Låst",
    "equip": "Utrusta",
    "unequip": "Ta av",
    ...
    "items": {
      ...
      "tileNeon": "Neonglöd",
      "tileNeonDesc": "Lysande neonbrickor som lyser upp brädet.",
      "tileWooden": "Träbrickor",
      "tileWoodenDesc": "Varma träbrickor med rustik känsla.",
      ...
      "boardDarkDesc": "Ett elegant mörkt tema för fokuserat spel.",
      "boardOcean": "Havsbräde",
      "boardOceanDesc": "Lugnande havsvågor som bakgrund.",
      ...
      "victoryLightningDesc": "En storm av segerblixtar.",
      "frameNone": "Ingen ram",
      "frameNoneDesc": "Rent utseende, ingen ram.",
      "frameBronze": "Bronsram",
      "frameBronzeDesc": "En solid bronsram för nybörjare.",
      "frameSilver": "Silverram",
      "frameSilverDesc": "En polerad silverram.",
      "frameGold": "Guldram",
  ...
  "legal": {
    ...
    "index": {
      ...
      "disclaimerDescription": "Viktiga friskrivningar om vår tjänst och innehåll"
    },
    "terms": {
  ...
  "season": {
    ...
    "lastSeason": "Din förra säsong",
    "finalDays": "Sista dagarna!",
    "yourRecap": "Din sammanfattning",
  ...
  "landing": {
    ...
    "classroomHeroTitle": "Ordspel för din klass",
    "classroomHeroSubtitle": "Inga elevkonton. Dela en kod på 6 tecken. Hela klassen spelar gratis.",
    "forTeachers": "För lärare",
    ...
    "tickerWord": "ORD",
    "tickerStreak": "SVIT",
    "tickerScored": "fick {score} poäng med {count} ord",
    "tickerFoundWord": "hittade \"{word}\" ({score} poäng)",
    "tickerScoredPts": "fick {score} poäng",
    "tickerCracked": "knäckte ordet på {tries} försök",
    "tickerCleared": "rensade {tiles} brickor med {combo}x kombo",
    "tickerFoundLong": "hittade \"{word}\" ({length} bokstäver!)",
    ...
    "seo": {
      ...
      "modeTagAdventure": "100 nivåer",
      "modeTagBlast": "Kedjereaktioner",
      "feature5Title": "Communitybrädor",
      "modeTagCommunity": "Spelargjorda pussel",
      "highlightMobile": "Alla enheter, alla webbläsare",
      "highlightAges": "Från 6 år",
      "highlightEdu": "Används i klassrum",
      "highlightNoSignup": "Ingen registrering krävs",
      "howToPlayTitle": "Hur man spelar",
      "step1": "Skapa eller gå med i ett spelrum",
      "step2": "Svep över intilliggande bokstäver för att bilda ord",
      "step3": "Bygg kombos för bonuspoäng",
      "step4": "Få flest poäng för att vinna!",
  ...
  "practice": {
    ...
    "wheelRush": {
      ...
      "reset": "Rensa",
      "shuffle": "Blanda",
      "builderHint": "Tryck eller dra bokstäver",
  ...
  "daily": {
    ...
    "chaseLeadingCta": "Håll förstaplatsen",
    ...
    "generatingPuzzle": "Skapar unikt pussel...",
  ...
  "wordHunt": {
    ...
    "leaderboard": {
      ...
      "myLanguage": "Mitt språk",
      "countries": "{count} länder",
      "countrySingular": "1 land",
      "live": "Live",
      "movedUp": "Upp {count}",
      "movedDown": "Ner {count}",
      "newEntry": "Ny",
      "seasonPts": "säsongspoäng",
      "daysPlayed": "{count} dagar",
      "dayPlayed": "1 dag",
      "seasonNoPlayers": "Inga säsongspoäng ännu – dagens pussel är första steget",
      "seasonEndsIn": "Slutar om {days} d {hours} h",
      "seasonEnded": "Säsongen är slut",
      "seasonHint": "Varje daglig utmaning du spelar räknas in i din säsongspoäng",
      "currentSeason": "Nu",
      "seasonPicker": "Välj säsong",
      "languageScope": "Språkfilter"
    },
    "shareMessage": {
  ...
  "peerValidation": {
    ...
    "valid": "Giltig",
    "invalid": "Ogiltig",
    "voteRecorded": "Röst registrerad!",
    "yourWordRejected": "Ditt ord nekades!",
    "wordRejected": "Ord nekat",
    "communityRejected": "Gemenskapen röstade detta ord som ogiltigt.",
    "pointsLost": "Förlorade poäng",
    "wasRejected": "nekades",
    "invalidVotes": "Ogiltig",
    "validVotes": "Giltig"
  },
  "email": {
  ...
  "pushNotifications": {
    "settings": {
      ...
      "description": "Få påminnelser om dina dagliga pussel",
      "enabled": "Daglig påminnelse",
      "enabledDesc": "En liten knuff på morgonen för dina dagliga utmaningar",
      "time": "Påminnelsetid",
      "timeDesc": "När ska vi väcka dig med ett färskt pussel",
      "permissionRequired": "Behörighet krävs",
      "permissionDenied": "Aviseringar blockerade",
    ...
    "daily": {
      ...
      "body6": "Kaffe och pussel? Perfekt kombination. Kör!",
      "title7": "Utmaning accepterad? 🎮",
      "body7": "Ny dag, nya ord, nya chanser att klättra på topplistan."
    }
  },
  "unsubscribe": {
  ...
  "admin": {
    ...
    "insights": {
      ...
      "gamesToday": "Spel idag",
      "vsYesterday": "vs igår",
      "vsYesterdayNew": "vs 0 igår",
      "bestDayEver": "Bästa dagen någonsin",
      "fastestGrowing": "Snabbast växande läge",
      "thisWeek": "denna vecka",
      "byDayOfWeek": "Strax dag",
      "isPeakDay": "är din toppdag",
      "byHour": "Topptime (UTC)",
      "isPeakHour": "är din topptime",
      "crossPlay": "Spelare som spelar X spelar också Y",
      "noShowRate": "Anslutna men aldrig poäng",
      "noShowHint": "Andel spel som spelades med 0 poäng & 0 ord — spelare som anslöt men inte spelade.",
      "wordQuality": "Ordkvalitet efter språk",
      "wordQualityHint": "Avvisade vs godkända ordförslag (30 dagar). En högt avvisningsfrekvens indikerar ordlistluckor för det språket.",
      "rejected": "avvisad",
      "dow": {
        "sun": "Söndag",
        "mon": "Måndag",
    ...
    "teacherAccess": {
      ...
      "preview_title": "Förhandsgranskning av mejl",
      "preview_subject": "Ämne",
      "copy_email": "Kopiera mejl-HTML",
      "copy_success": "Mejl-HTML kopierad till urklipp",
      "copy_error": "Kunde inte kopiera mejlet",
      "approve": "Godkänn",
      "decline": "Avvisa",
      "close": "Stäng",
    ...
    "todayGames": {
      ...
      "allTypes": "Alla typer",
      "allModes": "Alla lägen",
      "rankedOnly": "Endast rankade",
      "casualOnly": "Endast casual",
      "time": "Tid",
      "player": "Spelare",
      "type": "Typ",
      "language": "Språk",
    ...
    "wordBank": {
      ...
      "filters": {
        ...
        "allValidationStatuses": "Alla valideringsstatusar",
      ...
      "bulkImport": {
        "button": "Massimport",
        "title": "Massimport av ord",
        "description": "Importera flera ord på en gång. Ange ett ord per rad eller separera med komma.",
        "instructions": "Ange ord att importera:",
        "formatPlain": "Vanlig text: Ett ord per rad",
        "formatCsv": "CSV: Första kolumnen används som ord",
        "lengthFilter": "Ord utanför giltigt längdintervall hoppas över",
        "source": "Källa",
        "inputLabel": "Ord att importera",
        "placeholder": "Ange ord separerade med ny rad eller komma...",
        "options": "Importalternativ",
        "validationStatus": "Valideringsstatus",
        "wordsLabel": "Ord",
        "noContent": "Ange ord att importera",
        "sourcePlaceholder": "Välj källa",
        "languagePlaceholder": "Välj språk",
        "importing": "Importerar...",
        "import": "Importera",
        "result": "Importresultat",
        "imported": "Importerade",
        "skipped": "Överhoppade",
        "errors": "Fel",
        "showErrors": "Visa feldetaljer...",
        "successMessage": "{{count}} ord importerades",
      ...
      "bulkActions": {
        ...
        "approving": "Godkänner...",
        "rejecting": "Avvisar...",
        "successMessage": "{{count}} ord {{action}}",
        "errorMessage": "Massåtgärd misslyckades",
        "clearSelection": "Rensa val"
      },
      "wikipediaSync": {
        "title": "Wikipedia-synkronisering",
        "description": "Synkronisera Wikipedia-ord till ordbanken för granskning",
        "currentLanguage": "Aktuellt språk",
        "syncButton": "Synkronisera Wikipedia-ord",
        "syncNow": "Synka nu",
        "syncing": "Synkroniserar...",
        "success": "Synkade {{files}} filer, importerade {{words}} ord",
        "successMessage": "{{count}} ord synkroniserade",
        "errorMessage": "Synkronisering misslyckades",
    ...
    "activity": {
      ...
      "totalGames": "Totala spel",
      "uniquePlayers": "Unika spelare",
      "signups": "Registreringar",
      "empty": "Ingen aktivitet i detta intervall",
      "error": "Kunde inte ladda daglig aktivitet"
    },
    "geo": {
      "title": "Spelare per land",
      "registered": "registrerade",
      "guests": "gäster",
      "empty": "Ingen länderdata än",
      "error": "Kunde inte ladda länderdata"
    },
    "acquisition": {
      "title": "Förvärv",
      "sources": "Källor",
      ...
      "empty": "Inga data i denna dimension",
      "error": "Kunde inte ladda förvärvsdata"
    },
    "authSessions": {
      "title": "Inloggad aktivitet",
      "totalGames": "Spel",
      "uniqueUsers": "Unika användare",
      "avgScore": "Medelpoäng",
      "completionRate": "Slutförd",
      "byMode": "Per läge",
      "byLanguage": "Per språk",
      "empty": "Inga inloggade spel i detta fönster",
      "error": "Kunde inte ladda inloggade spel"
    },
    "guests": {
      "title": "Gästaktivitet",
      "totalGames": "Spel",
      "uniqueGuests": "Unika gäster",
      "avgScore": "Medelpoäng",
      "byMode": "Per läge",
      "byLanguage": "Per språk",
      "windowDays": "{{days}}d fönster",
      "empty": "Inga gästspel i detta fönster",
      "error": "Kunde inte ladda gästdata"
    },
    "player": {
      "title": "Spelardetaljer",
      "back": "Tillbaka",
      "notFound": "Spelaren hittades inte",
      "loadError": "Kunde inte ladda spelaren",
      "joined": "Gick med",
      ...
      "identity": "Identitet",
      "role": "Roll",
      "dailyEmail": "Dagligt mejl",
      "referrals": "Hänvisningar",
      "seasonScore": "Säsongspoäng",
      "economy": "Ekonomi",
      "coins": "Mynt",
      "lifetimeCoins": "Mynt totalt",
      "hintsUsed": "Använda tips",
      "longestWord": "Längsta ord",
      "acquisition": "Förvärv",
      "utmSource": "Källa",
      "utmMedium": "Medium",
      "utmCampaign": "Kampanj",
      "referrer": "Refererare",
      "noAcquisitionData": "Inga förvärvsdata",
      "byLanguage": "Spelade språk",
      "byMode": "Per läge (senaste 200 sessioner)",
      "sessions": "Sessioner",
      "completed": "Slutförda",
      "ranked": "rankad",
      "casual": "vanlig",
      "noGames": "Inga senaste spel",
      "gameCode": "Spel",
      "score": "Poäng",
      "words": "Ord",
      "placement": "#",
  ...
  "quickPlay": {
    "solo": {
      ...
      "raceStandings": "Denna runda",
      "rivalsPassed": "Slog {passed} av {total}",
      "passed": "slog",
      "wordsCollected": "{count} ord",
      "wordsNew": "{count} nya",
  ...
  "adminGifts": {
    ...
    "writeMessage": "Skriv meddelande",
    "setRewards": "Ange belöningar",
    "preview": "Förhandsgranska & skicka",
    "send": "Skicka gåva",
    "sending": "Skickar...",
    "sent": "Gåva skickad!",
    "history": "Gåvohistorik",
    "searchPlayers": "Sök spelare...",
    "noPlayersSelected": "Inga spelare valda",
    "selectAtLeast": "Välj minst en spelare",
    "playerSelected": "spelare vald",
    "playersSelected": "spelare valda",
    "messageTitle": "Meddelanderubrik",
    "messageTitlePlaceholder": "Ange en rubrik för ditt meddelande",
    "messageBody": "Meddelande",
    "messageBodyPlaceholder": "Skriv ditt personliga meddelande...",
    "xpAmount": "XP-mängd",
    "coinAmount": "Myntmängd",
    "rewardPresets": "Snabbval",
    "presetSmall": "Liten",
    "presetMedium": "Mellan",
    "presetLarge": "Stor",
    "template": {
    ...
    "previewTitle": "Förhandsgranska din gåva",
  ...
  "adventure": {
    ...
    "lexi": {
      "longWord": {
        "default": "Wow! Det var ett långt ord!",
  ...
  "blast": {
    ...
    "helpPrism": "Använd i 2 ord för att utlösa korsrensning (hel rad + kolumn).",
    "helpGemLabel": "Ädelsten",
    "helpGem": "Använd i 3 ord för att samla. +3 per användning, +8 vid insamling.",
    "helpIceLabel": "Is",
    "helpIce": "2 träffar att bryta. Spricker vid första användningen.",
    "helpLightningLabel": "Blixt",
    "helpLightning": "Rensar hela kolumnen när den används i ett ord.",
    "helpMagnetLabel": "Magnet",
    "helpMagnet": "Drar närliggande brickor mot sig när den rensas.",
    "helpMirrorLabel": "Spegel",
    "helpMirror": "Fördubblar partnereffekten, eller 2x poäng.",
    ...
    "objective": {
      ...
      "colorCyan": "Cyan",
      "colorLime": "Limefärg",
      "clearJelly": "Rensa all gelé",
      "killCake": "Förstör tårtan",
      "stopChocolate": "Stoppa chokladen",
      "bannerTitle": "Mål",
      "pathRoute": "Koppla ◯ till ◉ i ett ord",
      "pathRouteSuccess": "RUTT KOPPLAD!",
  ...
  "student": {
    "practiceFun": {
      ...
      "starsEarned": "{{count}} av 3 stjärnor",
      "scoreLine": "{{correct}} av {{total}} · {{percent}} %",
      "xpGain": "+{{xp}} XP",
      "xpRate": "{{xp}} XP",
      "next": "Nästa spel",
      "nextMode": "Nästa: {{mode}}",
  ...
  "teacher": {
    "nav": {
      ...
      "me": "Jag",
      "studentPlay": "Spela",
      "studentPractice": "Träna",
      "studentAchievements": "Utmärkelser",
      "sidebarLabel": "Lärarens avsnitt",
    ...
    "curriculum": {
      ...
      "wordCount": "{{count}} ord",
      "noResults": "Inga resultat",
      "selectGrade": "Välj årskurs",
      "selectSubject": "Välj ämne",
      "allGrades": "Alla årskurser",
  ...
  "education": {
    ...
    "homework": {
      ...
      "promptSpelling": "Vilken stavning är rätt?",
      "promptSpellingHint": "Ett av alternativen är rättstavat.",
      "promptSpell": "Stava ordet",
      "timeLeft": "{{seconds}} sekunder kvar",
      "correct": "Precis rätt!",
      "almost": "Det var {{word}}",
      "finishTitle": "Läxan är klar!",
      "finishTitlePerfect": "Helt felfritt!",
      "wordsRight": "Rätta ord",
      "bestRun": "Bästa svit",
      "starsEarned": "{{stars}} av 3 stjärnor",
      "playAgain": "Spela igen",
    ...
    "modePicker": {
      ...
      "change": "Byt spel",
      "sheetTitle": "Byt spel",
      "sheetHint": "Tryck på en annan affisch så öppnar vi rummet med den i stället.",
      "close": "Behåll det här",
      "settings": "Finjustera",
      ...
      "how": {
        "classic": "Dra varje ord du hittar på ett gemensamt bokstavsrutnät.",
    ...
    "results": {
      ...
      "moment": {
        "winnerBanner": "VI HAR EN VINNARE!",
        "drumroll": "Trumvirvel…",
        "sweepTag": "Alla ord hittade!",
        "classSweptTag": "Klassen hittade alla {{total}}!",
        "sweepStreak": "{{count}} fullpott i rad",
        "roundOfSession": "Runda {{round}} den här lektionen",
        "deltaUp": "+{{points}} mot förra rundan",
        "deltaDown": "{{points}} sämre än förra rundan",
        "deltaSame": "Samma som förra rundan",
        "personalBest": "Personbästa!",
        "climbed": "Upp {{places}} placeringar"
      },
      ...
      "startTeamTilesUnplugged": "Starta Team Tiles Unplugged",
      "teamTilesProgress": "Brickor {{judged}} av {{total}}",
      "teamTilesClassScore": "Klasspoäng",
      "teamTilesChooseTeams": "Hur många lag?",
      "teamTilesTeamName": "Lag {{number}}",
      "teamTilesActiveTeam": "Lag {{number}}s tur",
      "teamTilesFlipHint": "Vänd en bricka",
      "teamTilesFaceDown": "Neråtvänd miss-gap-bricka",
      "teamTilesGotIt": "Laget klarade det!",
      ...
      "startClassicUnplugged": "Starta Classic Unplugged",
      "classicUnpluggedProgress": "Ord {{current}} av {{total}}",
      "classicUnpluggedClassScore": "Klasspoäng",
      "classicUnpluggedChooseMode": "Klass eller lag?",
      "classicUnpluggedClassMode": "Klass",
      "classicUnpluggedTeamName": "Lag {{number}}",
      "classicUnpluggedActiveTeam": "Lag {{number}}s tur",
      "classicUnpluggedDiscussHint": "Diskutera, sedan avslöja",
      "classicUnpluggedReveal": "Visa ord",
      "classicUnpluggedSubmitGotIt": "Skicka: klarade det",
      "classicUnpluggedSubmitNotYet": "Skicka: inte än",
      "classicUnpluggedExit": "Lämna Classic Unplugged",
      ...
      "unpluggedGameScore": "Klassens poäng",
      "unpluggedGameStreak": "Svit",
      "unpluggedGameStart": "Starta klockan",
      "unpluggedGameRevealNow": "Visa ordet",
      "unpluggedGameGotIt": "Klassen klarade det!",
      "unpluggedGameNotYet": "Inte än",
      ...
      "unpluggedGameTimerLabel": "kvar",
      "unpluggedGameExit": "Lämna analog repetition",
      ...
      "unpluggedGameCleared": "Ord klarade",
    ...
    "duels": {
      ...
      "revealDraw": "Oavgjort!",
      "xpEarned": "+{{count}} XP",
      "bestChain": "Bästa kedja {{count}}",
      "coinsEarned": "{{count}} mynt",
      "backToLobby": "Lobbyn",
      "newSeries": "Ny serie",
      "seriesWon": "Serien vunnen",
      "seriesLost": "Serien förlorad",
      "seriesTied": "Serien oavgjord",
      "seriesGameOf": "Match {{game}} av {{total}}",
      "turnBeatThem": "Slå {{name}}",
      "turnFirstMove": "Din tur mot {{name}}",
      "turnToBeat": "att slå",
      "turnBeatIt": "Slå det",
    ...
    "achievements": {
      ...
      "newBadge": "Ny medalj!",
      "pin": "Fäst på profil",
      "pinLimit": "{{current}}/{{max}} fästa. Ta bort en för att fästa ny",
      "exploration": "Utforskande",
      "consistency": "Uthållighet",
      "skill": "Färdighet",
      "all": "Alla",
      "progress": "{{current}}/{{next}}",
      "secret": "Hemlig prestation",
      "secretRemaining": "{{count}} hemliga kvar",
    ...
    "analytics": {
      ...
      "assignLessonsHint": "Välj lektioner för klassen",
      "avgAccuracy": "Genomsnittlig träffsäkerhet",
      "avgXpGain": "Genomsnittlig XP",
      ...
      "students": "Elever",
      "studentsNeedingHelp": "Elever som behöver stöd",
      "subtitle": "Spåra klassens framsteg",
      "title": "Statistik",
      "today": "Idag",
      "updatedAgo": "Uppdaterad {{time}} sedan",
      "viewAssignments": "Se uppgifter",
      "viewLessons": "Se lektioner",
    ...
    "classroomGame": {
      ...
      "selectClassroom": "Välj klassrum",
      "selectClassroomAndLessons": "Sätt upp spelet",
      "selectClassroomAndLessonsDesc": "Välj klassrum och lektioner",
      "selectLessons": "Välj lektioner",
      "shareCode": "Dela koden",
      "shareCodeWithStudents": "Dela med eleverna",
    ...
    "header": {
      ...
      "educationHome": "LexiClash Utbildning",
      "homeLink": "Hem",
      "menu": "Meny",
      "navigation": "Meny",
      "studentDashboard": "Min panel",
      "subtitle": "Lär genom spel",
    ...
    "landing": {
      ...
      "studentFeature3": "Duellera klasskompisar",
      "tagline": "Ord är styrka",
      "teacher": "Lärare",
      ...
      "modes": {
        ...
        "classroom_game": {
          "tag": "Live",
          "title": "Klassrumsspel",
          "body": "Hela klassen söker ord samtidigt på samma bräde. Du ser vem som ligger före i realtid.",
          "teaches": "Ordförråd, stavning, snabbhet"
        },
        "vocab_duels": {
          "tag": "Duell",
        ...
        "brain_drills": {
          "tag": "Hjärna",
          "title": "Hjärnövningar",
          "body": "Minnesspel, mönsterigenkänning, snabbhet. Tränar fokus och kognitiv flexibilitet.",
          "teaches": "Arbetsminne, uppmärksamhet"
        },
        "daily_wordhunt": {
          "tag": "Daglig",
          "title": "Ordjakt varje dag",
          "body": "Ett nytt pussel för alla varje dag. Eleverna jämför resultat och håller en svit.",
          "teaches": "Daglig praktik, rutinuppbyggnad"
        },
        "adventure": {
          "tag": "Äventyr",
          "title": "Ordäventyr",
      ...
      "faq": {
        ...
        "q5": {
          ...
          "a": "Nej. De flesta spel spelar utan inloggning. Klassrumskoden räcker."
        },
        "q6": {
    ...
    "leaderboard": {
      ...
      "monthly": "Denna månad",
      "newEntry": "Ny!",
      "noStudentsYet": "Inga elever ännu",
      "rank": "#{{rank}}",
      "streak": "{{count}} dagar i rad",
      "studentsInClass": "{{count}} elever",
      "title": "Klassens topplista",
      "top10": "Topp 10",
      "top25": "Topp 25",
      "top50": "Topp 50",
      "totalXP": "Totalt XP",
    ...
    "milestones": {
      ...
      "continue": "Fortsätt",
      "level": "Nivå {{level}}",
      "reached": "Milstolpe nådd!",
      "titleUnlocked": "Ny titel!",
      "xpBonus": "+{{xp}} XP",
      "xpRemaining": "{{xp}} XP kvar till nästa nivå"
    },
    "onboarding": {
      "getStarted": "Börja",
      "of": "av",
    ...
    "vsWayground": {
      "starterLimit": {
        ...
        "cta": "Starta classroom reteach Live utan 20-resursgräns"
      }
    },
    "vsGimkit": {
      "proExclusiveModes": {
        "eyebrow": "Gratisplanens Pro Exclusive — honesty foil",
...
"vsBlooket": {
    ...
    "practice": {
      ...
      "encouragement50": "Bra!",
      "encouragement80": "Mycket bra!",
      "finish": "Avsluta",
      "flashcards": "Ordkort",
      "foundWordsLabel": "Hittade",
      "gotIt": "Kan det",
      "hints": "Tips",
      "hintsUsed": "{{count}} tips använda",
      "incorrect": "Inte helt rätt",
      "matchPairs": "Matcha par",
      "matching": "Koppla ihop",
      "matchingDefinitions": "Koppla ord till betydelser",
      "matchingWords": "Koppla ord",
      "maxStreak": "Bästa rad: {{count}}",
      "more": "Mer",
      "moreOptions": "Fler val",
      "noDefinition": "Ingen beskrivning",
      "noResults": "Inga träffar",
      "noWords": "Inga ord att öva",
      "points": "{{count}} poäng",
      ...
      "streak": "{{count}} i rad",
      "submit": "Skicka",
      "swipeExplain": "Svep höger = kan det, vänster = hoppa över",
      "swipeHint": "Svep för att svara",
      "tapCard": "Tryck för att vända",
    ...
    "template": {
      ...
      "saved": "Sparat!",
      "saving": "Sparar...",
      "setDefault": "Använd som standard",
      "setDefaultDesc": "Dessa inställningar används nästa gång",
      "settings": "Inställningar",
      "startGame": "Starta",
      "timer": "Tid"
    },
    ...
    "teacher": {
      "activeGames": "aktiva spel",
      "noActiveGames": "Inga aktiva spel just nu",
    ...
    "lessonWords": {
      "title": "Lektionens ord",
      "subtitle": "Din måluppfyllelse på dessa ord",
      "found": "Hittade",
      "total": "Totalt",
      "completion": "Procent",
    ...
    "reports": {
      ...
      "reportGenerated": "Rapport framtagen",
      "downloadReady": "Rapporten är redo att hämta",
      "metrics": {
        "wordsLearned": "Lärda ord",
        "totalWords": "Ordförråd totalt",
        "accuracy": "Träffsäkerhet",
        "practiceTime": "Övningstid",
      ...
      "classMetrics": {
        "classAverage": "Klassens snitt",
        "topPerformer": "Bästa elev",
        "mostImproved": "Mest framsteg",
        "needsAttention": "Behöver stöd",
        "participationRate": "Aktivitet",
      ...
      "studentRanking": "Elevernas placering",
      "rank": "Placering",
      "student": "Elev",
      "score": "Poäng",
      "noStudents": "Inga elever hittades",
      "printReport": "Skriv ut",
      "emailReport": "Mejla",
      "error": {
        "generateFailed": "Rapporten kunde inte skapas",
    ...
    "access": {
      ...
      "verify_email_title": "Verifiera din e-post först",
      ...
      "use_case_ex1": "Veckovisa ordförrådsmatcher med klassen",
  ...
  "passAndPlay": {
    "title": "Skicka och spela",
    "subtitle": "Samma skärm, samma bräde, turas om.",
    "playerCount": "Spelare",
    "playerName": "Namn",
    "playerNameDefault": "Spelare {n}",
    "color": "Färg",
    "avatar": "Avatar",
    ...
    "seconds": "{n}s",
    "stolen": "Redan tagen",
    "emptyName": "Varje spelare behöver ett namn",
    "minPlayers": "Minst 2 spelare",
    "maxPlayers": "Högst 6 spelare",
    "nameTaken": "Namnen måste vara unika",
    "langEn": "Engelska",
    "langHe": "Hebreiska",
    "langSv": "Svenska",
    "langJa": "Japanska",
  ...
  "pendingChallenges": "Väntande utmaningar",
  "quickMatch": "Snabbmatch",
  "selectLesson": "Välj lektion",
  "sendChallenge": "Skicka utmaning",
  "selectDuelType": "Välj duelltyp",
  "turnBased": "Turbaserad",
  "realTime": "Realtid",
  "turnBasedDesc": "Spela i din egen takt",
  "realTimeDesc": "Tävla live mot varandra",
  "waitingForStart": "Väntar på motståndare...",
  "timeRemaining": "Tid kvar",
  "yourScore": "Din poäng",
  "opponentScore": "Motståndarens poäng",
  "wordsFound": "ord hittade",
  "wordAccepted": "Ord accepterat!",
  "wordRejected": "Ogiltigt ord",
  "notOnBoard": "Inte på brädet",
  "notInDictionary": "Inte i ordlistan",
  "alreadyFound": "Redan hittat",
  ...
  "reengagement": {
    ...
    "longTimeNoSee": "Lång tid sen sist!",
    "goodToSeeYou": "Kul att se dig!",
  ...
  "party": {
    ...
    "join": "Gå med",
    "roomCode": "Rumskod",
    "scanOrEnter": "Skanna QR eller ange kod på lexiclash.live",
    "players": "spelare",
    "spectators": "åskådare",
    ...
    "captionClash": {
      "name": "Caption Clash",
      "description": "Skriv den roligaste texten till meme-bilder"
    },
    "pixelClash": {
      "name": "Pixel Clash",
      "description": "Rita, gissa och bygg pixelkonst tillsammans"
    },
    "shadowClash": {
      "name": "Shadow Clash",
    ...
    "writePrompt": "Skriv något att rita",
    "promptPlaceholder": "katt på skateboard...",
    "done": "Klar",
    "whatIsThis": "Vad är det?",
    ...
    "nightFalls": "Natten faller...",
    "shadowsAwaken": "Skuggorna vaknar... välj ert offer.",
    "seerInvestigates": "Siaren öppnar sina ögon...",
    "medicProtects": "Läkaren ger sitt skydd...",
    "someoneWasSaved": "Någon räddades!",
    "medicSaved": "Läkaren skyddade sitt mål.",
    "wasEliminated": "eliminerades",
    "peacefulNight": "En lugn natt...",
    "discuss": "Diskutera!",
    "whoIsTheShadow": "Vem är skuggan bland er?",
    "theVotes": "Rösterna är inne...",
    "isEliminated": "är eliminerad!",
    "noConsensus": "Ingen enighet. Ingen eliminerad.",
    "citizensWin": "Medborgarna vinner!",
    "shadowsWin": "Skuggorna vinner!",
    "roleShadow": "Skugga",
    "roleSeer": "Siare",
    "roleMedic": "Läkare",
    "roleCitizen": "Medborgare",
    "shadowDesc": "Eliminera medborgare utan att bli avslöjad",
    "seerDesc": "Undersök en spelare varje natt",
    ...
    "bestLabel": "Bäst",
    "funniestLabel": "Roligast",
    "yourPartner": "Din partner:",
    "choiceMade": "Val gjort. Vänta på gryningen...",
    "nightIsDark": "Natten är mörk...",
    "isShadow": "SKUGGA!",
  ...
  "wordForge": {
    ...
    "runs": "Körningar",
    "chooseRune": "Välj din runa",
    "yourRunes": "Dina runor",
    "replaceWhich": "Vilken runa vill du byta?",
    "cancel": "Avbryt",
    "skip": "Hoppa över",
    "bonusPoints": "bonuspoäng nästa runda",
    "bossRound": "Bossrunda",
    "ready": "Redo",
    "victory": "Seger!",
    ...
    "forgeXp": "Smedja-XP",
    "rune": {
      "vowelMiner": "+3 poäng per vokal i ordet",
      "rareFinder": "+5 poäng per sällsynt bokstav (J,K,Q,X,Z)",
      "doubleDown": "+8 poäng om ordet har dubbla bokstäver",
      "firstBlood": "+15 poäng på första ordet varje runda",
      ...
      "echo": "Sista bokstaven i varje ord ger dubbla poäng",
    ...
    "boss": {
      "censor": "Alla vokaler är värda 0 poäng",
      "abbreviator": "Bara ord med 3-4 bokstäver räknas",
      "purist": "Bara ord med 6+ bokstäver räknas",
      "banisher": "En vanlig bokstav tas bort från rutnätet",
