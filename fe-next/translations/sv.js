...
const sv = {
  ...
  "wordTowerV2": {
    ...
    "newBest": "Nytt rekord!",
    "hud": {"floor": "Våning", "floorA11y": "Våning {n}, {m} meter", "effect": "{name}: {n} kvar", "exit": "Avsluta — rundan sparas"},
...
"createForm": {
  ...
  "teacher": {
    ...
    "subscription": {
      ...
      "usagePromptStudentsBody": "Du har {{count}} elever i en klass. Teacher Pro täcker alla — obegränsade klasser och elever, plus progressanalys och utskriftsbara rapporter.",
      "usagePromptAssignmentsBody": "Du har skapat {{count}} uppgifter för en klass. Teacher Pro lyfter gränsen — obegränsade uppgifter, plus progressanalys och rapporter.",
