...
"createForm": {
  ...
  "student": {
    ...
    "activeGame": {
      ...
      "joinNow": "Gå med nu",
      "joinTeachersGame": "Gå med i {{teacher}}s spel",
      "joining": "Går med...",
  ...
  "teacher": {
    ...
    "dashboard": {
      ...
      "tools": "Klassverktyg",
      "startGameHero": "Starta spel",
      "startGameHeroHint": "Öppna ett live-rum för den här klassen",
  ...
  "education": {
    ...
    "classroomGame": {
      ...
      "advanced": "Avancerat",
      "advancedHint": "Timer, bräde, läge, förhandsvisning",
