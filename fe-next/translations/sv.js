...
const sv = {
  ...
  "academy": {
    "teacher": {
      "classesTitle": "Dina klasser",
      "hqTitle": "Lärarbasen",
      "classActions": "Klassåtgärder",
      "orTypeCode": "eller öppna länken och skriv koden"
    },
    "hq": {
      "startTitle": "Starta ett spel",
      "pickGame": "Välj spel",
      "getStudentsIn": "Få in eleverna",
      "classCode": "Klasskod",
      "showQr": "Visa QR-kod",
      "qr": "QR",
      "qrLabel": "QR-kod för att gå med",
      "scanToJoin": "Skanna & gå med",
      ...
      "modes": {
        "vocabQuiz": "Ordquiz",
        "vocabQuizBlurb": "Tävla om rätt betydelse",
        "classic": "Ordarenan",
        "classicBlurb": "Hitta ord på en gemensam bräda",
        "blast": "Blast",
    ...
    "modes": {
      "workshop": {
        ...
        "rival": {
          "name": "Baron Ordbygge",
          "open": "Ditt drag, lärling!",
          "gloat": "Min verkstad, mina regler!",
          "intro": "Tror du att du kan bygga mer än jag?",
          "taunt1": "Tick-tack! Min tur.",
          "taunt2": "Slå DEN, lärling!",
          "taunt3": "Mina kugghjul missar aldrig.",
          "taunt4": "Den här verkstan är min!",
          "hurt1": "Ett lektionsord?! Mina bultar!",
          "hurt2": "Aj! Den där gnistrade!",
          "enraged1": "Hmpf. Turbricka.",
          "enraged2": "Grr… inte illa."
        },
        "wonBaron": "Du slog baronen!",
        "lostBaron": "Baronen vann den här gången",
        "statLessonWords": "Lektionsord",
        "starsValue": "★{count}",
        "statStars": "Stjärnor",
        "statWords": "Byggda ord",
        "lessonWords": "Lektionsord",
        "panelHint": "Bygg ett av dessa (eller ett ord som gömmer ett) för en gyllene bonus.",
        "you": "Du",
        "vs": "VS",
        "introTitleBaron": "Bygg mer än baronen",
        "stakes": "Lektionsord = guld",
        "battle": "Kämpa!"
      },
      "review": {
        "title": "Repetera missade ord",
        "signedOutTitle": "Gå med i din klass för att låsa upp repetition",
        ...
        "streak": "Svit {count}",
        "progress": "{n} / {total}",
        "pickMeaning": "Vad betyder det?",
        "unscramble": "Ordna bokstäverna",
        "perfect": "Felfri runda!",
        "runDone": "Rundan klar!",
        "outOf": "/{total}",
        "statCorrect": "Rätt",
        ...
        "statPoints": "Poäng",
        "mascot": {
          "think": "Den här kan du!",
          "cheer": "Klockrent!",
          "fire": "Du är i storform!",
          "oops": "Hoppsan! Den dyker upp igen snart."
        },
        "vaultTitle": "Ord inlåsta i valvet: {count}",
        "crack": "Knäck valvet",
        "chest": {
          "bronze": "Bronskista",
          "silver": "Silverkista",
    ...
    "student": {
      "liveNow": "Live nu",
      "ctaReview": "Repetera",
      "ctaBoss": "Bossen upplåst",
      "ctaStart": "Börja här",
      "ctaSoloOver": "Värm upp",
      "ctaPlay": "Spela",
      "ctaLive": "Gå med live",
      "ctaReviewTitle": "{count} missade ord",
      "ctaBossTitle": "Utmana bossen",
      "ctaJoinSub": "Skriv koden från din lärare",
      "dockLabel": "Akademin",
      "dockLessons": "Lektioner",
      "reviewDueAria": "{count} ord att repetera",
      "dockClass": "Klass",
      "solo": "Solo",
      "mapLabel": "Akademikarta",
      "title": "Ordakademin",
      "rewardXp": "+{xp} XP",
      "arenaWaiting": "Din lärare har inte startat ett livespel än. Den här ön tänds när det händer.",
      "bossLockedNote": "Lär dig {count} ord till för att låsa upp bossen.",
      "level": "Nivå {level}",
      "xpToNext": "XP till nästa nivå",
      "xpLine": "{xp} / {need} XP",
      "stars": "Stjärnor",
      "workshop": "Ordverkstan",
      "review": "Missade ord",
      "arena": "Klassarenan",
      "boss": "Boss",
      "bossLockedAria": "Bossen är låst – bemästra {have} av {need} ord för att låsa upp",
      "bossOpenAria": "Utmana bossen",
      "nodeDoneAria": "{name}: klar · stjärnor: {stars}",
      "arenaWaitingAria": "{name}: väntar på din lärare",
      "nodePlayAria": "Spela {name}",
      "liveTag": "Live",
      "bossNeed": "Bemästra {have}/{need} ord",
      "bossReady": "Upplåst",
      "chestReady": "Daglig kista – tryck för att öppna",
      "chestTomorrow": "Nästa kista i morgon",
      "chestTag": "Gratis",
      "chestDone": "Öppnad",
      "chestTitle": "Daglig kista",
      "chestFailed": "Kunde inte spara din XP – tryck på kistan för att försöka igen",
      "chestComeBack": "Kom tillbaka i morgon för en ny kista",
      "chestCollect": "Hämta"
    },
    "classes": {
      "pagerLabel": "Klassidor",
    ...
    "launch": {
      "title": "Starta ett livespel",
      "subtitle": "Välj ett spel. Hela klassen ansluter med en enda kod.",
      "questions": "Frågor: {{count}}",
      "pace": "{{seconds}} s/fråga",
      "minLetters": "{{count}}+ bokstäver"
    },
    "live": {
    ...
    "results": {
      "classChest": "Klasskista",
      "classChestWords": "ord av {{total}} hittade",
      "playAgain": "Spela igen",
      "playAgainHint": "Samma ord, samma kod. Ingen behöver gå med igen."
    },
    "waiting": {
      "classmates": "Klasskompisar här",
      "editAvatar": "Byt avatar",
      "forTeacher": "Väntar på att läraren ska starta",
      "inClass": "i klassen",
      "classmateHere": "klasskompis är här",
      "classmatesHere": "klasskompisar är här",
      "firstIn": "Du är först här! Klasskompisarna dyker upp här."
    },
    "homework": {
  ...
  "homeFresh": {
    "hero": {
      "kicker": "Ordspelet för flera spelare",
      "title": "Hitta ord.\nSlå dina vänner.",
      ...
      "found": "{word}! Så enkelt är det.",
      "miss": "Inget ord än. Testa {letters}"
    },
    "modes": {
      "title": "Välj ditt spel",
      "line": "Snabba rundor, lugna pussel och allt däremellan.",
      ...
      "items": {
        ...
        "wordTower": {
          "title": "Ordtornet",
          "line": "Stapla ord mot himlen innan tornet vinglar."
        },
        "wordCraft": {
          "title": "WordCraft",
          "line": "Ta över brädet och lura boten."
        },
        "connections": {
          "title": "Ordkedja",
          "line": "Hitta ordet som binder ihop två andra."
        },
        "brainGym": {
          "title": "Hjärnträning",
          "line": "Korta övningar som skärper tanken."
        },
        "blast": {
          "title": "Blast-läge",
          "line": "Kedja ord, rensa brädet och pang!"
        }
      }
    },
    "sections": {
      "daily": {
        "title": "Ett pussel om dagen. Håll sviten vid liv.",
        "line": "En ny bräda varje morgon. Alla får samma bokstäver, så ni kan jämföra poäng.",
        "cta": "Spela dagens pussel",
        "streak": "dagars svit"
      },
      "friends": {
        "title": "Tävla mot dina vänner, live",
        "line": "Dela en rumskod och spela samma bräda samtidigt.",
        "cta": "Starta ett rum",
        "room": "Rum",
        "you": "Du",
        "rival": "Elsa"
      ...
      "languages": {
        ...
        "line": "Engelska, hebreiska, svenska, japanska, spanska och ryska, var och en med egen ordlista."
      },
      "classrooms": {
        "title": "Ta med spelet till klassrummet",
        "line": "Kör ett ordspel live med klassen. Eleverna går med via en kod från valfri enhet.",
        "cta": "Starta en klass gratis"
      }
    },
    "close": {
      "title": "Redo? Brädan väntar.",
      "line": "Ingen nedladdning och ingen registrering för att börja.",
      "play": "Spela nu",
      "blogTitle": "Senaste från bloggen",
      "blogAll": "Alla artiklar",
...
"createForm": {
  ...
  "profile": {
    "showcase": {
      "stageLabel": "Spelarens scen",
      "titles": {
        "rookie": "Nykomling",
        "hunter": "Ordjägare",
        "wordsmith": "Ordsmed",
        "lexicon": "Levande lexikon",
        "legend": "Levande legend"
      },
      "stats": {
        "bestWord": "Bästa ord",
        "wins": "Vinster",
      ...
      "emptyStats": "Spela en match så fylls din scen",
      "emptyStatsPublic": "Ny på brädet",
      ...
      "collection": "Samling",
      "rarest": "Sällsyntaste prylen",
      "nextUnlock": "Nästa upplåsning",
      "unlocksAt": "Låses upp på nivå {level}",
      "levelShort": "Nv",
      "xpToNext": "{xp} XP till nivå {level}",
      "maxLevel": "Maxnivå",
      "unnamed": "Mystisk spelare",
      "setName": "Välj ditt namn",
      "settings": "Inställningar",
      "pinned": "Utvalda meriter",
      "seeAll": "Visa alla",
      "noBadges": "Vinn en match för att fästa ditt första märke",
      "avatarCollection": {
        "title": "Avatarsamling",
        "body": "Gå upp i nivå och spela för att låsa upp delar. Ju ovanligare prylar, desto mer sticker din scen ut.",
        "byRarity": "Efter sällsynthet"
      },
      "account": "Konto och inställningar",
      "memberSince": "Sedan {date}",
      "shareFailed": "Det gick inte att dela. Försök igen."
    },
    "xpByMode": {
      "title": "XP per läge",
...
"vsBlooket": {
  ...
  "revealUnlock": {
    ...
    "equipping": "Tar på…",
    "equipped": "På plats!",
    "equipError": "Det gick inte att ta på. Försök igen.",
    "later": "Senare",
    "unlockedAt": "Belöning nivå {level}",
    "guestTitle": "Skapa konto och behåll den",
    "guestBody": "Gratis konto, sen är den din för alltid.",
    "chip": "Ny upplåsning!",
    "chipMany": "{count} nya upplåsningar!",
    "nextHint": "Nästa upplåsning på nivå {level}",
    "profileEntry": "Din profil",
    "levelShort": "Nv {level}",
    "share": "Dela",
    ...
    "voice": {
      ...
      "kawaii": "Maxad gullighet. Motståndarna är chanslösa.",
      "cottonCandy": "Söt, fluffig och helt sockerfri.",
      "cowboyHat": "Yeehaw! Det finns en ny sheriff på brädet.",
      "bg4B0082": "Djup, kunglig och väldigt mycket du.",
      "heartEye": "Varning: du är nu livsfarligt charmig.",
      "fangs": "Dina ord har fått huggtänder.",
      "duckHat": "Kvackattack! Ord, ta skydd.",
      "vaporwave": "Estetiskt. Extremt estetiskt.",
      "frogHat": "Ett skutt uppåt, grodstil.",
      "bg000000": "Mörkt läge, fast ikoniskt.",
      "slime": "Kladdig utanpå, geni inuti.",
      "starEye": "Att se stjärnor har aldrig varit så snyggt.",
      "lightning": "Varning: ordförråd med högspänning.",
    ...
    "parts": {
      "headphones": "Beat-lurar",
      "kawaii": "Kawaii-ögon",
      "cottonCandy": "Sockervaddshår",
      "cowboyHat": "Cowboyhatt",
      "bg4B0082": "Indigonatt",
      "heartEye": "Hjärtögon",
      "fangs": "Vampyrtänder",
      "duckHat": "Ankhatt",
      "vaporwave": "Vaporwave-hår",
      "frogHat": "Groddhatt",
      "bg000000": "Rymdsvart",
      "slime": "Slimeansikte",
      "starEye": "Stjärnögon",
      "lightning": "Blixthår",
      "butterflyWings": "Fjärilsvingar",
      "neonSmile": "Neonleende",
      "ghostFace": "Spökansikte",
      "rainbowMohawk": "Regnbågsirokes",
      "iceCrown": "Iskrona"
    }
  },
  "avatarLab": {
    ...
    "openBuilder": "Öppna avatarbyggaren",
    "placeholder": {
      "title": "Kommer snart",
      "profile": "Här hamnar profilens skyltfönster.",
      "reveal": "Här visas det du låser upp när du går upp i nivå."
    },
    "collection": "{owned} av {total} sällsynta delar samlade",
    "unlocksAtLevel": "Nytt på nivå {level}",
    "noUnlocks": "Inget nytt låses upp på den här nivån.",
    "nextUnlock": "Nästa upplåsning på nivå {level}",
    "liteNote": "Testspelaren har inget sparat ansikte, så miniavataren visar bara sin färgcirkel. Hela avataren står bredvid.",
    "randomAvatars": "Slumpade avatarer",
    "allParts": "Alla delar",
    "sections": {
      "faceShapes": "Ansiktsformer",
      "eyes": "Ögon",
      "mouths": "Munnar",
      "hair": "Hår",
      "accessories": "Tillbehör"
