...
const en = {
  ...
  "bots": {
    ...
    "autoFill": "Auto-fill Room",
    "autoFillDesc": "Fills empty slots with AI bots",
    "orAddManually": "Or add manually:",
    "addBotsManually": "Add Bots",
    "selectDifficultyPrompt": "Select difficulty:",
    "roomFull": "Room is full",
    "maxReached": "Maximum bots reached",
    "autoStart": "Auto-start after 30s",
    "autoStartDesc": "Start game automatically after 30 seconds",
  ...
  "wordHunt": {
    "title": "Word Hunt",
    "attemptsRemaining": "Attempt {current} of {max}",
    "wrongLength": "Word must be {expected} letters (you entered {got})",
    "alreadyGuessed": "You already guessed that word!",
    "victory": "🎉 You found it!",
    "defeat": "Game over! The word was: {word}",
    "keepGoing": "Keep hunting! Use the feedback to guide your next guess",
    "formWord": "Form a word from the grid...",
    "letterKnowledge": "Letter Knowledge",
    "targetLength": "Target word length: {length} letters",
    "greenMeaning": "🟩 = Letter in correct position",
    "yellowMeaning": "🟨 = Letter exists but wrong position",
