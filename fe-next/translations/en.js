...
const en = {
  "adventurePlay": {
    ...
    "variety": {
      ...
      "rule": {
        "classic": "Score enough points before the clock runs out.",
        ...
        "fog": "Fog covers the board. Only tiles next to your last word are clear.",
        "bomb": "Use a bomb tile in a word before its fuse burns out, or lose 4 seconds.",
        "elite": "A tough enemy that hits back. Knock out its HP before time runs out.",
        "boss": "The world boss. Every word is an attack, so keep swinging and survive its hits."
      },
      "twist": {
        ...
        "bomb": "Bombs! Use a bomb tile in a word before its fuse burns out, or lose 4 seconds.",
    ...
    "loot": {
      ...
      "runOver": "Run over",
      "runOverSub": "The world starts fresh from level 1. Your stars and collection stay yours.",
      "newRun": "New run",
      ...
      "stackPerLevel": "pts per level, from this run's words",
      "contribAria": "{name}: +{n} points this level",
      "value": {
        "label": "This run",
        "hitsLine": "hits {hits} of your {total} words",
        "synergy": "Combo",
        "synergyHint": "Stacks with a relic you already own",
        "ptsPerLevel": "pts per level",
        "goldPerLevel": "gold per level",
        "seconds": "sec every level",
        "shield": "shield each fight",
        "frost": "curse time",
        "revive": "extra life",
        "longWords": "heals from your long words",
        ...
        "noData": "no words yet",
        "stackLine": "alone → with your relics",
    ...
    "relicDesc": {
      "sharp-quill": "Words of 6+ letters score +50%",
      "long-bow": "Words of 7+ letters score double",
      "short-sword": "3-letter words +2 points",
      "storm-rune": "5-letter words +5 points",
      "twin-ink": "Your first word each level scores double",
      "echo-stone": "+1 point per word already found (max +10)",
      "magnet": "All words +20%",
      "heart-locket": "+1 max HP",
      "hourglass": "+10 seconds every level",
      "lens-of-insight": "+1 hint every level",
      "sage-scroll": "Hints reveal the whole word",
      "iron-bookmark": "Start every fight with a shield",
      "frost-ward": "Freezes and curses last half as long",
      "vampire-fang": "6+ letter words heal 1 HP in fights",
      "gold-tooth": "+50% gold",
      "lucky-clover": "Choose from 4 rewards instead of 3",
      "phoenix-feather": "Once per run, revive at 1 HP"
    },
    "potion": {
      "heal": "Healing Potion",
      "time": "Time Potion",
