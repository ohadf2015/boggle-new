...
const en = {
  "adventurePlay": {
    ...
    "loot": {
      ...
      "runOver": "Run over",
      "runOverSub": "A new map, a new run from the first floor. Your stars and collection stay yours.",
      "newRun": "New run",
  ...
  "wordTowerV2": {
    ...
    "rescue": {"crumbled":"Lost {n} floors! Keep building","counterweight":"COUNTERWEIGHT! Tower steadied","braced":"BRACED! The steel holds"},
