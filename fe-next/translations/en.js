...
"wordHunt": {
  ...
  "accessibility": {
    ...
    "fireRoundLights": {
      ...
      "description": "Turns off rainbow glowing cells during fire rounds for a calmer visual experience."
    },
    "reduceMotion": {
      "title": "Reduce Animations",
      "description": "Minimizes animations and transitions for a calmer experience. Helps with motion sensitivity."
    },
    "disableSounds": {
    ...
    "earthquakeEffects": {
      ...
      "description": "Turns off intense earthquake animations (shaking, 3D effects, motion blur, and debris) for a gentler experience."
    }
  },
  "peerValidation": {
    "title": "Is this a real word?",
    "submittedBy": "Submitted by",
    "valid": "Valid",
    "invalid": "Invalid",
    "voteRecorded": "Vote recorded!",
    "yourWordRejected": "Your word was rejected!",
    "wordRejected": "Word rejected",
    "communityRejected": "The community voted this word as invalid.",
  ...
  "brain": {
    ...
    "recommendation": {
      ...
      "declining": "Your {domain} has been declining. This drill can help!",
      "low": "Your {domain} needs work. Practice makes perfect!",
      "improve": "Keep building your {domain} skills!",
      "unlock": "Play {games} more games to unlock"
    },
    "welcomeBack": {
      "title": "Welcome Back!",
      ...
      "reachTier": "Can you reach {tier} tier again?",
      "beatBest": "Your best is {score}. Can you beat it?",
      "daysAway": "{days} days since last game"
    },
    "share": {
    ...
    "playMoreForTrends": "Play {count} more games to see trends",
    "errors": {
