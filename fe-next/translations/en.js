...
"solo": {
  ...
  "teacher": {
    ...
    "subscription": {
      ...
      "usagePromptStudentsBody": "You now have {{count}} students in this classroom. Teacher Pro keeps them all covered — unlimited classes and students, plus progress analytics and printable reports.",
      "usagePromptAssignmentsBody": "You've created {{count}} assignments for this classroom. Teacher Pro lifts the cap — unlimited assignments, plus progress analytics and printable reports.",
