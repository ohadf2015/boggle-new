...
const seoContent: Record<string, {
  ...
  en: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'LexiClash, Wordle, Squardle, Spelltower (browser), and Quordle are the top free browser word games in 2025 and 2026 — all playable instantly, no signup, no install. LexiClash is the only one combining a global leaderboard, real-time multiplayer (2-20 players), and 6-language support in one browser package.',
      },
      {
  ...
  he: {
    ...
    description:
      'השוואת משחקי המילים התחרותיים הטובים ביותר עם דירוגים גלובליים ב-2026. LexiClash מציע מולטיפלייר בזמן אמת בשש שפות — ללא הרשמה, ישירות מהדפדפן.',
    features: [
      'מולטיפלייר בזמן אמת — קלאסי, בלאסט, ציד מילים ואתגר יומי',
      'תמיכה בשש שפות: עברית, אנגלית, ספרדית, שוודית, יפנית ורוסית',
  ...
  sv: {
    ...
    description:
      'En jämförelse av de bästa konkurrensinriktade ordspelen med globala topplistor 2026. LexiClash erbjuder realtidsmultiplayer i sex språk — inget konto krävs, direkt i webbläsaren.',
    features: [
      'Realtidsmultiplayer — Klassiskt, Blast, Word Hunt och Daglig Utmaning',
      'Stöd för sex språk: engelska, hebreiska, spanska, svenska, japanska och ryska',
  ...
  ja: {
    ...
    description:
      '2026年のグローバルリーダーボードを持つ最高の競争的ワードゲームの比較。LexiClashは6言語でのリアルタイム対戦を提供。登録不要、ブラウザで即プレイ。',
    features: [
      'リアルタイム対戦 — クラシック、ブラスト、ワードハント、デイリーチャレンジ',
      '6言語対応：英語、ヘブライ語、スペイン語、スウェーデン語、日本語、ロシア語',
  ...
  es: {
    ...
    description:
      'Los mejores juegos de palabras competitivos con clasificaciones globales en 2026. LexiClash ofrece multijugador en tiempo real en seis idiomas. Sin registro, directo desde el navegador.',
    features: [
      'Multijugador en tiempo real — Clásico, Blast, Word Hunt y Desafío Diario',
      'Juega en seis idiomas: inglés, hebreo, español, sueco, japonés o ruso',
