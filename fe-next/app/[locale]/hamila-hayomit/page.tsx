...
// Hebrew is the primary (and only indexable) market for this page. Any other-locale
// variant consolidates to the Hebrew canonical so we never split authority.
const CANONICAL = `${BASE_URL}/he/hamila-hayomit`;
const DAILY_URL = `${BASE_URL}/he/daily`;
