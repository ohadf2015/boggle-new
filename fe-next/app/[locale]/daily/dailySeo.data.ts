...
export const dailySeoContent: Record<string, DailySeoEntry> = {
  ...
  he: {
    title: 'המילה היומית — מילת היום, פאזל מילים יומי חינם | LexiClash',
    description: 'המילה היומית של LexiClash — פאזל מילים חדש כל יום בחצות. כולם בעולם משחקים על אותו לוח. ציד מילים וגלגל מילים, שתפו תוצאות אמוג\'י והתחרו בטבלת המובילים היומית. חינם, ללא הרשמה.',
    features: [
