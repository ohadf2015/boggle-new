...
export const dailySeoContent: Record<string, DailySeoEntry> = {
  ...
  he: {
    ...
    description: 'פאזל מילים יומי חינם בעברית — ציד מילים וגלגל מילים חדשים כל יום בחצות. כולם על אותו לוח, שתפו תוצאות אמוג\'י, התחרו בטבלת מובילים יומית. ללא הרשמה.',
    features: [
