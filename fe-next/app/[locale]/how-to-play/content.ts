    ...
    en: {
        ...
        faq: {
            ...
            items: [
                ...
                { question: 'What languages does LexiClash support?', answer: 'LexiClash supports English, Hebrew, Swedish, Japanese, Spanish, and Russian. Each language has its own dictionary for word validation.' },
    ...
    he: {
        ...
        faq: {
            ...
            items: [
                ...
                { question: 'באילו שפות לקסיקלאש תומך?', answer: 'לקסיקלאש תומך באנגלית, עברית, שוודית, יפנית, ספרדית ורוסית. לכל שפה יש מילון משלה לאימות מילים.' },
    ...
    sv: {
        ...
        faq: {
            ...
            items: [
                ...
                { question: 'Vilka sprak stoder LexiClash?', answer: 'LexiClash stoder engelska, hebreiska, svenska, japanska, spanska och ryska.' },
    ...
    ja: {
        ...
        faq: {
            ...
            items: [
                ...
                { question: 'どの言語をサポートしていますか？', answer: 'LexiClashは英語、ヘブライ語、スウェーデン語、日本語、スペイン語、ロシア語をサポートしています。' },
    ...
    es: {
        ...
        faq: {
            ...
            items: [
                ...
                { question: 'Que idiomas soporta LexiClash?', answer: 'LexiClash soporta ingles, hebreo, sueco, japones, espanol y ruso. Cada idioma tiene su propio diccionario.' },
