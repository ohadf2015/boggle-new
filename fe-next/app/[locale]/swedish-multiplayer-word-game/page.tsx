...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Spela Alfapet & Scrabble online på svenska i realtid — inte tur-baserat. Upp till 50 spelare, bjud in med länk. Ingen registrering. Starta nu!',
    ...
    openGraph: {
      title: 'Alfapet & Scrabble Online Svenska Gratis | LexiClash',
      description: 'Spela Alfapet & Scrabble på svenska i realtid — inte tur och ordning. Upp till 50 spelare, bjud in med länk. Gratis.',
      locale: 'sv_SE',
      type: 'website',
      url: pageUrl,
      images: [
    ...
    twitter: {
      ...
      title: 'Alfapet & Scrabble Online Svenska Gratis | LexiClash',
      description: 'Spela Alfapet & Scrabble online på svenska i realtid — inte tur-baserat. Upp till 50 spelare, bjud in med länk. Gratis.',
