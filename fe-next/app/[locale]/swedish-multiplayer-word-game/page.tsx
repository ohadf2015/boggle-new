...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Alfapet & Scrabble Svenska Gratis — Spela Nu | LexiClash',
    description: 'Spela Alfapet & Scrabble online gratis på svenska. Utan registrering, utan app. Upp till 50 spelare i realtid. Starta ett rum på 10 sekunder →',
