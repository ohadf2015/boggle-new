...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Spela Scrabble eller Alfapet online gratis på svenska. Utan konto, utan app. 2–50 spelare i realtid. Starta rum på 10 sek →',
    ...
    openGraph: {
      title: 'Scrabble & Alfapet Online Gratis på Svenska | LexiClash',
      description: 'Spela Scrabble eller Alfapet online gratis på svenska. Utan konto, utan app. 2–50 spelare i realtid. Skapa rum och tävla direkt!',
      locale: 'sv_SE',
      type: 'website',
      url: pageUrl,
      images: [
    ...
    twitter: {
      ...
      description: 'Spela Scrabble eller Alfapet online gratis på svenska. Utan konto, utan app. Starta rum på 10 sek →',
