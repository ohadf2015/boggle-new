...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Spela Scrabble och Alfapet online på svenska gratis med 2–50 vänner i realtid. Skapa rum, ingen app, ingen registrering. Tävla direkt →',
    keywords: 'scrabble svenska, ordspel online, multiplayer ordspel, ordspel svenska, wordfeud alternativ, boggle online svenska, alfapet online gratis, scrabble online gratis, ordspel med vänner, ordspel i realtid, ordhjul, ordhjul online, daglig ordhjul',
    openGraph: {
      title: 'Scrabble Svenska Online Gratis — Alfapet | LexiClash',
      description: 'Spela Scrabble och Alfapet online på svenska gratis med 2–50 vänner i realtid. Skapa rum, ingen app, ingen registrering. Tävla direkt →',
      locale: 'sv_SE',
