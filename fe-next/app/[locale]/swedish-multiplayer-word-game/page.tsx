...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Spela Scrabble & Wordfeud online på svenska gratis — utan registrering, ingen app. 2–50 spelare i realtid. Skapa rum, bjud in med länk. Starta nu →',
    ...
    openGraph: {
      ...
      description: 'Spela Scrabble & Wordfeud online på svenska gratis — utan registrering, upp till 50 spelare i realtid. Skapa rum och tävla direkt!',
      locale: 'sv_SE',
      type: 'website',
      url: pageUrl,
      images: [
    ...
    twitter: {
      ...
      title: 'Scrabble Online Svenska Gratis | LexiClash',
      description: 'Spela Scrabble & Wordfeud online på svenska i realtid. Skapa rum, bjud in med länk, tävla direkt. Gratis.',
