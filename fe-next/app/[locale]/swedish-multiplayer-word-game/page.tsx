...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Scrabble Svenska Online Gratis · Alfapet Alternativ | LexiClash',
    description: 'Scrabble online på svenska gratis — ingen registrering, 2–50 spelare i realtid. Skapa rum på 10 sek och tävla med vänner. Som Alfapet, fast snabbare.',
    ...
    twitter: {
      ...
      title: 'Scrabble Svenska Online Gratis · Alfapet Alternativ | LexiClash',
      description: 'Scrabble online på svenska gratis. Ingen registrering — skapa rum, bjud in med länk, tävla direkt. Som Alfapet, fast snabbare.',
