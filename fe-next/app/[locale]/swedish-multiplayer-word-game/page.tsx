...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Alfapet & Scrabble Online Gratis på Svenska — 50 Spelare | LexiClash',
    description: 'Spela Alfapet & Scrabble på svenska gratis online — inget konto, ingen app. Upp till 50 spelare i realtid. Starta på 10 sekunder! →',
