...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Scrabble Online Svenska Gratis — Alfapet, Spela Nu | LexiClash',
    description: 'Spela Scrabble online på svenska gratis — utan registrering, 2–50 spelare i realtid. Ingen app, ingen väntan. Starta nu →',
