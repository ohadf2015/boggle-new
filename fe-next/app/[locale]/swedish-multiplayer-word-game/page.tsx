...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Alfapet Online Gratis på Svenska — Utan App | LexiClash',
    description: 'Alfapet & Scrabble online gratis på svenska: 50 spelare i realtid, utan registrering eller app. Skapa rum på 10 sekunder. Spela nu →',
    ...
    openGraph: {
      ...
      description: 'Alfapet & Scrabble online gratis på svenska: 50 spelare i realtid, utan registrering. Skapa rum på 10 sekunder och tävla direkt!',
      locale: 'sv_SE',
      type: 'website',
      url: pageUrl,
      images: [
