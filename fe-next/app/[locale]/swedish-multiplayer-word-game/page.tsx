...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Scrabble Online Gratis på Svenska — Alfapet, 50 Spelare | LexiClash',
    description: 'Spela Scrabble online gratis på svenska — ingen app, inget konto. Upp till 50 spelare i realtid. Starta på 10 sekunder! →',
