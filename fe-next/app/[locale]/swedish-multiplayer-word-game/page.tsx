...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Scrabble Online Svenska Gratis — Spela Ordspel Nu | LexiClash',
    description: 'Spela Scrabble online på svenska gratis, utan registrering. Skapa rum, bjud in med länk och tävla i realtid. 10 000+ svenska ord. Börja nu!',
