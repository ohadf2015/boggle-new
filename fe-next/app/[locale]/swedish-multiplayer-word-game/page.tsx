...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Alfapet Online Gratis Svenska — 2–50 Spelare | LexiClash',
    description: 'Spela Alfapet online gratis på svenska — utan konto, utan app. 2–50 spelare i realtid. Starta ett rum på 10 sekunder →',
