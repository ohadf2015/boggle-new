...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Spela Alfapet online gratis nu — inget konto, ingen app. Bjud in vänner med länk. Upp till 50 spelare i realtid. Starta ett rum på 10 sekunder →',
    ...
    openGraph: {
      ...
      description: 'Spela Alfapet online gratis på svenska — inget konto, ingen app. Upp till 50 spelare i realtid. Skapa rum och tävla direkt!',
      locale: 'sv_SE',
      type: 'website',
      url: pageUrl,
      images: [
