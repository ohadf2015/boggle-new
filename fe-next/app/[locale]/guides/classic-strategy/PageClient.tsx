...
export default function ClassicStrategyPageClient(): React.ReactElement {
  ...
  return (
    <div className={cn(
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 page-content-safe">
        ...
        {/* Quick Tips - AEO optimized numbered list */}
        <section
          data-speakable="true"
          className={cn(
            'mb-8 p-6 rounded-neo border-3 border-neo-black shadow-hard',
            isDarkMode ? 'bg-neo-navy-light' : 'bg-neo-yellow/20'
          )}
        >
        ...
        <section className="mb-8">
          ...
          <div className={cn(
            ...
            <table className="w-full text-center">
              <thead>
                <tr className={cn('border-b-3 border-neo-black', isDarkMode ? 'bg-neo-navy-elevated' : 'bg-neo-lime')}>
                  <th className="py-3 px-4 font-bold">Word Length</th>
              ...
              <tbody>
                {content.scoringTable.map((row, i) => (
                  <tr key={`row-${row.length}`} className={cn(
                    ...
                    <td className={cn('py-2 px-4 font-bold', isDarkMode ? 'text-neo-yellow' : 'text-neo-black')}>
                      {row.points}
                    </td>
                  </tr>
                ))}
