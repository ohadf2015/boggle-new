  ...
  en: {
    ...
    relatedReading: {
      ...
      links: [
        ...
        { label: 'Word Solver & Anagram Finder tool', href: '/en/tools/word-solver' },
      ],
    },
  },
  he: {
    ...
    relatedReading: {
      ...
      links: [
        ...
        { label: 'כלי פותר מילים ומוצא אנגרמות', href: '/he/tools/word-solver' },
      ],
    },
  },
  sv: {
    ...
    relatedReading: {
      ...
      links: [
        ...
        { label: 'Ordlösare och anagramverktyg', href: '/sv/tools/word-solver' },
      ],
    },
  },
  ja: {
    ...
    relatedReading: {
      ...
      links: [
        ...
        { label: 'ワードソルバー＆アナグラムツール', href: '/ja/tools/word-solver' },
      ],
    },
  },
  es: {
    ...
    relatedReading: {
      ...
      links: [
        ...
        { label: 'Herramienta de resolucion de palabras y anagramas', href: '/es/tools/word-solver' },
      ],
    },
  },
};
