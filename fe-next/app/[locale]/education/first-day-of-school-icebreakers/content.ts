    ...
    },
    {
      ...
      groups: [
        ...
        },
        {
          ...
          words: ['שולחן', 'כיתה', 'מורה', 'חברה', 'ארוחה', 'פעמון', 'ספר', 'בחינה', 'הפסקה', 'ציון'],
        },
      ],
    },
    {
  ...
  sections: [
    ...
    },
    {
      ...
      groups: [
        ...
        {
          label: 'あなたが好きなもの',
          words: ['読書', '描くこと', '音楽', 'スポーツ', 'ゲーム', '寝ること', '食べること', 'コード', '踊ること', '作ること'],
        },
        {
          label: '学校について',
          words: ['机', 'クラス', '先生', '友達', 'お昼', 'ベル', '本', 'テスト', '休み時間', '成績'],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      groups: [
        ...
        },
        {
          ...
          words: ['читать', 'рисовать', 'музыка', 'спорт', 'игра', 'спать', 'есть', 'код', 'танцевать', 'строить'],
        },
        {
          label: 'Слова о школе',
