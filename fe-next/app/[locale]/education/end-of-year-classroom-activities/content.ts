  ...
  sections: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          activity: 'Финальная игра: раунд Boggle со словами, предложенными учащимися за весь год. Пока играется, учащиеся выкрикивают свои любимые воспоминания о классе. После: учитель делится тем, что заметил о годе. 15 минут.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          desc: "Проектор класса или интерактивная доска и учащиеся с телефонами или планшетами. Chromebooks работают. Нет приложения для установки—всё в браузере.",
        },
        {
  ...
  faqs: [
    {
      ...
      a: 'Поиск слов в стиле Boggle и головоломки Connections работают лучше всего: быстрый темп, нет побеждённых или проигравших (только "нашли ли вы слова?"), и все учащиеся играют одновременно.',
    },
    {
      q: 'Могут ли мои учащиеся играть дома?',
      a: 'Да. Если учащиеся имеют устройства, они могут присоединиться к любой игре, которую вы проводите, введя код доступа. Им не нужна электронная почта или учётная запись—они просто пишут своё имя.',
    },
    {
    ...
    },
    {
      ...
      a: 'В LexiClash все учащиеся играют в одну и ту же игру одновременно, поэтому нет "закончить раньше". Все видят один и тот же доску и играют до конца времени.',
    },
    {
