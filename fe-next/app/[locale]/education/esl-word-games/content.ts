...
const content: Record<EducationLocale, LocaleContent> = {
  ...
  he: {
    metaTitle: 'משחקי אנגלית חינמיים — מרובי שחקנים, בכיתה ולבד | LexiClash',
    metaDescription: 'משחקי אנגלית בחיים ישירים, בחינם לכיתה. חשבונות תלמידים חינמיים, 5 מילונות, דשבורד מורה. אנגלית, עברית, ספרדית, שוודית, יפנית.',
    ogTitle: 'משחקי אנגלית חינמיים',
    ogDescription: 'משחקי אנגלית בחיים ישירים. חשבונות חינמיים, 5 מילונות, דשבורד למורים.',
    ...
    heroSubtitle: 'משחקי יצירת מילים לתלמידי אנגלית. חשבונות חינמיים, 5 מילונות, ודשבורד למורים שמראה איזה מילים קשות.',
    ctaLabel: 'צור כיתה חינמית',
    faqTitle: 'שאלות נפוצות',
    features: [
      { icon: '🌍', text: '5 מילונות: אנגלית, ספרדית, עברית (RTL), שוודית, יפנית' },
      { icon: '⚡', text: 'חשבונות חינמיים — הגדרה מהירה, אחרי כן עוקב התקדמות' },
      { icon: '👥', text: 'ריבוי משתתפים חי — עד 30 תלמידים; דו־קרבות זוגות' },
      { icon: '📈', text: 'דיוק לתלמיד + מילים קשות לכל הכיתה' },
      { icon: '🎯', text: '3 משחקים: Boggle, Word Hunt, Word Wheel' },
      { icon: '📱', text: 'טלפון, טאבלט, Chromebook, כל דפדפן' },
      { icon: '⏱️', text: 'חימום של 5 דקות — כל תוכנית שיעור' },
      { icon: '💸', text: 'הכל חינם — ללא פרמיום' },
    ],
    proficiencyLevels: [
      { tag: 'A1-A2', title: 'מתחיל', desc: 'מילים קצרות, טיימר ארוך, מילות ראייה. Word Wheel לתרגול מודרך.' },
      { tag: 'B1-B2', title: 'בינוני', desc: 'אורכים שונים, טיימר רגיל. Boggle חושף דפוסים וקידומות.' },
      { tag: 'C1-C2', title: 'מתקדם', desc: 'מילים ארוכות, טיימר הדוק, רשימות מתקדמות (TOEFL, IELTS).' },
    ],
    sections: {
      builtFor: 'בנוי לתלמידי אנגלית.',
      scaleToCefr: 'התאם לרמת CEFR.',
      ctaHeading: 'חמש דקות נשארו?',
      ctaSubtitle: 'הפעל סיבוב אוצר מילים.',
      ctaPrimaryButtonLabel: '▶ התחל משחק אנגלית',
      ctaSecondaryButtonLabel: 'ראה משחקי כיתה',
    },
    faqs: [
      {
        q: 'מה משחקי המילים הטובים ביותר לתלמידי אנגלית?',
        a: 'LexiClash מציע משחקי יצירת מילים בחיים: Boggle מהיר, Word Wheel לאוצר מילים, Word Hunt לחיפוש. כל משחק בזמן אמת נגד חברים או בינה מלאכותית — תחרותי ומעניין.',
      },
      {
        q: 'צריכים תלמידים חשבון?',
        a: 'כן, חשבון נדרש אבל תמיד חינמי. מורים יוצרים כיתה, תלמידים נכנסים עם קוד. אפס עלות.',
      },
      {
        q: 'איך משחקי מילים עוזרים?',
        a: 'משחקים חיזקו איות, זיכרון מילים, מהירות תחת לחץ — כל זה הופך לשטף דיבור. התחרות מגברת עניין, במיוחד לנערים.',
      },
      {
        q: 'אוכל להתאים לרמות אחרות?',
        a: 'כן. העלה רשימות (A0–C2) והקצה לפי רמה. הדשבורד מראה איזה מילים קשות.',
      },
      {
        q: 'תומך בתלמידים בוגרים?',
        a: 'כן. יש למי בוגרים ותוכניות אוניברסיטה משתמשים ב-LexiClash למילים ומשחקים.',
      },
      {
        q: 'אוכל להשתמש בתוכנית דו-לשונית?',
        a: 'כן. LexiClash תומך בעברית, אנגלית, ספרדית, שוודית, יפנית. מושלם לטבילה והעברה.',
      },
    ],
  },
  es: {
    metaTitle: 'Juegos de Inglés Gratis — Multijugador, 5 Idiomas | LexiClash',
    metaDescription: 'Juegos de inglés para el aula. Multijugador en vivo, duelos 1v1, tus listas de palabras. Inglés, español, hebreo, sueco, japonés. Cuentas gratis. Funciona en cualquier navegador.',
