...
const EN: ForSchoolsContent = {
  ...
  compareRows: [
    { competitor: 'Kahoot', freeTierLimit: 'Free tier caps live players (too few for a full class); school plans are per-teacher.', lexiclash: 'No player cap during trial. School plans $39/term.' },
    { competitor: 'Gimkit', freeTierLimit: 'Free tier limited to 5 students; school plans run $650-$1,000/yr.', lexiclash: 'No student cap during trial. School plans from $39/term.' },
  ...
  coming: [
    ...
    { title: 'Curriculum content libraries', body: 'Curated multilingual word sets mapped to your curriculum -- across all six languages.' },
  ...
  faqs: [
    ...
    { q: 'How do we start our trial or get a school plan?', a: 'Fill in the form on this page with your role, school or district, and rough student count. We\'ll confirm your trial access and share school plan details -- $39/term, district pricing on request.' },
...
const RU: ForSchoolsContent = {
  ...
  compareRows: [
    { competitor: 'Kahoot', freeTierLimit: 'Бесплатная версия ограничивает количество живых игроков; школьные планы платятся за учителя.', lexiclash: 'Без ограничений на количество игроков во время пробы. Школьные планы $39 за семестр.' },
    { competitor: 'Gimkit', freeTierLimit: 'Бесплатная версия ограничена 5 учениками; школьные планы стоят $650–$1000 в год.', lexiclash: 'Без ограничений на количество учеников во время пробы. Школьные планы от $39 за семестр.' },
  ...
  faqs: [
    ...
    { q: 'Как начать пробный период или получить школьный план?', a: 'Заполните форму на этой странице со своей ролью, школой или районом и примерным количеством учеников. Мы подтвердим ваш доступ к пробному периоду и поделимся информацией о школьном плане — $39 за семестр, цены для районов по запросу.' },
...
const HE: ForSchoolsContent = {
  ...
  compareRows: [
    { competitor: 'Kahoot', freeTierLimit: 'המסלול החינמי מגביל את מספר השחקנים החיים (מעט מדי לכיתה מלאה); תוכניות בית ספר נגבות לפי מורה.', lexiclash: 'בלי הגבלת שחקנים בזמן הניסיון. תוכניות בית ספר $39 לסמסטר.' },
    { competitor: 'Gimkit', freeTierLimit: 'המסלול החינמי מוגבל ל-5 תלמידים; תוכניות בית ספר עולות $650–$1,000 לשנה.', lexiclash: 'בלי הגבלת תלמידים בזמן הניסיון. תוכניות בית ספר החל מ-$39 לסמסטר.' },
  ...
  faqs: [
    ...
    { q: 'איך מתחילים את הניסיון או מקבלים תוכנית בית ספר?', a: 'מלאו את הטופס בעמוד הזה עם התפקיד שלכם, בית הספר או הרשות ומספר תלמידים משוער. נאשר לכם את גישת הניסיון ונשתף פרטים על תוכנית בית הספר — $39 לסמסטר, מחיר לרשויות לפי בקשה.' },
...
const SV: ForSchoolsContent = {
  ...
  compareRows: [
    { competitor: 'Kahoot', freeTierLimit: 'Gratisversionen begränsar antalet livespelare (för få för en full klass); skolplaner är per lärare.', lexiclash: 'Ingen spelargräns under provperioden. Skolplaner $39/termin.' },
    { competitor: 'Gimkit', freeTierLimit: 'Gratisversionen begränsad till 5 elever; skolplaner kostar $650–$1 000/år.', lexiclash: 'Ingen elevgräns under provperioden. Skolplaner från $39/termin.' },
  ...
  coming: [
    ...
    { title: 'Läroplansbibliotek', body: 'Kurerade flerspråkiga ordsamlingar mappade till din läroplan — över alla sex språken.' },
  ...
  faqs: [
    ...
    { q: 'Hur börjar vi vår provperiod eller får en skolplan?', a: 'Fyll i formuläret på den här sidan med din roll, skola eller distrikt och ungefärligt antal elever. Vi bekräftar din provåtkomst och delar information om skolplanen — $39/termin, distriktspriser på begäran.' },
    { q: 'Hur skiljer sig detta från Kahoot, Gimkit eller Quizlet?', a: 'Det är quiz-/flashcardverktyg som begränsar sina gratisversioner och är engelskfokuserade. LexiClash är ett ordbyggande spel (inte flervalsfrågor), stöder sex språk inklusive hebreiska RTL, har ingen spelargräns under provperioden och erbjuder riktiga 1v1-dueller.' },
...
const JA: ForSchoolsContent = {
  ...
  compareRows: [
    { competitor: 'Kahoot', freeTierLimit: '無料プランはライブプレイヤー数が制限され（クラス全体には少なすぎる）、学校プランは教師ごとの課金。', lexiclash: 'トライアル中はプレイヤー数制限なし。学校プランは学期$39。' },
    { competitor: 'Gimkit', freeTierLimit: '無料プランは5学生まで; 学校プランは年$650～$1,000。', lexiclash: 'トライアル中は学生数制限なし。学校プランは学期$39から。' },
  ...
  coming: [
    ...
    { title: 'カリキュラムコンテンツライブラリ', body: 'あなたのカリキュラムにマッピングされた多言語の単語セット — 6言語すべてに対応。' },
  ...
  faqs: [
    ...
    { q: 'トライアルを始める、または学校プランを取得するにはどうすればよいですか？', a: 'このページのフォームに、あなたの役割、学校または学区、およびおおよその学生数を入力してください。トライアルアクセスを確認し、学校プランの詳細をお伝えします — 学期$39、学区向け価格はご要望に応じます。' },
    { q: 'Kahoot、Gimkit、Quizletとどう違いますか？', a: 'それらは無料プランを制限し英語優先のクイズ／フラッシュカードツールです。LexiClashは単語構築ゲーム（選択式ではありません）で、ヘブライ語RTLを含む6言語に対応し、トライアル中はプレイヤー数制限がなく、本物の1v1決闘を提供します。' },
...
const ES: ForSchoolsContent = {
  ...
  compareRows: [
    { competitor: 'Kahoot', freeTierLimit: 'El nivel gratuito limita los jugadores en vivo (muy pocos para una clase completa); los planes escolares son por maestro.', lexiclash: 'Sin límite de jugadores durante la prueba. Planes escolares $39/trimestre.' },
    { competitor: 'Gimkit', freeTierLimit: 'El nivel gratuito se limita a 5 estudiantes; los planes escolares cuestan $650–$1,000/año.', lexiclash: 'Sin límite de estudiantes durante la prueba. Planes escolares desde $39/trimestre.' },
  ...
  coming: [
    ...
    { title: 'Bibliotecas de contenido de currículo', body: 'Conjuntos de palabras multilingües curados y asignados a tu currículo — en los seis idiomas.' },
