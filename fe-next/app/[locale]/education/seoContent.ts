...
export const educationSeoContent: Record<string, EducationSeoEntry> = {
  ...
  ru: {
    ...
    faq: [
      ...
      { question: 'LexiClash Education действительно бесплатна?', answer: 'Да — полностью бесплатна, без скрытых платежей, без премиум-версии. Учителя и учащиеся получают те же словесные игры, словарные дуэли, многопользовательскую игру в классе и аналитическую панель без каких-либо расходов.' },
