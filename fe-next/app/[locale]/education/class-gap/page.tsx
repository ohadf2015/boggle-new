...
export default async function ClassGapPage(props: PageProps) {
  ...
  const unpluggedLive = readString(
    t,
  ...
  const classicUnpluggedLive = readString(
    t,
    'education.results.startClassicUnplugged',
    'Start Classic Unplugged',
  );
    ...
    >
      <article className="w-full max-w-xl p-6 rounded-neo border-neo border-neo-cream/40 bg-neo-navy-light shadow-hard">
        ...
        <ClassGapReteachLiveCta
          ...
          classicUnpluggedLabel={classicUnpluggedLive}
