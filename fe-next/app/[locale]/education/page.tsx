...
const RESOURCE_CARDS: Record<string, { heading: string; subhead: string; vocab: ResourceCard; esl: ResourceCard; teachers: ResourceCard; spelling: ResourceCard; forSchools: ResourceCard }> = {
  en: {
    ...
    vocab: { badge: 'Guide', title: 'Vocabulary Games for the Classroom', desc: 'No signup, 5 languages, free for teachers — vs Quizlet/Kahoot/Wordwall.' },
  ...
  he: {
    ...
    vocab: { badge: 'מדריך', title: 'משחקי אוצר מילים לכיתה', desc: 'בלי הרשמה, 5 שפות, חינם למורים — מול Quizlet/Kahoot/Wordwall.' },
  ...
  sv: {
    ...
    vocab: { badge: 'Guide', title: 'Ordförrådsspel för klassrummet', desc: 'Ingen registrering, 5 språk, gratis för lärare — jämfört med Quizlet/Kahoot/Wordwall.' },
  ...
  ja: {
    ...
    vocab: { badge: 'ガイド', title: '教室向け語彙ゲーム', desc: '登録不要、5言語、教師に無料 — Quizlet/Kahoot/Wordwallと比較。' },
  ...
  es: {
    ...
    vocab: { badge: 'Guía', title: 'Juegos de vocabulario para el aula', desc: 'Sin registro, 5 idiomas, gratis para docentes — frente a Quizlet/Kahoot/Wordwall.' },
