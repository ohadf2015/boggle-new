...
const RESOURCE_CARDS: Record<string, { heading: string; subhead: string; vocab: ResourceCard; esl: ResourceCard; teachers: ResourceCard; spelling: ResourceCard; sightWords: ResourceCard; forSchools: ResourceCard }> = {
  en: {
    ...
    esl: { badge: 'ESL', title: 'ESL Word Games Online', desc: 'Beginner to advanced, 6 dictionaries, no student signup.' },
  ...
  he: {
    ...
    esl: { badge: 'אנגלית', title: 'משחקי מילים באנגלית כשפה זרה', desc: 'ממתחילים ועד מתקדמים, 6 מילונים, בלי הרשמת תלמידים.' },
  ...
  sv: {
    ...
    esl: { badge: 'ESL', title: 'Ordspel för engelska online', desc: 'Nybörjare till avancerad, 6 ordböcker, ingen elevregistrering.' },
  ...
  ja: {
    ...
    esl: { badge: 'ESL', title: 'オンライン英語単語ゲーム', desc: '初級から上級まで、6つの辞書、生徒の登録不要。' },
  ...
  es: {
    ...
    esl: { badge: 'ESL', title: 'Juegos de palabras en inglés online', desc: 'De principiante a avanzado, 6 diccionarios, sin registro de estudiantes.' },
  ...
  ru: {
    ...
    esl: { badge: 'ESL', title: 'Онлайн-игры по английским словам', desc: 'От начинающего до продвинутого, 6 словарей, без регистрации учеников.' },
