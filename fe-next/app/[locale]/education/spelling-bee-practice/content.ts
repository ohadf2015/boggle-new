...
const content: Record<EducationLocale, LocaleContent> = {
  en: {
    ...
    badgeText: '★ Spelling Bee Prep ★ Free To Start ★',
    ...
    faqs: [
      ...
      { q: 'Is LexiClash classroom-ready for school spelling bees?', a: 'Yes. Teachers can run whole-class spelling-bee warm-ups (a whole class join with a 6-character code, no student accounts), 1v1 elimination brackets, or assign solo practice. The teacher dashboard shows per-student accuracy and which words tripped the most competitors — useful for targeting review sessions.' },
      { q: 'Is it free for individual students preparing at home?', a: 'Yes — solo practice at home is free, with no per-user fee. Open the browser, pick a mode, start practicing. No account required (though optional account saves your progress and unlocks streak tracking).' },
    ],
  ...
  he: {
    ...
    badgeText: '★ הכנה לתחרויות איות ★ חינם להתחיל ★',
    h1Part1: 'תרגול',
    h1Part2: 'איות',
    h1Part3: 'בחינם.',
    h1Part4: 'עכשיו.',
    ...
    faqs: [
      ...
      { q: 'מתאים לכיתה שלמה?', a: 'כן. מורים יכולים להנהל תרגול לכל הכיתה (כל הכיתה עם קוד בן 6 תווים, בלי חשבונות), תחרויות דו-קרב או תרגול בודד. לוח המורה מראה דיוק לתלמיד ואילו מילים טרידו את רוב המתחרים — כך אתם יודעים מה לתרגל בחזרה.' },
  ...
  sv: {
    ...
    badgeText: '★ Stavningspraktik ★ Gratis Att Börja ★',
    h1Part1: 'Stavning',
    h1Part2: 'Praktik',
    h1Part3: 'Online.',
    h1Part4: 'Gratis.',
    ...
    faqs: [
      ...
      { q: 'Är LexiClash klassrumsklar för stavningstävlingar i skolor?', a: 'Ja. Lärare kan köra stavningsuppvärmning för hela klassen (hela klassen ansluter med en klasskod, utan elevkonton), 1v1-eliminationsmatcher eller tilldela soloträning. Lärarinstrumentpanelen visar noggrannhet per elev och vilka ord som trippade de flesta deltagarna — användbar för att rikta in granskningssessioner.' },
  ...
  ja: {
    ...
    faqs: [
      ...
      { q: 'LexiClashは学校のスペリング競争に対応していますか？', a: 'はい。教師は全クラスのスペリング暖房を実行できます（クラス全員が6文字のコードで参加、学生アカウントなし）、1v1排除戦、またはソロ練習を割り当てます。教師のダッシュボードは生徒ごとの精度と、ほとんどの競争者がつまずいた単語を示しています — レビューセッションのターゲット化に役立ちます。' },
      { q: '家で準備している個々の学生にとって無料ですか？', a: 'はい — 家庭での個人練習は無料で、ユーザーごとの料金はかかりません。ブラウザを開き、モードを選択し、練習を開始します。アカウント不要（オプションのアカウントは進捗を保存し、ストリーク追跡をロック解除します）。' },
    ],
  ...
  es: {
    ...
    badgeText: '★ Práctica de Ortografía ★ Gratis Para Empezar ★',
    h1Part1: 'Práctica',
    h1Part2: 'de',
    h1Part3: 'Ortografía.',
    h1Part4: 'Gratis.',
    ...
    faqs: [
      ...
      { q: '¿Está LexiClash lista para competencias de ortografía en escuelas?', a: 'Sí. Los maestros pueden ejecutar calentamientos de ortografía para toda la clase (toda la clase se unen con un código de 6 caracteres, sin cuentas de estudiante), torneos de eliminación 1v1 o asignar práctica solo. El panel del maestro muestra la precisión por estudiante y qué palabras tropezaron con la mayoría de los competidores — útil para dirigirse a sesiones de revisión.' },
  ...
  ru: {
    ...
    badgeText: '★ Подготовка к конкурсам ★ Бесплатный старт ★',
    h1Part1: 'Практика',
    h1Part2: 'орфографии',
    h1Part3: 'бесплатно.',
