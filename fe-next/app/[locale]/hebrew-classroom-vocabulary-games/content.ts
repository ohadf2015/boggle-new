...
const contentMap: Record<ClassroomGameLocale, LocaleContent> = {
  en: {
    ...
    heroTag: '★ FOR TEACHERS ★ FOREVER FREE ★',
    heroPart1: 'Word ',
    ...
    features: [
      ...
      { icon: '💸', text: 'Everything is free — no premium tier, no hidden charges' },
    ],
  ...
  sv: {
    ...
    metaDescription:
      'Gratis ordspel designade för klassrummet. Eleverna går med med en fyrsiffrig kod (ingen inloggning, inga konton). Live klassrumsspel, orddueller, egna ordlistor och realtidstavlor. Funkar i vilken webbläsare som helst. Upp till 30 elever.',
    ...
    twitterDescription: 'Liveordspel för klassrummet. Fyrsiffrig kod för att gå med, ingen inloggning, riktig ordöving, upp till 30 elever.',
    heroTag: '★ FÖR LÄRARE ★ ALLTID GRATIS ★',
    heroPart1: 'Ordspel ',
    ...
    features: [
      ...
      { icon: '👥', text: 'Direkt flerspelat — upp till 30 elever tillsammans' },
  ...
  ja: {
    ...
    metaDescription:
      '教室向けに設計された無料単語ゲーム。生徒は4桁のコードで参加（ログイン不要、アカウント不要）。ライブ教室ゲーム、単語デュエル、カスタム単語リスト、リアルタイムダッシュボード。どのブラウザでも動作。最大30人の生徒。',
    ...
    twitterDescription: '教室向けライブ単語ゲーム。4桁のコードで参加、ログイン不要、ほんもののボキャブラリー練習、最大30人の生徒。',
    heroTag: '★ 先生向け ★ 永遠に無料 ★',
    heroPart1: '単語 ',
    heroHighlight1: 'ゲーム',
    heroPart2: 'は教室向け。 ',
    ...
    features: [
      ...
      { icon: '👥', text: 'リアルタイムマルチプレイヤー — 最大30人の生徒が一緒に' },
      ...
      { icon: '💸', text: 'すべて無料 — プレミアム版なし、隠れた料金なし' },
    ],
  ...
  es: {
    ...
    metaDescription:
      'Juegos de palabras gratis diseñados para el aula. Los alumnos se unen con un código de 4 dígitos (sin registro, sin cuentas). Juegos de aula en vivo, duelos de vocabulario, listas de palabras personalizadas y tableros en tiempo real. Funciona en cualquier navegador. Hasta 30 alumnos.',
    ...
    twitterDescription: 'Juegos en vivo para aula. Código de 4 dígitos para unirse, sin registro, práctica real de vocabulario, hasta 30 alumnos.',
    heroTag: '★ PARA MAESTROS ★ GRATIS POR SIEMPRE ★',
    heroPart1: 'Juegos de ',
    ...
    features: [
      ...
      { icon: '👥', text: 'Multijugador en vivo — hasta 30 alumnos juntos' },
      ...
      { icon: '💸', text: 'Todo es gratis — sin versión premium, sin cargos ocultos' },
    ],
  ...
  ru: {
    ...
    metaDescription:
      'Бесплатные словесные игры для урока. Ученики присоединяются по 4-значному коду (без входа, без аккаунтов). Живые классные игры, дуэли по словарю, свои списки слов, панели в реальном времени. Работает в браузере. До 30 учеников.',
    ...
    twitterDescription: 'Живые игры по словам. 4-значный код, без входа, реальная практика лексики, до 30 учеников.',
    ...
    features: [
      ...
      { icon: '👥', text: 'Живой мультиплеер — до 30 учеников одновременно' },
