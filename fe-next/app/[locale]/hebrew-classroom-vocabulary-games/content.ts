...
const contentMap: Record<ClassroomGameLocale, LocaleContent> = {
  en: {
    ...
    features: [
      ...
      { icon: '💸', text: 'Free to start — 3 classes of 10 students, no hidden charges' },
    ],
  ...
  he: {
    ...
    features: [
      ...
      { icon: '💸', text: 'חינם להתחלה — 3 כיתות של 10 תלמידים, בלי תשלום נסתר' },
    ],
  ...
  ja: {
    ...
    features: [
      ...
      { icon: '💸', text: '無料で始められる — 3クラス・各10人、隠れた料金なし' },
    ],
  ...
  es: {
    ...
    features: [
      ...
      { icon: '💸', text: 'Gratis para empezar — 3 clases de 10 alumnos, sin cargos ocultos' },
    ],
