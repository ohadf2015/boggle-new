...
const faqs = [
  ...
  { q: 'יש חלופה ל-Quizlet בעברית בלי חשבונות לתלמידים?', a: 'כן. Quizlet Live דורש שהתלמידים יפתחו חשבונות, והגרסה החינמית כוללת פרסומות. ב-LexiClash התלמידים מצטרפים בקוד בן 4 ספרות בלי הרשמה ובלי פרסומות, ומשחקים משחק אוצר מילים חי במקום כרטיסיות. רשימת מילים קיימת אפשר פשוט להדביק לייבוא מהיר.' },
