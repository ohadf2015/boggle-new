...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Эрудит онлайн в реальном времени — бесплатно | LexiClash',
    description: 'Играй в Эрудит онлайн бесплатно в реальном времени — с друзьями или соперниками. Составляй слова, зарабатывай очки. Без скачивания, прямо в браузере!',
