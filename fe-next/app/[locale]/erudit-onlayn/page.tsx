...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Эрудит онлайн с друзьями — бесплатно, без регистрации | LexiClash',
    description: 'Эрудит онлайн бесплатно — играй с друзьями в реальном времени. Составляй слова из букв, набирай очки за длинные и редкие слова. Без скачивания, прямо в браузере.',
  ...
  return (
    <main className="min-h-screen bg-neo-navy text-neo-white">
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <RuLandingLinks locale={locale} current="erudit-onlayn" />
