...
export default function LightningRoundPageClient() {
  ...
  const [sessionId] = useState(() => `drill_lightning-round_${safeRandomUUID()}`);
  ...
  React.useEffect(() => {
    ...
    trackDrillStart({ drillType: 'lightning-round', level: drillLevel });
    ...
    return (
      <div className={cn(
        ...
        <div
          ...
          className="w-12 h-12 border-4 border-t-transparent rounded-full border-neo-lime motion-safe:animate-spin"
        />
      </div>
    );
  }
