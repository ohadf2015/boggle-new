...
const ru: DownloadLandingCopy = {
  metaTitle: 'Скачайте LexiClash — Бесплатная словесная игра для Android | Google Play',
  metaDescription:
    'Скачайте LexiClash бесплатно для Android: быстрая многопользовательская словесная игра с ежедневными испытаниями, тренингом мозга и комнатами на 2-20 игроков. Без платных стен, без регистрации. Получите в Google Play.',
  metaKeywords:
    'игра в слова android, скачать игру в слова, приложение слова бесплатное, многопользовательская словесная игра android, головоломка со словами, богл android, словесная игра google play, word game android',
  ogTitle: 'Скачайте LexiClash — Бесплатная словесная игра для Android',
  ogDescription:
    'Быстрая многопользовательская словесная игра на вашем рабочем столе. Ежедневные испытания, тренинг мозга, комнаты на 2-20 игроков. Бесплатно в Google Play.',
  ...
  introP1:
    'LexiClash — это быстрая, шумная многопользовательская словесная игра: соревнуйтесь с друзьями в поиске слов на общей сетке букв, поднимайтесь в ежедневных таблицах и тренируйте ум между раундами. Приложение для Android оставляет вас одним касанием от вашего рабочего стола.',
  introP2:
    'Бесплатно скачать, бесплатно играть. Без платных стен, без pay-to-win, без стены регистрации для начала. Установите, выберите режим и начните искать слова за считаные секунды.',
  heroImageAlt: 'Словесная игра LexiClash на телефоне Android рядом с талисманом куба зефира',

  installCtaLabel: 'ДОСТУПНО В',
  installCtaAria: 'Скачайте LexiClash в Google Play',
  playWebLabel: 'Или играйте бесплатно в браузере →',

  featuresHeading: 'Почему установить приложение',
  featuresSub: 'Всё, что делает веб-версия, плюс то, что приложение на рабочем столе делает лучше.',
  features: [
    { icon: '📲', title: 'Установка одним касанием', blurb: 'Получите в Google Play и значок LexiClash появится на вашем рабочем столе. Без платежей и сложности.' },
  ...
  comparisonHeaders: ['Функция', 'Браузер', 'Приложение для Android'],
  comparisonRows: [
    ['Установка', 'Нечего устанавливать', 'Одно касание в Google Play'],
    ['Значок на рабочем столе', 'Добавить вручную', 'Автоматически'],
    ['Ежедневные напоминания', 'Недоступно', 'Push-уведомления'],
    ['Полноэкранная игра', 'Полосы браузера', 'Полностью полноэкранно'],
    ['Обновления', 'Мгновенные', 'Автоматические через Play'],
    ['Цена', 'Бесплатно', 'Бесплатно'],
  ],
  comparisonFooter: 'Оба бесплатны и играют в одну игру. Комнаты межплатформенные: игроки приложения, браузера и iPhone могут делиться одним кодом комнаты.',

  installHeading: 'Установка в 3 касания',
  installSteps: [
    { step: '1', title: 'Откройте Google Play', sub: 'Коснитесь «Доступно в Google Play» и откроется карточка LexiClash в Play Store.' },
    { step: '2', title: 'Коснитесь Установить', sub: 'Одно касание. Приложение загружается и автоматически добавляется на ваш рабочий стол.' },
    { step: '3', title: 'Играйте', sub: 'Откройте LexiClash, выберите режим и начните искать слова. Без регистрации для начала.' },
  ],

  faqHeading: 'Вопросы о загрузке',
  faqs: [
    { q: 'Приложение LexiClash для Android бесплатно?', a: 'Да. Бесплатно скачать в Google Play и бесплатно играть. Нет платных стен и платы за выигрыш: все режимы, включая многопользовательский и тренинг мозга, разблокированы с самого начала.' },
    { q: 'Нужна ли мне учётная запись для игры?', a: 'Нет. Вы можете установить и начать играть прямо сейчас. Бесплатная учётная запись опциональна и служит только для сохранения вашего прогресса, серий и статистики между устройствами.' },
    { q: 'Будет ли работать на моём телефоне?', a: 'LexiClash совместим с современными телефонами и планшетами Android. Если на вашем устройстве работает текущая версия Android и Google Play, вы можете его установить.' },
    { q: 'Приложение то же самое, что веб-версия?', a: 'Да: одинаковые сетки, одинаковые режимы игры, одинаковые живые многопользовательские комнаты. Приложение добавляет значок на рабочем столе, полноэкранную игру и опциональные ежедневные напоминания.' },
    { q: 'Могу ли я играть с друзьями, использующими браузер или iPhone?', a: 'Да. Многопользовательские комнаты являются кроссплатформенными. Поделитесь кодом комнаты, и ваши друзья смогут присоединиться из приложения, браузера или любого телефона.' },
    { q: 'Насколько большой размер загрузки?', a: 'Это лёгкая словесная игра, поэтому загрузка небольшая и устанавливается за считаные секунды на большинстве соединений.' },
    { q: 'Как мне его получить?', a: 'Коснитесь кнопки «Доступно в Google Play» на этой странице, а затем нажмите Установить. Приложение появится на вашем рабочем столе, готовом к игре.' },
  ],

  relatedHeading: 'Исследуйте игру',
  related: [
    { title: 'Многопользовательский', sub: 'Словесные батальи в реальном времени, 2-20 игроков', hrefSuffix: '/multiplayer' },
    { title: 'Ежедневный вызов', sub: 'Новая головоломка со словами каждый день', hrefSuffix: '/daily' },
    { title: 'Тренинг мозга', sub: '5 быстрых когнитивных упражнений', hrefSuffix: '/brain' },
    { title: 'Как играть', sub: 'Выучите правила за минуту', hrefSuffix: '/how-to-play' },
  ],

  finalCtaHeading: 'Получите LexiClash для Android',
  finalCtaBody: 'Бесплатно скачать, бесплатно играть, все режимы разблокированы. Положите словесную игру на ваш рабочий стол и начните серию сегодня.',
