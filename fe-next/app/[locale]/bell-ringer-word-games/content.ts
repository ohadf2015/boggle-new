...
const contentMap: Record<BellRingerLocale, LocaleContent> = {
  en: {
    ...
    faqs: [
      ...
      { q: 'Is it free?', a: 'Yes — free for up to 3 classes of 50 students, and a live game holds 50 players. Teacher Pro ($9/month) adds unlimited classes and the progress reports.' },
  ...
  he: {
    ...
    faqs: [
      ...
      { q: 'זה בחינם?', a: 'כן — חינם עד 3 כיתות של 50 תלמידים, ומשחק חי מכיל 50 שחקנים. Teacher Pro ($9 לחודש) מוסיף כיתות ללא הגבלה ודוחות התקדמות.' },
  ...
  ja: {
    ...
    faqs: [
      ...
      { q: '無料ですか？', a: 'はい — 3クラス、1クラス50人まで無料です。ライブゲームは50人まで参加できます。Teacher Pro（月$9）でクラス数無制限と進捗レポートが使えます。' },
  ...
  es: {
    ...
    faqs: [
      ...
      { q: '¿Es gratis?', a: 'Sí — gratis para hasta 3 clases de 50 alumnos, y una partida en vivo admite 50 jugadores. Teacher Pro ($9/mes) añade clases ilimitadas y los informes de progreso.' },
