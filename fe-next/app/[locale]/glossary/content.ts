...
const enTerms: GlossaryTerm[] = [
  ...
  { term: 'Vocabulary', definition: 'The dictionary of valid words accepted by the game. LexiClash supports multiple language dictionaries for Hebrew, English, Swedish, Japanese, Spanish, and Russian.', related: ['Word Validation'] },
...
export const contentByLocale: Record<string, GlossaryContent> = {
  ...
  he: {
    ...
    terms: [
      ...
      { term: 'אוצר מילים', definition: 'מילון המילים החוקיות שהמשחק מקבל. לקסיקלאש תומך במילונים בעברית, אנגלית, שוודית, יפנית, ספרדית ורוסית.', related: ['אימות מילים'] },
