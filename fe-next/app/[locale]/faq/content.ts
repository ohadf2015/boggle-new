...
export const contentByLocale: Record<string, FAQContent> = {
  ...
  ru: {
    ...
    hereToHelp: 'Мы здесь, чтобы помочь! Свяжитесь с нами в любой момент.',
    contactUs: 'Свяжитесь с нами',
    learnMore: 'Хотите узнать больше?',
    blogCta: 'Посетите наш блог для советов, стратегий и науки о словесных играх.',
    blogScienceTitle: 'Наука о словесных играх',
    blogStrategiesTitle: 'Стратегии ежедневного испытания',
    blogViewAll: 'Посмотреть все статьи →',
    categories: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'Вы можете играть как гость или создать учетную запись с использованием входа Google. Наличие учетной записи позволяет сохранять прогресс, отслеживать статистику, соревноваться в таблицах лидеров и играть на нескольких устройствах.',
      },
      {
        category: 'gettingStarted',
        question: 'LexiClash бесплатна?',
        answer: 'Да! LexiClash полностью бесплатна. Все игровые режимы, включая одиночную игру, многопользовательскую игру и ежедневные испытания, доступны без каких-либо затрат.',
      },
      {
        category: 'gameplay',
        question: 'Как набирать очки?',
        answer: 'Очки присуждаются на основе длины слова и стоимости букв. Более длинные слова дают больше очков. Редкие буквы имеют более высокую стоимость. Бонусные очки присуждаются за нахождение всех слов на поле.',
      },
      {
        category: 'gameplay',
        question: 'Какие игровые режимы доступны?',
        answer: 'LexiClash предлагает три основных режима: (1) Одиночная игра - тренировка против ИИ с различными уровнями сложности, (2) Многопользовательская - матчи в реальном времени против других игроков, (3) Ежедневное испытание - соревнуйтесь над той же головоломкой, что и игроки со всего мира.',
      },
      {
        category: 'gameplay',
        question: 'Как работает ежедневное испытание?',
        answer: 'Каждый день в полночь по UTC создается новая головоломка, в которой все игроки мира могут попытаться участвовать. У вас есть один шанс в день найти как можно больше слов. Ваш результат записывается в ежедневную таблицу лидеров.',
      },
      {
        category: 'gameplay',
      ...
      },
      {
        ...
        answer: 'LexiClash работает на всех современных устройствах, включая настольные компьютеры, планшеты и смартфоны. Мы поддерживаем последние версии браузеров Chrome, Firefox, Safari и Edge.',
      },
      {
        category: 'technical',
        question: 'Нужно ли подключение к интернету для игры?',
        answer: 'Да, подключение к интернету требуется для многопользовательской игры и ежедневных испытаний. Однако вы можете играть в режиме одиночной игры без интернета, если ранее загружали игру.',
      },
      {
        category: 'technical',
        question: 'Как сообщить об ошибке или технической проблеме?',
        answer: 'Если вы столкнулись с ошибкой, свяжитесь с нами по адресу lexiclash.game@gmail.com или напишите нам в Instagram @lexi.clash. Включите подробности о том, что произошло, и какое устройство/браузер вы использовали.',
      },
      {
        category: 'account',
        question: 'Как изменить имя пользователя или профиль?',
        answer: 'Перейдите в раздел "Настройки" (значок шестеренки в заголовке) и откройте раздел профиля. Там вы сможете обновить имя пользователя, аватар и другие данные профиля.',
      },
      {
        category: 'account',
        question: 'Можно ли играть на нескольких устройствах?',
        answer: 'Да! Если вы создадите учетную запись с использованием входа Google, ваш прогресс, статистика и настройки будут автоматически синхронизированы на всех ваших устройствах.',
      },
      {
        category: 'account',
        question: 'Как удалить свою учетную запись?',
        answer: 'Чтобы удалить учетную запись, перейдите в раздел "Настройки" > "Аккаунт" > "Удалить аккаунт". Это действие необратимо и удалит все ваши данные, включая статистику, достижения и историю игр.',
      },
      {
        category: 'privacy',
        question: 'Мои данные в безопасности?',
        answer: 'Да. Мы серьезно относимся к конфиденциальности и собираем только необходимые данные для работы игры. Мы используем стандартное шифрование отрасли и никогда не продаем вашу личную информацию. Полную информацию см. в нашей политике конфиденциальности.',
      },
      {
        category: 'privacy',
        question: 'LexiClash показывает объявления?',
        answer: 'Мы сотрудничаем с Google AdMob для показа релевантных объявлений. Объявления помогают нам сохранять игру бесплатной для всех. Вы можете узнать больше о персонализации объявлений и возможностях отказа в нашей политике конфиденциальности.',
      },
      {
        category: 'privacy',
        question: 'Могу ли я отказаться от сбора данных?',
        answer: 'Хотя некоторый сбор данных необходим для работы игры (например, ваше имя пользователя и результаты), вы можете отказаться от аналитики и персонализированных объявлений в разделе "Настройки" > "Конфиденциальность".',
      },
    ],
  },
};
