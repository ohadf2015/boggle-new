    ...
    items: [
      {
        ...
        answer: 'LexiClash הוא משחק מילים מרובה משתתפים שבו אתם מתחרים נגד חברים או יריבי AI כדי למצוא מילים על לוח משותף. שחקו לבד, התמודדו באתגרים יומיים או התחרו במשחקים בזמן אמת בעברית, אנגלית, שוודית ויפנית.',
      },
      {
        category: 'gettingStarted',
      ...
      },
      {
        ...
        answer: 'נקודות ניתנות על פי אורך המילה וערך האותיות. מילים ארוכות שוות יותר נקודות. אותיות נדירות שוות יותר. בונוס ניתן על מציאת כל המילים בלוח.',
      },
      {
        category: 'gameplay',
      ...
      {
        category: 'gameplay',
        question: 'אפשר לשחק במספר שפות?',
        answer: 'כן! LexiClash תומך בעברית, אנגלית, שוודית ויפנית. אפשר להחליף שפות בהגדרות. לכל שפה יש מילון משלה וטבלאות מובילים נפרדות.',
      },
      {
        category: 'technical',
      ...
      },
      {
        ...
        answer: 'כן, חיבור לאינטרנט נדרש למשחק מרובה משתתפים ולאתגרים יומיים. עם זאת, אפשר לשחק במצב יחיד אופליין אם טענתם את המשחק קודם.',
      },
      {
        category: 'technical',
        question: 'איך מדווחים על באג או בעיה טכנית?',
        answer: 'אם נתקלתם בבאג, אנא צרו קשר ב-lexiclash.game@gmail.com או פנו אלינו באינסטגרם @lexi.clash. כללו פרטים על מה שקרה ובאיזה מכשיר/דפדפן השתמשתם.',
      },
      {
        category: 'account',
        question: 'איך משנים שם משתמש או פרופיל?',
        answer: 'עברו להגדרות (אייקון גלגל שיניים בכותרת) ונווטו לחלק הפרופיל. שם תוכלו לעדכן את שם המשתמש, האווטאר ופרטי פרופיל נוספים.',
      },
      {
        category: 'account',
