...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Игры в слова онлайн с друзьями — бесплатно | LexiClash',
    description: 'Бесплатные игры в слова онлайн с друзьями — без регистрации и скачивания. Составляй слова из букв на общем поле в реальном времени. Как «Балда» и «Эрудит», только быстрее. 6 режимов, в браузере.',
  ...
  return (
    <main className="min-h-screen bg-neo-navy text-neo-white">
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <RuLandingLinks locale={locale} current="igry-v-slova-onlayn" />
