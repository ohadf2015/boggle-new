...
const contentMap: Record<SubstituteLocale, LocaleContent> = {
  ...
  he: {
    ...
    faqs: [
      ...
      { q: 'זה בחינם?', a: 'כן — לגמרי חינם, בלי מסלול פרימיום. עד 30 תלמידים במשחק חי אחד.' },
  ...
  sv: {
    ...
    faqs: [
      ...
      { q: 'Är det gratis?', a: 'Ja — helt gratis, ingen premiumnivå. Upp till 30 elever per live-spel.' },
      { q: 'Vilka årskurser passar det?', a: 'Starkast från mellanstadiet upp till gymnasiet och vuxen-ESL. Svårighetsgraden är CEFR-skalad (A1–C2), så vikarien kan välja en nivå som passar vilken klass som helst.' },
  ...
  es: {
    ...
    faqs: [
      ...
      { q: '¿Es gratis?', a: 'Sí, totalmente gratis, sin plan premium. Hasta 30 alumnos por partida en vivo.' },
  ...
  ru: {
    ...
    faqs: [
      ...
      { q: 'Это бесплатно?', a: 'Да — полностью бесплатно, без платного тарифа. До 30 учеников в одной живой игре.' },
