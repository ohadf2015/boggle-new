...
describe('/es/juego-de-palabras-multijugador metadata', () => {
  it('uses a keyword-led title and a CTR-focused description for scrabble online', async () => {
    ...
    expect(meta.title).toBe('Scrabble Online en Español Gratis — Sin App | LexiClash');
    expect(meta.description).toBe(
      'Juega Scrabble en español online gratis — sin app, sin registro. Hasta 50 jugadores en tiempo real. ¡Sin descarga, empieza ya! →',
    );
