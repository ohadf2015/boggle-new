...
describe('/es/juego-de-palabras-multijugador metadata', () => {
  it('uses a keyword-led title and a CTR-focused description for scrabble online', async () => {
    ...
    expect(meta.title).toBe('Scrabble Online Gratis en Español — 50 Jugadores | LexiClash');
    expect(meta.description).toBe(
      'Juega Scrabble online en español gratis con hasta 50 jugadores en tiempo real. Sin app, sin registro — empieza en 10 segundos →',
    );
