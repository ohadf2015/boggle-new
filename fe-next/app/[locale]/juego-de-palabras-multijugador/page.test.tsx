...
describe('/es/juego-de-palabras-multijugador metadata', () => {
  it('uses a keyword-led title and a CTR-focused description for scrabble online', async () => {
    ...
    expect(meta.title).toBe('Scrabble Online Gratis en Español — Sin App ni Registro | LexiClash');
    expect(meta.description).toBe(
      'Juega Scrabble online gratis en español ahora — sin registro, sin app. Empieza en 10 segundos con hasta 50 jugadores en tiempo real. →',
    );
