...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Juega Scrabble online gratis en español con hasta 50 personas — sin registro ni descarga. Sala lista en 10 segundos. ¡Empieza ahora →',
    ...
    openGraph: {
      title: 'Jugar Scrabble Online en Español Gratis — Multijugador | LexiClash',
      description: 'Juega Scrabble online gratis en español con hasta 50 personas — sin registro ni descarga. Sala lista en 10 segundos.',
      locale: 'es_ES',
      type: 'website',
      url: pageUrl,
      images: [
