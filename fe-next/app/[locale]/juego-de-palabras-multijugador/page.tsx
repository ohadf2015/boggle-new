...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Juega Scrabble online en español gratis — sin registro, sin descarga. Crea sala en 10 seg, 2–50 jugadores en tiempo real. ¡Empieza ya →',
    ...
    openGraph: {
      title: 'Scrabble Online en Español Gratis — Sin Registro | LexiClash',
      description: 'Juega Scrabble online en español gratis — sin registro, sin descarga. Crea sala en 10 seg, 2–50 jugadores en tiempo real.',
      locale: 'es_ES',
      type: 'website',
      url: pageUrl,
      images: [
