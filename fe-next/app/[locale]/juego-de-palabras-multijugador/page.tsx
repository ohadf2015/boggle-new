...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Scrabble Online Gratis en Español — Sin Turnos ni Registro',
    description: 'Juega Scrabble online en español gratis — tiempo real, sin esperar turnos. Sin descarga ni registro. Sala en 1 clic, invita con enlace. Hasta 50 jugadores.',
