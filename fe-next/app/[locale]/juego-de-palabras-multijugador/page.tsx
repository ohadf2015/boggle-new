...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Scrabble Online en Español Gratis — 50 Jugadores, Sin Registro | LexiClash',
    description: 'Juega Scrabble en español gratis — sin app, sin registro. Hasta 50 jugadores en tiempo real. ¡Crea tu sala en 10 segundos! →',
