...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Juega Scrabble online en español gratis con hasta 50 amigos — sala en 10 seg, sin registro ni descarga. El mejor Scrabble multijugador en español. ¡Empieza ahora →',
