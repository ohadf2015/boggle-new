...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Juega Scrabble online en español gratis con hasta 50 jugadores en tiempo real — sin registro, sin descarga. Crea sala en 10 segundos. ¡Juega ahora! →',
