...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: '¡Juega ya! Alternativa a Scrabble en español: 50 jugadores en tiempo real, sala lista en 10 seg. Sin registro ni descarga. Empieza →',
    ...
    openGraph: {
      title: 'Scrabble Online Gratis en Español · Multijugador | LexiClash',
      description: 'Alternativa a Scrabble en español: 50 jugadores en tiempo real, sala lista en 10 seg. Sin registro ni descarga.',
      locale: 'es_ES',
      type: 'website',
      url: pageUrl,
      images: [
