...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Juega Scrabble online en español gratis con hasta 50 amigos en tiempo real — sin app, sin turnos, sin registro. ¡Crea tu sala y comparte el link! →',
