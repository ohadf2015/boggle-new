...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Scrabble Online en Español Gratis — Sin App ni Registro | LexiClash',
    description: 'Juega Scrabble online gratis en español — sin app, sin registro. Hasta 50 jugadores en tiempo real. ¡Empieza ya! →',
