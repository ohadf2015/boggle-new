...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Scrabble online en español con hasta 50 jugadores en tiempo real — sin turnos. Sala en 10 s, invita con enlace. Sin registro ni descarga. ¡Juega ahora!',
    ...
    openGraph: {
      title: 'Scrabble Online Gratis en Español · Multijugador | LexiClash',
      description: 'Hasta 50 jugadores en tiempo real, sin turnos. Crea sala en 10 s, invita por enlace. Sin registro ni descargas.',
      locale: 'es_ES',
      type: 'website',
      url: pageUrl,
      images: [
    ...
    twitter: {
      ...
      title: 'Scrabble Online Gratis en Español · Multijugador | LexiClash',
      description: 'Juega scrabble online en español con hasta 50 jugadores en tiempo real — no por turnos. Sala con enlace, sin registro.',
