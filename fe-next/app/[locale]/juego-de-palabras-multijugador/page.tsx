...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Scrabble Gratis Online en Español — Sin Registro | LexiClash',
    description: '¡Juega scrabble gratis en español — sin registro ni descarga! Sala lista en 10 seg, hasta 50 jugadores en tiempo real. ¡Empieza ya →',
    ...
    openGraph: {
      title: 'Scrabble Gratis Online en Español — Sin Registro | LexiClash',
      description: '¡Juega scrabble gratis en español — sin registro ni descarga! Sala lista en 10 seg, hasta 50 jugadores en tiempo real.',
      locale: 'es_ES',
      type: 'website',
      url: pageUrl,
      images: [
