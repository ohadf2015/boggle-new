...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Juega scrabble online en español gratis con 2-50 amigos en tiempo real — sin registro, sin descarga. Crea sala en segundos, invita con enlace.',
    ...
    openGraph: {
      title: 'Scrabble Online en Español Gratis — Sin Registro | LexiClash',
      description: 'Juega scrabble online en español gratis con amigos. Crea sala, invita por enlace. 2-50 jugadores, sin descargas.',
      locale: 'es_ES',
      type: 'website',
      url: pageUrl,
      images: [
    ...
    twitter: {
      ...
      title: 'Scrabble Online en Español Gratis — Sin Registro | LexiClash',
      description: 'Juega scrabble online en español gratis. Sala con enlace, tiempo real, sin registro. ¡2-50 jugadores!',
