...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Juega scrabble en español con amigos en tiempo real — crea sala en 10 s, invita por enlace. Hasta 50 jugadores, sin registro. ¡Empieza ahora!',
    ...
    openGraph: {
      title: 'Scrabble Online en Español Gratis · Multijugador | LexiClash',
      description: 'Scrabble online en español gratis — crea sala en 10 s, invita por enlace. Hasta 50 jugadores, sin registro. Compite en tiempo real.',
      locale: 'es_ES',
      type: 'website',
      url: pageUrl,
      images: [
