...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Scrabble Online Español Multijugador Gratis | LexiClash',
    description: 'Scrabble online en español multijugador — sin registro, sin app. Hasta 50 jugadores en tiempo real. Sala lista en 10 segundos. ¡Juega gratis ahora →',
    ...
    openGraph: {
      title: 'Scrabble Online Español Multijugador Gratis | LexiClash',
      description: 'Scrabble online en español multijugador — sin registro, sin app. Hasta 50 jugadores en tiempo real. Sala lista en 10 segundos.',
      locale: 'es_ES',
      type: 'website',
      url: pageUrl,
      images: [
