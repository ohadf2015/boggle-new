...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Scrabble Online en Español — Sin Registro Gratis | LexiClash',
    description: 'Juega scrabble online en español gratis: crea sala, compite con 50 jugadores en tiempo real. Sin registro, sin descarga. ¡Empieza ahora!',
