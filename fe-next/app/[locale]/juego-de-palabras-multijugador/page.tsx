...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Scrabble Online en Español Gratis · Sin Registro · Multijugador | LexiClash',
    description: 'Juega scrabble online en español gratis ahora — sin registro, sin descarga. Crea sala en 10 seg, hasta 50 jugadores en tiempo real. ¡Empieza ya!',
