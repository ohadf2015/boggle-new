...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Scrabble en Español Online Gratis — Hasta 50 Jugadores | LexiClash',
    description: 'Juega Scrabble en español gratis con hasta 50 amigos en tiempo real. Sin app, sin registro. ¡Comparte un enlace y empieza ya! →',
