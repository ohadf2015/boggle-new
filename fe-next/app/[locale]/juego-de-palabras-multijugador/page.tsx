...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Scrabble Online en Español — Gratis, Tiempo Real | LexiClash',
    description: 'Sin turnos, todo en tiempo real: scrabble gratis en español. Sala lista en 10 seg, invita con enlace. Sin registro ni descarga. ¡Hasta 50 jugadores!',
