...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Scrabble Online Gratis en Español — Sin Turnos, Sin Registro',
    description: 'Juega scrabble online gratis en español — tiempo real, sin turnos. Sala en 10 seg, invita por enlace. 50+ jugadores. Sin registro ni descarga. ¡Empieza!',
