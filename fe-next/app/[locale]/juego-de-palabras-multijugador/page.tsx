...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Scrabble Online en Español — Juega Gratis Ahora | LexiClash',
    description: '¿Buscas scrabble online en español? Juega gratis en LexiClash — tiempo real, sala en 1 clic, invita por enlace. Sin registro ni descarga. ¡Hasta 50 jugadores!',
