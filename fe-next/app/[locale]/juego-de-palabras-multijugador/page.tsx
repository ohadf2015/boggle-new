...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Juega Scrabble online en español gratis — sala en 10 seg, 50 jugadores en tiempo real, 10.000+ palabras. Sin registro. ¡Empieza ahora →',
    ...
    openGraph: {
      title: 'Scrabble Online en Español Gratis — Sin Registro | LexiClash',
      description: 'Juega Scrabble online en español gratis — sala en 10 seg, 50 jugadores en tiempo real, 10.000+ palabras. Sin registro.',
      locale: 'es_ES',
      type: 'website',
      url: pageUrl,
      images: [
