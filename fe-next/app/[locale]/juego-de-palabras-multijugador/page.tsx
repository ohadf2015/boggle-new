...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Juega Scrabble en español gratis — sin registro, sin descarga. Sala en 10 seg, hasta 50 jugadores en tiempo real. 10,000+ palabras. ¡Empieza! →',
    ...
    openGraph: {
      title: 'Scrabble Online Gratis en Español — Sin Registro | LexiClash',
      description: 'Juega Scrabble en español gratis — sin registro, sin descarga. Sala en 10 seg, hasta 50 jugadores en tiempo real. 10,000+ palabras.',
      locale: 'es_ES',
      type: 'website',
      url: pageUrl,
      images: [
