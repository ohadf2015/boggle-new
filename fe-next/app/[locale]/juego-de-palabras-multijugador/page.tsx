...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Juega scrabble en línea gratis en español — sin registro, sin descarga. Sala lista en 10 seg, hasta 50 jugadores en tiempo real. ¡Entra ahora →',
    ...
    openGraph: {
      title: 'Juega Scrabble Online en Español Gratis — Tiempo Real, Sin Registro | LexiClash',
      description: 'Juega scrabble en línea gratis en español — sin registro, sin descarga. Sala lista en 10 seg, hasta 50 jugadores en tiempo real. ¡Entra ahora →',
      locale: 'es_ES',
      type: 'website',
      url: pageUrl,
