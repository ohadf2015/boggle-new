...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Free Multiplayer Word Game Online — No Signup | LexiClash',
    description: 'Free multiplayer word game — real-time Boggle-style battles online. Create a room, invite 2-20+ friends, compete instantly. No download, no signup.',
