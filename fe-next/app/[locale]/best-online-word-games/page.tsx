...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Best Online Word Games 2026 — 9 Free Picks | LexiClash',
    description: 'Best free online word games 2026, honestly ranked: Wordle, NYT Connections, LexiClash & more — no download, no signup.',
