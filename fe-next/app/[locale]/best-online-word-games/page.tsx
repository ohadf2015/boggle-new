...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Most Popular Online Word Games 2026 — 9 Honest Picks | LexiClash',
    ...
    openGraph: {
      title: 'Most Popular Online Word Games 2026 — 9 Honest Picks',
      description: 'Most popular online word games of 2026, honestly ranked. Wordle, NYT Connections, LexiClash & more — no download required.',
      locale: 'en_US',
      type: 'website',
      url: pageUrl,
    ...
    twitter: {
      ...
      title: 'Most Popular Online Word Games 2026 — 9 Honest Picks',
      description: 'Most popular online word games of 2026, honestly ranked. No download required.',
