...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Best Online Word Games 2026 — Top 9 Free Picks, No Download',
    description: 'Best online word games of 2026, honestly ranked. Wordle, NYT Connections, Strands, Spelling Bee, LexiClash & more. Play free in your browser — no download, no signup.',
