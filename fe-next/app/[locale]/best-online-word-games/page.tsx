...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Ranked: 9 best online word games of 2026 — Wordle, NYT Connections, Scrabble GO, LexiClash & more. Honest pros & cons. Find the right one in 2 minutes.',
