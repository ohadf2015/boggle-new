...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Best free browser word games of 2026, honestly ranked: Wordle, NYT Connections, LexiClash & 6 more. No download. Pros, cons & our pick in 2 minutes.',
    ...
    openGraph: {
      title: 'Best Free Browser Word Games 2026 — 9 Honest Picks',
      description: 'Best free browser word games 2026, honestly ranked. Wordle, NYT Connections, LexiClash & more — no download required.',
      locale: 'en_US',
      type: 'website',
      url: pageUrl,
