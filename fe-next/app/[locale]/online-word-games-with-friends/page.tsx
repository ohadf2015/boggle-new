...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Words With Friends Online Free — Instant Play, No App | LexiClash',
    description: 'Play Words With Friends free online — no app, no account, no turn-waiting. Real-time word battles for 2–50 players. Share a link, start instantly →',
