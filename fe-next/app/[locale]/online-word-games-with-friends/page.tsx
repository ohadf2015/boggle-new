...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Words With Friends Online Free — Play Instantly, No App | LexiClash',
    description: 'Play Words With Friends online free — no app, no account. Real-time word battles for 2–50 players. Share a link and everyone joins instantly →',
