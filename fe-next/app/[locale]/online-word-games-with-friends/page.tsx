...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Words With Friends Online Free — Real-Time, No App | LexiClash',
    description: 'Play Words With Friends free online — no app, no account needed. Real-time word battles for 2–50 players. Share a link, everyone joins instantly →',
