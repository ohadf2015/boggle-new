...
const seoContent: Record<string, {
  ...
  he: {
    ...
    description:
      'LexiClash הוא משחק מילים מרובה משתתפים חינמי בעברית שמשלב את חיפוש המילים על לוח אותיות בסגנון בוגל עם משחקיות תחרותית בזמן אמת בסגנון סקרבל. מצאו מילים על לוח משותף, התחרו ראש בראש אונליין נגד חברים או זרים, וטפסו בטבלת המובילים — הכל ישירות בדפדפן, ללא הורדה וללא הרשמה. שחקו בעברית, אנגלית, שוודית, יפנית או ספרדית במגוון מצבי משחק: קלאסי, ציד מילים, בלאסט, גלגל מילים (מילת היום), מצב הרפתקה עם 50+ שלבים, ואימוני מוח לשיפור אוצר מילים, זיכרון ומהירות עיבוד. LexiClash כולל גם מצב מסיבה למשחק קבוצתי על מסך טלוויזיה משותף עם הטלפונים כשלטים.',
    features: [
    ...
    faq: [
      {
        ...
        answer:
          'LexiClash הוא משחק מילים מרובה משתתפים חינמי שבו מוצאים מילים על לוח אותיות בזמן אמת. החליקו או הקלידו כדי לחבר אותיות סמוכות ולהרכיב מילים לפני שהטיימר נגמר. ככל שהמילה ארוכה ונדירה יותר, כך תקבלו יותר נקודות. ניתן לשחק לבד, נגד AI, או לאתגר חברים בחדרים פרטיים.',
      },
      {
        question: 'האם LexiClash חינמי לשחק?',
        answer:
          'כן — LexiClash חינמי לחלוטין, ללא הורדה וללא צורך בחשבון. פתחו בדפדפן והתחילו לשחק מיד. אין תשלומים, אין מנגנוני "צפייה בפרסומות כדי לפתוח", ואין מצבי משחק פרימיום.',
      },
      {
        question: 'במה LexiClash שונה מבוגל, סקרבל או וורדל?',
        answer:
          'בניגוד לסקרבל (הנחת אריחים בתורות) או וורדל (ניחוש יומי בודד), LexiClash הוא ציד מילים תחרותי בזמן אמת על לוח משותף. כולם משחקים בו-זמנית תחת לחץ זמן, עם פידים חיים של ניקוד ושרשראות קומבו. בוגל פוגש אי-ספורט — אותו רעיון של חיפוש על הלוח, אבל מרובה משתתפים, עם ניקוד, ומהיר.',
      },
      {
