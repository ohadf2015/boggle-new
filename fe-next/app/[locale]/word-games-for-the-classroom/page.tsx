      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <section data-testid="hero-ctas" className="mb-12">
          ...
          <div className="mt-3 flex flex-wrap gap-x-6 gap-y-2 text-sm font-bold">
            <Link href={`/${locale}/education/duels`} className="text-neo-cyan underline underline-offset-2 transition-colors hover:text-neo-cyan/80">
              {c.ctaCduel}
            </Link>
            <Link href={`/${locale}/vocabulary-games-for-middle-school`} className="text-neo-pink underline underline-offset-2 transition-colors hover:text-neo-pink/80">
              {c.ctaMiddleSchool}
            </Link>
          </div>
        </section>
