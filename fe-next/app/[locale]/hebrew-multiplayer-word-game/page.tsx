...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'משחק מילים מרובה משתתפים בעברית - בוגל וסקראבל אונליין | לקסיקלאש',
    description: 'משחק מילים מרובה משתתפים בעברית! צרו חדר, שלחו לינק לחברים והתחרו בזמן אמת. 10,000+ מילים בעברית, ללא הרשמה, חינם לגמרי. מושלם לערבי משפחה ומסיבות.',
    ...
    openGraph: {
      title: 'משחק מילים בעברית - בוגל וסקראבל אונליין | לקסיקלאש',
      description: 'משחק מילים מרובה משתתפים בעברית! צרו חדר, שלחו לינק, התחרו בזמן אמת. חינם וללא הרשמה!',
      locale: 'he_IL',
      type: 'website',
      url: pageUrl,
      images: [
