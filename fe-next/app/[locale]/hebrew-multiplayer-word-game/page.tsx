...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'סקראבל ובוגל אונליין בעברית — משחק מילים מרובה משתתפים, חינם | לקסיקלאש',
    description: 'שחקו סקראבל ובוגל אונליין בעברית — 50 שחקנים בזמן אמת, ללא הרשמה, חינם לגמרי. צרו חדר, שלחו לינק, התחרו עכשיו!',
    ...
    openGraph: {
      title: 'סקראבל ובוגל אונליין בעברית — משחק מילים, חינם | לקסיקלאש',
      description: 'שחקו סקראבל ובוגל אונליין בעברית — 50 שחקנים בזמן אמת, ללא הרשמה, חינם לגמרי. צרו חדר, שלחו לינק!',
      locale: 'he_IL',
      type: 'website',
      url: pageUrl,
      images: [
