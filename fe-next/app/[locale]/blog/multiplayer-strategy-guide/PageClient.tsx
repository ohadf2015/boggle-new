...
export default function MultiplayerStrategyPageClient(): React.ReactElement {
  ...
  const blogIndexContent = {
    en: {
      ...
      'leaderboard-elo-explained': { title: 'How the LexiClash Leaderboard Works', excerpt: 'ELO ratings, rank tiers, and seasons explained from the actual code.', readTime: '9 min read', category: 'Guide' },
    },
  };
    ...
    <div className={cn(
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 page-content-safe">
        ...
        <div className={cn(
          ...
          <RelatedArticles
            currentSlug="multiplayer-strategy-guide"
            locale={locale}
