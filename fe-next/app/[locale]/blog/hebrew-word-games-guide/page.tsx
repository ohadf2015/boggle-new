...
const metaTitles: Record<string, string> = {
  ...
  he: 'סקריבל בעברית חינם | מדריך מלא למשחק מילים | LexiClash',
...
const metaDescriptions: Record<string, string> = {
  ...
  he: 'שחק סקריבל בעברית חינם ועכשיו! ללא הורדה ולא הרשמה. עד 50 שחקנים בזמן אמת. מדריך מלא לאתגרי המשחק — אתגר מילים יומי כלול. →',
