...
export default function AlternativasAScrabblePageClient(): React.ReactElement {
  ...
  const relatedHeading = relatedHeadingByLocale[locale] || relatedHeadingByLocale.es;
  const relatedArticlesData = [
    ...
    { slug: 'free-word-games-online', title: 'Free Word Games Online: The Honest Guide', excerpt: '', readTime: '11 min read', category: 'Guide', image: '' },
    { slug: 'boggle-vs-words-with-friends', title: 'Boggle vs Words with Friends', excerpt: '', readTime: '8 min read', category: 'Versus', image: '' },
    ...
    <div className={cn(
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 page-content-safe">
        ...
        <div className={cn(
          ...
          <RelatedArticles
            currentSlug="alternativas-a-scrabble"
            locale={locale}
