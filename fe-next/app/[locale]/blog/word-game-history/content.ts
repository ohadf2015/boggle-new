...
But here's the thing: the history of word games is genuinely one of the wildest, most unexpected stories in all of human culture. It involves ancient Egyptian riddles, medieval monks with too much free time, a bitter intellectual property dispute that tore apart friendships, a newspaper craze that got people fired from their jobs, and a Welsh software engineer who accidentally created a global phenomenon during lockdown.

If you think word games are just a casual hobby, buckle up. This story has more plot twists than a telenovela.`,
      },
      {
...
But the real revolution wouldn't come until the industrial age, when mass literacy, cheap paper, and newspapers created the conditions for word games to go truly mainstream.`,
      },
      {
        ...
        content: `Let me tell you about Alfred Mosher Butts, because his story is both inspiring and infuriating.
...
This is a pattern we'll see again with word games: the creators rarely capture the value they create. Remember that when we get to Wordle.`,
      ...
      {
        title: 'The Crossword Craze: When Word Games Went Viral (1920s Edition)',
        content: `Before Scrabble, there was the crossword — and its rise was absolutely bonkers.
...
The book sold over 350,000 copies in its first year. Crossword puzzle books became the hottest gift in America. Newspapers that didn't run crosswords started losing subscribers to those that did. The New York Times — which would eventually become synonymous with crosswords — initially refused to run them, calling them "a primitive form of mental exercise" in a snooty 1924 editorial. They didn't start publishing crosswords until 1942. Even then, they justified it as a "wartime diversion."
...
This is what word games do to people. They've been making us slightly unhinged for a century.`,
      ...
      {
        title: 'Boggle: The Stay-at-Home Dad Who Changed Everything',
...
This was revolutionary. Scrabble and crosswords were sequential, cerebral, patient activities. Boggle was frantic, competitive, and visceral. It turned word games from a solitary intellectual exercise into a social experience with genuine tension and excitement.
...
What I love about Boggle is that it democratized word games in a way Scrabble never quite did. In Scrabble, experienced players have a massive advantage — they know the two-letter words, the Q-without-U words, the obscure high-scoring plays. The learning curve is steep. Boggle is more egalitarian. A twelve-year-old with a good eye for patterns can beat a literature professor. Speed and pattern recognition matter as much as vocabulary size.

This is the lineage that LexiClash inherits, by the way. That core mechanic — everyone plays simultaneously on the same grid, racing against the clock — that's pure Boggle DNA.`,
      },
      {
        title: 'The Digital Revolution: Words With Friends and the Mobile Era',
...
Let's be honest: Words With Friends was Scrabble. The board was slightly different, the tile distribution was slightly different, but the core gameplay was identical. Hasbro sued. They eventually settled, and Zynga (which had acquired the game) paid an undisclosed sum. But by then, the genie was out of the bottle.
...
Then came a wave of mobile word games: Wordament (Microsoft's real-time multiplayer word search), Ruzzle (basically mobile Boggle), Word Cookies, Wordscapes, and dozens more. The market exploded. By 2020, word games were one of the most profitable categories in mobile gaming.
...
But something was missing. Most of these games were designed around monetization — loot boxes, energy systems, advertising. The actual word game experience was secondary to the business model. The soul of the thing was getting squeezed out.`,
      ...
      {
        title: 'The Wordle Phenomenon: Lightning in a Bottle',
...
One puzzle per day meant everyone was solving the same puzzle. This created shared experience. You could discuss it without spoiling it (those colored squares people shared on social media were genius).
...
Here's what interests me most about Wordle: it proved that word games don't need complex mechanics to captivate people. The appeal is in the language itself — the satisfaction of narrowing down possibilities, the "aha" moment when the letters click into place. That's the same dopamine hit people have been chasing since Egyptian scribes tested each other with riddles four thousand years ago.`,
      },
      {
