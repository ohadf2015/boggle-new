...
const metaTitles: Record<string, string> = {
  en: 'Best Games Like Boggle in 2026: 6 Honest Reviews',
...
const metaDescriptions: Record<string, string> = {
  en: 'Tested 6 games like Boggle in 2026 — Wordle, Words With Friends, Wordscapes, LexiClash. Which are pay-to-win? Which are free? Honest reviews, no download.',
