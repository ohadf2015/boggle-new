...
const metaTitles: Record<string, string> = {
  en: 'Best Boggle Alternatives 2026 — Free Word Games Like Boggle',
...
const metaDescriptions: Record<string, string> = {
  en: '6 Boggle alternatives tested in 2026 — find free word games like Boggle with no download. Wordle, Words With Friends, LexiClash ranked honestly.',
