...
const metaTitles: Record<string, string> = {
  en: '6 Best Boggle Alternatives & Apps in 2026 — Tested | LexiClash',
...
const metaDescriptions: Record<string, string> = {
  en: 'Best boggle alternatives tested: Wordle, Words With Friends, Wordscapes, LexiClash. Skip the pay-to-win apps. Free word games like boggle, no download.',
