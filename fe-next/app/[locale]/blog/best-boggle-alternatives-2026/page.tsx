...
const metaTitles: Record<string, string> = {
  en: '6 Best Word Games Like Boggle — Alternatives Tested (2026)',
...
const metaDescriptions: Record<string, string> = {
  en: 'The best word games like Boggle in 2026 — tested & ranked. Wordle, Words With Friends, LexiClash compared. Honest picks, free, no download needed.',
