...
export default function OrdspelFamiljerPageClient(): React.ReactElement {
  ...
  const relatedHeading = relatedHeadingByLocale[locale] || relatedHeadingByLocale.sv;
