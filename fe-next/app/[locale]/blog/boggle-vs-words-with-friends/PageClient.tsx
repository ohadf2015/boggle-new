...
export default function BoggleVsWwfPageClient(): React.ReactElement {
    ...
    <div className={cn(
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 page-content-safe">
        ...
        <header className="mb-8">
          ...
          <div className={cn(
            ...
            <span className="flex items-center gap-1">
              ...
              {new Date('2026-03-28').toLocaleDateString(toBcp47Locale(language), { month: 'long', day: 'numeric', year: 'numeric' })}
            </span>
            <span className="flex items-center gap-1">
        ...
        <div className={cn(
          ...
          <RelatedArticles
            currentSlug="boggle-vs-words-with-friends"
            locale={locale}
