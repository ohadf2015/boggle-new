...
La palabra de siete letras pega distinto cuando la oye toda la sala.`,
  ...
  ru: {
    ...
    subtitle: 'Твой мозг буквально переключается на другое ПО, когда в комнате появляются люди. Наука это доказывает.',
    category: 'Социальная наука',
    readTime: '11 минут',
    authorName: 'Ohad Fisher',
    authorBio: 'Однажды принудил незнакомца в поезде играть в Boggle четыре остановки дольше, чем ему было нужно. Оба рады.',
    sections: [
      {
        content: `У меня есть таблица. Два года данных о том, как я играю в словесные игры — одна колонка для одиночных игр, другая для игр с людьми. Колонка «в одиночку» выглядит прилично. Колонка «с друзьями» консистентно выше на 15-20%.

Сначала я думал, что это просто эго. Конечно, ты стараешься больше, когда кто-то смотрит. Но оказалось, что настоящее объяснение намного странней.

На прошлой пятнице я собрал четырёх друзей, запастись закусками, и мы три часа подряд кричали друг на друга над буквами. На какой-то момент я нашел слово из семи букв. Друг сказал: «Ты невыносим.» И знаешь что? Этот момент, эта реакция — это стоило больше, чем любой рекорд, который я когда-либо ставил в одиночку. И это не метафора.

Мозг включает совершенно другие нейронные сети, когда в комнате появляются другие люди. Не образно. Буквально разные сети. Исследования по этому совершенно ясны, и как только я это узнал, всё изменилось.`,
      },
      {
        title: 'Мозг в одиночку и мозг с компанией',
        content: `Словесная игра в одиночку активирует то, что ты ожидаешь. Область Брока, область Вернике, дорсолатеральная префронтальная кора. Стандартная языковая обработка, рабочая память. Учебник.

Добавь одного человека — и вся новая сеть просыпается. Нейробиологи называют это «сетью социального мозга». Медиальная префронтальная кора, височно-теменное соединение, задняя верхняя височная борозда. По сути, все системы, которые эволюционировали для одного: понять, что думает другой человек.

Redcay с коллегами в 2010 году запихнули людей в аппарат fMRI и сравнили одиночные задачи с интерактивными. При интерактивных условиях регионы, отвечающие за ментализацию, активировались намного сильнее. Опубликовано в Cerebral Cortex, если хочешь проверить.

На практике это значит: когда я играю в одиночку, я ищу слова. Когда я играю с кем-то ещё, я ищу слова, отслеживаю, что может найти противник, стратегически планирую, и пытаюсь скрыть, что я завис. Двойная работа. И мозг это делает не каждый день.

Должно быть утомительно. Но нет. Социальная сеть мозга и система вознаграждения активируются вместе. Больше когнитивной нагрузки, больше удовольствия. Странная сделка, но я согласен.`,
      },
      {
        title: 'Почему соперничество делает тебя умнее',
        content: `Группа Decety опубликовала в 2004 году кое-что дикое. Они сказали людям: «Ты играешь против человека» или «Ты играешь против компьютера.» Иногда «человек» был на самом деле алгоритмом. Не имело значения. Те, кто верил, что противник человек, показывали повышенную активность в регионах стратегического планирования и предвкушения награды.

Мозг не интересует истина. Его интересует то, во что ты веришь.

Это совершенно совпадает с моим опытом. Против бота — я заинтересован. Нормально. Но против кого-то, кто точно будет меня высмеивать, если я проиграю? Каждый нейрон ищет длинные слова. Конкурентное давление делает что-то, что таблица лидеров никогда не сможет повторить.

Festinger называл это теорией социального сравнения еще в 1954 году. Мы оцениваем себя не по абстрактным стандартам, а в сравнении с другими людьми. В словесной игре каждое слово, которое нашел противник, пересчитывает твой внутренний счётчик «я достаточно хорош?» Отстаёшь? Давай напрягайся. Впереди? Не расслабляйся.

Но есть предел. Слишком много давления — и ты переходишь из режима мотивации в режим тревоги, а тревожный мозг ужасен в поиске творческих слов. Идеальная точка — низко-ставочная конкуренция. Только право похвастаться. Вот почему спокойный вечер игр кажется намного лучше турнира.`,
      },
      {
        title: 'Когда все начинают придумывать одновременно',
        content: `Jackbox разрушил мне представление о словесных играх. Раньше я думал, что это тихое, мозговое занятие. Потом я играл Quiplash на вечеринке и понял, что словесные игры перед публикой — это совсем другая наркотик.

Дизайнеры игр называют это «общим творческим пространством». Несколько людей генерируют идеи одновременно, отскакивают друг от друга, и результат группы оказывается в месте, куда никто из них не пришел бы один. Хотя тут надо быть честным: исследование Osborn о брейнштормах в 1950-х годах показало, что люди индивидуально генерируют больше идей, чем в группах. Группы имеют социальное трение. Люди стесняются, говорят одновременно, цензурируют себя.

Но идеи, которые выходят из групп, они странные и креативные. Особенно когда формат правильный. Словесные игры — правильный формат. Есть структура (должно быть настоящее слово), временное давление (без переанализирования), и мгновенная реакция публики («Погодите, это слово?!»).

Я помню рауд два года назад, когда подруга нашла ZOEA. Полстола сказало, что такого слова нет. Она нашла словарь. Это множественное число от zoea — личинка ракообразного. Дебаты длились дольше, чем сам раунд. Такого не будет, если ты одна сидишь с телефоном в полночь.

Зеркальные нейроны причастны к этому. Когда кто-то искренне удивляется твоему слову, твой мозг зеркалит эту эмоцию и усиливает исходное удовольствие. Обратная связь начинает крутиться. Хорошее слово, большая реакция, сильнее ощущение, попытка превзойти на следующем раунде.`,
      },
      {
        title: 'Что было в 2020 году',
        content: `Words With Friends получил на 40% больше ежедневных пользователей в марте 2020 года. Scrabble GO запустился посередине пандемии и скачался миллионы раз. Люди были запертой и нуждались в способе чувствовать связь, которая не требовала ещё один Zoom after work.

Vuorre и коллеги опубликовали в Computers in Human Behavior в 2021 году, что социальный гейминг во время lockdown был связан с лучшим психическим здоровьем. Но только если там была реальная двусторонняя интерация. Просто играть рядом с кем-то или асинхронно без чата — не то же самое. Коммуникация была активным ингредиентом.

Я могу это подтвердить. Мои друзья из университета и я запустили еженедельный Boggle по Zoom той весной. Мы говорили себе, что это про игру. Это не было про игру. Это была час, когда мы кричали друг на друга о сомнительных словах, а потом ещё двадцать минут разговаривали о жизни, при этом делая вид, что всё ещё обсуждаем правила.

Когда я вспоминаю 2020, те четверговые вечера среди самых ярких воспоминаний, которые у меня есть. Не потому что игры были хорошие. Потому что связь была. Даже через экран, с плохим звуком и чьим-то котом, ходящим по клавиатуре — это работало. Словесные игры дали нам предлог быть друг с другом, без того чтобы говорить: «Мне одиноко и мне нужно видеть твоё лицо.»`,
      },
      {
        title: 'В одной комнате — это другое',
        content: `Кафе настольных игр выросли с менее чем 1000 по всему миру в 2015 году до более чем 5000 в 2023 году. Желание играть вместе в живую не умерло. Оно стало сильнее.

Я начал устраивать месячные вечера словесных игр. Закуски, таймер, буквенные плитки, кто придёт. Без формальных приглашений. Без сложных правил.

Что меня каждый раз удивляет — насколько это отличается от онлайна. Онлайн — веселье. Но в одной комнате информация течёт, которую экран не может передать. Чья-то колено подскакивает, потому что они застряли. Небольшой вздох, когда сетка плохая. Поднятая бровь через стол, когда твой друг играет что-то неожиданное.

Baltes и его группа в 2002 году сравнили очные группы с удаленными. Очные выигрывали в координации и творческом решении проблем. Не удивительно, но размер эффекта был больше, чем я ожидал. Физическая близость изменяет не просто как люди себя чувствуют в группе. Она изменяет как они думают вместе.`,
      },
      {
        title: 'Искусство называть друга «лексической аферой»',
        content: `Никто об этом не говорит, но трёх-разговор — это половина сути.

Назвать кого-то «лексической аферой» за то, что он сыграл АТ за два очка. Театральный вздох, когда противник находит семибуквенное слово. Поддельное возмущение, притворный ужас, обиды, которые длятся ровно до начала следующего раунда.

Психологи называют это «аффилиативной дразнью.» Исследование Keltner в 2001 году показало, что игривые оскорбления на самом деле укрепляют социальные связи. Они сигнализируют доверие. Ты можешь назвать кого-то мошенником только если вы оба знаете, что ты не имеешь в виду. Это тест отношений и одновременно развлечение.

Но в словесных играх трёх-разговор делает что-то ещё. Он превращает упражнение на словарный запас в историю. Моя группа друзей всё ещё говорит об «Инциденте с Сарой». Три года назад она сыграла слово, которое разделило стол на двадцатиминутный спор о правилах. Мы это вспоминаем как минимум раз в месяц. Без этого спора раунд был бы забыт к следующему утру.

Каждый вечер игр генерирует такой материал. Внутренние шутки, повторяющиеся номера, старые враги. Исследования о совместных новых опытах и качестве отношений говорят, что это имеет значение. Пары и группы друзей, которые делают интересные вещи вместе, сообщают о более высокой удовлетворённости. Словесные игры проверяют оба квадрата. Новая сетка каждый раз, давление времени держит адреналин, достаточно конкурентного напряжения, чтобы казалось, что что-то на кону. Даже если на кону только то, кто следующий раз купит закуски.`,
      },
      {
        title: 'Scrabble с родителями был важнее, чем ты думаешь',
        content: `Я играл Scrabble с родителями каждое воскресенье вечер, когда рос. В двенадцать я думал, что это самое скучное из всего. В тридцать я понял, что это была одна из самых важных вещей, которые они для меня делали.

Лонгитюдное исследование Coyl-Shepherd и Newland, опубликованное в Journal of Family Issues в 2013 году, отслеживало семьи. Те, кто регулярно играли вместе, имели более сильное сплочение, лучшее общение между родителями и детьми, и более высокие оценки удовлетворённости. И это оставалось правдой, даже когда контролировались другие семейные действия.

Словесные игры имеют конкретное преимущество: не нужно, чтобы все были на одном уровне. Моя племянница начала приходить на игровые вечера в семь лет, находя КОТ и СОБАКА, пока взрослые охотились за длинными словами. Теперь ей одиннадцать. В прошлом месяце она победила двух взрослых. Без формального обучения, без карточек. Просто впитала словарный запас, сидя за столом.

Есть новейшие исследования про бабушек и дедушек, играющих с внуками вместе. Обе стороны выигрывают. Бабушки-дедушки получают когнитивную стимуляцию и социальное участие — два из самых сильных защитных факторов против когнитивного упадка. Внуки получают воздействие словарного запаса и сосредоточенное внимание взрослого, который не пытается делать три вещи одновременно.

Обзор 2022 года в Educational Psychology Review назвал это «низкотревожной средой обучения.» Игры создают теплоту. Теплота снижает тревогу производительности, которая затрудняет обучение. Дети лучше запоминают новые слова из игры, чем из карточек. Что имеет смысл. Никто никогда не испытывал стресс, играя Boggle с бабушкой.`,
      },
      {
        title: 'Организуй вечер игр. По-настоящему.',
        content: `Всё, что я прочитал, и всё, что я испытал, указывает в одну сторону. Словесные игры лучше с людьми. Когнитивные преимущества реальны в любом случае. Но социальная версия добавляет слои, которых одиночка не может коснуться: ты играешь лучше, ты чувствуешь больше, ты помнишь это дольше, и ты оканчиваешь ближе к людям, с которыми играл.

Я не ставил целью создать сообщество вокруг словесных игр. Это просто произошло. Групповой чат, где мы делимся дневными результатами. Месячный очный вечер. Иногда турнир онлайн, когда кто-то в путешествии. Если бы мне сказали пять лет назад, что моя самая стабильная социальная круг будет «друзья словесных игр,» я бы рассмеялся. Но так и произошло. Это люди, которых я вижу чаще всего. С которыми у меня больше всего внутренних шуток.

Социолог Ray Oldenburg писал о «третьих местах» — социальных пространствах, которые не дом и не работа. Бары, парикмахерские, общественные центры. Места, куда ты приходишь регулярно, атмосфера расслабленная, принадлежность градиентно нарастает. Вечер словесных игр — это третье место. Не нужно быть хорошим. Не нужно знать редкие слова. Просто приди.

Так что схвати друзей. Открой закуски. Установи таймер. Поспорьте о том, считается ли жи словом. (Считается. Это инструмент для разведения пчёл, и я буду спорить об этом с кем угодно.) Посмотри, что происходит, когда ты перестаёшь играть один и начинаешь играть с людьми.

Семибуквенное слово звучит иначе, когда это слышит вся комната.`,
      },
      {
        content: `Источники:
- Redcay, E., et al. (2010). "fMRI evidence of a neural modulation by social norm information." Cerebral Cortex.
...
- Educational Psychology Review (2022). "Low-anxiety learning environments in games-based education."`,
    ...
    tryDaily: 'Попробуйте ежедневный челлендж',
    practice: 'Играйте мультиплеер',
    scrabbleAlternativeCta: 'Бесплатная мультиплеерная словесная игра',
  },
};
