...
export default function MultiplayerSocialPageClient(): React.ReactElement {
  ...
  const blogIndexContent = {
    en: {
      ...
      'vocabulary-building-strategies': { title: 'I Learned 500 New Words in 30 Days', excerpt: 'Practical vocabulary building through word games and spaced repetition.', readTime: '12 min read', category: 'Learning' },
    },
  };
    ...
    <div className={cn(
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 page-content-safe">
        ...
        <header className="mb-8">
          ...
          <div className={cn(
            ...
            <span className="flex items-center gap-1">
              ...
              {safeToLocaleDateString(new Date('2026-02-15'), language, { month: 'long', day: 'numeric', year: 'numeric' })}
            </span>
            <span className="flex items-center gap-1">
        ...
        <div className={cn(
            ...
            <div className="flex flex-wrap gap-4">
              ...
              >
                <Button className="rounded-neo border-3 border-neo-black bg-neo-pink text-neo-black font-bold shadow-hard hover:shadow-hard-lg">
                  {content.scrabbleAlternativeCta}
                </Button>
              </Link>
            </div>
          </div>
          ...
          <RelatedArticles
            currentSlug="multiplayer-word-games-social"
            locale={locale}
