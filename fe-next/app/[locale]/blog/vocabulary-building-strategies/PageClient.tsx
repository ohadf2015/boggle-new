...
export default function VocabularyPageClient(): React.ReactElement {
  ...
  const blogIndexContent = {
    en: {
      ...
      'multiplayer-word-games-social': { title: 'Why Playing Word Games With Friends Hits Different', excerpt: 'The science of social gaming, competitive cognition, and party word games.', readTime: '11 min read', category: 'Social Science' },
    },
  };
    ...
    <div className={cn(
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 page-content-safe">
        ...
        <header className="mb-8">
          ...
          <div className={cn(
            ...
            <span className="flex items-center gap-1">
              ...
              {new Date('2026-03-05').toLocaleDateString(toBcp47Locale(language), { month: 'long', day: 'numeric', year: 'numeric' })}
            </span>
            <span className="flex items-center gap-1">
        ...
        <div className={cn(
          ...
          <RelatedArticles
            currentSlug="vocabulary-building-strategies"
            locale={locale}
