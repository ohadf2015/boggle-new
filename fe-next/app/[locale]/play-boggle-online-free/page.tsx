...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Free Boggle Online — No Download, No Signup | LexiClash',
    description: 'Real-time Boggle for 2–50 players free online — 4×4 to 6×6 grids, daily challenges, 6 modes. No download, no signup. Start now →',
    ...
    openGraph: {
      title: 'Free Boggle Online — No Download Needed | LexiClash',
      description: 'Free Boggle for 2–50 players online — no download, no signup. Daily challenges, multiple grid sizes. Instant play in your browser!',
      locale: 'en_US',
      type: 'website',
      url: pageUrl,
      images: [
