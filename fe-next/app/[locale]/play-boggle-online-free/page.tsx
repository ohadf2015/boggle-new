...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Play boggle online free — no download, no signup. Multiplayer with 2–50 players or solo, 4x4–6x6 grids, daily challenges, boss battles. Free boggle game in your browser.',
