...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Free Boggle Online — Play Solo or Multiplayer, No Signup | LexiClash',
    description: 'Free boggle online — no download, no signup. Real-time multiplayer (2–50 players) or solo challenge. 4×4 to 6×6 grids, daily puzzles. Start now →',
