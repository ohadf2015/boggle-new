...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Boggle Online Free — No Download, Multiplayer | LexiClash',
    description: 'Play boggle online free — no download, no signup. Real-time multiplayer (2–50 players) or solo. 4×4 to 6×6 grids, daily puzzles, leaderboards. Start →',
