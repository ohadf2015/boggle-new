...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Play boggle online free — no download, no signup. Solo or multiplayer with 2-20+ friends. 4x4 to 6x6 grids, daily challenges & boss battles. Instant play.',
