...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Play Boggle free online — no download, no signup. Solo or multiplayer with 2–20 friends. 4×4–6×6 grids, daily challenges. Best Boggle alternative 2026.',
