...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Free Boggle Game Online — Play Now, No Download | LexiClash',
    description: 'Free boggle game online — no download, no signup. Solo vs bots or multiplayer with 2–50 players. 4×4 to 6×6 grids, daily Word Wheel. Start now →',
    ...
    openGraph: {
      title: 'Free Boggle Game Online — Play Now, No Download | LexiClash',
      description: 'Free boggle game online — no download, no signup. Solo or multiplayer with 2–50 players. Instant play in your browser!',
      locale: 'en_US',
      type: 'website',
      url: pageUrl,
      images: [
