...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Play Boggle Online Free — With Friends or Solo, No Download | LexiClash',
    description: 'Play Boggle online free with friends or solo — no download, no account needed. Real-time word battles with up to 50 players. Start instantly →',
