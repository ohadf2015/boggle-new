...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Play Boggle Online Free — Multiplayer, No Download | LexiClash',
    description: 'Play boggle online free — no download, no signup. Real-time multiplayer up to 50 players or solo challenge. 4×4 to 6×6 grids, daily puzzles. Start now →',
