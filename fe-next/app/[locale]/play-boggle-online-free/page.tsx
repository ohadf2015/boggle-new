...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Free Boggle Online Game — No Download, No Signup | LexiClash',
    description: 'Play free Boggle online — no download or signup. Solo or multiplayer with up to 50 players. 4×4–6×6 letter grids, daily challenges. Start now →',
