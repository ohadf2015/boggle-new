...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Play Boggle free online — instant browser play, no download, no signup. Solo vs bots or real-time multiplayer up to 50 players. 4×4 to 6×6 grids. Start now →',
