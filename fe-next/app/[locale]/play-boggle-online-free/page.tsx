...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Play Boggle Online Free — Multiplayer, No Signup | LexiClash',
    description: 'Play boggle online free with friends — no download, no signup. 2–50 players, 4×4 to 6×6 grids, real-time multiplayer or solo vs bots. Start now →',
