...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Free Boggle Online — No Download, No Account | LexiClash',
    description: 'Free Boggle online — no download, no account. Challenge friends in real-time or take on AI bots. Up to 50 players, instant play in your browser →',
