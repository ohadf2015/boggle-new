...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Boggle Online Free — No Download, No Signup | LexiClash',
    description: 'Play Boggle online free with 2–50 players — no download, no signup. Solo or multiplayer, 4×4 to 6×6 grids, daily challenges. Start now →',
