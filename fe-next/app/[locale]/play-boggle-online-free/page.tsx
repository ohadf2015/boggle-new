...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Play Boggle Online Free — No Signup, No Download | LexiClash',
    description: 'Play boggle online free — no download, no signup. Real-time multiplayer (2–50 players) or solo vs bots. 4×4 to 6×6 grids, daily puzzles. Start now →',
