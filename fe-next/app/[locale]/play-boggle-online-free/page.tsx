...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Play boggle online free — no download, no signup. Multiplayer with 2–50 players, 4×4–6×6 grids, daily challenges. Best online boggle game. Start now →',
