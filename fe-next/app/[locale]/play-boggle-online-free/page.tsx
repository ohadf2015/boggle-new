...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Boggle Online Free — play instantly in your browser, no download, no account. Multiplayer up to 50 players or solo vs bots. 4×4 to 6×6 grids. Start now →',
