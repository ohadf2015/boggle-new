...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: 'Free Boggle Online — Play Solo or Multiplayer, No Download | LexiClash',
    description: 'Play Boggle online free — no download, no account needed. Solo vs AI bots or real-time multiplayer with up to 50 players. Start instantly →',
