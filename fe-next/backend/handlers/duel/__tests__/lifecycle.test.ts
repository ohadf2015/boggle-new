...
describe('Duel Lifecycle Handlers', () => {
  ...
  // duel:rematch moved to ./rematch.ts — it is a two-tap handshake now, and its
  // tests live in rematch.test.ts. The old per-tap INSERT tested here is the bug
  // that stranded both students in two different duel rooms.
});
