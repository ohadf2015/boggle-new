...
// Frequency-banding helper moved to a dependency-free module so other bot drivers
// (blast, wheel-rush) can reuse it without importing this heavy module. Imported
// for local use (prepareBotWords) and re-exported for backward compat (existing
// imports + tests).
import { orderWordPoolByFrequencyBand, MIN_CORPUS_FOR_BANDING } from './wordFrequencyBanding';
export { orderWordPoolByFrequencyBand, MIN_CORPUS_FOR_BANDING };
