-- =====================================================
-- Migration 026: Add Word Hunt Leaderboard Views
-- =====================================================
-- Creates the missing leaderboard views for Word Hunt mode:
-- 1. daily_word_hunt_leaderboard - Daily rankings by efficiency
-- 2. word_hunt_alltime_leaderboard - All-time rankings by total efficiency
-- =====================================================

-- Create daily Word Hunt leaderboard view
...
COMMENT ON VIEW daily_word_hunt_leaderboard IS 'Daily Word Hunt leaderboard with player rankings by efficiency score';

-- Create all-time Word Hunt leaderboard view
...
GROUP BY dwa.player_id, dwa.guest_fingerprint, dwa.language, p.display_name, p.avatar_emoji, p.avatar_color, p.profile_picture_url, p.country_code
ORDER BY rank_position ASC;

COMMENT ON VIEW word_hunt_alltime_leaderboard IS 'All-time Word Hunt leaderboard ranked by total efficiency score across all puzzles';
