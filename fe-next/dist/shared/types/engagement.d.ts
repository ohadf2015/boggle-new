 ...
 */
export type ChallengeType = 'word_count' | 'long_words' | 'perfect_games' | 'combo' | 'speed_run' | 'social_play' | 'accuracy' | 'unique_words';
...
export type CalendarRewardType = 'xp' | 'hints' | 'streak_freeze' | 'mystery_box' | 'exclusive_title';
...
export type MysteryRewardTrigger = 'game_completion' | 'long_word' | 'achievement' | 'win';
export type MysteryRewardType = 'xp_multiplier' | 'bonus_hints' | 'streak_freeze' | 'xp_flat' | 'rare_title' | 'instant_xp' | 'combo_boost';
