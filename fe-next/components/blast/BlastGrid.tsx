...
export const BlastGrid = memo(function BlastGrid({
  ...
  return (
    <div
      ref={containerRef}
      className={`blast-game blast-grid-frame relative w-full aspect-square max-w-[360px] md:max-w-[420px] lg:max-w-[min(480px,50vh)] transition-shadow duration-300 overflow-hidden ${!isInteractive ? 'ring-2 ring-cyan-400/30 ring-offset-1 ring-offset-transparent' : ''}`}
