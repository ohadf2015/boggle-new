...
const PAIR_COMBOS: Array<{
  ...
  // Highest multiplier pairs first
  { a: 'prism',     b: 'prism',     comboType: 'prism_prism',         scoreMultiplier: 10 },
  { a: 'prism',     b: 'rainbow',   comboType: 'prism_rainbow',       scoreMultiplier: 7  },
  { a: 'lightning', b: 'prism',     comboType: 'lightning_prism',     scoreMultiplier: 6  },
  { a: 'prism',     b: 'mirror',    comboType: 'prism_mirror',        scoreMultiplier: 6  },
  { a: 'prism',     b: 'magnet',    comboType: 'prism_magnet',        scoreMultiplier: 6  },
  { a: 'bomb',      b: 'prism',     comboType: 'bomb_prism',          scoreMultiplier: 5  },
  { a: 'prism',     b: 'gem',       comboType: 'prism_gem',           scoreMultiplier: 5  },
  { a: 'bomb',      b: 'magnet',    comboType: 'bomb_magnet',         scoreMultiplier: 5  },
  { a: 'lightning', b: 'rainbow',   comboType: 'lightning_rainbow',   scoreMultiplier: 5  },
  { a: 'lightning', b: 'magnet',    comboType: 'lightning_magnet',    scoreMultiplier: 5  },
  { a: 'mirror',    b: 'magnet',    comboType: 'mirror_magnet',       scoreMultiplier: 5  },
  { a: 'mirror',    b: 'gem',       comboType: 'mirror_gem',          scoreMultiplier: 5  },
  { a: 'magnet',    b: 'gem',       comboType: 'magnet_gem',          scoreMultiplier: 5  },
  ...
  { a: 'bomb',      b: 'rainbow',   comboType: 'bomb_rainbow',        scoreMultiplier: 4  },
  { a: 'bomb',      b: 'mirror',    comboType: 'bomb_mirror',         scoreMultiplier: 4  },
  { a: 'bomb',      b: 'gem',       comboType: 'bomb_gem',            scoreMultiplier: 4  },
  { a: 'lightning', b: 'mirror',    comboType: 'lightning_mirror',    scoreMultiplier: 4  },
  { a: 'lightning', b: 'gem',       comboType: 'lightning_gem',       scoreMultiplier: 4  },
  { a: 'rainbow',   b: 'mirror',    comboType: 'rainbow_mirror',      scoreMultiplier: 5  },
  { a: 'rainbow',   b: 'magnet',    comboType: 'rainbow_magnet',      scoreMultiplier: 4  },
  { a: 'rainbow',   b: 'gem',       comboType: 'rainbow_gem',         scoreMultiplier: 4  },
  { a: 'prism',     b: 'frozen',    comboType: 'prism_frozen',        scoreMultiplier: 4  },
  { a: 'mirror',    b: 'frozen',    comboType: 'mirror_frozen',       scoreMultiplier: 4  },
  { a: 'magnet',    b: 'frozen',    comboType: 'magnet_frozen',       scoreMultiplier: 4  },
  { a: 'gem',       b: 'frozen',    comboType: 'gem_frozen',          scoreMultiplier: 4  },
  { a: 'bomb',      b: 'bomb',      comboType: 'bomb_bomb',           scoreMultiplier: 3  },
  { a: 'bomb',      b: 'frozen',    comboType: 'bomb_frozen',         scoreMultiplier: 3  },
  { a: 'lightning', b: 'frozen',    comboType: 'lightning_frozen',    scoreMultiplier: 3  },
  { a: 'rainbow',   b: 'frozen',    comboType: 'rainbow_frozen',      scoreMultiplier: 3  },
];
