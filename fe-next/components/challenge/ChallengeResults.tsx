...
const ChallengeResults: React.FC<ChallengeResultsProps> = ({
  ...
  return (
    <div className="flex-1 min-h-screen flex items-center justify-center bg-neo-navy dark:from-neo-navy dark:via-neo-navy-light dark:to-neo-navy p-4 overflow-y-auto scrollable-area">
      <motion.div
