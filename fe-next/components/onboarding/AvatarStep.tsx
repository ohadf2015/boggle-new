  ...
  return (
    <div className="flex flex-col items-center space-y-6">
      ...
      <motion.div
        ...
        className="bg-neo-yellow border-3 border-neo-black rounded-neo p-4 shadow-hard-md"
      >
        <div className="flex flex-col items-center gap-3">
          <div className="relative w-24 h-24 rounded-full overflow-hidden border-3 border-neo-black shadow-hard-sm">
            <Image
          ...
          <div className="text-center">
            <div className="text-xs text-neo-black/60">
              {t('onboarding.avatar.selected')}
            </div>
            <div className="font-black text-lg text-neo-black">
              {selectedAvatar.name}
            </div>
          </div>
        </div>
          ...
          {AVATARS.map((avatar, index) => {
            ...
            return (
              <motion.button
                ...
                className={cn(
                  'relative aspect-square rounded-neo border-3 overflow-hidden',
                  'transition-all hover:scale-105 active:scale-95',
                  'min-h-[60px] min-w-[60px]',
                  isSelected
                    ? 'border-neo-cyan shadow-hard-md scale-105 ring-3 ring-neo-pink'
              ...
              >
                ...
                {isSelected && (
                  ...
                  >
                    <div className="bg-neo-pink border-2 border-neo-black rounded-full w-8 h-8 flex items-center justify-center font-black text-sm shadow-hard-sm">
                      ✓
                    </div>
                  </motion.div>
                )}
