      ...
      <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className={cn(
                  ...
                  selectedStatus === option.value
                    ...
                    : 'bg-white dark:bg-slate-700 border-gray-200 dark:border-slate-600 text-gray-700 dark:text-gray-300 hover:border-gray-400'
                )}
              >
                {option.label}
              </button>
        ...
        <div className="flex items-center gap-2 flex-1">
          <input
            ...
            className="px-2 py-1.5 border-2 border-gray-200 dark:border-slate-600 rounded-lg text-sm bg-white dark:bg-slate-700 text-gray-800 dark:text-gray-200"
          />
