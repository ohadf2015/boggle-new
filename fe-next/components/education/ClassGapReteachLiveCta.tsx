/**
 * Class-gap → 3-min reteach Live handoff.
 *
 * The share card is public (parents / Slack / Google Classroom Stream). One click
 * stages the missed words into lessonGameData with a 3-minute timer and opens a
 * NEW Live room as host. This is not the same-room reteach round (#896).
 */
'use client';
