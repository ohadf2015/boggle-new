    ...
    <div className="flex flex-col gap-3 md:gap-4 md:flex-1 md:min-h-0">
      {sweep && (
        ...
        >
          ...
          <span className="font-neo-display font-black text-xl uppercase tracking-wide md:text-[2.2vw]">
            {t('vocabQuiz.sweep.title')}
          </span>
          <span className="font-neo-body text-base md:text-[1.3vw]">{t('vocabQuiz.sweep.subtitle')}</span>
        </div>
      )}
          ...
          return (
            ...
            >
              ...
              <div className="relative h-full flex items-center gap-3 md:gap-4 px-4 py-3 md:px-5 md:py-4">
                ...
                <span className="flex-1 min-w-0 font-neo-display font-bold text-lg break-words md:text-[1.8vw]">{choice}</span>
                {isCorrect && (
