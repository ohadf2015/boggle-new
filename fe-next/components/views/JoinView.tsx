...
const JoinView: React.FC<JoinViewProps> = ({
  ...
  // Main join/host form
  return (
    <div dir={dir} className="flex-1 bg-neo-navy pt-4 flex flex-col items-center justify-start md:justify-center p-2 sm:p-4 md:p-6 overflow-auto transition-colors duration-300">
