...
const WITTY_MESSAGES: Record<string, Record<string, string[]>> = {
  ...
  sv: {
    legendary: ["Ordboken är rädd för mig nu", "Ordmästare i tjänst"],
    amazing: ["Ordförråd? Check. Motståndare? Krossade."],
    good: ["Inte illa alls", "Bokstäverna var rädda idag"],
    normal: ["Varje ord räknas!"],
  },
  es: {
    legendary: ["El diccionario me tiene miedo", "Maestro de palabras al servicio"],
    amazing: ["¿Vocabulario? Listo. ¿Oponentes? Destruidos."],
    good: ["Nada mal", "Las letras me temían hoy"],
    normal: ["¡Cada palabra cuenta!"],
  },
  fr: {
    legendary: ["Le dictionnaire a peur de moi", "Maître des mots au service"],
    amazing: ["Vocabulaire? OK. Adversaires? Détruits."],
    good: ["Pas mal du tout", "Les lettres me craignaient aujourd'hui"],
    normal: ["Chaque mot compte!"],
  },
  de: {
    legendary: ["Das Wörterbuch hat Angst vor mir", "Wortmeister im Dienst"],
    amazing: ["Wortschatz? Check. Gegner? Zerstört."],
    good: ["Nicht schlecht", "Die Buchstaben hatten heute Angst"],
    normal: ["Jedes Wort zählt!"],
  },
};
