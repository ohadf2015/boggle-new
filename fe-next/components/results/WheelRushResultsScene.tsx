...
import { Crown, Lock, Sparkles, Sword, Swords, Trophy } from 'lucide-react';
        ...
        >
          ...
          <div className="mt-1.5 text-center">
            ...
            <div className="flex items-center justify-center gap-1 text-[10px] uppercase tracking-wider text-neo-white mt-0.5">
              ...
              <Swords className="w-3 h-3 text-neo-red" />
              <span className="tabular-nums">{winner[1].wordsStolen}</span>
            </div>
          </div>
        </div>
