        ...
        <div className="bg-neo-purple border-3 border-neo-black rounded-neo shadow-hard-lg p-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 px-4 py-2.5 bg-neo-yellow text-neo-black font-bold border-3 border-neo-black rounded-neo shadow-hard-sm hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-hard transition-all duration-100 uppercase text-sm"
            >
