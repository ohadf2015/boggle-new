    ...
    <>
      <div
        ...
        className={cn(
          ...
          'bg-neo-navy/90 animate-in fade-in-0 duration-300',
          className
        )}
      >
        {/* Pause Card */}
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className={cn(
                ...
                'shadow-hard hover:shadow-hard-lg hover:scale-[1.02] hover:-translate-y-0.5',
                'active:scale-[0.98]',
            ...
            <button
              ...
              className={cn(
                ...
                'hover:bg-neo-white/20 hover:border-neo-white/30 hover:scale-[1.02] hover:-translate-y-0.5',
                'active:scale-[0.98]',
                'transition-all duration-200'
              )}
            >
            ...
            <button
              ...
              className={cn(
                ...
                'hover:bg-neo-red/10 hover:text-neo-red hover:border-neo-red/30 hover:scale-[1.02] hover:-translate-y-0.5',
                'active:scale-[0.98]',
                'transition-all duration-200'
              )}
            >
