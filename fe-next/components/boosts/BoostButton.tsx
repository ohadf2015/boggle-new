  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-2 rounded-neo border-neo bg-neo-pink px-4 py-2 font-neo-display text-neo-cream shadow-hard hover:active:shadow-hard-pressed disabled:opacity-50"
      >
