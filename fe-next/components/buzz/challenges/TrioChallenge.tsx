    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        <motion.div
          ...
          className="inline-block px-4 py-2 bg-neo-lime/10 rounded-lg border border-neo-lime/30 mb-3"
        >
          <span className="text-xs font-black text-neo-lime uppercase tracking-wider">
            <Sparkles className="w-4 h-4 inline me-2" />
            {t('buzz.type.trio') || 'TRIO'}
          </span>
        </motion.div>
      ...
      >
        <input
          ...
          autoFocus
          className="w-full px-6 py-4 text-2xl font-black text-center text-white bg-slate-800 border-3 border-neo-black rounded-xl shadow-hard focus:border-neo-lime focus:shadow-hard-lg outline-none transition-all uppercase tracking-wider"
        />
      </motion.div>
      ...
      >
        <Button
          ...
          className="w-full py-6 text-xl font-black uppercase bg-neo-lime text-neo-black border-3 border-neo-black rounded-xl shadow-hard hover:shadow-hard-lg disabled:opacity-50"
        >
