  ...
  return (
    <Page size="A4" style={isRTL ? styles.pageRTL : styles.page}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableHeader}>
            <Text style={[styles.tableHeaderCell, styles.wordCol1]}>{t('teacher.reports.columns.word')}</Text>
            <Text style={[styles.tableHeaderCell, styles.wordCol2]}>{t('teacher.reports.columns.status')}</Text>
            <Text style={[styles.tableHeaderCell, styles.wordCol3]}>{t('teacher.reports.columns.accuracy')}</Text>
            <Text style={[styles.tableHeaderCell, styles.wordCol4]}>{t('teacher.reports.columns.attempts')}</Text>
          </View>
      ...
      <View style={styles.footer} fixed>
        <Text>{t('teacher.reports.generatedBy')} - {formatDate(data.generatedAt)}</Text>
      </View>
    </Page>
  );
}
  ...
  return (
    <Page size="A4" style={isRTL ? styles.pageRTL : styles.page}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>{data.classroomName}</Text>
        <Text style={styles.subtitle}>{t('teacher.reports.teacherLabel')}: {data.teacherName}</Text>
        <Text style={styles.date}>{formatDate(data.generatedAt)}</Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.metricsGrid}>
          <View style={styles.metricCard}>
            <Text style={styles.metricLabel}>{t('teacher.reports.metrics.totalStudents')}</Text>
            <Text style={styles.metricValue}>{data.metrics.totalStudents}</Text>
          </View>
          <View style={styles.metricCard}>
            <Text style={styles.metricLabel}>{t('teacher.reports.metrics.activeStudents')}</Text>
            <Text style={styles.metricValue}>{data.metrics.activeStudents}</Text>
          </View>
          <View style={styles.metricCard}>
            <Text style={styles.metricLabel}>{t('teacher.reports.metrics.classAverageAccuracy')}</Text>
            <Text style={styles.metricValue}>{data.metrics.classAverageAccuracy}%</Text>
          </View>
          <View style={styles.metricCard}>
            <Text style={styles.metricLabel}>{t('teacher.reports.metrics.completionRate')}</Text>
      ...
      {data.topPerformers.length > 0 && (
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>{t('teacher.reports.sections.topPerformers')}</Text>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>{t('teacher.reports.sections.studentRankings')}</Text>
        <View style={styles.table}>
          {/* Table Header */}
          <View style={styles.tableHeader}>
            <Text style={[styles.tableHeaderCell, styles.col1]}>{t('teacher.reports.columns.rank')}</Text>
            <Text style={[styles.tableHeaderCell, styles.col2]}>{t('teacher.reports.columns.student')}</Text>
            <Text style={[styles.tableHeaderCell, styles.col3]}>{t('teacher.reports.columns.score')}</Text>
            <Text style={[styles.tableHeaderCell, styles.col4]}>{t('teacher.reports.columns.accuracy')}</Text>
            <Text style={[styles.tableHeaderCell, styles.col5]}>{t('teacher.reports.columns.words')}</Text>
          </View>
