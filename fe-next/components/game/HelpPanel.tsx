...
import { X, HelpCircle, Zap, Trophy, Target, Keyboard } from 'lucide-react';
        ...
        <>
          ...
          >
            ...
            <div className="p-4 space-y-4">
              {/* How to Play */}
              <section className="bg-neo-cyan/10 border-2 border-neo-cyan rounded-neo p-3">
                <h3 className="font-black text-neo-black uppercase flex items-center gap-2 mb-2">
                  <Target className="w-4 h-4" />
                  {t('help.howToPlay') || 'How to Play'}
                </h3>
                <ul className="list-disc list-inside text-sm text-neo-black/80 space-y-1">
              ...
              {/* Scoring */}
              <section className="bg-neo-yellow/20 border-2 border-neo-yellow rounded-neo p-3">
                <h3 className="font-black text-neo-black uppercase flex items-center gap-2 mb-2">
                  <Trophy className="w-4 h-4" />
                  {t('help.scoring') || 'Scoring'}
                </h3>
                <div className="text-sm text-neo-black/80 space-y-1">
              ...
              {/* Combos */}
              <section className="bg-neo-orange/20 border-2 border-neo-orange rounded-neo p-3">
                <h3 className="font-black text-neo-black uppercase flex items-center gap-2 mb-2">
              ...
              <section className="bg-neo-purple/10 border-2 border-neo-purple rounded-neo p-3 hidden sm:block">
