...
import { Card as CardComponent, CardContent as CardContentComponent } from '../ui/card';
import { Badge as BadgeComponent } from '../ui/badge';

// Type assertions for JSX UI components
...
import type { LetterGrid, Avatar as AvatarType } from '@/types';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-slate-100 to-slate-200 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 p-1 md:p-4 flex flex-col transition-colors duration-300">
      ...
      <div className="flex flex-col lg:flex-row gap-1 md:gap-2 max-w-7xl mx-auto flex-grow w-full overflow-hidden">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-2 min-w-0 min-h-0">
          <div className="bg-slate-800/95 dark:bg-slate-800/95 backdrop-blur-md border border-cyan-500/40 shadow-[0_0_25px_rgba(6,182,212,0.2)] rounded-lg p-2 md:p-4">
            <GridComponent
              grid={letterGrid}
              interactive={true}
              animateOnMount={true}
