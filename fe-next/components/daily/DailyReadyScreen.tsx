...
const DailyReadyScreenInner: React.FC<DailyReadyScreenProps> = ({
  ...
  const formattedDate = useMemo(() => {
    try {
      // timeZone: 'UTC' — puzzleDate is a UTC calendar day (getDailyChallengeDate).
      // Without it, Americas evenings format midnight-UTC as the previous local day
      // while the hub still shows today's UTC ISO.
