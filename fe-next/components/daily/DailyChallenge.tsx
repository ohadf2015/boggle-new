...
const DailyChallenge: React.FC = () => {
  ...
  return (
    <div
      className={`flex-1 flex flex-col min-h-0 bg-gray-100 dark:bg-neo-navy relative [overflow-x:clip] ${phase === 'completed' || phase === 'already-played' || phase === 'playing' ? '' : 'overflow-y-auto'}`}
    >
      <AutoHideHeader />
