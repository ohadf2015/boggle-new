...
export const TryAnotherLanguage: React.FC<TryAnotherLanguageProps> = ({
  ...
  return (
    <div className="mt-6 p-4 bg-gradient-to-br from-neo-cyan/10 via-neo-purple/10 to-neo-pink/10 border-3 border-neo-black rounded-neo shadow-hard">
      <div className="flex items-center gap-3 mb-3">
        <div className="w-10 h-10 flex-shrink-0 bg-gradient-to-br from-neo-cyan to-neo-purple rounded-neo border-2 border-neo-black flex items-center justify-center shadow-hard-sm">
