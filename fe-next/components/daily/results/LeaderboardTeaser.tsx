...
/**
 * LeaderboardTeaser Component
 *
 * Shows a teaser for anonymous users who can't see the leaderboard.
 * Encourages signup to compete and track rankings.
 */
...
export const LeaderboardTeaser: React.FC<LeaderboardTeaserProps> = ({
  t,
  className = '',
}) => {
    ...
    >
      ...
      <div className="flex items-center justify-center gap-2 mb-4">
        <div className="relative">
          ...
          <Lock className="w-4 h-4 text-indigo-600 dark:text-indigo-300 absolute -bottom-1 -right-1 bg-white dark:bg-neo-navy rounded-full p-0.5" />
        </div>
      </div>

      {/* Title */}
      <h3 className="text-lg font-black text-center text-indigo-800 dark:text-indigo-200 mb-2">
        {t('daily.leaderboardLocked')}
      </h3>

      {/* Description */}
      <p className="text-sm text-center text-indigo-600 dark:text-indigo-300 mb-4">
        {t('daily.leaderboardTeaser')}
      </p>
