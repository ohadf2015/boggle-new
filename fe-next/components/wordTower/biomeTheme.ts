...
export const BIOME_THEME: Record<WordTowerBiomeId, BiomeTheme> = {
  city: {
    ...
    nativePropIds: ['hardhatPigeon', 'cityBird', 'birds', 'helicopter', 'plane', 'drone', 'blimp'],
  ...
  sky: {
    ...
    nativePropIds: ['skyManta', 'kite', 'balloon', 'paraglider', 'birds', 'blimp', 'letterFlock', 'stormCloud'],
  ...
  stratosphere: {
    ...
    nativePropIds: ['stratSerpent', 'plane', 'rocket', 'weatherBalloon', 'stormCloud'],
