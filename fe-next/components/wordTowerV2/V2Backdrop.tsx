...
/**
 * v1's whole sky — gradient, clouds, altitude props, rare sightings, ambient
 * birds — reused as DOM layers BEHIND a transparent Pixi canvas. The city and
...
export const V2Backdrop = memo(function V2Backdrop({
  ...
  const common = { biomeId: fromId, heightM: alt, reducedMotion, groundInsetPx: groundInsetPx + GROUND_STRIP_PX, city: false };
