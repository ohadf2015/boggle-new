...
const keys: string[] = [
  ...
  'wordTowerV2.brace.useFree',
  'wordTowerV2.brace.buy',
  'wordTowerV2.brace.poor',
  'wordTowerV2.brace.rescue',
  'wordTowerV2.brace.rescueLeft',
  'wordTowerV2.brace.rescueNow',
  'wordTowerV2.brace.cancel',
  'wordTowerV2.brace.short',
  'wordTowerV2.gear.foundation',
  'wordTowerV2.gear.craneYard',
  'wordTowerV2.gear.vault',
  'wordTowerV2.gear.insurance',
  'wordTowerV2.gear.landmark',
  'wordTowerV2.gear.see.foundation',
  'wordTowerV2.gear.see.craneYard',
  'wordTowerV2.gear.see.vault',
  'wordTowerV2.gear.see.insurance',
  'wordTowerV2.gear.see.landmark',
