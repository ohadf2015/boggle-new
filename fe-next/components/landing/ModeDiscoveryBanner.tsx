        ...
        >
          <div className="bg-gradient-to-r from-neo-cyan via-neo-lime to-neo-yellow border-3 border-neo-black rounded-neo shadow-hard overflow-hidden">
            ...
            <button
              ...
              className="absolute top-2 right-2 sm:top-3 sm:right-3 w-7 h-7 sm:w-8 sm:h-8 bg-neo-white/80 hover:bg-neo-white border-2 border-neo-black rounded-full flex items-center justify-center transition-colors z-10"
