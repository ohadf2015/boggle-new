  ...
  return (
    ...
    >
      <Link
        ...
        className="group relative block rounded-neo border-neo border-black bg-neo-navy-light overflow-hidden shadow-hard transition-transform hover:-translate-y-0.5 active:translate-y-0 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neo-cyan min-h-32 sm:min-h-36"
      ...
      >
        ...
        <div className="relative flex flex-col items-center justify-center text-center gap-1 px-6 py-6 pe-32 sm:pe-44">
          <span
