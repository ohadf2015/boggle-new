    ...
    <div className='flex flex-col w-full'>
      ...
      <div className="w-full animate-fade-in-fast grid grid-cols-2 gap-2 sm:gap-3 min-h-0 auto-rows-auto content-center">
        ...
        >
          <Link
            ...
            className={cn(
              ...
              'bg-linear-to-br from-neo-cyan to-cyan-400',
          ...
          >
            {isFirstTimer && (
              <motion.span
                className="absolute -top-2.5 inset-e-2 z-10 inline-flex items-center gap-1 px-2 py-0.5 bg-neo-yellow text-neo-black font-black uppercase text-[9px] border-2 border-neo-black rounded-neo shadow-hard-sm rotate-3 rtl:-rotate-3"
        ...
        >
          <Link
            ...
            className={cn(
              ...
              'bg-linear-to-br from-neo-pink to-pink-400',
              'border-3 sm:border-4 border-neo-black rounded-neo shadow-hard',
              'transition-all duration-200 min-h-[68px] sm:min-h-[88px]',
        ...
        <div className="col-span-2">
          <Suspense fallback={
            <div
              className="w-full p-1.5 sm:p-2.5 rounded-neo border-3 border-neo-black shadow-hard-lg bg-linear-to-br from-yellow-300 via-amber-400 to-orange-500"
        ...
        >
          <Link
            ...
            className={cn(
              ...
              'bg-linear-to-br from-neo-lime via-lime-400 to-lime-500',
              'border-3 sm:border-4 border-neo-black rounded-neo shadow-hard',
          ...
          >
            <Link
              ...
              className={cn(
                ...
                'bg-linear-to-br from-neo-orange to-amber-500',
                'border-3 sm:border-4 border-neo-black rounded-neo shadow-hard',
            ...
            >
              <span className="absolute top-1 inset-e-1 sm:top-2 sm:inset-e-2 px-1.5 py-0.5 sm:px-2 sm:py-0.5 bg-neo-navy text-neo-white font-black uppercase text-[8px] sm:text-[10px] border border-neo-black rounded-neo shadow-hard-xs transform rotate-3 rtl:-rotate-3">
                ADMIN
              </span>
              <div className="relative w-10 h-10 sm:w-12 sm:h-12">
