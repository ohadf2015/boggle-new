...
const ru: LandingSEOContent = {
  ...
  whatIsContent:
    'LexiClash — это бесплатная многопользовательская словесная игра в быстром темпе, в которую вы можете играть прямо в браузере. Соревнуйтесь с друзьями в боевых действиях в реальном времени на общей сетке букв — ищите слова, составляйте комбо и поднимайтесь в рейтинговой таблице. Это как Boggle встречается с Wordle, но многопользовательская. Без загрузок, без регистрации. Доступна на русском, английском, иврите, шведском и японском языках.',
  whatIsShort:
    'Бесплатные многопользовательские словесные баталии в браузере. Ищите слова, составляйте комбо, побеждайте друзей. Без загрузок, без регистрации.',
  featuresTitle: 'Почему игроки полюбили LexiClash',
  gameModes: [
    {
      title: 'Многопользовательская игра в реальном времени',
      tag: '2-20 игроков',
      description:
        'Соревнуйтесь с 2-20 игроками одновременно. Создайте комнату, поделитесь кодом и начните игру мгновенно.',
    },
    {
      title: 'Ежедневные испытания',
      tag: 'Новая головоломка каждый день',
      description:
        'Одна и та же головоломка для всех в мире каждый день. Отслеживайте вашу серию и делитесь результатами эмодзи — как Wordle.',
    },
    {
      title: 'Режим приключений',
      tag: '100 уровней',
      description:
        '100 уровней в 10 тематических мирах. Специальные плитки, боссы и бонусы делают каждый раунд свежим.',
    },
    {
      title: 'Режим взрыва',
      tag: 'Цепные реакции',
      description:
        'Взрывайте плитки в цепных реакциях. Составляйте комбо, запускайте каскады и гоните против времени.',
    },
    {
      title: 'Доски сообщества',
      tag: 'Головоломки от игроков',
      description:
        'Создавайте пользовательские сетки букв со своими словами. Публикуйте их, чтобы другие могли играть, оценивать и соревноваться.',
    },
  ],
  howToPlayTitle: 'Как играть',
  steps: [
    'Создайте или присоединитесь к игровой комнате',
    'Проведите по соседним буквам, чтобы составить слова',
    'Составляйте комбо для бонусных очков',
    'Набьте больше очков и победите!',
  ],
  highlights: ['Любое устройство, любой браузер', 'От 6 лет', 'Используется в школах', 'Без регистрации'],
  whoCanPlayTitle: 'Кто может играть?',
  whoCanPlayCards: [
    {
      label: 'Любое устройство',
      detail: 'Телефоны, планшеты, ноутбуки, настольные компьютеры — любой современный браузер, без необходимости загружать приложение.',
    },
    {
      label: 'От 6 лет',
      detail: 'Встроенные функции безопасности для детей. Соответствует COPPA с неперсонализированной рекламой для молодых игроков.',
    },
    {
      label: 'В школах',
      detail: 'Учителя используют многопользовательские словесные баталии как упражнения для расширения словарного запаса. Применяется в школах трёх континентов.',
    },
    {
      label: 'Группы друзей',
      detail: 'Организуйте игру для вечеринки с до 20 игроками. Поделитесь кодом комнаты и соревнуйтесь в реальном времени.',
    },
  ],
  gameModesTitle: 'Описание режимов игры',
  gameModesDetails: [
    {
      title: 'Многопользовательские комнаты',
      content:
        'Создайте приватную комнату и поделитесь кодом с до 20 друзьями. Все видят одну и ту же сетку букв и гонят найти слова до конца времени. Игрок с наибольшим количеством очков побеждает. Идеально для вечеринок, школ и командного строительства на расстоянии.',
    },
    {
      title: 'Одиночная игра против ботов',
      content:
        'Тренируйте свои навыки поиска слов против ИИ противников разной сложности. Устанавливайте личные рекорды, получайте достижения и совершенствуйте стратегию без давления живого соревнования.',
    },
    {
      title: 'Ежедневное испытание',
      content:
        'Свежая головоломка каждый день, одинаковая для всех игроков в мире. Выполните её, чтобы сохранить свою серию, и сравните свой результат с глобальным сообществом. Делитесь результатами сетками эмодзи, как Wordle.',
    },
    {
      title: 'Режим приключений',
      content:
        'Путешествуйте по 10 тематическим мирам со 100 уровнями нарастающей сложности. Встречайте специальные типы плиток — лед, огонь, бомбы и радугу. Побеждайте боссов силой слов и открывайте новые миры по мере продвижения.',
    },
  ],
  educationTitle: 'Разработано для обучения',
  educationContent:
    'Словесные игры — один из самых эффективных способов расширить словарный запас и улучшить орфографию. Исследования, опубликованные в AIMS Neuroscience, показывают, что словесные головоломки активируют несколько областей мозга одновременно — включая области, отвечающие за обработку языка, рабочую память и исполнительные функции. LexiClash идёт дальше, предлагая игру на пяти языках, делая его практическим инструментом для изучающих языки. Учителя используют LexiClash в школах трёх континентов, чтобы сделать упражнения на словарный запас увлекательными. Многопользовательский формат создает здоровую конкуренцию, которая мотивирует учащихся естественно расширять свой словарный запас.',
  educationStats: [
    { value: '5', label: 'Языков' },
    { value: '3', label: 'Континентов' },
    { value: '100+', label: 'Уровней' },
  ],
  faqTitle: 'Часто задаваемые вопросы',
  faq: [
    {
      question: 'LexiClash действительно бесплатна?',
      answer:
        'Да, полностью бесплатна. Нет скрытых платежей, нет подписок. Мы содержим игру благодаря ненавязчивой рекламе, которая уважает вашу приватность.',
    },
    {
      question: 'Нужно ли создавать аккаунт?',
      answer:
        'Нет. Вы можете играть как гость сразу же. Создание аккаунта (через Google или Discord) разблокирует функции, такие как рейтинговые таблицы, отслеживание достижений и сохранение прогресса на нескольких устройствах.',
    },
    {
      question: 'Какие языки поддерживаются?',
      answer:
        'LexiClash поддерживает русский, английский, иврит, шведский и японский языки. Каждый язык имеет собственный словарь, ежедневные испытания и рейтинговые таблицы. Вы можете переключаться между языками в любое время из меню настроек.',
    },
    {
      question: 'Можно ли играть на мобильном?',
      answer:
        'Конечно. LexiClash полностью адаптивна и работает в любом современном мобильном браузере. Проводите по буквам, чтобы составить слова — сенсорные элементы управления специально разработаны для мобильной игры.',
    },
    {
      question: 'Безопасна ли для детей?',
      answer:
        'Да. LexiClash разработана для игроков от 6 лет и старше. Мы соответствуем нормам COPPA, показываем только неперсонализированную рекламу и не отслеживаем поведение детей в сети.',
    },
    {
      question: 'Могу ли я создать свою доску?',
      answer:
        'Да! Используйте редактор досок сообщества, чтобы создать пользовательские сетки букв со своими словами. Публикуйте их, чтобы другие могли играть, оценивать и соревноваться. Лучшие доски размещаются на главной странице.',
    },
  ],
  communityStats: [
    { value: '40+', label: 'Стран' },
    { value: '5', label: 'Языков' },
    { value: '∞', label: 'Слов для поиска' },
  ],
  communityTitle: 'Присоединяйтесь к тысячам любителей словесных игр',
  communityContent:
    'Игроки LexiClash распределены по более чем 40 странам и пяти языкам. Присоединяйтесь к сообществу, чтобы соревноваться в глобальных рейтинговых таблицах, делиться результатами ежедневных испытаний и открывать новые словесные стратегии. Следите за нами в Instagram @lexi.clash для советов, обновлений и лучших моментов сообщества.',
};
