...
const ModeCard: React.FC<ModeCardProps> = ({
  ...
  const variantStyles = {
    cyan: {
      bg: 'bg-linear-to-br from-neo-navy via-neo-navy-light to-neo-cyan/45',
      hoverBg: 'hover:to-neo-cyan/60',
      iconBg: 'bg-neo-cyan',
    ...
    pink: {
      bg: 'bg-linear-to-br from-neo-navy via-neo-navy-light to-neo-pink/45',
      hoverBg: 'hover:to-neo-pink/60',
      iconBg: 'bg-neo-pink',
      iconText: 'text-neo-navy',
    ...
    purple: {
      bg: 'bg-linear-to-br from-neo-navy via-neo-navy-light to-neo-purple/45',
      hoverBg: 'hover:to-neo-purple/60',
    ...
    orange: {
      bg: 'bg-linear-to-br from-neo-navy via-neo-navy-light to-neo-orange/45',
      hoverBg: 'hover:to-neo-orange/60',
    ...
    lime: {
      bg: 'bg-linear-to-br from-neo-navy via-neo-navy-light to-neo-lime/45',
      hoverBg: 'hover:to-neo-lime/60',
      iconBg: 'bg-neo-lime',
      iconText: 'text-neo-navy',
    ...
    blue: {
      bg: 'bg-linear-to-br from-neo-navy via-neo-navy-light to-blue-500/45',
      hoverBg: 'hover:to-blue-500/60',
      iconBg: 'bg-blue-500',
      iconText: 'text-neo-white',
