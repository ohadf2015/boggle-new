...
const alertVariants = cva(
  ...
  [
    ...
    "p-4",
    "shadow-hard",
    "[&>svg~*]:pl-8 [&>svg~*]:rtl:pl-0 [&>svg~*]:rtl:pr-8 [&>svg+div]:translate-y-[-3px]",
    "[&>svg]:absolute [&>svg]:left-4 [&>svg]:rtl:left-auto [&>svg]:rtl:right-4 [&>svg]:top-4 [&>svg]:h-5 [&>svg]:w-5 [&>svg]:stroke-[2.5]",
  ].join(" "),
  {
    variants: {
      variant: {
