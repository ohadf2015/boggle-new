      ...
      {puzzles.map((p, i) => {
        ...
        return (
          <m.div
            ...
            className="flex items-center justify-center gap-1.5 font-neo-display text-sm"
          >
            {solved ? (
            ...
            <span className="text-neo-white/55">{p.word1}</span>
            <span
            ...
            <span className="text-neo-white/55">{p.word2}</span>
          </m.div>
        );
      })}
    </section>
