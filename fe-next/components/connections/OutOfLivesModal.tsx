            ...
            <div className="flex flex-col gap-3">
              {isAdmin ? (
                ...
                <motion.button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 rounded-neo border-neo-thick border-neo-purple bg-neo-purple text-neo-cream font-neo-display font-bold px-5 py-3 shadow-hard disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
              ...
              <button
                type="button"
                onClick={onQuit}
                className="w-full inline-flex items-center justify-center gap-2 rounded-neo border-neo border-neo-white/30 bg-transparent text-neo-white/70 font-neo-body text-sm px-5 py-2.5 hover:bg-neo-white/5 transition-colors"
              >
