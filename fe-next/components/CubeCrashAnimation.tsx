...
type AnimationPhase = 'cubes' | 'shockwave' | 'text';
...
interface CubeCrashAnimationProps {
  onComplete?: () => void;
}

const CubeCrashAnimation: React.FC<CubeCrashAnimationProps> = ({ onComplete }) => {
  const [isVisible, setIsVisible] = useState(true);
  const [phase, setPhase] = useState<AnimationPhase>('cubes');
