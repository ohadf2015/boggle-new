...
export default function PracticeWheelSandbox() {
  ...
  return (
    <div data-testid="practice-wheel" className="relative flex flex-col items-stretch w-full max-w-md mx-auto px-4 pt-3 pb-2 gap-2 h-full min-h-0 overflow-hidden md:overflow-y-auto">
