    ...
    contentSecurityPolicy: {
      directives: {
        ...
        scriptSrc: ["'self'", "'unsafe-inline'", "'unsafe-eval'",
          ...
          'https://api.gamemonetize.com', 'https://gamemonetize.com',
          'https://*.gamemonetize.com', 'https://*.gamemonetize.games'],
        ...
        frameSrc: ["'self'", 'https://*.googlesyndication.com', 'https://*.doubleclick.net',
          ...
          'https://gamemonetize.com', 'https://*.gamemonetize.com', 'https://*.gamemonetize.games'],
