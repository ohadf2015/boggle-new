...
### sealed-bid — readiness: 88% — status: IN PROGRESS
- **Why next:** RTL `+{r.points}` sign polish (minor, deferred) is the only open item; re-verify after next audit whether 90% gate should trigger.
