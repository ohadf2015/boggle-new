# Nightly BASELINE-RED alert — 2026-07-28

The nightly gate failed, but a clean-HEAD baseline gate (NO lane code) fails the SAME test file(s):
  - fe-next/app/api/stats/record-game/__tests__/route.test.ts
  - fe-next/components/daily/__tests__/DailyChallengeGame.trackGameStart.test.tsx
  - fe-next/components/daily/__tests__/WordWheelResults.crossPromoTranslation.test.tsx
